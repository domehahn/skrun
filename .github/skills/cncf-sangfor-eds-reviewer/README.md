...
7. Run `skcr validate` and `skcr asps coverage cncf-sangfor-eds-reviewer`.
8. Run `skcr compile cncf-sangfor-eds-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sangfor-eds-reviewer`.
...
```bash
skpm validate cncf-sangfor-eds-reviewer
skpm package cncf-sangfor-eds-reviewer
skpm publish cncf-sangfor-eds-reviewer
```
