...
7. Run `skcr validate` and `skcr asps coverage llmops-security-reviewer`.
8. Run `skcr compile llmops-security-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend llmops-security-reviewer`.
