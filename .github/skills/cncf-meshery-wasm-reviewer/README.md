...
7. Run `skcr validate` and `skcr asps coverage cncf-meshery-wasm-reviewer`.
8. Run `skcr compile cncf-meshery-wasm-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-meshery-wasm-reviewer`.
...
```bash
skpm validate cncf-meshery-wasm-reviewer
skpm package cncf-meshery-wasm-reviewer
skpm publish cncf-meshery-wasm-reviewer
```
