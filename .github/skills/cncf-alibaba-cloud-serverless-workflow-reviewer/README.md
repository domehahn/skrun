...
7. Run `skcr validate` and `skcr asps coverage cncf-alibaba-cloud-serverless-workflow-reviewer`.
8. Run `skcr compile cncf-alibaba-cloud-serverless-workflow-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-alibaba-cloud-serverless-workflow-reviewer`.
...
```bash
skpm validate cncf-alibaba-cloud-serverless-workflow-reviewer
skpm package cncf-alibaba-cloud-serverless-workflow-reviewer
skpm publish cncf-alibaba-cloud-serverless-workflow-reviewer
```
