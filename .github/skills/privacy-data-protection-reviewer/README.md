...
7. Run `skcr validate` and `skcr asps coverage privacy-data-protection-reviewer`.
8. Run `skcr compile privacy-data-protection-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend privacy-data-protection-reviewer`.
...
```bash
skpm validate privacy-data-protection-reviewer
skpm package privacy-data-protection-reviewer
skpm publish privacy-data-protection-reviewer
```
