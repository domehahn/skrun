...
7. Run `skcr validate` and `skcr asps coverage cncf-cargurus-supporter-reviewer`.
8. Run `skcr compile cncf-cargurus-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cargurus-supporter-reviewer`.
...
```bash
skpm validate cncf-cargurus-supporter-reviewer
skpm package cncf-cargurus-supporter-reviewer
skpm publish cncf-cargurus-supporter-reviewer
```
