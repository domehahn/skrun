...
7. Run `skcr validate` and `skcr asps coverage cncf-decathlon-contributor-reviewer`.
8. Run `skcr compile cncf-decathlon-contributor-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-decathlon-contributor-reviewer`.
...
```bash
skpm validate cncf-decathlon-contributor-reviewer
skpm package cncf-decathlon-contributor-reviewer
skpm publish cncf-decathlon-contributor-reviewer
```
