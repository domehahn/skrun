...
7. Run `skcr validate` and `skcr asps coverage release-readiness-reviewer`.
8. Run `skcr compile release-readiness-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend release-readiness-reviewer`.
