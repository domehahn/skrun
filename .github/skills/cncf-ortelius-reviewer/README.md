...
7. Run `skcr validate` and `skcr asps coverage cncf-ortelius-reviewer`.
8. Run `skcr compile cncf-ortelius-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ortelius-reviewer`.
...
```bash
skpm validate cncf-ortelius-reviewer
skpm package cncf-ortelius-reviewer
skpm publish cncf-ortelius-reviewer
```
