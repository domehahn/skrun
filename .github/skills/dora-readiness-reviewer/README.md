...
7. Run `skcr validate` and `skcr asps coverage dora-readiness-reviewer`.
8. Run `skcr compile dora-readiness-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend dora-readiness-reviewer`.
