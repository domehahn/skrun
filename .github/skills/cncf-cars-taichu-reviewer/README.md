...
7. Run `skcr validate` and `skcr asps coverage cncf-cars-taichu-reviewer`.
8. Run `skcr compile cncf-cars-taichu-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cars-taichu-reviewer`.
...
```bash
skpm validate cncf-cars-taichu-reviewer
skpm package cncf-cars-taichu-reviewer
skpm publish cncf-cars-taichu-reviewer
```
