...
7. Run `skcr validate` and `skcr asps coverage cncf-easegress-reviewer`.
8. Run `skcr compile cncf-easegress-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-easegress-reviewer`.
...
```bash
skpm validate cncf-easegress-reviewer
skpm package cncf-easegress-reviewer
skpm publish cncf-easegress-reviewer
```
