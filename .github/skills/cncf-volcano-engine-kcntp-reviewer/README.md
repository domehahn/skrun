...
7. Run `skcr validate` and `skcr asps coverage cncf-volcano-engine-kcntp-reviewer`.
8. Run `skcr compile cncf-volcano-engine-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-volcano-engine-kcntp-reviewer`.
...
```bash
skpm validate cncf-volcano-engine-kcntp-reviewer
skpm package cncf-volcano-engine-kcntp-reviewer
skpm publish cncf-volcano-engine-kcntp-reviewer
```
