...
7. Run `skcr validate` and `skcr asps coverage cncf-marqo-reviewer`.
8. Run `skcr compile cncf-marqo-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-marqo-reviewer`.
...
```bash
skpm validate cncf-marqo-reviewer
skpm package cncf-marqo-reviewer
skpm publish cncf-marqo-reviewer
```
