...
7. Run `skcr validate` and `skcr asps coverage cncf-lpi-japan-member-reviewer`.
8. Run `skcr compile cncf-lpi-japan-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-lpi-japan-member-reviewer`.
...
```bash
skpm validate cncf-lpi-japan-member-reviewer
skpm package cncf-lpi-japan-member-reviewer
skpm publish cncf-lpi-japan-member-reviewer
```
