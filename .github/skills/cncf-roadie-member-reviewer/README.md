...
7. Run `skcr validate` and `skcr asps coverage cncf-roadie-member-reviewer`.
8. Run `skcr compile cncf-roadie-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-roadie-member-reviewer`.
...
```bash
skpm validate cncf-roadie-member-reviewer
skpm package cncf-roadie-member-reviewer
skpm publish cncf-roadie-member-reviewer
```
