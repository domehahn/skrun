...
7. Run `skcr validate` and `skcr asps coverage cncf-kube-router-reviewer`.
8. Run `skcr compile cncf-kube-router-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kube-router-reviewer`.
...
```bash
skpm validate cncf-kube-router-reviewer
skpm package cncf-kube-router-reviewer
skpm publish cncf-kube-router-reviewer
```
