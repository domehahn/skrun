...
7. Run `skcr validate` and `skcr asps coverage cncf-langgraph-reviewer`.
8. Run `skcr compile cncf-langgraph-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-langgraph-reviewer`.
...
```bash
skpm validate cncf-langgraph-reviewer
skpm package cncf-langgraph-reviewer
skpm publish cncf-langgraph-reviewer
```
