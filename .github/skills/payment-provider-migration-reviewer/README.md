...
7. Run `skcr validate` and `skcr asps coverage payment-provider-migration-reviewer`.
8. Run `skcr compile payment-provider-migration-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend payment-provider-migration-reviewer`.
...
```bash
skpm validate payment-provider-migration-reviewer
skpm package payment-provider-migration-reviewer
skpm publish payment-provider-migration-reviewer
```
