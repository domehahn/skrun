...
7. Run `skcr validate` and `skcr asps coverage cncf-steamhaus-kcsp-reviewer`.
8. Run `skcr compile cncf-steamhaus-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-steamhaus-kcsp-reviewer`.
...
```bash
skpm validate cncf-steamhaus-kcsp-reviewer
skpm package cncf-steamhaus-kcsp-reviewer
skpm publish cncf-steamhaus-kcsp-reviewer
```
