...
7. Run `skcr validate` and `skcr asps coverage cncf-entigo-kcntp-reviewer`.
8. Run `skcr compile cncf-entigo-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-entigo-kcntp-reviewer`.
...
```bash
skpm validate cncf-entigo-kcntp-reviewer
skpm package cncf-entigo-kcntp-reviewer
skpm publish cncf-entigo-kcntp-reviewer
```
