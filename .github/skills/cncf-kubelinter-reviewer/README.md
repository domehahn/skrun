...
7. Run `skcr validate` and `skcr asps coverage cncf-kubelinter-reviewer`.
8. Run `skcr compile cncf-kubelinter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kubelinter-reviewer`.
...
```bash
skpm validate cncf-kubelinter-reviewer
skpm package cncf-kubelinter-reviewer
skpm publish cncf-kubelinter-reviewer
```
