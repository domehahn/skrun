...
7. Run `skcr validate` and `skcr asps coverage cncf-sup-info-information-technology-member-reviewer`.
8. Run `skcr compile cncf-sup-info-information-technology-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sup-info-information-technology-member-reviewer`.
...
```bash
skpm validate cncf-sup-info-information-technology-member-reviewer
skpm package cncf-sup-info-information-technology-member-reviewer
skpm publish cncf-sup-info-information-technology-member-reviewer
```
