...
7. Run `skcr validate` and `skcr asps coverage cncf-automq-reviewer`.
8. Run `skcr compile cncf-automq-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-automq-reviewer`.
...
```bash
skpm validate cncf-automq-reviewer
skpm package cncf-automq-reviewer
skpm publish cncf-automq-reviewer
```
