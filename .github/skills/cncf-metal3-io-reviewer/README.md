...
7. Run `skcr validate` and `skcr asps coverage cncf-metal3-io-reviewer`.
8. Run `skcr compile cncf-metal3-io-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-metal3-io-reviewer`.
...
```bash
skpm validate cncf-metal3-io-reviewer
skpm package cncf-metal3-io-reviewer
skpm publish cncf-metal3-io-reviewer
```
