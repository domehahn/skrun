...
7. Run `skcr validate` and `skcr asps coverage cncf-chaos-toolkit-reviewer`.
8. Run `skcr compile cncf-chaos-toolkit-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-chaos-toolkit-reviewer`.
...
```bash
skpm validate cncf-chaos-toolkit-reviewer
skpm package cncf-chaos-toolkit-reviewer
skpm publish cncf-chaos-toolkit-reviewer
```
