...
7. Run `skcr validate` and `skcr asps coverage cncf-platform9-elastic-machine-pool-reviewer`.
8. Run `skcr compile cncf-platform9-elastic-machine-pool-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-platform9-elastic-machine-pool-reviewer`.
...
```bash
skpm validate cncf-platform9-elastic-machine-pool-reviewer
skpm package cncf-platform9-elastic-machine-pool-reviewer
skpm publish cncf-platform9-elastic-machine-pool-reviewer
```
