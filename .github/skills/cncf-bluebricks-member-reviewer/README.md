...
7. Run `skcr validate` and `skcr asps coverage cncf-bluebricks-member-reviewer`.
8. Run `skcr compile cncf-bluebricks-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-bluebricks-member-reviewer`.
...
```bash
skpm validate cncf-bluebricks-member-reviewer
skpm package cncf-bluebricks-member-reviewer
skpm publish cncf-bluebricks-member-reviewer
```
