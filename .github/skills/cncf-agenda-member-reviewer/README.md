...
7. Run `skcr validate` and `skcr asps coverage cncf-agenda-member-reviewer`.
8. Run `skcr compile cncf-agenda-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-agenda-member-reviewer`.
...
```bash
skpm validate cncf-agenda-member-reviewer
skpm package cncf-agenda-member-reviewer
skpm publish cncf-agenda-member-reviewer
```
