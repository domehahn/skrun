...
7. Run `skcr validate` and `skcr asps coverage cncf-tencent-cloud-kcsp-reviewer`.
8. Run `skcr compile cncf-tencent-cloud-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-tencent-cloud-kcsp-reviewer`.
...
```bash
skpm validate cncf-tencent-cloud-kcsp-reviewer
skpm package cncf-tencent-cloud-kcsp-reviewer
skpm publish cncf-tencent-cloud-kcsp-reviewer
```
