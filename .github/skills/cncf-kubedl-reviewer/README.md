...
7. Run `skcr validate` and `skcr asps coverage cncf-kubedl-reviewer`.
8. Run `skcr compile cncf-kubedl-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kubedl-reviewer`.
...
```bash
skpm validate cncf-kubedl-reviewer
skpm package cncf-kubedl-reviewer
skpm publish cncf-kubedl-reviewer
```
