...
7. Run `skcr validate` and `skcr asps coverage cncf-whatap-reviewer`.
8. Run `skcr compile cncf-whatap-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-whatap-reviewer`.
...
```bash
skpm validate cncf-whatap-reviewer
skpm package cncf-whatap-reviewer
skpm publish cncf-whatap-reviewer
```
