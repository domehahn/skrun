...
7. Run `skcr validate` and `skcr asps coverage cncf-kyverno-json-reviewer`.
8. Run `skcr compile cncf-kyverno-json-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kyverno-json-reviewer`.
...
```bash
skpm validate cncf-kyverno-json-reviewer
skpm package cncf-kyverno-json-reviewer
skpm publish cncf-kyverno-json-reviewer
```
