...
7. Run `skcr validate` and `skcr asps coverage cncf-zesty-member-reviewer`.
8. Run `skcr compile cncf-zesty-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-zesty-member-reviewer`.
...
```bash
skpm validate cncf-zesty-member-reviewer
skpm package cncf-zesty-member-reviewer
skpm publish cncf-zesty-member-reviewer
```
