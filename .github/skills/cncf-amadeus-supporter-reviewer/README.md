...
7. Run `skcr validate` and `skcr asps coverage cncf-amadeus-supporter-reviewer`.
8. Run `skcr compile cncf-amadeus-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-amadeus-supporter-reviewer`.
...
```bash
skpm validate cncf-amadeus-supporter-reviewer
skpm package cncf-amadeus-supporter-reviewer
skpm publish cncf-amadeus-supporter-reviewer
```
