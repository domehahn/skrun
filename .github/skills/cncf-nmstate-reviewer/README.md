...
7. Run `skcr validate` and `skcr asps coverage cncf-nmstate-reviewer`.
8. Run `skcr compile cncf-nmstate-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nmstate-reviewer`.
...
```bash
skpm validate cncf-nmstate-reviewer
skpm package cncf-nmstate-reviewer
skpm publish cncf-nmstate-reviewer
```
