...
7. Run `skcr validate` and `skcr asps coverage cncf-harmonycloud-kcsp-reviewer`.
8. Run `skcr compile cncf-harmonycloud-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-harmonycloud-kcsp-reviewer`.
...
```bash
skpm validate cncf-harmonycloud-kcsp-reviewer
skpm package cncf-harmonycloud-kcsp-reviewer
skpm publish cncf-harmonycloud-kcsp-reviewer
```
