...
7. Run `skcr validate` and `skcr asps coverage cncf-ambient-it-kcsp-reviewer`.
8. Run `skcr compile cncf-ambient-it-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ambient-it-kcsp-reviewer`.
...
```bash
skpm validate cncf-ambient-it-kcsp-reviewer
skpm package cncf-ambient-it-kcsp-reviewer
skpm publish cncf-ambient-it-kcsp-reviewer
```
