...
7. Run `skcr validate` and `skcr asps coverage cncf-indeed-member-reviewer`.
8. Run `skcr compile cncf-indeed-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-indeed-member-reviewer`.
...
```bash
skpm validate cncf-indeed-member-reviewer
skpm package cncf-indeed-member-reviewer
skpm publish cncf-indeed-member-reviewer
```
