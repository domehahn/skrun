...
7. Run `skcr validate` and `skcr asps coverage cncf-xline-reviewer`.
8. Run `skcr compile cncf-xline-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-xline-reviewer`.
...
```bash
skpm validate cncf-xline-reviewer
skpm package cncf-xline-reviewer
skpm publish cncf-xline-reviewer
```
