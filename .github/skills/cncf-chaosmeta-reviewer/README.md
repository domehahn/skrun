...
7. Run `skcr validate` and `skcr asps coverage cncf-chaosmeta-reviewer`.
8. Run `skcr compile cncf-chaosmeta-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-chaosmeta-reviewer`.
...
```bash
skpm validate cncf-chaosmeta-reviewer
skpm package cncf-chaosmeta-reviewer
skpm publish cncf-chaosmeta-reviewer
```
