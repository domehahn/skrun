...
7. Run `skcr validate` and `skcr asps coverage cncf-rafay-reviewer`.
8. Run `skcr compile cncf-rafay-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-rafay-reviewer`.
...
```bash
skpm validate cncf-rafay-reviewer
skpm package cncf-rafay-reviewer
skpm publish cncf-rafay-reviewer
```
