...
7. Run `skcr validate` and `skcr asps coverage cncf-ape-factory-kcsp-reviewer`.
8. Run `skcr compile cncf-ape-factory-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ape-factory-kcsp-reviewer`.
...
```bash
skpm validate cncf-ape-factory-kcsp-reviewer
skpm package cncf-ape-factory-kcsp-reviewer
skpm publish cncf-ape-factory-kcsp-reviewer
```
