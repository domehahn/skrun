...
7. Run `skcr validate` and `skcr asps coverage cncf-fujitsu-member-reviewer`.
8. Run `skcr compile cncf-fujitsu-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-fujitsu-member-reviewer`.
...
```bash
skpm validate cncf-fujitsu-member-reviewer
skpm package cncf-fujitsu-member-reviewer
skpm publish cncf-fujitsu-member-reviewer
```
