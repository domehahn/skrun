...
7. Run `skcr validate` and `skcr asps coverage cncf-github-actions-reviewer`.
8. Run `skcr compile cncf-github-actions-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-github-actions-reviewer`.
...
```bash
skpm validate cncf-github-actions-reviewer
skpm package cncf-github-actions-reviewer
skpm publish cncf-github-actions-reviewer
```
