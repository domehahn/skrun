...
7. Run `skcr validate` and `skcr asps coverage cncf-hush-security-member-reviewer`.
8. Run `skcr compile cncf-hush-security-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-hush-security-member-reviewer`.
...
```bash
skpm validate cncf-hush-security-member-reviewer
skpm package cncf-hush-security-member-reviewer
skpm publish cncf-hush-security-member-reviewer
```
