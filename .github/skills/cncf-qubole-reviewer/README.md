...
7. Run `skcr validate` and `skcr asps coverage cncf-qubole-reviewer`.
8. Run `skcr compile cncf-qubole-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-qubole-reviewer`.
...
```bash
skpm validate cncf-qubole-reviewer
skpm package cncf-qubole-reviewer
skpm publish cncf-qubole-reviewer
```
