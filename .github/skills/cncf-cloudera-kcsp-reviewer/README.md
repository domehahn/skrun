...
7. Run `skcr validate` and `skcr asps coverage cncf-cloudera-kcsp-reviewer`.
8. Run `skcr compile cncf-cloudera-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloudera-kcsp-reviewer`.
...
```bash
skpm validate cncf-cloudera-kcsp-reviewer
skpm package cncf-cloudera-kcsp-reviewer
skpm publish cncf-cloudera-kcsp-reviewer
```
