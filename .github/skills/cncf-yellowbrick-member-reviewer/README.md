...
7. Run `skcr validate` and `skcr asps coverage cncf-yellowbrick-member-reviewer`.
8. Run `skcr compile cncf-yellowbrick-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-yellowbrick-member-reviewer`.
...
```bash
skpm validate cncf-yellowbrick-member-reviewer
skpm package cncf-yellowbrick-member-reviewer
skpm publish cncf-yellowbrick-member-reviewer
```
