...
7. Run `skcr validate` and `skcr asps coverage cncf-kloia-member-reviewer`.
8. Run `skcr compile cncf-kloia-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kloia-member-reviewer`.
...
```bash
skpm validate cncf-kloia-member-reviewer
skpm package cncf-kloia-member-reviewer
skpm publish cncf-kloia-member-reviewer
```
