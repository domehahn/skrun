...
7. Run `skcr validate` and `skcr asps coverage cncf-infoblox-member-reviewer`.
8. Run `skcr compile cncf-infoblox-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-infoblox-member-reviewer`.
...
```bash
skpm validate cncf-infoblox-member-reviewer
skpm package cncf-infoblox-member-reviewer
skpm publish cncf-infoblox-member-reviewer
```
