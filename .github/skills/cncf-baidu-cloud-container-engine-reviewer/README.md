...
7. Run `skcr validate` and `skcr asps coverage cncf-baidu-cloud-container-engine-reviewer`.
8. Run `skcr compile cncf-baidu-cloud-container-engine-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-baidu-cloud-container-engine-reviewer`.
...
```bash
skpm validate cncf-baidu-cloud-container-engine-reviewer
skpm package cncf-baidu-cloud-container-engine-reviewer
skpm publish cncf-baidu-cloud-container-engine-reviewer
```
