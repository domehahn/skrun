...
7. Run `skcr validate` and `skcr asps coverage cncf-linkedin-supporter-reviewer`.
8. Run `skcr compile cncf-linkedin-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-linkedin-supporter-reviewer`.
...
```bash
skpm validate cncf-linkedin-supporter-reviewer
skpm package cncf-linkedin-supporter-reviewer
skpm publish cncf-linkedin-supporter-reviewer
```
