...
7. Run `skcr validate` and `skcr asps coverage cncf-easeagent-reviewer`.
8. Run `skcr compile cncf-easeagent-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-easeagent-reviewer`.
...
```bash
skpm validate cncf-easeagent-reviewer
skpm package cncf-easeagent-reviewer
skpm publish cncf-easeagent-reviewer
```
