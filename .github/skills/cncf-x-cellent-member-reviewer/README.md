...
7. Run `skcr validate` and `skcr asps coverage cncf-x-cellent-member-reviewer`.
8. Run `skcr compile cncf-x-cellent-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-x-cellent-member-reviewer`.
...
```bash
skpm validate cncf-x-cellent-member-reviewer
skpm package cncf-x-cellent-member-reviewer
skpm publish cncf-x-cellent-member-reviewer
```
