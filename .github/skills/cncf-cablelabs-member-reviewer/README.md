...
7. Run `skcr validate` and `skcr asps coverage cncf-cablelabs-member-reviewer`.
8. Run `skcr compile cncf-cablelabs-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cablelabs-member-reviewer`.
...
```bash
skpm validate cncf-cablelabs-member-reviewer
skpm package cncf-cablelabs-member-reviewer
skpm publish cncf-cablelabs-member-reviewer
```
