...
7. Run `skcr validate` and `skcr asps coverage cncf-algorithmia-reviewer`.
8. Run `skcr compile cncf-algorithmia-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-algorithmia-reviewer`.
...
```bash
skpm validate cncf-algorithmia-reviewer
skpm package cncf-algorithmia-reviewer
skpm publish cncf-algorithmia-reviewer
```
