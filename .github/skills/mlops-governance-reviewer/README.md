...
7. Run `skcr validate` and `skcr asps coverage mlops-governance-reviewer`.
8. Run `skcr compile mlops-governance-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend mlops-governance-reviewer`.
