...
7. Run `skcr validate` and `skcr asps coverage cncf-mesh-infra-reviewer`.
8. Run `skcr compile cncf-mesh-infra-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-mesh-infra-reviewer`.
...
```bash
skpm validate cncf-mesh-infra-reviewer
skpm package cncf-mesh-infra-reviewer
skpm publish cncf-mesh-infra-reviewer
```
