...
7. Run `skcr validate` and `skcr asps coverage cncf-loggie-reviewer`.
8. Run `skcr compile cncf-loggie-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-loggie-reviewer`.
...
```bash
skpm validate cncf-loggie-reviewer
skpm package cncf-loggie-reviewer
skpm publish cncf-loggie-reviewer
```
