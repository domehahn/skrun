...
7. Run `skcr validate` and `skcr asps coverage cncf-azure-event-hubs-reviewer`.
8. Run `skcr compile cncf-azure-event-hubs-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-azure-event-hubs-reviewer`.
...
```bash
skpm validate cncf-azure-event-hubs-reviewer
skpm package cncf-azure-event-hubs-reviewer
skpm publish cncf-azure-event-hubs-reviewer
```
