...
7. Run `skcr validate` and `skcr asps coverage cncf-perfectscale-member-reviewer`.
8. Run `skcr compile cncf-perfectscale-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-perfectscale-member-reviewer`.
...
```bash
skpm validate cncf-perfectscale-member-reviewer
skpm package cncf-perfectscale-member-reviewer
skpm publish cncf-perfectscale-member-reviewer
```
