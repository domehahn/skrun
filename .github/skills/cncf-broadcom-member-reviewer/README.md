...
7. Run `skcr validate` and `skcr asps coverage cncf-broadcom-member-reviewer`.
8. Run `skcr compile cncf-broadcom-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-broadcom-member-reviewer`.
...
```bash
skpm validate cncf-broadcom-member-reviewer
skpm package cncf-broadcom-member-reviewer
skpm publish cncf-broadcom-member-reviewer
```
