...
7. Run `skcr validate` and `skcr asps coverage cncf-tintri-member-reviewer`.
8. Run `skcr compile cncf-tintri-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-tintri-member-reviewer`.
...
```bash
skpm validate cncf-tintri-member-reviewer
skpm package cncf-tintri-member-reviewer
skpm publish cncf-tintri-member-reviewer
```
