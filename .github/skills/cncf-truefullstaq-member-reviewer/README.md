...
7. Run `skcr validate` and `skcr asps coverage cncf-truefullstaq-member-reviewer`.
8. Run `skcr compile cncf-truefullstaq-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-truefullstaq-member-reviewer`.
...
```bash
skpm validate cncf-truefullstaq-member-reviewer
skpm package cncf-truefullstaq-member-reviewer
skpm publish cncf-truefullstaq-member-reviewer
```
