...
7. Run `skcr validate` and `skcr asps coverage cncf-tetrate-member-reviewer`.
8. Run `skcr compile cncf-tetrate-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-tetrate-member-reviewer`.
...
```bash
skpm validate cncf-tetrate-member-reviewer
skpm package cncf-tetrate-member-reviewer
skpm publish cncf-tetrate-member-reviewer
```
