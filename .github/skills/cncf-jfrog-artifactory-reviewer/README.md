...
7. Run `skcr validate` and `skcr asps coverage cncf-jfrog-artifactory-reviewer`.
8. Run `skcr compile cncf-jfrog-artifactory-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-jfrog-artifactory-reviewer`.
...
```bash
skpm validate cncf-jfrog-artifactory-reviewer
skpm package cncf-jfrog-artifactory-reviewer
skpm publish cncf-jfrog-artifactory-reviewer
```
