...
7. Run `skcr validate` and `skcr asps coverage cncf-launchdarkly-reviewer`.
8. Run `skcr compile cncf-launchdarkly-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-launchdarkly-reviewer`.
...
```bash
skpm validate cncf-launchdarkly-reviewer
skpm package cncf-launchdarkly-reviewer
skpm publish cncf-launchdarkly-reviewer
```
