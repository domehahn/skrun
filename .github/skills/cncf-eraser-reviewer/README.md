...
7. Run `skcr validate` and `skcr asps coverage cncf-eraser-reviewer`.
8. Run `skcr compile cncf-eraser-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-eraser-reviewer`.
...
```bash
skpm validate cncf-eraser-reviewer
skpm package cncf-eraser-reviewer
skpm publish cncf-eraser-reviewer
```
