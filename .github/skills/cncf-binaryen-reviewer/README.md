...
7. Run `skcr validate` and `skcr asps coverage cncf-binaryen-reviewer`.
8. Run `skcr compile cncf-binaryen-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-binaryen-reviewer`.
...
```bash
skpm validate cncf-binaryen-reviewer
skpm package cncf-binaryen-reviewer
skpm publish cncf-binaryen-reviewer
```
