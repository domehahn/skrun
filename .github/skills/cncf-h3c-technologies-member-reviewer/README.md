...
7. Run `skcr validate` and `skcr asps coverage cncf-h3c-technologies-member-reviewer`.
8. Run `skcr compile cncf-h3c-technologies-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-h3c-technologies-member-reviewer`.
...
```bash
skpm validate cncf-h3c-technologies-member-reviewer
skpm package cncf-h3c-technologies-member-reviewer
skpm publish cncf-h3c-technologies-member-reviewer
```
