...
7. Run `skcr validate` and `skcr asps coverage cncf-amazon-elastic-container-registry-ecr-reviewer`.
8. Run `skcr compile cncf-amazon-elastic-container-registry-ecr-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-amazon-elastic-container-registry-ecr-reviewer`.
...
```bash
skpm validate cncf-amazon-elastic-container-registry-ecr-reviewer
skpm package cncf-amazon-elastic-container-registry-ecr-reviewer
skpm publish cncf-amazon-elastic-container-registry-ecr-reviewer
```
