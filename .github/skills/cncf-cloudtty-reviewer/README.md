...
7. Run `skcr validate` and `skcr asps coverage cncf-cloudtty-reviewer`.
8. Run `skcr compile cncf-cloudtty-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloudtty-reviewer`.
...
```bash
skpm validate cncf-cloudtty-reviewer
skpm package cncf-cloudtty-reviewer
skpm publish cncf-cloudtty-reviewer
```
