...
7. Run `skcr validate` and `skcr asps coverage cncf-adyen-member-reviewer`.
8. Run `skcr compile cncf-adyen-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-adyen-member-reviewer`.
...
```bash
skpm validate cncf-adyen-member-reviewer
skpm package cncf-adyen-member-reviewer
skpm publish cncf-adyen-member-reviewer
```
