...
7. Run `skcr validate` and `skcr asps coverage cncf-claion-kcsp-reviewer`.
8. Run `skcr compile cncf-claion-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-claion-kcsp-reviewer`.
...
```bash
skpm validate cncf-claion-kcsp-reviewer
skpm package cncf-claion-kcsp-reviewer
skpm publish cncf-claion-kcsp-reviewer
```
