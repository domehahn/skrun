...
7. Run `skcr validate` and `skcr asps coverage cncf-caddy-reviewer`.
8. Run `skcr compile cncf-caddy-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-caddy-reviewer`.
...
```bash
skpm validate cncf-caddy-reviewer
skpm package cncf-caddy-reviewer
skpm publish cncf-caddy-reviewer
```
