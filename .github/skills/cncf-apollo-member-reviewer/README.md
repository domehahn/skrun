...
7. Run `skcr validate` and `skcr asps coverage cncf-apollo-member-reviewer`.
8. Run `skcr compile cncf-apollo-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-apollo-member-reviewer`.
...
```bash
skpm validate cncf-apollo-member-reviewer
skpm package cncf-apollo-member-reviewer
skpm publish cncf-apollo-member-reviewer
```
