...
7. Run `skcr validate` and `skcr asps coverage cncf-applications-manager-reviewer`.
8. Run `skcr compile cncf-applications-manager-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-applications-manager-reviewer`.
...
```bash
skpm validate cncf-applications-manager-reviewer
skpm package cncf-applications-manager-reviewer
skpm publish cncf-applications-manager-reviewer
```
