...
7. Run `skcr validate` and `skcr asps coverage iac-gitops-reviewer`.
8. Run `skcr compile iac-gitops-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend iac-gitops-reviewer`.
