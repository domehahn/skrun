...
7. Run `skcr validate` and `skcr asps coverage cncf-greptimedb-reviewer`.
8. Run `skcr compile cncf-greptimedb-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-greptimedb-reviewer`.
...
```bash
skpm validate cncf-greptimedb-reviewer
skpm package cncf-greptimedb-reviewer
skpm publish cncf-greptimedb-reviewer
```
