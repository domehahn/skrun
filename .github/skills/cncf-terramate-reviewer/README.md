...
7. Run `skcr validate` and `skcr asps coverage cncf-terramate-reviewer`.
8. Run `skcr compile cncf-terramate-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-terramate-reviewer`.
...
```bash
skpm validate cncf-terramate-reviewer
skpm package cncf-terramate-reviewer
skpm publish cncf-terramate-reviewer
```
