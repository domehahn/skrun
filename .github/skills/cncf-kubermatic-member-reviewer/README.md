...
7. Run `skcr validate` and `skcr asps coverage cncf-kubermatic-member-reviewer`.
8. Run `skcr compile cncf-kubermatic-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kubermatic-member-reviewer`.
...
```bash
skpm validate cncf-kubermatic-member-reviewer
skpm package cncf-kubermatic-member-reviewer
skpm publish cncf-kubermatic-member-reviewer
```
