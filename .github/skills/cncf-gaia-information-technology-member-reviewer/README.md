...
7. Run `skcr validate` and `skcr asps coverage cncf-gaia-information-technology-member-reviewer`.
8. Run `skcr compile cncf-gaia-information-technology-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-gaia-information-technology-member-reviewer`.
...
```bash
skpm validate cncf-gaia-information-technology-member-reviewer
skpm package cncf-gaia-information-technology-member-reviewer
skpm publish cncf-gaia-information-technology-member-reviewer
```
