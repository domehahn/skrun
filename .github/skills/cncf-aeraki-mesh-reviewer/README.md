...
7. Run `skcr validate` and `skcr asps coverage cncf-aeraki-mesh-reviewer`.
8. Run `skcr compile cncf-aeraki-mesh-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-aeraki-mesh-reviewer`.
...
```bash
skpm validate cncf-aeraki-mesh-reviewer
skpm package cncf-aeraki-mesh-reviewer
skpm publish cncf-aeraki-mesh-reviewer
```
