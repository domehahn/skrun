...
7. Run `skcr validate` and `skcr asps coverage cncf-yellowbrick-reviewer`.
8. Run `skcr compile cncf-yellowbrick-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-yellowbrick-reviewer`.
...
```bash
skpm validate cncf-yellowbrick-reviewer
skpm package cncf-yellowbrick-reviewer
skpm publish cncf-yellowbrick-reviewer
```
