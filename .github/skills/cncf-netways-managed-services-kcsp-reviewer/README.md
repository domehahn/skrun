...
7. Run `skcr validate` and `skcr asps coverage cncf-netways-managed-services-kcsp-reviewer`.
8. Run `skcr compile cncf-netways-managed-services-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-netways-managed-services-kcsp-reviewer`.
...
```bash
skpm validate cncf-netways-managed-services-kcsp-reviewer
skpm package cncf-netways-managed-services-kcsp-reviewer
skpm publish cncf-netways-managed-services-kcsp-reviewer
```
