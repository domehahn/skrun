...
7. Run `skcr validate` and `skcr asps coverage cncf-gientech-member-reviewer`.
8. Run `skcr compile cncf-gientech-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-gientech-member-reviewer`.
...
```bash
skpm validate cncf-gientech-member-reviewer
skpm package cncf-gientech-member-reviewer
skpm publish cncf-gientech-member-reviewer
```
