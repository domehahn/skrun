...
7. Run `skcr validate` and `skcr asps coverage cncf-aks-engine-for-azure-stack-reviewer`.
8. Run `skcr compile cncf-aks-engine-for-azure-stack-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-aks-engine-for-azure-stack-reviewer`.
...
```bash
skpm validate cncf-aks-engine-for-azure-stack-reviewer
skpm package cncf-aks-engine-for-azure-stack-reviewer
skpm publish cncf-aks-engine-for-azure-stack-reviewer
```
