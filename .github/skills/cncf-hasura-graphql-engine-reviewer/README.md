...
7. Run `skcr validate` and `skcr asps coverage cncf-hasura-graphql-engine-reviewer`.
8. Run `skcr compile cncf-hasura-graphql-engine-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-hasura-graphql-engine-reviewer`.
...
```bash
skpm validate cncf-hasura-graphql-engine-reviewer
skpm package cncf-hasura-graphql-engine-reviewer
skpm publish cncf-hasura-graphql-engine-reviewer
```
