...
7. Run `skcr validate` and `skcr asps coverage cncf-unikraft-member-reviewer`.
8. Run `skcr compile cncf-unikraft-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-unikraft-member-reviewer`.
...
```bash
skpm validate cncf-unikraft-member-reviewer
skpm package cncf-unikraft-member-reviewer
skpm publish cncf-unikraft-member-reviewer
```
