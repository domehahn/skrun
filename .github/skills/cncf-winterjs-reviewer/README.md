...
7. Run `skcr validate` and `skcr asps coverage cncf-winterjs-reviewer`.
8. Run `skcr compile cncf-winterjs-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-winterjs-reviewer`.
...
```bash
skpm validate cncf-winterjs-reviewer
skpm package cncf-winterjs-reviewer
skpm publish cncf-winterjs-reviewer
```
