...
7. Run `skcr validate` and `skcr asps coverage cncf-kubediagrams-reviewer`.
8. Run `skcr compile cncf-kubediagrams-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kubediagrams-reviewer`.
...
```bash
skpm validate cncf-kubediagrams-reviewer
skpm package cncf-kubediagrams-reviewer
skpm publish cncf-kubediagrams-reviewer
```
