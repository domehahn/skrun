...
7. Run `skcr validate` and `skcr asps coverage cncf-epsagon-reviewer`.
8. Run `skcr compile cncf-epsagon-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-epsagon-reviewer`.
...
```bash
skpm validate cncf-epsagon-reviewer
skpm package cncf-epsagon-reviewer
skpm publish cncf-epsagon-reviewer
```
