...
7. Run `skcr validate` and `skcr asps coverage cncf-witc-reviewer`.
8. Run `skcr compile cncf-witc-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-witc-reviewer`.
...
```bash
skpm validate cncf-witc-reviewer
skpm package cncf-witc-reviewer
skpm publish cncf-witc-reviewer
```
