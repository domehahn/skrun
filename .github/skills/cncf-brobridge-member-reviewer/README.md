...
7. Run `skcr validate` and `skcr asps coverage cncf-brobridge-member-reviewer`.
8. Run `skcr compile cncf-brobridge-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-brobridge-member-reviewer`.
...
```bash
skpm validate cncf-brobridge-member-reviewer
skpm package cncf-brobridge-member-reviewer
skpm publish cncf-brobridge-member-reviewer
```
