...
7. Run `skcr validate` and `skcr asps coverage cncf-containerssh-reviewer`.
8. Run `skcr compile cncf-containerssh-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-containerssh-reviewer`.
...
```bash
skpm validate cncf-containerssh-reviewer
skpm package cncf-containerssh-reviewer
skpm publish cncf-containerssh-reviewer
```
