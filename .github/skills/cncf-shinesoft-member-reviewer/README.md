...
7. Run `skcr validate` and `skcr asps coverage cncf-shinesoft-member-reviewer`.
8. Run `skcr compile cncf-shinesoft-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-shinesoft-member-reviewer`.
...
```bash
skpm validate cncf-shinesoft-member-reviewer
skpm package cncf-shinesoft-member-reviewer
skpm publish cncf-shinesoft-member-reviewer
```
