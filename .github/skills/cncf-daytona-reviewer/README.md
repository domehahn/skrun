...
7. Run `skcr validate` and `skcr asps coverage cncf-daytona-reviewer`.
8. Run `skcr compile cncf-daytona-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-daytona-reviewer`.
...
```bash
skpm validate cncf-daytona-reviewer
skpm package cncf-daytona-reviewer
skpm publish cncf-daytona-reviewer
```
