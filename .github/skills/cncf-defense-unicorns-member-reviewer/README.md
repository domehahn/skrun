...
7. Run `skcr validate` and `skcr asps coverage cncf-defense-unicorns-member-reviewer`.
8. Run `skcr compile cncf-defense-unicorns-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-defense-unicorns-member-reviewer`.
...
```bash
skpm validate cncf-defense-unicorns-member-reviewer
skpm package cncf-defense-unicorns-member-reviewer
skpm publish cncf-defense-unicorns-member-reviewer
```
