...
7. Run `skcr validate` and `skcr asps coverage cncf-giant-swarm-kcsp-reviewer`.
8. Run `skcr compile cncf-giant-swarm-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-giant-swarm-kcsp-reviewer`.
...
```bash
skpm validate cncf-giant-swarm-kcsp-reviewer
skpm package cncf-giant-swarm-kcsp-reviewer
skpm publish cncf-giant-swarm-kcsp-reviewer
```
