...
7. Run `skcr validate` and `skcr asps coverage cncf-ape-factory-member-reviewer`.
8. Run `skcr compile cncf-ape-factory-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ape-factory-member-reviewer`.
...
```bash
skpm validate cncf-ape-factory-member-reviewer
skpm package cncf-ape-factory-member-reviewer
skpm publish cncf-ape-factory-member-reviewer
```
