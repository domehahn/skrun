...
7. Run `skcr validate` and `skcr asps coverage cncf-novaglobal-member-reviewer`.
8. Run `skcr compile cncf-novaglobal-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-novaglobal-member-reviewer`.
...
```bash
skpm validate cncf-novaglobal-member-reviewer
skpm package cncf-novaglobal-member-reviewer
skpm publish cncf-novaglobal-member-reviewer
```
