...
7. Run `skcr validate` and `skcr asps coverage cncf-tensorflow-distributed-reviewer`.
8. Run `skcr compile cncf-tensorflow-distributed-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-tensorflow-distributed-reviewer`.
...
```bash
skpm validate cncf-tensorflow-distributed-reviewer
skpm package cncf-tensorflow-distributed-reviewer
skpm publish cncf-tensorflow-distributed-reviewer
```
