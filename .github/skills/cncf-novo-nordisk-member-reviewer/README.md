...
7. Run `skcr validate` and `skcr asps coverage cncf-novo-nordisk-member-reviewer`.
8. Run `skcr compile cncf-novo-nordisk-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-novo-nordisk-member-reviewer`.
...
```bash
skpm validate cncf-novo-nordisk-member-reviewer
skpm package cncf-novo-nordisk-member-reviewer
skpm publish cncf-novo-nordisk-member-reviewer
```
