...
7. Run `skcr validate` and `skcr asps coverage cncf-hostersi-kcsp-reviewer`.
8. Run `skcr compile cncf-hostersi-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-hostersi-kcsp-reviewer`.
...
```bash
skpm validate cncf-hostersi-kcsp-reviewer
skpm package cncf-hostersi-kcsp-reviewer
skpm publish cncf-hostersi-kcsp-reviewer
```
