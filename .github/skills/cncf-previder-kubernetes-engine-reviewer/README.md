...
7. Run `skcr validate` and `skcr asps coverage cncf-previder-kubernetes-engine-reviewer`.
8. Run `skcr compile cncf-previder-kubernetes-engine-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-previder-kubernetes-engine-reviewer`.
...
```bash
skpm validate cncf-previder-kubernetes-engine-reviewer
skpm package cncf-previder-kubernetes-engine-reviewer
skpm publish cncf-previder-kubernetes-engine-reviewer
```
