...
7. Run `skcr validate` and `skcr asps coverage cncf-aws-codepipeline-reviewer`.
8. Run `skcr compile cncf-aws-codepipeline-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-aws-codepipeline-reviewer`.
...
```bash
skpm validate cncf-aws-codepipeline-reviewer
skpm package cncf-aws-codepipeline-reviewer
skpm publish cncf-aws-codepipeline-reviewer
```
