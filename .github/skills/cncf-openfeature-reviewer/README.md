...
7. Run `skcr validate` and `skcr asps coverage cncf-openfeature-reviewer`.
8. Run `skcr compile cncf-openfeature-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-openfeature-reviewer`.
...
```bash
skpm validate cncf-openfeature-reviewer
skpm package cncf-openfeature-reviewer
skpm publish cncf-openfeature-reviewer
```
