...
7. Run `skcr validate` and `skcr asps coverage cncf-jetstack-member-reviewer`.
8. Run `skcr compile cncf-jetstack-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-jetstack-member-reviewer`.
...
```bash
skpm validate cncf-jetstack-member-reviewer
skpm package cncf-jetstack-member-reviewer
skpm publish cncf-jetstack-member-reviewer
```
