...
7. Run `skcr validate` and `skcr asps coverage cncf-tensorflow-reviewer`.
8. Run `skcr compile cncf-tensorflow-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-tensorflow-reviewer`.
...
```bash
skpm validate cncf-tensorflow-reviewer
skpm package cncf-tensorflow-reviewer
skpm publish cncf-tensorflow-reviewer
```
