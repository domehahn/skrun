...
7. Run `skcr validate` and `skcr asps coverage cncf-dosec-kcsp-reviewer`.
8. Run `skcr compile cncf-dosec-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-dosec-kcsp-reviewer`.
...
```bash
skpm validate cncf-dosec-kcsp-reviewer
skpm package cncf-dosec-kcsp-reviewer
skpm publish cncf-dosec-kcsp-reviewer
```
