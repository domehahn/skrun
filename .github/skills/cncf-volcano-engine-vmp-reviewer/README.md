...
7. Run `skcr validate` and `skcr asps coverage cncf-volcano-engine-vmp-reviewer`.
8. Run `skcr compile cncf-volcano-engine-vmp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-volcano-engine-vmp-reviewer`.
...
```bash
skpm validate cncf-volcano-engine-vmp-reviewer
skpm package cncf-volcano-engine-vmp-reviewer
skpm publish cncf-volcano-engine-vmp-reviewer
```
