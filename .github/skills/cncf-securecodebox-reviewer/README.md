...
7. Run `skcr validate` and `skcr asps coverage cncf-securecodebox-reviewer`.
8. Run `skcr compile cncf-securecodebox-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-securecodebox-reviewer`.
...
```bash
skpm validate cncf-securecodebox-reviewer
skpm package cncf-securecodebox-reviewer
skpm publish cncf-securecodebox-reviewer
```
