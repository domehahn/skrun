...
7. Run `skcr validate` and `skcr asps coverage cncf-wasmex-reviewer`.
8. Run `skcr compile cncf-wasmex-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-wasmex-reviewer`.
...
```bash
skpm validate cncf-wasmex-reviewer
skpm package cncf-wasmex-reviewer
skpm publish cncf-wasmex-reviewer
```
