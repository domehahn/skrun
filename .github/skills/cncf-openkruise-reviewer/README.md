...
7. Run `skcr validate` and `skcr asps coverage cncf-openkruise-reviewer`.
8. Run `skcr compile cncf-openkruise-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-openkruise-reviewer`.
...
```bash
skpm validate cncf-openkruise-reviewer
skpm package cncf-openkruise-reviewer
skpm publish cncf-openkruise-reviewer
```
