...
7. Run `skcr validate` and `skcr asps coverage cncf-mantech-solution-member-reviewer`.
8. Run `skcr compile cncf-mantech-solution-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-mantech-solution-member-reviewer`.
...
```bash
skpm validate cncf-mantech-solution-member-reviewer
skpm package cncf-mantech-solution-member-reviewer
skpm publish cncf-mantech-solution-member-reviewer
```
