...
7. Run `skcr validate` and `skcr asps coverage cncf-kapeta-reviewer`.
8. Run `skcr compile cncf-kapeta-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kapeta-reviewer`.
...
```bash
skpm validate cncf-kapeta-reviewer
skpm package cncf-kapeta-reviewer
skpm publish cncf-kapeta-reviewer
```
