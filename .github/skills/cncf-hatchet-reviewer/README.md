...
7. Run `skcr validate` and `skcr asps coverage cncf-hatchet-reviewer`.
8. Run `skcr compile cncf-hatchet-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-hatchet-reviewer`.
...
```bash
skpm validate cncf-hatchet-reviewer
skpm package cncf-hatchet-reviewer
skpm publish cncf-hatchet-reviewer
```
