...
7. Run `skcr validate` and `skcr asps coverage cncf-fairwinds-insights-reviewer`.
8. Run `skcr compile cncf-fairwinds-insights-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-fairwinds-insights-reviewer`.
...
```bash
skpm validate cncf-fairwinds-insights-reviewer
skpm package cncf-fairwinds-insights-reviewer
skpm publish cncf-fairwinds-insights-reviewer
```
