...
7. Run `skcr validate` and `skcr asps coverage cncf-alasca-member-reviewer`.
8. Run `skcr compile cncf-alasca-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-alasca-member-reviewer`.
...
```bash
skpm validate cncf-alasca-member-reviewer
skpm package cncf-alasca-member-reviewer
skpm publish cncf-alasca-member-reviewer
```
