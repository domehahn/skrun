...
7. Run `skcr validate` and `skcr asps coverage cncf-guidance-reviewer`.
8. Run `skcr compile cncf-guidance-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-guidance-reviewer`.
...
```bash
skpm validate cncf-guidance-reviewer
skpm package cncf-guidance-reviewer
skpm publish cncf-guidance-reviewer
```
