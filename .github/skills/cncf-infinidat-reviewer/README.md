...
7. Run `skcr validate` and `skcr asps coverage cncf-infinidat-reviewer`.
8. Run `skcr compile cncf-infinidat-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-infinidat-reviewer`.
...
```bash
skpm validate cncf-infinidat-reviewer
skpm package cncf-infinidat-reviewer
skpm publish cncf-infinidat-reviewer
```
