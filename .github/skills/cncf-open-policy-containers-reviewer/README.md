...
7. Run `skcr validate` and `skcr asps coverage cncf-open-policy-containers-reviewer`.
8. Run `skcr compile cncf-open-policy-containers-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-open-policy-containers-reviewer`.
...
```bash
skpm validate cncf-open-policy-containers-reviewer
skpm package cncf-open-policy-containers-reviewer
skpm publish cncf-open-policy-containers-reviewer
```
