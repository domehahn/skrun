...
7. Run `skcr validate` and `skcr asps coverage cncf-clush-kcsp-reviewer`.
8. Run `skcr compile cncf-clush-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-clush-kcsp-reviewer`.
...
```bash
skpm validate cncf-clush-kcsp-reviewer
skpm package cncf-clush-kcsp-reviewer
skpm publish cncf-clush-kcsp-reviewer
```
