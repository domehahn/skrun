...
7. Run `skcr validate` and `skcr asps coverage cncf-ampere-computing-member-reviewer`.
8. Run `skcr compile cncf-ampere-computing-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ampere-computing-member-reviewer`.
...
```bash
skpm validate cncf-ampere-computing-member-reviewer
skpm package cncf-ampere-computing-member-reviewer
skpm publish cncf-ampere-computing-member-reviewer
```
