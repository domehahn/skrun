...
7. Run `skcr validate` and `skcr asps coverage cncf-giant-swarm-member-reviewer`.
8. Run `skcr compile cncf-giant-swarm-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-giant-swarm-member-reviewer`.
...
```bash
skpm validate cncf-giant-swarm-member-reviewer
skpm package cncf-giant-swarm-member-reviewer
skpm publish cncf-giant-swarm-member-reviewer
```
