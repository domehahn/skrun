...
7. Run `skcr validate` and `skcr asps coverage cncf-jenkinsx-reviewer`.
8. Run `skcr compile cncf-jenkinsx-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-jenkinsx-reviewer`.
...
```bash
skpm validate cncf-jenkinsx-reviewer
skpm package cncf-jenkinsx-reviewer
skpm publish cncf-jenkinsx-reviewer
```
