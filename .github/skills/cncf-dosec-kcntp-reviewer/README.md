...
7. Run `skcr validate` and `skcr asps coverage cncf-dosec-kcntp-reviewer`.
8. Run `skcr compile cncf-dosec-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-dosec-kcntp-reviewer`.
...
```bash
skpm validate cncf-dosec-kcntp-reviewer
skpm package cncf-dosec-kcntp-reviewer
skpm publish cncf-dosec-kcntp-reviewer
```
