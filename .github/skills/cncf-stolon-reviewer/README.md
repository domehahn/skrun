...
7. Run `skcr validate` and `skcr asps coverage cncf-stolon-reviewer`.
8. Run `skcr compile cncf-stolon-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-stolon-reviewer`.
...
```bash
skpm validate cncf-stolon-reviewer
skpm package cncf-stolon-reviewer
skpm publish cncf-stolon-reviewer
```
