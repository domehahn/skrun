...
7. Run `skcr validate` and `skcr asps coverage cncf-syntasso-member-reviewer`.
8. Run `skcr compile cncf-syntasso-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-syntasso-member-reviewer`.
...
```bash
skpm validate cncf-syntasso-member-reviewer
skpm package cncf-syntasso-member-reviewer
skpm publish cncf-syntasso-member-reviewer
```
