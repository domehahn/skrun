...
7. Run `skcr validate` and `skcr asps coverage cncf-direktiv-reviewer`.
8. Run `skcr compile cncf-direktiv-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-direktiv-reviewer`.
...
```bash
skpm validate cncf-direktiv-reviewer
skpm package cncf-direktiv-reviewer
skpm publish cncf-direktiv-reviewer
```
