...
7. Run `skcr validate` and `skcr asps coverage cncf-sweet-security-member-reviewer`.
8. Run `skcr compile cncf-sweet-security-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sweet-security-member-reviewer`.
...
```bash
skpm validate cncf-sweet-security-member-reviewer
skpm package cncf-sweet-security-member-reviewer
skpm publish cncf-sweet-security-member-reviewer
```
