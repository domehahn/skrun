...
7. Run `skcr validate` and `skcr asps coverage cncf-casdoor-reviewer`.
8. Run `skcr compile cncf-casdoor-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-casdoor-reviewer`.
...
```bash
skpm validate cncf-casdoor-reviewer
skpm package cncf-casdoor-reviewer
skpm publish cncf-casdoor-reviewer
```
