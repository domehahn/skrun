...
7. Run `skcr validate` and `skcr asps coverage cncf-catalyst-cloud-member-reviewer`.
8. Run `skcr compile cncf-catalyst-cloud-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-catalyst-cloud-member-reviewer`.
...
```bash
skpm validate cncf-catalyst-cloud-member-reviewer
skpm package cncf-catalyst-cloud-member-reviewer
skpm publish cncf-catalyst-cloud-member-reviewer
```
