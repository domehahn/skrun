...
7. Run `skcr validate` and `skcr asps coverage cncf-oteemo-kcsp-reviewer`.
8. Run `skcr compile cncf-oteemo-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-oteemo-kcsp-reviewer`.
...
```bash
skpm validate cncf-oteemo-kcsp-reviewer
skpm package cncf-oteemo-kcsp-reviewer
skpm publish cncf-oteemo-kcsp-reviewer
```
