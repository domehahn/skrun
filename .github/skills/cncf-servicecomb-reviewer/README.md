...
7. Run `skcr validate` and `skcr asps coverage cncf-servicecomb-reviewer`.
8. Run `skcr compile cncf-servicecomb-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-servicecomb-reviewer`.
...
```bash
skpm validate cncf-servicecomb-reviewer
skpm package cncf-servicecomb-reviewer
skpm publish cncf-servicecomb-reviewer
```
