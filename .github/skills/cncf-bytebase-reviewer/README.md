...
7. Run `skcr validate` and `skcr asps coverage cncf-bytebase-reviewer`.
8. Run `skcr compile cncf-bytebase-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-bytebase-reviewer`.
...
```bash
skpm validate cncf-bytebase-reviewer
skpm package cncf-bytebase-reviewer
skpm publish cncf-bytebase-reviewer
```
