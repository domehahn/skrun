...
7. Run `skcr validate` and `skcr asps coverage cncf-rafay-kcsp-reviewer`.
8. Run `skcr compile cncf-rafay-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-rafay-kcsp-reviewer`.
...
```bash
skpm validate cncf-rafay-kcsp-reviewer
skpm package cncf-rafay-kcsp-reviewer
skpm publish cncf-rafay-kcsp-reviewer
```
