...
7. Run `skcr validate` and `skcr asps coverage cncf-cubex-reviewer`.
8. Run `skcr compile cncf-cubex-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cubex-reviewer`.
...
```bash
skpm validate cncf-cubex-reviewer
skpm package cncf-cubex-reviewer
skpm publish cncf-cubex-reviewer
```
