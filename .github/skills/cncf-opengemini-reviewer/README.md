...
7. Run `skcr validate` and `skcr asps coverage cncf-opengemini-reviewer`.
8. Run `skcr compile cncf-opengemini-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-opengemini-reviewer`.
...
```bash
skpm validate cncf-opengemini-reviewer
skpm package cncf-opengemini-reviewer
skpm publish cncf-opengemini-reviewer
```
