...
7. Run `skcr validate` and `skcr asps coverage cncf-rad-security-reviewer`.
8. Run `skcr compile cncf-rad-security-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-rad-security-reviewer`.
...
```bash
skpm validate cncf-rad-security-reviewer
skpm package cncf-rad-security-reviewer
skpm publish cncf-rad-security-reviewer
```
