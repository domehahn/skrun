...
7. Run `skcr validate` and `skcr asps coverage cncf-nasdaq-supporter-reviewer`.
8. Run `skcr compile cncf-nasdaq-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nasdaq-supporter-reviewer`.
...
```bash
skpm validate cncf-nasdaq-supporter-reviewer
skpm package cncf-nasdaq-supporter-reviewer
skpm publish cncf-nasdaq-supporter-reviewer
```
