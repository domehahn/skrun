...
7. Run `skcr validate` and `skcr asps coverage cncf-tigera-kcsp-reviewer`.
8. Run `skcr compile cncf-tigera-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-tigera-kcsp-reviewer`.
...
```bash
skpm validate cncf-tigera-kcsp-reviewer
skpm package cncf-tigera-kcsp-reviewer
skpm publish cncf-tigera-kcsp-reviewer
```
