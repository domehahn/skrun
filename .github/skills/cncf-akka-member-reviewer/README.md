...
7. Run `skcr validate` and `skcr asps coverage cncf-akka-member-reviewer`.
8. Run `skcr compile cncf-akka-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-akka-member-reviewer`.
...
```bash
skpm validate cncf-akka-member-reviewer
skpm package cncf-akka-member-reviewer
skpm publish cncf-akka-member-reviewer
```
