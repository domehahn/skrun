...
7. Run `skcr validate` and `skcr asps coverage cncf-akri-reviewer`.
8. Run `skcr compile cncf-akri-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-akri-reviewer`.
...
```bash
skpm validate cncf-akri-reviewer
skpm package cncf-akri-reviewer
skpm publish cncf-akri-reviewer
```
