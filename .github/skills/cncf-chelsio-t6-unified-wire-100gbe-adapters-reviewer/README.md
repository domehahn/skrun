...
7. Run `skcr validate` and `skcr asps coverage cncf-chelsio-t6-unified-wire-100gbe-adapters-reviewer`.
8. Run `skcr compile cncf-chelsio-t6-unified-wire-100gbe-adapters-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-chelsio-t6-unified-wire-100gbe-adapters-reviewer`.
...
```bash
skpm validate cncf-chelsio-t6-unified-wire-100gbe-adapters-reviewer
skpm package cncf-chelsio-t6-unified-wire-100gbe-adapters-reviewer
skpm publish cncf-chelsio-t6-unified-wire-100gbe-adapters-reviewer
```
