...
7. Run `skcr validate` and `skcr asps coverage cncf-portworx-by-pure-storage-kcsp-reviewer`.
8. Run `skcr compile cncf-portworx-by-pure-storage-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-portworx-by-pure-storage-kcsp-reviewer`.
...
```bash
skpm validate cncf-portworx-by-pure-storage-kcsp-reviewer
skpm package cncf-portworx-by-pure-storage-kcsp-reviewer
skpm publish cncf-portworx-by-pure-storage-kcsp-reviewer
```
