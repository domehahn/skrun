...
7. Run `skcr validate` and `skcr asps coverage cncf-fd-io-reviewer`.
8. Run `skcr compile cncf-fd-io-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-fd-io-reviewer`.
...
```bash
skpm validate cncf-fd-io-reviewer
skpm package cncf-fd-io-reviewer
skpm publish cncf-fd-io-reviewer
```
