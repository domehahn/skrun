...
7. Run `skcr validate` and `skcr asps coverage cncf-china-mobile-panji-paas-platform-reviewer`.
8. Run `skcr compile cncf-china-mobile-panji-paas-platform-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-china-mobile-panji-paas-platform-reviewer`.
...
```bash
skpm validate cncf-china-mobile-panji-paas-platform-reviewer
skpm package cncf-china-mobile-panji-paas-platform-reviewer
skpm publish cncf-china-mobile-panji-paas-platform-reviewer
```
