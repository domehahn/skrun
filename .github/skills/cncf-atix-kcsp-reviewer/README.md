...
7. Run `skcr validate` and `skcr asps coverage cncf-atix-kcsp-reviewer`.
8. Run `skcr compile cncf-atix-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-atix-kcsp-reviewer`.
...
```bash
skpm validate cncf-atix-kcsp-reviewer
skpm package cncf-atix-kcsp-reviewer
skpm publish cncf-atix-kcsp-reviewer
```
