...
7. Run `skcr validate` and `skcr asps coverage cncf-deutsche-telekom-ag-member-reviewer`.
8. Run `skcr compile cncf-deutsche-telekom-ag-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-deutsche-telekom-ag-member-reviewer`.
...
```bash
skpm validate cncf-deutsche-telekom-ag-member-reviewer
skpm package cncf-deutsche-telekom-ag-member-reviewer
skpm publish cncf-deutsche-telekom-ag-member-reviewer
```
