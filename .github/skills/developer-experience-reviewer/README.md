...
7. Run `skcr validate` and `skcr asps coverage developer-experience-reviewer`.
8. Run `skcr compile developer-experience-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend developer-experience-reviewer`.
...
```bash
skpm validate developer-experience-reviewer
skpm package developer-experience-reviewer
skpm publish developer-experience-reviewer
```
