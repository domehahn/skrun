...
7. Run `skcr validate` and `skcr asps coverage cncf-onecause-supporter-reviewer`.
8. Run `skcr compile cncf-onecause-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-onecause-supporter-reviewer`.
...
```bash
skpm validate cncf-onecause-supporter-reviewer
skpm package cncf-onecause-supporter-reviewer
skpm publish cncf-onecause-supporter-reviewer
```
