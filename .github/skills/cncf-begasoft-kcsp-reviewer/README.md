...
7. Run `skcr validate` and `skcr asps coverage cncf-begasoft-kcsp-reviewer`.
8. Run `skcr compile cncf-begasoft-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-begasoft-kcsp-reviewer`.
...
```bash
skpm validate cncf-begasoft-kcsp-reviewer
skpm package cncf-begasoft-kcsp-reviewer
skpm publish cncf-begasoft-kcsp-reviewer
```
