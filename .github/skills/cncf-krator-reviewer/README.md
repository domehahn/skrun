...
7. Run `skcr validate` and `skcr asps coverage cncf-krator-reviewer`.
8. Run `skcr compile cncf-krator-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-krator-reviewer`.
...
```bash
skpm validate cncf-krator-reviewer
skpm package cncf-krator-reviewer
skpm publish cncf-krator-reviewer
```
