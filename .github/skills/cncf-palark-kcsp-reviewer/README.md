...
7. Run `skcr validate` and `skcr asps coverage cncf-palark-kcsp-reviewer`.
8. Run `skcr compile cncf-palark-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-palark-kcsp-reviewer`.
...
```bash
skpm validate cncf-palark-kcsp-reviewer
skpm package cncf-palark-kcsp-reviewer
skpm publish cncf-palark-kcsp-reviewer
```
