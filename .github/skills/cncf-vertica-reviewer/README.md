...
7. Run `skcr validate` and `skcr asps coverage cncf-vertica-reviewer`.
8. Run `skcr compile cncf-vertica-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-vertica-reviewer`.
...
```bash
skpm validate cncf-vertica-reviewer
skpm package cncf-vertica-reviewer
skpm publish cncf-vertica-reviewer
```
