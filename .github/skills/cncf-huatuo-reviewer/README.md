...
7. Run `skcr validate` and `skcr asps coverage cncf-huatuo-reviewer`.
8. Run `skcr compile cncf-huatuo-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-huatuo-reviewer`.
...
```bash
skpm validate cncf-huatuo-reviewer
skpm package cncf-huatuo-reviewer
skpm publish cncf-huatuo-reviewer
```
