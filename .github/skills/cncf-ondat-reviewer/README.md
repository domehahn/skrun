...
7. Run `skcr validate` and `skcr asps coverage cncf-ondat-reviewer`.
8. Run `skcr compile cncf-ondat-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ondat-reviewer`.
...
```bash
skpm validate cncf-ondat-reviewer
skpm package cncf-ondat-reviewer
skpm publish cncf-ondat-reviewer
```
