...
7. Run `skcr validate` and `skcr asps coverage cncf-raydian-cloud-kcsp-reviewer`.
8. Run `skcr compile cncf-raydian-cloud-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-raydian-cloud-kcsp-reviewer`.
...
```bash
skpm validate cncf-raydian-cloud-kcsp-reviewer
skpm package cncf-raydian-cloud-kcsp-reviewer
skpm publish cncf-raydian-cloud-kcsp-reviewer
```
