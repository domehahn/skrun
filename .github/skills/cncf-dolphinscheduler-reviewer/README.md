...
7. Run `skcr validate` and `skcr asps coverage cncf-dolphinscheduler-reviewer`.
8. Run `skcr compile cncf-dolphinscheduler-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-dolphinscheduler-reviewer`.
...
```bash
skpm validate cncf-dolphinscheduler-reviewer
skpm package cncf-dolphinscheduler-reviewer
skpm publish cncf-dolphinscheduler-reviewer
```
