...
7. Run `skcr validate` and `skcr asps coverage cncf-firefly-member-reviewer`.
8. Run `skcr compile cncf-firefly-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-firefly-member-reviewer`.
...
```bash
skpm validate cncf-firefly-member-reviewer
skpm package cncf-firefly-member-reviewer
skpm publish cncf-firefly-member-reviewer
```
