...
7. Run `skcr validate` and `skcr asps coverage cncf-samsung-kubernetes-engine-ske-reviewer`.
8. Run `skcr compile cncf-samsung-kubernetes-engine-ske-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-samsung-kubernetes-engine-ske-reviewer`.
...
```bash
skpm validate cncf-samsung-kubernetes-engine-ske-reviewer
skpm package cncf-samsung-kubernetes-engine-ske-reviewer
skpm publish cncf-samsung-kubernetes-engine-ske-reviewer
```
