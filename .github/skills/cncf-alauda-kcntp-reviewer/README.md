...
7. Run `skcr validate` and `skcr asps coverage cncf-alauda-kcntp-reviewer`.
8. Run `skcr compile cncf-alauda-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-alauda-kcntp-reviewer`.
...
```bash
skpm validate cncf-alauda-kcntp-reviewer
skpm package cncf-alauda-kcntp-reviewer
skpm publish cncf-alauda-kcntp-reviewer
```
