...
7. Run `skcr validate` and `skcr asps coverage cncf-cloudsmith-member-reviewer`.
8. Run `skcr compile cncf-cloudsmith-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloudsmith-member-reviewer`.
...
```bash
skpm validate cncf-cloudsmith-member-reviewer
skpm package cncf-cloudsmith-member-reviewer
skpm publish cncf-cloudsmith-member-reviewer
```
