...
7. Run `skcr validate` and `skcr asps coverage cncf-elastisys-kcntp-reviewer`.
8. Run `skcr compile cncf-elastisys-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-elastisys-kcntp-reviewer`.
...
```bash
skpm validate cncf-elastisys-kcntp-reviewer
skpm package cncf-elastisys-kcntp-reviewer
skpm publish cncf-elastisys-kcntp-reviewer
```
