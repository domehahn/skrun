...
7. Run `skcr validate` and `skcr asps coverage cncf-schemahero-reviewer`.
8. Run `skcr compile cncf-schemahero-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-schemahero-reviewer`.
...
```bash
skpm validate cncf-schemahero-reviewer
skpm package cncf-schemahero-reviewer
skpm publish cncf-schemahero-reviewer
```
