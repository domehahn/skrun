...
7. Run `skcr validate` and `skcr asps coverage cncf-heroku-member-reviewer`.
8. Run `skcr compile cncf-heroku-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-heroku-member-reviewer`.
...
```bash
skpm validate cncf-heroku-member-reviewer
skpm package cncf-heroku-member-reviewer
skpm publish cncf-heroku-member-reviewer
```
