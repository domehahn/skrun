...
7. Run `skcr validate` and `skcr asps coverage cncf-atlassian-member-reviewer`.
8. Run `skcr compile cncf-atlassian-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-atlassian-member-reviewer`.
...
```bash
skpm validate cncf-atlassian-member-reviewer
skpm package cncf-atlassian-member-reviewer
skpm publish cncf-atlassian-member-reviewer
```
