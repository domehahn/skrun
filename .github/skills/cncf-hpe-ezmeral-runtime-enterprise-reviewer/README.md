...
7. Run `skcr validate` and `skcr asps coverage cncf-hpe-ezmeral-runtime-enterprise-reviewer`.
8. Run `skcr compile cncf-hpe-ezmeral-runtime-enterprise-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-hpe-ezmeral-runtime-enterprise-reviewer`.
...
```bash
skpm validate cncf-hpe-ezmeral-runtime-enterprise-reviewer
skpm package cncf-hpe-ezmeral-runtime-enterprise-reviewer
skpm publish cncf-hpe-ezmeral-runtime-enterprise-reviewer
```
