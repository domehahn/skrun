...
7. Run `skcr validate` and `skcr asps coverage cncf-wasmedge-quickjs-reviewer`.
8. Run `skcr compile cncf-wasmedge-quickjs-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-wasmedge-quickjs-reviewer`.
...
```bash
skpm validate cncf-wasmedge-quickjs-reviewer
skpm package cncf-wasmedge-quickjs-reviewer
skpm publish cncf-wasmedge-quickjs-reviewer
```
