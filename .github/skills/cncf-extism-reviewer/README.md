...
7. Run `skcr validate` and `skcr asps coverage cncf-extism-reviewer`.
8. Run `skcr compile cncf-extism-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-extism-reviewer`.
...
```bash
skpm validate cncf-extism-reviewer
skpm package cncf-extism-reviewer
skpm publish cncf-extism-reviewer
```
