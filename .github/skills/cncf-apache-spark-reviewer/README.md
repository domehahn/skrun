...
7. Run `skcr validate` and `skcr asps coverage cncf-apache-spark-reviewer`.
8. Run `skcr compile cncf-apache-spark-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-apache-spark-reviewer`.
...
```bash
skpm validate cncf-apache-spark-reviewer
skpm package cncf-apache-spark-reviewer
skpm publish cncf-apache-spark-reviewer
```
