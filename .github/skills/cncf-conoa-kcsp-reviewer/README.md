...
7. Run `skcr validate` and `skcr asps coverage cncf-conoa-kcsp-reviewer`.
8. Run `skcr compile cncf-conoa-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-conoa-kcsp-reviewer`.
...
```bash
skpm validate cncf-conoa-kcsp-reviewer
skpm package cncf-conoa-kcsp-reviewer
skpm publish cncf-conoa-kcsp-reviewer
```
