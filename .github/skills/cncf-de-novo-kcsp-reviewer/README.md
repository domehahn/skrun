...
7. Run `skcr validate` and `skcr asps coverage cncf-de-novo-kcsp-reviewer`.
8. Run `skcr compile cncf-de-novo-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-de-novo-kcsp-reviewer`.
...
```bash
skpm validate cncf-de-novo-kcsp-reviewer
skpm package cncf-de-novo-kcsp-reviewer
skpm publish cncf-de-novo-kcsp-reviewer
```
