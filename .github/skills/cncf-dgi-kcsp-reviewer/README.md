...
7. Run `skcr validate` and `skcr asps coverage cncf-dgi-kcsp-reviewer`.
8. Run `skcr compile cncf-dgi-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-dgi-kcsp-reviewer`.
...
```bash
skpm validate cncf-dgi-kcsp-reviewer
skpm package cncf-dgi-kcsp-reviewer
skpm publish cncf-dgi-kcsp-reviewer
```
