...
7. Run `skcr validate` and `skcr asps coverage cncf-zettaset-reviewer`.
8. Run `skcr compile cncf-zettaset-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-zettaset-reviewer`.
...
```bash
skpm validate cncf-zettaset-reviewer
skpm package cncf-zettaset-reviewer
skpm publish cncf-zettaset-reviewer
```
