...
7. Run `skcr validate` and `skcr asps coverage documentation-governance-reviewer`.
8. Run `skcr compile documentation-governance-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend documentation-governance-reviewer`.
