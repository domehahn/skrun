...
7. Run `skcr validate` and `skcr asps coverage cncf-finout-member-reviewer`.
8. Run `skcr compile cncf-finout-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-finout-member-reviewer`.
...
```bash
skpm validate cncf-finout-member-reviewer
skpm package cncf-finout-member-reviewer
skpm publish cncf-finout-member-reviewer
```
