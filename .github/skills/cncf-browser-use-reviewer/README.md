...
7. Run `skcr validate` and `skcr asps coverage cncf-browser-use-reviewer`.
8. Run `skcr compile cncf-browser-use-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-browser-use-reviewer`.
...
```bash
skpm validate cncf-browser-use-reviewer
skpm package cncf-browser-use-reviewer
skpm publish cncf-browser-use-reviewer
```
