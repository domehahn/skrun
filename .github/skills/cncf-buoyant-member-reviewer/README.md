...
7. Run `skcr validate` and `skcr asps coverage cncf-buoyant-member-reviewer`.
8. Run `skcr compile cncf-buoyant-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-buoyant-member-reviewer`.
...
```bash
skpm validate cncf-buoyant-member-reviewer
skpm package cncf-buoyant-member-reviewer
skpm publish cncf-buoyant-member-reviewer
```
