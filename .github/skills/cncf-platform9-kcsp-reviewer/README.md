...
7. Run `skcr validate` and `skcr asps coverage cncf-platform9-kcsp-reviewer`.
8. Run `skcr compile cncf-platform9-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-platform9-kcsp-reviewer`.
...
```bash
skpm validate cncf-platform9-kcsp-reviewer
skpm package cncf-platform9-kcsp-reviewer
skpm publish cncf-platform9-kcsp-reviewer
```
