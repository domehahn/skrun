...
7. Run `skcr validate` and `skcr asps coverage cncf-agileops-member-reviewer`.
8. Run `skcr compile cncf-agileops-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-agileops-member-reviewer`.
...
```bash
skpm validate cncf-agileops-member-reviewer
skpm package cncf-agileops-member-reviewer
skpm publish cncf-agileops-member-reviewer
```
