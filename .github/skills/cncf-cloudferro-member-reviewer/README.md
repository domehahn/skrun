...
7. Run `skcr validate` and `skcr asps coverage cncf-cloudferro-member-reviewer`.
8. Run `skcr compile cncf-cloudferro-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloudferro-member-reviewer`.
...
```bash
skpm validate cncf-cloudferro-member-reviewer
skpm package cncf-cloudferro-member-reviewer
skpm publish cncf-cloudferro-member-reviewer
```
