...
7. Run `skcr validate` and `skcr asps coverage cncf-iherb-supporter-reviewer`.
8. Run `skcr compile cncf-iherb-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-iherb-supporter-reviewer`.
...
```bash
skpm validate cncf-iherb-supporter-reviewer
skpm package cncf-iherb-supporter-reviewer
skpm publish cncf-iherb-supporter-reviewer
```
