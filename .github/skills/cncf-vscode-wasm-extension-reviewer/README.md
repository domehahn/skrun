...
7. Run `skcr validate` and `skcr asps coverage cncf-vscode-wasm-extension-reviewer`.
8. Run `skcr compile cncf-vscode-wasm-extension-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-vscode-wasm-extension-reviewer`.
...
```bash
skpm validate cncf-vscode-wasm-extension-reviewer
skpm package cncf-vscode-wasm-extension-reviewer
skpm publish cncf-vscode-wasm-extension-reviewer
```
