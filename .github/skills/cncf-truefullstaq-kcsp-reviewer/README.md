...
7. Run `skcr validate` and `skcr asps coverage cncf-truefullstaq-kcsp-reviewer`.
8. Run `skcr compile cncf-truefullstaq-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-truefullstaq-kcsp-reviewer`.
...
```bash
skpm validate cncf-truefullstaq-kcsp-reviewer
skpm package cncf-truefullstaq-kcsp-reviewer
skpm publish cncf-truefullstaq-kcsp-reviewer
```
