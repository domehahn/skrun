...
7. Run `skcr validate` and `skcr asps coverage cncf-booz-allen-hamilton-kcsp-reviewer`.
8. Run `skcr compile cncf-booz-allen-hamilton-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-booz-allen-hamilton-kcsp-reviewer`.
...
```bash
skpm validate cncf-booz-allen-hamilton-kcsp-reviewer
skpm package cncf-booz-allen-hamilton-kcsp-reviewer
skpm publish cncf-booz-allen-hamilton-kcsp-reviewer
```
