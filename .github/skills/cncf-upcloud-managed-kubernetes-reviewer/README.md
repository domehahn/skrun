...
7. Run `skcr validate` and `skcr asps coverage cncf-upcloud-managed-kubernetes-reviewer`.
8. Run `skcr compile cncf-upcloud-managed-kubernetes-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-upcloud-managed-kubernetes-reviewer`.
...
```bash
skpm validate cncf-upcloud-managed-kubernetes-reviewer
skpm package cncf-upcloud-managed-kubernetes-reviewer
skpm publish cncf-upcloud-managed-kubernetes-reviewer
```
