...
7. Run `skcr validate` and `skcr asps coverage cncf-viettel-member-reviewer`.
8. Run `skcr compile cncf-viettel-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-viettel-member-reviewer`.
...
```bash
skpm validate cncf-viettel-member-reviewer
skpm package cncf-viettel-member-reviewer
skpm publish cncf-viettel-member-reviewer
```
