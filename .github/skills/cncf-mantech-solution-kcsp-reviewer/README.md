...
7. Run `skcr validate` and `skcr asps coverage cncf-mantech-solution-kcsp-reviewer`.
8. Run `skcr compile cncf-mantech-solution-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-mantech-solution-kcsp-reviewer`.
...
```bash
skpm validate cncf-mantech-solution-kcsp-reviewer
skpm package cncf-mantech-solution-kcsp-reviewer
skpm publish cncf-mantech-solution-kcsp-reviewer
```
