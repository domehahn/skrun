...
7. Run `skcr validate` and `skcr asps coverage cncf-rancher-kubernetes-reviewer`.
8. Run `skcr compile cncf-rancher-kubernetes-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-rancher-kubernetes-reviewer`.
...
```bash
skpm validate cncf-rancher-kubernetes-reviewer
skpm package cncf-rancher-kubernetes-reviewer
skpm publish cncf-rancher-kubernetes-reviewer
```
