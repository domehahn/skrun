...
7. Run `skcr validate` and `skcr asps coverage cncf-canonical-kubernetes-reviewer`.
8. Run `skcr compile cncf-canonical-kubernetes-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-canonical-kubernetes-reviewer`.
...
```bash
skpm validate cncf-canonical-kubernetes-reviewer
skpm package cncf-canonical-kubernetes-reviewer
skpm publish cncf-canonical-kubernetes-reviewer
```
