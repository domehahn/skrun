...
7. Run `skcr validate` and `skcr asps coverage cncf-capital-one-member-reviewer`.
8. Run `skcr compile cncf-capital-one-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-capital-one-member-reviewer`.
...
```bash
skpm validate cncf-capital-one-member-reviewer
skpm package cncf-capital-one-member-reviewer
skpm publish cncf-capital-one-member-reviewer
```
