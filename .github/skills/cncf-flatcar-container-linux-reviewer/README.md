...
7. Run `skcr validate` and `skcr asps coverage cncf-flatcar-container-linux-reviewer`.
8. Run `skcr compile cncf-flatcar-container-linux-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-flatcar-container-linux-reviewer`.
...
```bash
skpm validate cncf-flatcar-container-linux-reviewer
skpm package cncf-flatcar-container-linux-reviewer
skpm publish cncf-flatcar-container-linux-reviewer
```
