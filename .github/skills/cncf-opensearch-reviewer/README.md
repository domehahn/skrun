...
7. Run `skcr validate` and `skcr asps coverage cncf-opensearch-reviewer`.
8. Run `skcr compile cncf-opensearch-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-opensearch-reviewer`.
...
```bash
skpm validate cncf-opensearch-reviewer
skpm package cncf-opensearch-reviewer
skpm publish cncf-opensearch-reviewer
```
