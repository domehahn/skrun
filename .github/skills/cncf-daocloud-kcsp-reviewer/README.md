...
7. Run `skcr validate` and `skcr asps coverage cncf-daocloud-kcsp-reviewer`.
8. Run `skcr compile cncf-daocloud-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-daocloud-kcsp-reviewer`.
...
```bash
skpm validate cncf-daocloud-kcsp-reviewer
skpm package cncf-daocloud-kcsp-reviewer
skpm publish cncf-daocloud-kcsp-reviewer
```
