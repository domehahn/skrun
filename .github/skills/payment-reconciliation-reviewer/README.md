...
7. Run `skcr validate` and `skcr asps coverage payment-reconciliation-reviewer`.
8. Run `skcr compile payment-reconciliation-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend payment-reconciliation-reviewer`.
...
```bash
skpm validate payment-reconciliation-reviewer
skpm package payment-reconciliation-reviewer
skpm publish payment-reconciliation-reviewer
```
