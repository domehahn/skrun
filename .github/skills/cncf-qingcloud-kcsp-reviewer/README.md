...
7. Run `skcr validate` and `skcr asps coverage cncf-qingcloud-kcsp-reviewer`.
8. Run `skcr compile cncf-qingcloud-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-qingcloud-kcsp-reviewer`.
...
```bash
skpm validate cncf-qingcloud-kcsp-reviewer
skpm package cncf-qingcloud-kcsp-reviewer
skpm publish cncf-qingcloud-kcsp-reviewer
```
