...
7. Run `skcr validate` and `skcr asps coverage cncf-diamanti-reviewer`.
8. Run `skcr compile cncf-diamanti-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-diamanti-reviewer`.
...
```bash
skpm validate cncf-diamanti-reviewer
skpm package cncf-diamanti-reviewer
skpm publish cncf-diamanti-reviewer
```
