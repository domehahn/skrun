...
7. Run `skcr validate` and `skcr asps coverage cncf-kusionstack-reviewer`.
8. Run `skcr compile cncf-kusionstack-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kusionstack-reviewer`.
...
```bash
skpm validate cncf-kusionstack-reviewer
skpm package cncf-kusionstack-reviewer
skpm publish cncf-kusionstack-reviewer
```
