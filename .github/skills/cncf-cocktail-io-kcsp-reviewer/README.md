...
7. Run `skcr validate` and `skcr asps coverage cncf-cocktail-io-kcsp-reviewer`.
8. Run `skcr compile cncf-cocktail-io-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cocktail-io-kcsp-reviewer`.
...
```bash
skpm validate cncf-cocktail-io-kcsp-reviewer
skpm package cncf-cocktail-io-kcsp-reviewer
skpm publish cncf-cocktail-io-kcsp-reviewer
```
