...
7. Run `skcr validate` and `skcr asps coverage cncf-dg-i-kubernetes-platform-reviewer`.
8. Run `skcr compile cncf-dg-i-kubernetes-platform-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-dg-i-kubernetes-platform-reviewer`.
...
```bash
skpm validate cncf-dg-i-kubernetes-platform-reviewer
skpm package cncf-dg-i-kubernetes-platform-reviewer
skpm publish cncf-dg-i-kubernetes-platform-reviewer
```
