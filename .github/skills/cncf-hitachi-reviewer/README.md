...
7. Run `skcr validate` and `skcr asps coverage cncf-hitachi-reviewer`.
8. Run `skcr compile cncf-hitachi-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-hitachi-reviewer`.
...
```bash
skpm validate cncf-hitachi-reviewer
skpm package cncf-hitachi-reviewer
skpm publish cncf-hitachi-reviewer
```
