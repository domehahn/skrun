...
7. Run `skcr validate` and `skcr asps coverage cncf-terasky-member-reviewer`.
8. Run `skcr compile cncf-terasky-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-terasky-member-reviewer`.
...
```bash
skpm validate cncf-terasky-member-reviewer
skpm package cncf-terasky-member-reviewer
skpm publish cncf-terasky-member-reviewer
```
