...
7. Run `skcr validate` and `skcr asps coverage cncf-devcycle-reviewer`.
8. Run `skcr compile cncf-devcycle-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-devcycle-reviewer`.
...
```bash
skpm validate cncf-devcycle-reviewer
skpm package cncf-devcycle-reviewer
skpm publish cncf-devcycle-reviewer
```
