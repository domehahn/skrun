...
7. Run `skcr validate` and `skcr asps coverage cncf-cosmonic-wasm-reviewer`.
8. Run `skcr compile cncf-cosmonic-wasm-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cosmonic-wasm-reviewer`.
...
```bash
skpm validate cncf-cosmonic-wasm-reviewer
skpm package cncf-cosmonic-wasm-reviewer
skpm publish cncf-cosmonic-wasm-reviewer
```
