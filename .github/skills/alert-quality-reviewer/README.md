...
7. Run `skcr validate` and `skcr asps coverage alert-quality-reviewer`.
8. Run `skcr compile alert-quality-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend alert-quality-reviewer`.
