...
7. Run `skcr validate` and `skcr asps coverage cncf-vjsar-kcsp-reviewer`.
8. Run `skcr compile cncf-vjsar-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-vjsar-kcsp-reviewer`.
...
```bash
skpm validate cncf-vjsar-kcsp-reviewer
skpm package cncf-vjsar-kcsp-reviewer
skpm publish cncf-vjsar-kcsp-reviewer
```
