...
7. Run `skcr validate` and `skcr asps coverage cncf-sysdig-secure-reviewer`.
8. Run `skcr compile cncf-sysdig-secure-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sysdig-secure-reviewer`.
...
```bash
skpm validate cncf-sysdig-secure-reviewer
skpm package cncf-sysdig-secure-reviewer
skpm publish cncf-sysdig-secure-reviewer
```
