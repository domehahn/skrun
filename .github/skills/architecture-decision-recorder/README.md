...
7. Run `skcr validate` and `skcr asps coverage architecture-decision-recorder`.
8. Run `skcr compile architecture-decision-recorder --target skil`.
9. Run `skcr sync` and `skcr version recommend architecture-decision-recorder`.
...
```bash
skpm validate architecture-decision-recorder
skpm package architecture-decision-recorder
skpm publish architecture-decision-recorder
```
