...
7. Run `skcr validate` and `skcr asps coverage cncf-wasmer-registry-reviewer`.
8. Run `skcr compile cncf-wasmer-registry-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-wasmer-registry-reviewer`.
...
```bash
skpm validate cncf-wasmer-registry-reviewer
skpm package cncf-wasmer-registry-reviewer
skpm publish cncf-wasmer-registry-reviewer
```
