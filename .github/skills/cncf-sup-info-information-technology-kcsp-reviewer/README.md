...
7. Run `skcr validate` and `skcr asps coverage cncf-sup-info-information-technology-kcsp-reviewer`.
8. Run `skcr compile cncf-sup-info-information-technology-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sup-info-information-technology-kcsp-reviewer`.
...
```bash
skpm validate cncf-sup-info-information-technology-kcsp-reviewer
skpm package cncf-sup-info-information-technology-kcsp-reviewer
skpm publish cncf-sup-info-information-technology-kcsp-reviewer
```
