...
7. Run `skcr validate` and `skcr asps coverage cncf-icubed-member-reviewer`.
8. Run `skcr compile cncf-icubed-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-icubed-member-reviewer`.
...
```bash
skpm validate cncf-icubed-member-reviewer
skpm package cncf-icubed-member-reviewer
skpm publish cncf-icubed-member-reviewer
```
