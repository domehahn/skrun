...
7. Run `skcr validate` and `skcr asps coverage cncf-open-policy-administration-layer-opal-reviewer`.
8. Run `skcr compile cncf-open-policy-administration-layer-opal-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-open-policy-administration-layer-opal-reviewer`.
...
```bash
skpm validate cncf-open-policy-administration-layer-opal-reviewer
skpm package cncf-open-policy-administration-layer-opal-reviewer
skpm publish cncf-open-policy-administration-layer-opal-reviewer
```
