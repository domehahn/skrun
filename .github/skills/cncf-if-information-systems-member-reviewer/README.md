...
7. Run `skcr validate` and `skcr asps coverage cncf-if-information-systems-member-reviewer`.
8. Run `skcr compile cncf-if-information-systems-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-if-information-systems-member-reviewer`.
...
```bash
skpm validate cncf-if-information-systems-member-reviewer
skpm package cncf-if-information-systems-member-reviewer
skpm publish cncf-if-information-systems-member-reviewer
```
