...
7. Run `skcr validate` and `skcr asps coverage cncf-easystack-kcntp-reviewer`.
8. Run `skcr compile cncf-easystack-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-easystack-kcntp-reviewer`.
...
```bash
skpm validate cncf-easystack-kcntp-reviewer
skpm package cncf-easystack-kcntp-reviewer
skpm publish cncf-easystack-kcntp-reviewer
```
