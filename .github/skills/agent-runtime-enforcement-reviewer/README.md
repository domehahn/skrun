...
7. Run `skcr validate` and `skcr asps coverage agent-runtime-enforcement-reviewer`.
8. Run `skcr compile agent-runtime-enforcement-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend agent-runtime-enforcement-reviewer`.
...
```bash
skpm validate agent-runtime-enforcement-reviewer
skpm package agent-runtime-enforcement-reviewer
skpm publish agent-runtime-enforcement-reviewer
```
