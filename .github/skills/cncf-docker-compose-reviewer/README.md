...
7. Run `skcr validate` and `skcr asps coverage cncf-docker-compose-reviewer`.
8. Run `skcr compile cncf-docker-compose-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-docker-compose-reviewer`.
...
```bash
skpm validate cncf-docker-compose-reviewer
skpm package cncf-docker-compose-reviewer
skpm publish cncf-docker-compose-reviewer
```
