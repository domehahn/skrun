...
7. Run `skcr validate` and `skcr asps coverage cncf-fullstacks-kcsp-reviewer`.
8. Run `skcr compile cncf-fullstacks-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-fullstacks-kcsp-reviewer`.
...
```bash
skpm validate cncf-fullstacks-kcsp-reviewer
skpm package cncf-fullstacks-kcsp-reviewer
skpm publish cncf-fullstacks-kcsp-reviewer
```
