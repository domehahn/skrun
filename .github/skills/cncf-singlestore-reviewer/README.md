...
7. Run `skcr validate` and `skcr asps coverage cncf-singlestore-reviewer`.
8. Run `skcr compile cncf-singlestore-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-singlestore-reviewer`.
...
```bash
skpm validate cncf-singlestore-reviewer
skpm package cncf-singlestore-reviewer
skpm publish cncf-singlestore-reviewer
```
