...
7. Run `skcr validate` and `skcr asps coverage cncf-deepshore-kcsp-reviewer`.
8. Run `skcr compile cncf-deepshore-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-deepshore-kcsp-reviewer`.
...
```bash
skpm validate cncf-deepshore-kcsp-reviewer
skpm package cncf-deepshore-kcsp-reviewer
skpm publish cncf-deepshore-kcsp-reviewer
```
