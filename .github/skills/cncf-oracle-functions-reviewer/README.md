...
7. Run `skcr validate` and `skcr asps coverage cncf-oracle-functions-reviewer`.
8. Run `skcr compile cncf-oracle-functions-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-oracle-functions-reviewer`.
...
```bash
skpm validate cncf-oracle-functions-reviewer
skpm package cncf-oracle-functions-reviewer
skpm publish cncf-oracle-functions-reviewer
```
