...
7. Run `skcr validate` and `skcr asps coverage cncf-nocalhost-reviewer`.
8. Run `skcr compile cncf-nocalhost-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nocalhost-reviewer`.
...
```bash
skpm validate cncf-nocalhost-reviewer
skpm package cncf-nocalhost-reviewer
skpm publish cncf-nocalhost-reviewer
```
