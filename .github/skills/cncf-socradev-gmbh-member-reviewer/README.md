...
7. Run `skcr validate` and `skcr asps coverage cncf-socradev-gmbh-member-reviewer`.
8. Run `skcr compile cncf-socradev-gmbh-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-socradev-gmbh-member-reviewer`.
...
```bash
skpm validate cncf-socradev-gmbh-member-reviewer
skpm package cncf-socradev-gmbh-member-reviewer
skpm publish cncf-socradev-gmbh-member-reviewer
```
