...
7. Run `skcr validate` and `skcr asps coverage cncf-kubermatic-kubernetes-platform-reviewer`.
8. Run `skcr compile cncf-kubermatic-kubernetes-platform-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kubermatic-kubernetes-platform-reviewer`.
...
```bash
skpm validate cncf-kubermatic-kubernetes-platform-reviewer
skpm package cncf-kubermatic-kubernetes-platform-reviewer
skpm publish cncf-kubermatic-kubernetes-platform-reviewer
```
