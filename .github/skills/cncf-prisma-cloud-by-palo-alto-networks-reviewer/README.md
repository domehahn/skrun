...
7. Run `skcr validate` and `skcr asps coverage cncf-prisma-cloud-by-palo-alto-networks-reviewer`.
8. Run `skcr compile cncf-prisma-cloud-by-palo-alto-networks-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-prisma-cloud-by-palo-alto-networks-reviewer`.
...
```bash
skpm validate cncf-prisma-cloud-by-palo-alto-networks-reviewer
skpm package cncf-prisma-cloud-by-palo-alto-networks-reviewer
skpm publish cncf-prisma-cloud-by-palo-alto-networks-reviewer
```
