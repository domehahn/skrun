...
7. Run `skcr validate` and `skcr asps coverage cncf-azure-kubernetes-service-aks-reviewer`.
8. Run `skcr compile cncf-azure-kubernetes-service-aks-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-azure-kubernetes-service-aks-reviewer`.
...
```bash
skpm validate cncf-azure-kubernetes-service-aks-reviewer
skpm package cncf-azure-kubernetes-service-aks-reviewer
skpm publish cncf-azure-kubernetes-service-aks-reviewer
```
