...
7. Run `skcr validate` and `skcr asps coverage cncf-nielseniq-supporter-reviewer`.
8. Run `skcr compile cncf-nielseniq-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nielseniq-supporter-reviewer`.
...
```bash
skpm validate cncf-nielseniq-supporter-reviewer
skpm package cncf-nielseniq-supporter-reviewer
skpm publish cncf-nielseniq-supporter-reviewer
```
