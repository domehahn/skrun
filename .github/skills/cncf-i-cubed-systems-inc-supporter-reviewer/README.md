...
7. Run `skcr validate` and `skcr asps coverage cncf-i-cubed-systems-inc-supporter-reviewer`.
8. Run `skcr compile cncf-i-cubed-systems-inc-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-i-cubed-systems-inc-supporter-reviewer`.
...
```bash
skpm validate cncf-i-cubed-systems-inc-supporter-reviewer
skpm package cncf-i-cubed-systems-inc-supporter-reviewer
skpm publish cncf-i-cubed-systems-inc-supporter-reviewer
```
