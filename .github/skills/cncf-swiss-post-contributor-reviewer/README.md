...
7. Run `skcr validate` and `skcr asps coverage cncf-swiss-post-contributor-reviewer`.
8. Run `skcr compile cncf-swiss-post-contributor-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-swiss-post-contributor-reviewer`.
...
```bash
skpm validate cncf-swiss-post-contributor-reviewer
skpm package cncf-swiss-post-contributor-reviewer
skpm publish cncf-swiss-post-contributor-reviewer
```
