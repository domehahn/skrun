...
7. Run `skcr validate` and `skcr asps coverage cncf-seatunnel-reviewer`.
8. Run `skcr compile cncf-seatunnel-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-seatunnel-reviewer`.
...
```bash
skpm validate cncf-seatunnel-reviewer
skpm package cncf-seatunnel-reviewer
skpm publish cncf-seatunnel-reviewer
```
