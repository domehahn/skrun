...
7. Run `skcr validate` and `skcr asps coverage cncf-kueue-reviewer`.
8. Run `skcr compile cncf-kueue-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kueue-reviewer`.
...
```bash
skpm validate cncf-kueue-reviewer
skpm package cncf-kueue-reviewer
skpm publish cncf-kueue-reviewer
```
