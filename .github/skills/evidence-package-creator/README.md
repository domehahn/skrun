...
7. Run `skcr validate` and `skcr asps coverage evidence-package-creator`.
8. Run `skcr compile evidence-package-creator --target skil`.
9. Run `skcr sync` and `skcr version recommend evidence-package-creator`.
