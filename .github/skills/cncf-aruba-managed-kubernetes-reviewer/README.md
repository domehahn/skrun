...
7. Run `skcr validate` and `skcr asps coverage cncf-aruba-managed-kubernetes-reviewer`.
8. Run `skcr compile cncf-aruba-managed-kubernetes-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-aruba-managed-kubernetes-reviewer`.
...
```bash
skpm validate cncf-aruba-managed-kubernetes-reviewer
skpm package cncf-aruba-managed-kubernetes-reviewer
skpm publish cncf-aruba-managed-kubernetes-reviewer
```
