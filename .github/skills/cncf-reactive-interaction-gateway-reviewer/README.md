...
7. Run `skcr validate` and `skcr asps coverage cncf-reactive-interaction-gateway-reviewer`.
8. Run `skcr compile cncf-reactive-interaction-gateway-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-reactive-interaction-gateway-reviewer`.
...
```bash
skpm validate cncf-reactive-interaction-gateway-reviewer
skpm package cncf-reactive-interaction-gateway-reviewer
skpm publish cncf-reactive-interaction-gateway-reviewer
```
