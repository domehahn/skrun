...
7. Run `skcr validate` and `skcr asps coverage cncf-dashbird-reviewer`.
8. Run `skcr compile cncf-dashbird-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-dashbird-reviewer`.
...
```bash
skpm validate cncf-dashbird-reviewer
skpm package cncf-dashbird-reviewer
skpm publish cncf-dashbird-reviewer
```
