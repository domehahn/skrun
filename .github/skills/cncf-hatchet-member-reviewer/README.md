...
7. Run `skcr validate` and `skcr asps coverage cncf-hatchet-member-reviewer`.
8. Run `skcr compile cncf-hatchet-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-hatchet-member-reviewer`.
...
```bash
skpm validate cncf-hatchet-member-reviewer
skpm package cncf-hatchet-member-reviewer
skpm publish cncf-hatchet-member-reviewer
```
