...
7. Run `skcr validate` and `skcr asps coverage cncf-confluentis-consulting-kcsp-reviewer`.
8. Run `skcr compile cncf-confluentis-consulting-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-confluentis-consulting-kcsp-reviewer`.
...
```bash
skpm validate cncf-confluentis-consulting-kcsp-reviewer
skpm package cncf-confluentis-consulting-kcsp-reviewer
skpm publish cncf-confluentis-consulting-kcsp-reviewer
```
