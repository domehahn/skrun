...
7. Run `skcr validate` and `skcr asps coverage cncf-oceanbase-reviewer`.
8. Run `skcr compile cncf-oceanbase-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-oceanbase-reviewer`.
...
```bash
skpm validate cncf-oceanbase-reviewer
skpm package cncf-oceanbase-reviewer
skpm publish cncf-oceanbase-reviewer
```
