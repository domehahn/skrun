...
7. Run `skcr validate` and `skcr asps coverage cncf-harness-io-reviewer`.
8. Run `skcr compile cncf-harness-io-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-harness-io-reviewer`.
...
```bash
skpm validate cncf-harness-io-reviewer
skpm package cncf-harness-io-reviewer
skpm publish cncf-harness-io-reviewer
```
