...
7. Run `skcr validate` and `skcr asps coverage cncf-keyfactor-member-reviewer`.
8. Run `skcr compile cncf-keyfactor-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-keyfactor-member-reviewer`.
...
```bash
skpm validate cncf-keyfactor-member-reviewer
skpm package cncf-keyfactor-member-reviewer
skpm publish cncf-keyfactor-member-reviewer
```
