...
7. Run `skcr validate` and `skcr asps coverage cncf-apache-ignite-reviewer`.
8. Run `skcr compile cncf-apache-ignite-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-apache-ignite-reviewer`.
...
```bash
skpm validate cncf-apache-ignite-reviewer
skpm package cncf-apache-ignite-reviewer
skpm publish cncf-apache-ignite-reviewer
```
