...
7. Run `skcr validate` and `skcr asps coverage cncf-archestra-ai-member-reviewer`.
8. Run `skcr compile cncf-archestra-ai-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-archestra-ai-member-reviewer`.
...
```bash
skpm validate cncf-archestra-ai-member-reviewer
skpm package cncf-archestra-ai-member-reviewer
skpm publish cncf-archestra-ai-member-reviewer
```
