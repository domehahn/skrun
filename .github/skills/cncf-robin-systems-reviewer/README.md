...
7. Run `skcr validate` and `skcr asps coverage cncf-robin-systems-reviewer`.
8. Run `skcr compile cncf-robin-systems-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-robin-systems-reviewer`.
...
```bash
skpm validate cncf-robin-systems-reviewer
skpm package cncf-robin-systems-reviewer
skpm publish cncf-robin-systems-reviewer
```
