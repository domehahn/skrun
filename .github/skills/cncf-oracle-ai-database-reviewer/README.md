...
7. Run `skcr validate` and `skcr asps coverage cncf-oracle-ai-database-reviewer`.
8. Run `skcr compile cncf-oracle-ai-database-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-oracle-ai-database-reviewer`.
...
```bash
skpm validate cncf-oracle-ai-database-reviewer
skpm package cncf-oracle-ai-database-reviewer
skpm publish cncf-oracle-ai-database-reviewer
```
