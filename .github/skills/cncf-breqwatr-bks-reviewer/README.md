...
7. Run `skcr validate` and `skcr asps coverage cncf-breqwatr-bks-reviewer`.
8. Run `skcr compile cncf-breqwatr-bks-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-breqwatr-bks-reviewer`.
...
```bash
skpm validate cncf-breqwatr-bks-reviewer
skpm package cncf-breqwatr-bks-reviewer
skpm publish cncf-breqwatr-bks-reviewer
```
