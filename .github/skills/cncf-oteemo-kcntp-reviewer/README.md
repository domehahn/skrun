...
7. Run `skcr validate` and `skcr asps coverage cncf-oteemo-kcntp-reviewer`.
8. Run `skcr compile cncf-oteemo-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-oteemo-kcntp-reviewer`.
...
```bash
skpm validate cncf-oteemo-kcntp-reviewer
skpm package cncf-oteemo-kcntp-reviewer
skpm publish cncf-oteemo-kcntp-reviewer
```
