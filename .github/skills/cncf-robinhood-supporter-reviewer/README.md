...
7. Run `skcr validate` and `skcr asps coverage cncf-robinhood-supporter-reviewer`.
8. Run `skcr compile cncf-robinhood-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-robinhood-supporter-reviewer`.
...
```bash
skpm validate cncf-robinhood-supporter-reviewer
skpm package cncf-robinhood-supporter-reviewer
skpm publish cncf-robinhood-supporter-reviewer
```
