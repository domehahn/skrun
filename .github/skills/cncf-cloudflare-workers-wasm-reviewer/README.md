...
7. Run `skcr validate` and `skcr asps coverage cncf-cloudflare-workers-wasm-reviewer`.
8. Run `skcr compile cncf-cloudflare-workers-wasm-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloudflare-workers-wasm-reviewer`.
...
```bash
skpm validate cncf-cloudflare-workers-wasm-reviewer
skpm package cncf-cloudflare-workers-wasm-reviewer
skpm publish cncf-cloudflare-workers-wasm-reviewer
```
