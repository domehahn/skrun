...
7. Run `skcr validate` and `skcr asps coverage devsecops-maturity-reviewer`.
8. Run `skcr compile devsecops-maturity-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend devsecops-maturity-reviewer`.
