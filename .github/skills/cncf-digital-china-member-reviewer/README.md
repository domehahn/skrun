...
7. Run `skcr validate` and `skcr asps coverage cncf-digital-china-member-reviewer`.
8. Run `skcr compile cncf-digital-china-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-digital-china-member-reviewer`.
...
```bash
skpm validate cncf-digital-china-member-reviewer
skpm package cncf-digital-china-member-reviewer
skpm publish cncf-digital-china-member-reviewer
```
