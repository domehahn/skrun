...
7. Run `skcr validate` and `skcr asps coverage cncf-fullstacks-kcntp-reviewer`.
8. Run `skcr compile cncf-fullstacks-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-fullstacks-kcntp-reviewer`.
...
```bash
skpm validate cncf-fullstacks-kcntp-reviewer
skpm package cncf-fullstacks-kcntp-reviewer
skpm publish cncf-fullstacks-kcntp-reviewer
```
