...
7. Run `skcr validate` and `skcr asps coverage cncf-alerant-kcsp-reviewer`.
8. Run `skcr compile cncf-alerant-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-alerant-kcsp-reviewer`.
...
```bash
skpm validate cncf-alerant-kcsp-reviewer
skpm package cncf-alerant-kcsp-reviewer
skpm publish cncf-alerant-kcsp-reviewer
```
