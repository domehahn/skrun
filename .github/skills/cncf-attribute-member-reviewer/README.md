...
7. Run `skcr validate` and `skcr asps coverage cncf-attribute-member-reviewer`.
8. Run `skcr compile cncf-attribute-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-attribute-member-reviewer`.
...
```bash
skpm validate cncf-attribute-member-reviewer
skpm package cncf-attribute-member-reviewer
skpm publish cncf-attribute-member-reviewer
```
