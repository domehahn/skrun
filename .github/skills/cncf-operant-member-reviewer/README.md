...
7. Run `skcr validate` and `skcr asps coverage cncf-operant-member-reviewer`.
8. Run `skcr compile cncf-operant-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-operant-member-reviewer`.
...
```bash
skpm validate cncf-operant-member-reviewer
skpm package cncf-operant-member-reviewer
skpm publish cncf-operant-member-reviewer
```
