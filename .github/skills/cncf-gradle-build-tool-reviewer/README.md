...
7. Run `skcr validate` and `skcr asps coverage cncf-gradle-build-tool-reviewer`.
8. Run `skcr compile cncf-gradle-build-tool-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-gradle-build-tool-reviewer`.
...
```bash
skpm validate cncf-gradle-build-tool-reviewer
skpm package cncf-gradle-build-tool-reviewer
skpm publish cncf-gradle-build-tool-reviewer
```
