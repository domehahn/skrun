...
7. Run `skcr validate` and `skcr asps coverage cncf-sandstone-reviewer`.
8. Run `skcr compile cncf-sandstone-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sandstone-reviewer`.
...
```bash
skpm validate cncf-sandstone-reviewer
skpm package cncf-sandstone-reviewer
skpm publish cncf-sandstone-reviewer
```
