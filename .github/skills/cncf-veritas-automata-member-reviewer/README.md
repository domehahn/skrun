...
7. Run `skcr validate` and `skcr asps coverage cncf-veritas-automata-member-reviewer`.
8. Run `skcr compile cncf-veritas-automata-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-veritas-automata-member-reviewer`.
...
```bash
skpm validate cncf-veritas-automata-member-reviewer
skpm package cncf-veritas-automata-member-reviewer
skpm publish cncf-veritas-automata-member-reviewer
```
