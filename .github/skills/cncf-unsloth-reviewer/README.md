...
7. Run `skcr validate` and `skcr asps coverage cncf-unsloth-reviewer`.
8. Run `skcr compile cncf-unsloth-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-unsloth-reviewer`.
...
```bash
skpm validate cncf-unsloth-reviewer
skpm package cncf-unsloth-reviewer
skpm publish cncf-unsloth-reviewer
```
