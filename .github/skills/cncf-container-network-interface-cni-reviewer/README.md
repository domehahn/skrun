...
7. Run `skcr validate` and `skcr asps coverage cncf-container-network-interface-cni-reviewer`.
8. Run `skcr compile cncf-container-network-interface-cni-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-container-network-interface-cni-reviewer`.
...
```bash
skpm validate cncf-container-network-interface-cni-reviewer
skpm package cncf-container-network-interface-cni-reviewer
skpm publish cncf-container-network-interface-cni-reviewer
```
