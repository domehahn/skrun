...
7. Run `skcr validate` and `skcr asps coverage cncf-podman-container-tools-reviewer`.
8. Run `skcr compile cncf-podman-container-tools-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-podman-container-tools-reviewer`.
...
```bash
skpm validate cncf-podman-container-tools-reviewer
skpm package cncf-podman-container-tools-reviewer
skpm publish cncf-podman-container-tools-reviewer
```
