...
7. Run `skcr validate` and `skcr asps coverage cncf-kosko-reviewer`.
8. Run `skcr compile cncf-kosko-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kosko-reviewer`.
...
```bash
skpm validate cncf-kosko-reviewer
skpm package cncf-kosko-reviewer
skpm publish cncf-kosko-reviewer
```
