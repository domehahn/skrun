...
7. Run `skcr validate` and `skcr asps coverage cncf-china-systems-member-reviewer`.
8. Run `skcr compile cncf-china-systems-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-china-systems-member-reviewer`.
...
```bash
skpm validate cncf-china-systems-member-reviewer
skpm package cncf-china-systems-member-reviewer
skpm publish cncf-china-systems-member-reviewer
```
