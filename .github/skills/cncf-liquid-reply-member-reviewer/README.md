...
7. Run `skcr validate` and `skcr asps coverage cncf-liquid-reply-member-reviewer`.
8. Run `skcr compile cncf-liquid-reply-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-liquid-reply-member-reviewer`.
...
```bash
skpm validate cncf-liquid-reply-member-reviewer
skpm package cncf-liquid-reply-member-reviewer
skpm publish cncf-liquid-reply-member-reviewer
```
