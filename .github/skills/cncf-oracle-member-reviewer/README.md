...
7. Run `skcr validate` and `skcr asps coverage cncf-oracle-member-reviewer`.
8. Run `skcr compile cncf-oracle-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-oracle-member-reviewer`.
...
```bash
skpm validate cncf-oracle-member-reviewer
skpm package cncf-oracle-member-reviewer
skpm publish cncf-oracle-member-reviewer
```
