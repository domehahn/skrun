...
7. Run `skcr validate` and `skcr asps coverage cncf-alibaba-cloud-file-storage-reviewer`.
8. Run `skcr compile cncf-alibaba-cloud-file-storage-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-alibaba-cloud-file-storage-reviewer`.
...
```bash
skpm validate cncf-alibaba-cloud-file-storage-reviewer
skpm package cncf-alibaba-cloud-file-storage-reviewer
skpm publish cncf-alibaba-cloud-file-storage-reviewer
```
