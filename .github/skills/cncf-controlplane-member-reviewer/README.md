...
7. Run `skcr validate` and `skcr asps coverage cncf-controlplane-member-reviewer`.
8. Run `skcr compile cncf-controlplane-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-controlplane-member-reviewer`.
...
```bash
skpm validate cncf-controlplane-member-reviewer
skpm package cncf-controlplane-member-reviewer
skpm publish cncf-controlplane-member-reviewer
```
