...
7. Run `skcr validate` and `skcr asps coverage cncf-eunomia-bpf-reviewer`.
8. Run `skcr compile cncf-eunomia-bpf-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-eunomia-bpf-reviewer`.
...
```bash
skpm validate cncf-eunomia-bpf-reviewer
skpm package cncf-eunomia-bpf-reviewer
skpm publish cncf-eunomia-bpf-reviewer
```
