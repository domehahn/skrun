...
7. Run `skcr validate` and `skcr asps coverage gitops-operations-reviewer`.
8. Run `skcr compile gitops-operations-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend gitops-operations-reviewer`.
