...
7. Run `skcr validate` and `skcr asps coverage cncf-stackrox-reviewer`.
8. Run `skcr compile cncf-stackrox-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-stackrox-reviewer`.
...
```bash
skpm validate cncf-stackrox-reviewer
skpm package cncf-stackrox-reviewer
skpm publish cncf-stackrox-reviewer
```
