...
7. Run `skcr validate` and `skcr asps coverage cncf-soda-foundation-reviewer`.
8. Run `skcr compile cncf-soda-foundation-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-soda-foundation-reviewer`.
...
```bash
skpm validate cncf-soda-foundation-reviewer
skpm package cncf-soda-foundation-reviewer
skpm publish cncf-soda-foundation-reviewer
```
