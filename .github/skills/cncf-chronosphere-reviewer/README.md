...
7. Run `skcr validate` and `skcr asps coverage cncf-chronosphere-reviewer`.
8. Run `skcr compile cncf-chronosphere-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-chronosphere-reviewer`.
...
```bash
skpm validate cncf-chronosphere-reviewer
skpm package cncf-chronosphere-reviewer
skpm publish cncf-chronosphere-reviewer
```
