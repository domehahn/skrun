...
7. Run `skcr validate` and `skcr asps coverage cncf-triton-object-storage-reviewer`.
8. Run `skcr compile cncf-triton-object-storage-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-triton-object-storage-reviewer`.
...
```bash
skpm validate cncf-triton-object-storage-reviewer
skpm package cncf-triton-object-storage-reviewer
skpm publish cncf-triton-object-storage-reviewer
```
