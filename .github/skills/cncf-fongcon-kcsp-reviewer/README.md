...
7. Run `skcr validate` and `skcr asps coverage cncf-fongcon-kcsp-reviewer`.
8. Run `skcr compile cncf-fongcon-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-fongcon-kcsp-reviewer`.
...
```bash
skpm validate cncf-fongcon-kcsp-reviewer
skpm package cncf-fongcon-kcsp-reviewer
skpm publish cncf-fongcon-kcsp-reviewer
```
