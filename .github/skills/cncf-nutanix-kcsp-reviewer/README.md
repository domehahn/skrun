...
7. Run `skcr validate` and `skcr asps coverage cncf-nutanix-kcsp-reviewer`.
8. Run `skcr compile cncf-nutanix-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nutanix-kcsp-reviewer`.
...
```bash
skpm validate cncf-nutanix-kcsp-reviewer
skpm package cncf-nutanix-kcsp-reviewer
skpm publish cncf-nutanix-kcsp-reviewer
```
