...
7. Run `skcr validate` and `skcr asps coverage cncf-middleware-member-reviewer`.
8. Run `skcr compile cncf-middleware-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-middleware-member-reviewer`.
...
```bash
skpm validate cncf-middleware-member-reviewer
skpm package cncf-middleware-member-reviewer
skpm publish cncf-middleware-member-reviewer
```
