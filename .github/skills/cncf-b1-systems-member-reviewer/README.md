...
7. Run `skcr validate` and `skcr asps coverage cncf-b1-systems-member-reviewer`.
8. Run `skcr compile cncf-b1-systems-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-b1-systems-member-reviewer`.
...
```bash
skpm validate cncf-b1-systems-member-reviewer
skpm package cncf-b1-systems-member-reviewer
skpm publish cncf-b1-systems-member-reviewer
```
