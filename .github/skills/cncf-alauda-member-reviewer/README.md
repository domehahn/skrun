...
7. Run `skcr validate` and `skcr asps coverage cncf-alauda-member-reviewer`.
8. Run `skcr compile cncf-alauda-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-alauda-member-reviewer`.
...
```bash
skpm validate cncf-alauda-member-reviewer
skpm package cncf-alauda-member-reviewer
skpm publish cncf-alauda-member-reviewer
```
