...
7. Run `skcr validate` and `skcr asps coverage cncf-velero-reviewer`.
8. Run `skcr compile cncf-velero-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-velero-reviewer`.
...
```bash
skpm validate cncf-velero-reviewer
skpm package cncf-velero-reviewer
skpm publish cncf-velero-reviewer
```
