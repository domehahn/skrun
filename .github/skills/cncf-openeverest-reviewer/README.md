...
7. Run `skcr validate` and `skcr asps coverage cncf-openeverest-reviewer`.
8. Run `skcr compile cncf-openeverest-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-openeverest-reviewer`.
...
```bash
skpm validate cncf-openeverest-reviewer
skpm package cncf-openeverest-reviewer
skpm publish cncf-openeverest-reviewer
```
