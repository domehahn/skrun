...
7. Run `skcr validate` and `skcr asps coverage cncf-mastercontrol-supporter-reviewer`.
8. Run `skcr compile cncf-mastercontrol-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-mastercontrol-supporter-reviewer`.
...
```bash
skpm validate cncf-mastercontrol-supporter-reviewer
skpm package cncf-mastercontrol-supporter-reviewer
skpm publish cncf-mastercontrol-supporter-reviewer
```
