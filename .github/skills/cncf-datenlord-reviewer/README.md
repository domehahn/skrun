...
7. Run `skcr validate` and `skcr asps coverage cncf-datenlord-reviewer`.
8. Run `skcr compile cncf-datenlord-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-datenlord-reviewer`.
...
```bash
skpm validate cncf-datenlord-reviewer
skpm package cncf-datenlord-reviewer
skpm publish cncf-datenlord-reviewer
```
