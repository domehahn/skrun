...
7. Run `skcr validate` and `skcr asps coverage cncf-mirantis-kcsp-reviewer`.
8. Run `skcr compile cncf-mirantis-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-mirantis-kcsp-reviewer`.
...
```bash
skpm validate cncf-mirantis-kcsp-reviewer
skpm package cncf-mirantis-kcsp-reviewer
skpm publish cncf-mirantis-kcsp-reviewer
```
