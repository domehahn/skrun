...
7. Run `skcr validate` and `skcr asps coverage cncf-siglens-reviewer`.
8. Run `skcr compile cncf-siglens-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-siglens-reviewer`.
...
```bash
skpm validate cncf-siglens-reviewer
skpm package cncf-siglens-reviewer
skpm publish cncf-siglens-reviewer
```
