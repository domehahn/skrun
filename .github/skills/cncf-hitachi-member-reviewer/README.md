...
7. Run `skcr validate` and `skcr asps coverage cncf-hitachi-member-reviewer`.
8. Run `skcr compile cncf-hitachi-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-hitachi-member-reviewer`.
...
```bash
skpm validate cncf-hitachi-member-reviewer
skpm package cncf-hitachi-member-reviewer
skpm publish cncf-hitachi-member-reviewer
```
