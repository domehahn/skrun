...
7. Run `skcr validate` and `skcr asps coverage cncf-aws-cloudformation-reviewer`.
8. Run `skcr compile cncf-aws-cloudformation-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-aws-cloudformation-reviewer`.
...
```bash
skpm validate cncf-aws-cloudformation-reviewer
skpm package cncf-aws-cloudformation-reviewer
skpm publish cncf-aws-cloudformation-reviewer
```
