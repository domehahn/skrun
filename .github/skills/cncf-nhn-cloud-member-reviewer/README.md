...
7. Run `skcr validate` and `skcr asps coverage cncf-nhn-cloud-member-reviewer`.
8. Run `skcr compile cncf-nhn-cloud-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nhn-cloud-member-reviewer`.
...
```bash
skpm validate cncf-nhn-cloud-member-reviewer
skpm package cncf-nhn-cloud-member-reviewer
skpm publish cncf-nhn-cloud-member-reviewer
```
