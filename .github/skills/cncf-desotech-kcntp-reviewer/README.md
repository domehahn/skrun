...
7. Run `skcr validate` and `skcr asps coverage cncf-desotech-kcntp-reviewer`.
8. Run `skcr compile cncf-desotech-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-desotech-kcntp-reviewer`.
...
```bash
skpm validate cncf-desotech-kcntp-reviewer
skpm package cncf-desotech-kcntp-reviewer
skpm publish cncf-desotech-kcntp-reviewer
```
