...
7. Run `skcr validate` and `skcr asps coverage cncf-yahoo-supporter-reviewer`.
8. Run `skcr compile cncf-yahoo-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-yahoo-supporter-reviewer`.
...
```bash
skpm validate cncf-yahoo-supporter-reviewer
skpm package cncf-yahoo-supporter-reviewer
skpm publish cncf-yahoo-supporter-reviewer
```
