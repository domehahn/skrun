...
7. Run `skcr validate` and `skcr asps coverage ict-incident-reporting-reviewer`.
8. Run `skcr compile ict-incident-reporting-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend ict-incident-reporting-reviewer`.
...
```bash
skpm validate ict-incident-reporting-reviewer
skpm package ict-incident-reporting-reviewer
skpm publish ict-incident-reporting-reviewer
```
