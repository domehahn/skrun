...
7. Run `skcr validate` and `skcr asps coverage cncf-northflank-member-reviewer`.
8. Run `skcr compile cncf-northflank-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-northflank-member-reviewer`.
...
```bash
skpm validate cncf-northflank-member-reviewer
skpm package cncf-northflank-member-reviewer
skpm publish cncf-northflank-member-reviewer
```
