...
7. Run `skcr validate` and `skcr asps coverage cncf-dell-technologies-member-reviewer`.
8. Run `skcr compile cncf-dell-technologies-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-dell-technologies-member-reviewer`.
...
```bash
skpm validate cncf-dell-technologies-member-reviewer
skpm package cncf-dell-technologies-member-reviewer
skpm publish cncf-dell-technologies-member-reviewer
```
