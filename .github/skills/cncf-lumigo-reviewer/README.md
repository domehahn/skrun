...
7. Run `skcr validate` and `skcr asps coverage cncf-lumigo-reviewer`.
8. Run `skcr compile cncf-lumigo-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-lumigo-reviewer`.
...
```bash
skpm validate cncf-lumigo-reviewer
skpm package cncf-lumigo-reviewer
skpm publish cncf-lumigo-reviewer
```
