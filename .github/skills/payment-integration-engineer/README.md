...
7. Run `skcr validate` and `skcr asps coverage payment-integration-engineer`.
8. Run `skcr compile payment-integration-engineer --target skil`.
9. Run `skcr sync` and `skcr version recommend payment-integration-engineer`.
...
```bash
skpm validate payment-integration-engineer
skpm package payment-integration-engineer
skpm publish payment-integration-engineer
```
