...
7. Run `skcr validate` and `skcr asps coverage cncf-fossa-reviewer`.
8. Run `skcr compile cncf-fossa-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-fossa-reviewer`.
...
```bash
skpm validate cncf-fossa-reviewer
skpm package cncf-fossa-reviewer
skpm publish cncf-fossa-reviewer
```
