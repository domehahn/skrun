...
7. Run `skcr validate` and `skcr asps coverage cncf-cyso-kcsp-reviewer`.
8. Run `skcr compile cncf-cyso-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cyso-kcsp-reviewer`.
...
```bash
skpm validate cncf-cyso-kcsp-reviewer
skpm package cncf-cyso-kcsp-reviewer
skpm publish cncf-cyso-kcsp-reviewer
```
