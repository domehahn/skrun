...
7. Run `skcr validate` and `skcr asps coverage cncf-flows-network-reviewer`.
8. Run `skcr compile cncf-flows-network-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-flows-network-reviewer`.
...
```bash
skpm validate cncf-flows-network-reviewer
skpm package cncf-flows-network-reviewer
skpm publish cncf-flows-network-reviewer
```
