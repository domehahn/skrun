...
7. Run `skcr validate` and `skcr asps coverage cncf-kyverno-reviewer`.
8. Run `skcr compile cncf-kyverno-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kyverno-reviewer`.
...
```bash
skpm validate cncf-kyverno-reviewer
skpm package cncf-kyverno-reviewer
skpm publish cncf-kyverno-reviewer
```
