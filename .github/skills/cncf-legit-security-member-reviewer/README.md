...
7. Run `skcr validate` and `skcr asps coverage cncf-legit-security-member-reviewer`.
8. Run `skcr compile cncf-legit-security-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-legit-security-member-reviewer`.
...
```bash
skpm validate cncf-legit-security-member-reviewer
skpm package cncf-legit-security-member-reviewer
skpm publish cncf-legit-security-member-reviewer
```
