...
7. Run `skcr validate` and `skcr asps coverage policy-documentation-maintainer`.
8. Run `skcr compile policy-documentation-maintainer --target skil`.
9. Run `skcr sync` and `skcr version recommend policy-documentation-maintainer`.
