...
7. Run `skcr validate` and `skcr asps coverage cncf-nivida-nemo-reviewer`.
8. Run `skcr compile cncf-nivida-nemo-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nivida-nemo-reviewer`.
...
```bash
skpm validate cncf-nivida-nemo-reviewer
skpm package cncf-nivida-nemo-reviewer
skpm publish cncf-nivida-nemo-reviewer
```
