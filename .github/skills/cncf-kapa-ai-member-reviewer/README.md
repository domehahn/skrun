...
7. Run `skcr validate` and `skcr asps coverage cncf-kapa-ai-member-reviewer`.
8. Run `skcr compile cncf-kapa-ai-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kapa-ai-member-reviewer`.
...
```bash
skpm validate cncf-kapa-ai-member-reviewer
skpm package cncf-kapa-ai-member-reviewer
skpm publish cncf-kapa-ai-member-reviewer
```
