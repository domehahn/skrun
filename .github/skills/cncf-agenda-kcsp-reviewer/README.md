...
7. Run `skcr validate` and `skcr asps coverage cncf-agenda-kcsp-reviewer`.
8. Run `skcr compile cncf-agenda-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-agenda-kcsp-reviewer`.
...
```bash
skpm validate cncf-agenda-kcsp-reviewer
skpm package cncf-agenda-kcsp-reviewer
skpm publish cncf-agenda-kcsp-reviewer
```
