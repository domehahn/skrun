...
7. Run `skcr validate` and `skcr asps coverage cncf-javy-reviewer`.
8. Run `skcr compile cncf-javy-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-javy-reviewer`.
...
```bash
skpm validate cncf-javy-reviewer
skpm package cncf-javy-reviewer
skpm publish cncf-javy-reviewer
```
