...
7. Run `skcr validate` and `skcr asps coverage cncf-azure-pipelines-reviewer`.
8. Run `skcr compile cncf-azure-pipelines-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-azure-pipelines-reviewer`.
...
```bash
skpm validate cncf-azure-pipelines-reviewer
skpm package cncf-azure-pipelines-reviewer
skpm publish cncf-azure-pipelines-reviewer
```
