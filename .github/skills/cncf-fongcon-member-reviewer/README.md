...
7. Run `skcr validate` and `skcr asps coverage cncf-fongcon-member-reviewer`.
8. Run `skcr compile cncf-fongcon-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-fongcon-member-reviewer`.
...
```bash
skpm validate cncf-fongcon-member-reviewer
skpm package cncf-fongcon-member-reviewer
skpm publish cncf-fongcon-member-reviewer
```
