...
7. Run `skcr validate` and `skcr asps coverage cncf-afi-technologies-member-reviewer`.
8. Run `skcr compile cncf-afi-technologies-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-afi-technologies-member-reviewer`.
...
```bash
skpm validate cncf-afi-technologies-member-reviewer
skpm package cncf-afi-technologies-member-reviewer
skpm publish cncf-afi-technologies-member-reviewer
```
