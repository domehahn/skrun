...
7. Run `skcr validate` and `skcr asps coverage cncf-msap-ai-reviewer`.
8. Run `skcr compile cncf-msap-ai-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-msap-ai-reviewer`.
...
```bash
skpm validate cncf-msap-ai-reviewer
skpm package cncf-msap-ai-reviewer
skpm publish cncf-msap-ai-reviewer
```
