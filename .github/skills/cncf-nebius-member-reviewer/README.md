...
7. Run `skcr validate` and `skcr asps coverage cncf-nebius-member-reviewer`.
8. Run `skcr compile cncf-nebius-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nebius-member-reviewer`.
...
```bash
skpm validate cncf-nebius-member-reviewer
skpm package cncf-nebius-member-reviewer
skpm publish cncf-nebius-member-reviewer
```
