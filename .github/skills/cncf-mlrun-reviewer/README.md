...
7. Run `skcr validate` and `skcr asps coverage cncf-mlrun-reviewer`.
8. Run `skcr compile cncf-mlrun-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-mlrun-reviewer`.
...
```bash
skpm validate cncf-mlrun-reviewer
skpm package cncf-mlrun-reviewer
skpm publish cncf-mlrun-reviewer
```
