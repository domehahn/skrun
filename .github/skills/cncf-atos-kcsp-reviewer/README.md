...
7. Run `skcr validate` and `skcr asps coverage cncf-atos-kcsp-reviewer`.
8. Run `skcr compile cncf-atos-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-atos-kcsp-reviewer`.
...
```bash
skpm validate cncf-atos-kcsp-reviewer
skpm package cncf-atos-kcsp-reviewer
skpm publish cncf-atos-kcsp-reviewer
```
