...
7. Run `skcr validate` and `skcr asps coverage cncf-caepe-reviewer`.
8. Run `skcr compile cncf-caepe-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-caepe-reviewer`.
...
```bash
skpm validate cncf-caepe-reviewer
skpm package cncf-caepe-reviewer
skpm publish cncf-caepe-reviewer
```
