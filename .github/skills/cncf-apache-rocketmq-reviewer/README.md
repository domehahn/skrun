...
7. Run `skcr validate` and `skcr asps coverage cncf-apache-rocketmq-reviewer`.
8. Run `skcr compile cncf-apache-rocketmq-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-apache-rocketmq-reviewer`.
...
```bash
skpm validate cncf-apache-rocketmq-reviewer
skpm package cncf-apache-rocketmq-reviewer
skpm publish cncf-apache-rocketmq-reviewer
```
