...
7. Run `skcr validate` and `skcr asps coverage cncf-k8sgpt-reviewer`.
8. Run `skcr compile cncf-k8sgpt-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-k8sgpt-reviewer`.
...
```bash
skpm validate cncf-k8sgpt-reviewer
skpm package cncf-k8sgpt-reviewer
skpm publish cncf-k8sgpt-reviewer
```
