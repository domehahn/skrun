...
7. Run `skcr validate` and `skcr asps coverage cncf-pubnub-functions-reviewer`.
8. Run `skcr compile cncf-pubnub-functions-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-pubnub-functions-reviewer`.
...
```bash
skpm validate cncf-pubnub-functions-reviewer
skpm package cncf-pubnub-functions-reviewer
skpm publish cncf-pubnub-functions-reviewer
```
