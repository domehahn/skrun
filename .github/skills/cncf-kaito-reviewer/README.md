...
7. Run `skcr validate` and `skcr asps coverage cncf-kaito-reviewer`.
8. Run `skcr compile cncf-kaito-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kaito-reviewer`.
...
```bash
skpm validate cncf-kaito-reviewer
skpm package cncf-kaito-reviewer
skpm publish cncf-kaito-reviewer
```
