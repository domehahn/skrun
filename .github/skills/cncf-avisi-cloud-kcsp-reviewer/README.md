...
7. Run `skcr validate` and `skcr asps coverage cncf-avisi-cloud-kcsp-reviewer`.
8. Run `skcr compile cncf-avisi-cloud-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-avisi-cloud-kcsp-reviewer`.
...
```bash
skpm validate cncf-avisi-cloud-kcsp-reviewer
skpm package cncf-avisi-cloud-kcsp-reviewer
skpm publish cncf-avisi-cloud-kcsp-reviewer
```
