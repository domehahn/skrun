...
7. Run `skcr validate` and `skcr asps coverage cncf-camel-reviewer`.
8. Run `skcr compile cncf-camel-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-camel-reviewer`.
...
```bash
skpm validate cncf-camel-reviewer
skpm package cncf-camel-reviewer
skpm publish cncf-camel-reviewer
```
