...
7. Run `skcr validate` and `skcr asps coverage cncf-cloud-custodian-reviewer`.
8. Run `skcr compile cncf-cloud-custodian-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloud-custodian-reviewer`.
...
```bash
skpm validate cncf-cloud-custodian-reviewer
skpm package cncf-cloud-custodian-reviewer
skpm publish cncf-cloud-custodian-reviewer
```
