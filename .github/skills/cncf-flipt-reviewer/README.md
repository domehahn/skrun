...
7. Run `skcr validate` and `skcr asps coverage cncf-flipt-reviewer`.
8. Run `skcr compile cncf-flipt-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-flipt-reviewer`.
...
```bash
skpm validate cncf-flipt-reviewer
skpm package cncf-flipt-reviewer
skpm publish cncf-flipt-reviewer
```
