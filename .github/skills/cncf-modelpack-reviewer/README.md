...
7. Run `skcr validate` and `skcr asps coverage cncf-modelpack-reviewer`.
8. Run `skcr compile cncf-modelpack-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-modelpack-reviewer`.
...
```bash
skpm validate cncf-modelpack-reviewer
skpm package cncf-modelpack-reviewer
skpm publish cncf-modelpack-reviewer
```
