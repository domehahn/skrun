...
7. Run `skcr validate` and `skcr asps coverage cncf-zstack-kcsp-reviewer`.
8. Run `skcr compile cncf-zstack-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-zstack-kcsp-reviewer`.
...
```bash
skpm validate cncf-zstack-kcsp-reviewer
skpm package cncf-zstack-kcsp-reviewer
skpm publish cncf-zstack-kcsp-reviewer
```
