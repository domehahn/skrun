...
7. Run `skcr validate` and `skcr asps coverage cncf-google-kubernetes-engine-gke-reviewer`.
8. Run `skcr compile cncf-google-kubernetes-engine-gke-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-google-kubernetes-engine-gke-reviewer`.
...
```bash
skpm validate cncf-google-kubernetes-engine-gke-reviewer
skpm package cncf-google-kubernetes-engine-gke-reviewer
skpm publish cncf-google-kubernetes-engine-gke-reviewer
```
