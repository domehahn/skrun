...
7. Run `skcr validate` and `skcr asps coverage cncf-agentgateway-reviewer`.
8. Run `skcr compile cncf-agentgateway-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-agentgateway-reviewer`.
...
```bash
skpm validate cncf-agentgateway-reviewer
skpm package cncf-agentgateway-reviewer
skpm publish cncf-agentgateway-reviewer
```
