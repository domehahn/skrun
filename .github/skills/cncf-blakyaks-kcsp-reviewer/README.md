...
7. Run `skcr validate` and `skcr asps coverage cncf-blakyaks-kcsp-reviewer`.
8. Run `skcr compile cncf-blakyaks-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-blakyaks-kcsp-reviewer`.
...
```bash
skpm validate cncf-blakyaks-kcsp-reviewer
skpm package cncf-blakyaks-kcsp-reviewer
skpm publish cncf-blakyaks-kcsp-reviewer
```
