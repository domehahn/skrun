...
7. Run `skcr validate` and `skcr asps coverage cncf-coredge-kcsp-reviewer`.
8. Run `skcr compile cncf-coredge-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-coredge-kcsp-reviewer`.
...
```bash
skpm validate cncf-coredge-kcsp-reviewer
skpm package cncf-coredge-kcsp-reviewer
skpm publish cncf-coredge-kcsp-reviewer
```
