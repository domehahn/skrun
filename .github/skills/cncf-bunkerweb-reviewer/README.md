...
7. Run `skcr validate` and `skcr asps coverage cncf-bunkerweb-reviewer`.
8. Run `skcr compile cncf-bunkerweb-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-bunkerweb-reviewer`.
...
```bash
skpm validate cncf-bunkerweb-reviewer
skpm package cncf-bunkerweb-reviewer
skpm publish cncf-bunkerweb-reviewer
```
