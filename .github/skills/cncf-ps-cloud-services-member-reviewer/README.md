...
7. Run `skcr validate` and `skcr asps coverage cncf-ps-cloud-services-member-reviewer`.
8. Run `skcr compile cncf-ps-cloud-services-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ps-cloud-services-member-reviewer`.
...
```bash
skpm validate cncf-ps-cloud-services-member-reviewer
skpm package cncf-ps-cloud-services-member-reviewer
skpm publish cncf-ps-cloud-services-member-reviewer
```
