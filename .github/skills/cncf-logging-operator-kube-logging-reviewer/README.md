...
7. Run `skcr validate` and `skcr asps coverage cncf-logging-operator-kube-logging-reviewer`.
8. Run `skcr compile cncf-logging-operator-kube-logging-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-logging-operator-kube-logging-reviewer`.
...
```bash
skpm validate cncf-logging-operator-kube-logging-reviewer
skpm package cncf-logging-operator-kube-logging-reviewer
skpm publish cncf-logging-operator-kube-logging-reviewer
```
