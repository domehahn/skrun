...
7. Run `skcr validate` and `skcr asps coverage cncf-openmessaging-reviewer`.
8. Run `skcr compile cncf-openmessaging-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-openmessaging-reviewer`.
...
```bash
skpm validate cncf-openmessaging-reviewer
skpm package cncf-openmessaging-reviewer
skpm publish cncf-openmessaging-reviewer
```
