...
7. Run `skcr validate` and `skcr asps coverage cncf-kubermatic-kubeone-reviewer`.
8. Run `skcr compile cncf-kubermatic-kubeone-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kubermatic-kubeone-reviewer`.
...
```bash
skpm validate cncf-kubermatic-kubeone-reviewer
skpm package cncf-kubermatic-kubeone-reviewer
skpm publish cncf-kubermatic-kubeone-reviewer
```
