...
7. Run `skcr validate` and `skcr asps coverage cncf-wikimedia-member-reviewer`.
8. Run `skcr compile cncf-wikimedia-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-wikimedia-member-reviewer`.
...
```bash
skpm validate cncf-wikimedia-member-reviewer
skpm package cncf-wikimedia-member-reviewer
skpm publish cncf-wikimedia-member-reviewer
```
