...
7. Run `skcr validate` and `skcr asps coverage cncf-apache-mesos-reviewer`.
8. Run `skcr compile cncf-apache-mesos-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-apache-mesos-reviewer`.
...
```bash
skpm validate cncf-apache-mesos-reviewer
skpm package cncf-apache-mesos-reviewer
skpm publish cncf-apache-mesos-reviewer
```
