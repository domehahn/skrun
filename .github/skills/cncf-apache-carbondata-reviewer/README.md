...
7. Run `skcr validate` and `skcr asps coverage cncf-apache-carbondata-reviewer`.
8. Run `skcr compile cncf-apache-carbondata-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-apache-carbondata-reviewer`.
...
```bash
skpm validate cncf-apache-carbondata-reviewer
skpm package cncf-apache-carbondata-reviewer
skpm publish cncf-apache-carbondata-reviewer
```
