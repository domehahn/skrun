...
7. Run `skcr validate` and `skcr asps coverage cncf-gloo-reviewer`.
8. Run `skcr compile cncf-gloo-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-gloo-reviewer`.
...
```bash
skpm validate cncf-gloo-reviewer
skpm package cncf-gloo-reviewer
skpm publish cncf-gloo-reviewer
```
