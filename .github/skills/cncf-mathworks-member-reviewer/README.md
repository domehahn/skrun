...
7. Run `skcr validate` and `skcr asps coverage cncf-mathworks-member-reviewer`.
8. Run `skcr compile cncf-mathworks-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-mathworks-member-reviewer`.
...
```bash
skpm validate cncf-mathworks-member-reviewer
skpm package cncf-mathworks-member-reviewer
skpm publish cncf-mathworks-member-reviewer
```
