...
7. Run `skcr validate` and `skcr asps coverage cncf-kloia-kcsp-reviewer`.
8. Run `skcr compile cncf-kloia-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kloia-kcsp-reviewer`.
...
```bash
skpm validate cncf-kloia-kcsp-reviewer
skpm package cncf-kloia-kcsp-reviewer
skpm publish cncf-kloia-kcsp-reviewer
```
