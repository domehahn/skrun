...
7. Run `skcr validate` and `skcr asps coverage cncf-symbotic-member-reviewer`.
8. Run `skcr compile cncf-symbotic-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-symbotic-member-reviewer`.
...
```bash
skpm validate cncf-symbotic-member-reviewer
skpm package cncf-symbotic-member-reviewer
skpm publish cncf-symbotic-member-reviewer
```
