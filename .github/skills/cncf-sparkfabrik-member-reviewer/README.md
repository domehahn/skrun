...
7. Run `skcr validate` and `skcr asps coverage cncf-sparkfabrik-member-reviewer`.
8. Run `skcr compile cncf-sparkfabrik-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sparkfabrik-member-reviewer`.
...
```bash
skpm validate cncf-sparkfabrik-member-reviewer
skpm package cncf-sparkfabrik-member-reviewer
skpm publish cncf-sparkfabrik-member-reviewer
```
