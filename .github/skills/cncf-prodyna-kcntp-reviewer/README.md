...
7. Run `skcr validate` and `skcr asps coverage cncf-prodyna-kcntp-reviewer`.
8. Run `skcr compile cncf-prodyna-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-prodyna-kcntp-reviewer`.
...
```bash
skpm validate cncf-prodyna-kcntp-reviewer
skpm package cncf-prodyna-kcntp-reviewer
skpm publish cncf-prodyna-kcntp-reviewer
```
