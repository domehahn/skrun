...
7. Run `skcr validate` and `skcr asps coverage cncf-uqbar-reviewer`.
8. Run `skcr compile cncf-uqbar-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-uqbar-reviewer`.
...
```bash
skpm validate cncf-uqbar-reviewer
skpm package cncf-uqbar-reviewer
skpm publish cncf-uqbar-reviewer
```
