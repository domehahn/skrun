...
7. Run `skcr validate` and `skcr asps coverage cncf-circleci-reviewer`.
8. Run `skcr compile cncf-circleci-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-circleci-reviewer`.
...
```bash
skpm validate cncf-circleci-reviewer
skpm package cncf-circleci-reviewer
skpm publish cncf-circleci-reviewer
```
