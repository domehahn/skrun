...
7. Run `skcr validate` and `skcr asps coverage cncf-network-service-mesh-reviewer`.
8. Run `skcr compile cncf-network-service-mesh-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-network-service-mesh-reviewer`.
...
```bash
skpm validate cncf-network-service-mesh-reviewer
skpm package cncf-network-service-mesh-reviewer
skpm publish cncf-network-service-mesh-reviewer
```
