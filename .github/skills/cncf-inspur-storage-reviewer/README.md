...
7. Run `skcr validate` and `skcr asps coverage cncf-inspur-storage-reviewer`.
8. Run `skcr compile cncf-inspur-storage-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-inspur-storage-reviewer`.
...
```bash
skpm validate cncf-inspur-storage-reviewer
skpm package cncf-inspur-storage-reviewer
skpm publish cncf-inspur-storage-reviewer
```
