...
7. Run `skcr validate` and `skcr asps coverage cncf-pravega-reviewer`.
8. Run `skcr compile cncf-pravega-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-pravega-reviewer`.
...
```bash
skpm validate cncf-pravega-reviewer
skpm package cncf-pravega-reviewer
skpm publish cncf-pravega-reviewer
```
