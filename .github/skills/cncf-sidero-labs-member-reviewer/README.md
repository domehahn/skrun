...
7. Run `skcr validate` and `skcr asps coverage cncf-sidero-labs-member-reviewer`.
8. Run `skcr compile cncf-sidero-labs-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sidero-labs-member-reviewer`.
...
```bash
skpm validate cncf-sidero-labs-member-reviewer
skpm package cncf-sidero-labs-member-reviewer
skpm publish cncf-sidero-labs-member-reviewer
```
