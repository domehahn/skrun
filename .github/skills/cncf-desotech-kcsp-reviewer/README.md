...
7. Run `skcr validate` and `skcr asps coverage cncf-desotech-kcsp-reviewer`.
8. Run `skcr compile cncf-desotech-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-desotech-kcsp-reviewer`.
...
```bash
skpm validate cncf-desotech-kcsp-reviewer
skpm package cncf-desotech-kcsp-reviewer
skpm publish cncf-desotech-kcsp-reviewer
```
