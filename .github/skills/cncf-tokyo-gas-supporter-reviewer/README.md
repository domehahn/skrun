...
7. Run `skcr validate` and `skcr asps coverage cncf-tokyo-gas-supporter-reviewer`.
8. Run `skcr compile cncf-tokyo-gas-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-tokyo-gas-supporter-reviewer`.
...
```bash
skpm validate cncf-tokyo-gas-supporter-reviewer
skpm package cncf-tokyo-gas-supporter-reviewer
skpm publish cncf-tokyo-gas-supporter-reviewer
```
