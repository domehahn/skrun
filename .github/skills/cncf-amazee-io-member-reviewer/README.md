...
7. Run `skcr validate` and `skcr asps coverage cncf-amazee-io-member-reviewer`.
8. Run `skcr compile cncf-amazee-io-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-amazee-io-member-reviewer`.
...
```bash
skpm validate cncf-amazee-io-member-reviewer
skpm package cncf-amazee-io-member-reviewer
skpm publish cncf-amazee-io-member-reviewer
```
