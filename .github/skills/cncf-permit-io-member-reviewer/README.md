...
7. Run `skcr validate` and `skcr asps coverage cncf-permit-io-member-reviewer`.
8. Run `skcr compile cncf-permit-io-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-permit-io-member-reviewer`.
...
```bash
skpm validate cncf-permit-io-member-reviewer
skpm package cncf-permit-io-member-reviewer
skpm publish cncf-permit-io-member-reviewer
```
