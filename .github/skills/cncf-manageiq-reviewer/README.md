...
7. Run `skcr validate` and `skcr asps coverage cncf-manageiq-reviewer`.
8. Run `skcr compile cncf-manageiq-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-manageiq-reviewer`.
...
```bash
skpm validate cncf-manageiq-reviewer
skpm package cncf-manageiq-reviewer
skpm publish cncf-manageiq-reviewer
```
