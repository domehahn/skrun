...
7. Run `skcr validate` and `skcr asps coverage cncf-teleport-reviewer`.
8. Run `skcr compile cncf-teleport-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-teleport-reviewer`.
...
```bash
skpm validate cncf-teleport-reviewer
skpm package cncf-teleport-reviewer
skpm publish cncf-teleport-reviewer
```
