...
7. Run `skcr validate` and `skcr asps coverage architecture-reviewer`.
8. Run `skcr compile architecture-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend architecture-reviewer`.
