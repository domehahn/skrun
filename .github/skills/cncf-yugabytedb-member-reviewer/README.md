...
7. Run `skcr validate` and `skcr asps coverage cncf-yugabytedb-member-reviewer`.
8. Run `skcr compile cncf-yugabytedb-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-yugabytedb-member-reviewer`.
...
```bash
skpm validate cncf-yugabytedb-member-reviewer
skpm package cncf-yugabytedb-member-reviewer
skpm publish cncf-yugabytedb-member-reviewer
```
