...
7. Run `skcr validate` and `skcr asps coverage compliance-governance-reviewer`.
8. Run `skcr compile compliance-governance-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend compliance-governance-reviewer`.
