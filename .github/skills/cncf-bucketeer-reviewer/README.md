...
7. Run `skcr validate` and `skcr asps coverage cncf-bucketeer-reviewer`.
8. Run `skcr compile cncf-bucketeer-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-bucketeer-reviewer`.
...
```bash
skpm validate cncf-bucketeer-reviewer
skpm package cncf-bucketeer-reviewer
skpm publish cncf-bucketeer-reviewer
```
