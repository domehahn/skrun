...
7. Run `skcr validate` and `skcr asps coverage cncf-cue-labs-member-reviewer`.
8. Run `skcr compile cncf-cue-labs-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cue-labs-member-reviewer`.
...
```bash
skpm validate cncf-cue-labs-member-reviewer
skpm package cncf-cue-labs-member-reviewer
skpm publish cncf-cue-labs-member-reviewer
```
