...
7. Run `skcr validate` and `skcr asps coverage cncf-gocrane-reviewer`.
8. Run `skcr compile cncf-gocrane-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-gocrane-reviewer`.
...
```bash
skpm validate cncf-gocrane-reviewer
skpm package cncf-gocrane-reviewer
skpm publish cncf-gocrane-reviewer
```
