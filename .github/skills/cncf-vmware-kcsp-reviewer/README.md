...
7. Run `skcr validate` and `skcr asps coverage cncf-vmware-kcsp-reviewer`.
8. Run `skcr compile cncf-vmware-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-vmware-kcsp-reviewer`.
...
```bash
skpm validate cncf-vmware-kcsp-reviewer
skpm package cncf-vmware-kcsp-reviewer
skpm publish cncf-vmware-kcsp-reviewer
```
