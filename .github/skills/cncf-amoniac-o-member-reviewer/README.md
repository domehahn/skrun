...
7. Run `skcr validate` and `skcr asps coverage cncf-amoniac-o-member-reviewer`.
8. Run `skcr compile cncf-amoniac-o-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-amoniac-o-member-reviewer`.
...
```bash
skpm validate cncf-amoniac-o-member-reviewer
skpm package cncf-amoniac-o-member-reviewer
skpm publish cncf-amoniac-o-member-reviewer
```
