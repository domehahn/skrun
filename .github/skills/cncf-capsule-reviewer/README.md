...
7. Run `skcr validate` and `skcr asps coverage cncf-capsule-reviewer`.
8. Run `skcr compile cncf-capsule-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-capsule-reviewer`.
...
```bash
skpm validate cncf-capsule-reviewer
skpm package cncf-capsule-reviewer
skpm publish cncf-capsule-reviewer
```
