...
7. Run `skcr validate` and `skcr asps coverage cncf-stacklock-minder-reviewer`.
8. Run `skcr compile cncf-stacklock-minder-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-stacklock-minder-reviewer`.
...
```bash
skpm validate cncf-stacklock-minder-reviewer
skpm package cncf-stacklock-minder-reviewer
skpm publish cncf-stacklock-minder-reviewer
```
