...
7. Run `skcr validate` and `skcr asps coverage cncf-kube-ovn-reviewer`.
8. Run `skcr compile cncf-kube-ovn-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kube-ovn-reviewer`.
...
```bash
skpm validate cncf-kube-ovn-reviewer
skpm package cncf-kube-ovn-reviewer
skpm publish cncf-kube-ovn-reviewer
```
