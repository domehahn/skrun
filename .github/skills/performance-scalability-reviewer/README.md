...
7. Run `skcr validate` and `skcr asps coverage performance-scalability-reviewer`.
8. Run `skcr compile performance-scalability-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend performance-scalability-reviewer`.
...
```bash
skpm validate performance-scalability-reviewer
skpm package performance-scalability-reviewer
skpm publish performance-scalability-reviewer
```
