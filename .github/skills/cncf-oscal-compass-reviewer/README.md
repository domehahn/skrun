...
7. Run `skcr validate` and `skcr asps coverage cncf-oscal-compass-reviewer`.
8. Run `skcr compile cncf-oscal-compass-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-oscal-compass-reviewer`.
...
```bash
skpm validate cncf-oscal-compass-reviewer
skpm package cncf-oscal-compass-reviewer
skpm publish cncf-oscal-compass-reviewer
```
