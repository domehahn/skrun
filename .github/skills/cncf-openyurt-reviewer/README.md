...
7. Run `skcr validate` and `skcr asps coverage cncf-openyurt-reviewer`.
8. Run `skcr compile cncf-openyurt-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-openyurt-reviewer`.
...
```bash
skpm validate cncf-openyurt-reviewer
skpm package cncf-openyurt-reviewer
skpm publish cncf-openyurt-reviewer
```
