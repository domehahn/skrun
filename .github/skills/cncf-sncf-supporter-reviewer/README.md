...
7. Run `skcr validate` and `skcr asps coverage cncf-sncf-supporter-reviewer`.
8. Run `skcr compile cncf-sncf-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sncf-supporter-reviewer`.
...
```bash
skpm validate cncf-sncf-supporter-reviewer
skpm package cncf-sncf-supporter-reviewer
skpm publish cncf-sncf-supporter-reviewer
```
