...
7. Run `skcr validate` and `skcr asps coverage cncf-blue-sentry-kcsp-reviewer`.
8. Run `skcr compile cncf-blue-sentry-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-blue-sentry-kcsp-reviewer`.
...
```bash
skpm validate cncf-blue-sentry-kcsp-reviewer
skpm package cncf-blue-sentry-kcsp-reviewer
skpm publish cncf-blue-sentry-kcsp-reviewer
```
