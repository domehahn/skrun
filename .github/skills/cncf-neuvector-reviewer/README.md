...
7. Run `skcr validate` and `skcr asps coverage cncf-neuvector-reviewer`.
8. Run `skcr compile cncf-neuvector-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-neuvector-reviewer`.
...
```bash
skpm validate cncf-neuvector-reviewer
skpm package cncf-neuvector-reviewer
skpm publish cncf-neuvector-reviewer
```
