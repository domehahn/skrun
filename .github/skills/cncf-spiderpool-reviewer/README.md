...
7. Run `skcr validate` and `skcr asps coverage cncf-spiderpool-reviewer`.
8. Run `skcr compile cncf-spiderpool-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-spiderpool-reviewer`.
...
```bash
skpm validate cncf-spiderpool-reviewer
skpm package cncf-spiderpool-reviewer
skpm publish cncf-spiderpool-reviewer
```
