...
7. Run `skcr validate` and `skcr asps coverage cncf-openfunction-reviewer`.
8. Run `skcr compile cncf-openfunction-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-openfunction-reviewer`.
...
```bash
skpm validate cncf-openfunction-reviewer
skpm package cncf-openfunction-reviewer
skpm publish cncf-openfunction-reviewer
```
