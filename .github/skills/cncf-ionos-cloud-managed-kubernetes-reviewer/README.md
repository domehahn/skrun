...
7. Run `skcr validate` and `skcr asps coverage cncf-ionos-cloud-managed-kubernetes-reviewer`.
8. Run `skcr compile cncf-ionos-cloud-managed-kubernetes-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ionos-cloud-managed-kubernetes-reviewer`.
...
```bash
skpm validate cncf-ionos-cloud-managed-kubernetes-reviewer
skpm package cncf-ionos-cloud-managed-kubernetes-reviewer
skpm publish cncf-ionos-cloud-managed-kubernetes-reviewer
```
