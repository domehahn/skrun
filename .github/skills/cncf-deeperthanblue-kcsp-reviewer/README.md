...
7. Run `skcr validate` and `skcr asps coverage cncf-deeperthanblue-kcsp-reviewer`.
8. Run `skcr compile cncf-deeperthanblue-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-deeperthanblue-kcsp-reviewer`.
...
```bash
skpm validate cncf-deeperthanblue-kcsp-reviewer
skpm package cncf-deeperthanblue-kcsp-reviewer
skpm publish cncf-deeperthanblue-kcsp-reviewer
```
