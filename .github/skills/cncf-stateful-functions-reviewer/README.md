...
7. Run `skcr validate` and `skcr asps coverage cncf-stateful-functions-reviewer`.
8. Run `skcr compile cncf-stateful-functions-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-stateful-functions-reviewer`.
...
```bash
skpm validate cncf-stateful-functions-reviewer
skpm package cncf-stateful-functions-reviewer
skpm publish cncf-stateful-functions-reviewer
```
