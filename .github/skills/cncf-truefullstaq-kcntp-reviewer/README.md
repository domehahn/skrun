...
7. Run `skcr validate` and `skcr asps coverage cncf-truefullstaq-kcntp-reviewer`.
8. Run `skcr compile cncf-truefullstaq-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-truefullstaq-kcntp-reviewer`.
...
```bash
skpm validate cncf-truefullstaq-kcntp-reviewer
skpm package cncf-truefullstaq-kcntp-reviewer
skpm publish cncf-truefullstaq-kcntp-reviewer
```
