...
7. Run `skcr validate` and `skcr asps coverage cncf-cloud-community-labs-member-reviewer`.
8. Run `skcr compile cncf-cloud-community-labs-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloud-community-labs-member-reviewer`.
...
```bash
skpm validate cncf-cloud-community-labs-member-reviewer
skpm package cncf-cloud-community-labs-member-reviewer
skpm publish cncf-cloud-community-labs-member-reviewer
```
