...
7. Run `skcr validate` and `skcr asps coverage cncf-conoa-kcntp-reviewer`.
8. Run `skcr compile cncf-conoa-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-conoa-kcntp-reviewer`.
...
```bash
skpm validate cncf-conoa-kcntp-reviewer
skpm package cncf-conoa-kcntp-reviewer
skpm publish cncf-conoa-kcntp-reviewer
```
