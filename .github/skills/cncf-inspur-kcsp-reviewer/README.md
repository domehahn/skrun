...
7. Run `skcr validate` and `skcr asps coverage cncf-inspur-kcsp-reviewer`.
8. Run `skcr compile cncf-inspur-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-inspur-kcsp-reviewer`.
...
```bash
skpm validate cncf-inspur-kcsp-reviewer
skpm package cncf-inspur-kcsp-reviewer
skpm publish cncf-inspur-kcsp-reviewer
```
