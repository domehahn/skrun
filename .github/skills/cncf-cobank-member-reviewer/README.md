...
7. Run `skcr validate` and `skcr asps coverage cncf-cobank-member-reviewer`.
8. Run `skcr compile cncf-cobank-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cobank-member-reviewer`.
...
```bash
skpm validate cncf-cobank-member-reviewer
skpm package cncf-cobank-member-reviewer
skpm publish cncf-cobank-member-reviewer
```
