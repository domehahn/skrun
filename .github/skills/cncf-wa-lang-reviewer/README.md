...
7. Run `skcr validate` and `skcr asps coverage cncf-wa-lang-reviewer`.
8. Run `skcr compile cncf-wa-lang-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-wa-lang-reviewer`.
...
```bash
skpm validate cncf-wa-lang-reviewer
skpm package cncf-wa-lang-reviewer
skpm publish cncf-wa-lang-reviewer
```
