...
7. Run `skcr validate` and `skcr asps coverage cncf-copa-reviewer`.
8. Run `skcr compile cncf-copa-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-copa-reviewer`.
...
```bash
skpm validate cncf-copa-reviewer
skpm package cncf-copa-reviewer
skpm publish cncf-copa-reviewer
```
