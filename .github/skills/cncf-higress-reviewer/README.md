...
7. Run `skcr validate` and `skcr asps coverage cncf-higress-reviewer`.
8. Run `skcr compile cncf-higress-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-higress-reviewer`.
...
```bash
skpm validate cncf-higress-reviewer
skpm package cncf-higress-reviewer
skpm publish cncf-higress-reviewer
```
