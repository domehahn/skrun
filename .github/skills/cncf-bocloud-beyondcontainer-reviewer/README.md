...
7. Run `skcr validate` and `skcr asps coverage cncf-bocloud-beyondcontainer-reviewer`.
8. Run `skcr compile cncf-bocloud-beyondcontainer-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-bocloud-beyondcontainer-reviewer`.
...
```bash
skpm validate cncf-bocloud-beyondcontainer-reviewer
skpm package cncf-bocloud-beyondcontainer-reviewer
skpm publish cncf-bocloud-beyondcontainer-reviewer
```
