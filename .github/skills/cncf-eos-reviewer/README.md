...
7. Run `skcr validate` and `skcr asps coverage cncf-eos-reviewer`.
8. Run `skcr compile cncf-eos-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-eos-reviewer`.
...
```bash
skpm validate cncf-eos-reviewer
skpm package cncf-eos-reviewer
skpm publish cncf-eos-reviewer
```
