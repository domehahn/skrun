...
7. Run `skcr validate` and `skcr asps coverage cncf-krakend-reviewer`.
8. Run `skcr compile cncf-krakend-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-krakend-reviewer`.
...
```bash
skpm validate cncf-krakend-reviewer
skpm package cncf-krakend-reviewer
skpm publish cncf-krakend-reviewer
```
