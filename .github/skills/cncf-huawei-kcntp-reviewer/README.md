...
7. Run `skcr validate` and `skcr asps coverage cncf-huawei-kcntp-reviewer`.
8. Run `skcr compile cncf-huawei-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-huawei-kcntp-reviewer`.
...
```bash
skpm validate cncf-huawei-kcntp-reviewer
skpm package cncf-huawei-kcntp-reviewer
skpm publish cncf-huawei-kcntp-reviewer
```
