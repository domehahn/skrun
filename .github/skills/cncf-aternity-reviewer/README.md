...
7. Run `skcr validate` and `skcr asps coverage cncf-aternity-reviewer`.
8. Run `skcr compile cncf-aternity-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-aternity-reviewer`.
...
```bash
skpm validate cncf-aternity-reviewer
skpm package cncf-aternity-reviewer
skpm publish cncf-aternity-reviewer
```
