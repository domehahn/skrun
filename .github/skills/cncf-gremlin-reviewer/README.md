...
7. Run `skcr validate` and `skcr asps coverage cncf-gremlin-reviewer`.
8. Run `skcr compile cncf-gremlin-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-gremlin-reviewer`.
...
```bash
skpm validate cncf-gremlin-reviewer
skpm package cncf-gremlin-reviewer
skpm publish cncf-gremlin-reviewer
```
