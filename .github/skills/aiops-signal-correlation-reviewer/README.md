...
7. Run `skcr validate` and `skcr asps coverage aiops-signal-correlation-reviewer`.
8. Run `skcr compile aiops-signal-correlation-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend aiops-signal-correlation-reviewer`.
...
```bash
skpm validate aiops-signal-correlation-reviewer
skpm package aiops-signal-correlation-reviewer
skpm publish aiops-signal-correlation-reviewer
```
