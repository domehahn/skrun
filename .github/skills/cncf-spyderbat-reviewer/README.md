...
7. Run `skcr validate` and `skcr asps coverage cncf-spyderbat-reviewer`.
8. Run `skcr compile cncf-spyderbat-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-spyderbat-reviewer`.
...
```bash
skpm validate cncf-spyderbat-reviewer
skpm package cncf-spyderbat-reviewer
skpm publish cncf-spyderbat-reviewer
```
