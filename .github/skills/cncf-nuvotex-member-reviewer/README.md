...
7. Run `skcr validate` and `skcr asps coverage cncf-nuvotex-member-reviewer`.
8. Run `skcr compile cncf-nuvotex-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nuvotex-member-reviewer`.
...
```bash
skpm validate cncf-nuvotex-member-reviewer
skpm package cncf-nuvotex-member-reviewer
skpm publish cncf-nuvotex-member-reviewer
```
