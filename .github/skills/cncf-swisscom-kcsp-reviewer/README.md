...
7. Run `skcr validate` and `skcr asps coverage cncf-swisscom-kcsp-reviewer`.
8. Run `skcr compile cncf-swisscom-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-swisscom-kcsp-reviewer`.
...
```bash
skpm validate cncf-swisscom-kcsp-reviewer
skpm package cncf-swisscom-kcsp-reviewer
skpm publish cncf-swisscom-kcsp-reviewer
```
