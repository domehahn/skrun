...
7. Run `skcr validate` and `skcr asps coverage cncf-apache-openwhisk-reviewer`.
8. Run `skcr compile cncf-apache-openwhisk-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-apache-openwhisk-reviewer`.
...
```bash
skpm validate cncf-apache-openwhisk-reviewer
skpm package cncf-apache-openwhisk-reviewer
skpm publish cncf-apache-openwhisk-reviewer
```
