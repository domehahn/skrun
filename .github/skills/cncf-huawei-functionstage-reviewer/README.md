...
7. Run `skcr validate` and `skcr asps coverage cncf-huawei-functionstage-reviewer`.
8. Run `skcr compile cncf-huawei-functionstage-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-huawei-functionstage-reviewer`.
...
```bash
skpm validate cncf-huawei-functionstage-reviewer
skpm package cncf-huawei-functionstage-reviewer
skpm publish cncf-huawei-functionstage-reviewer
```
