...
7. Run `skcr validate` and `skcr asps coverage cncf-vitess-reviewer`.
8. Run `skcr compile cncf-vitess-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-vitess-reviewer`.
...
```bash
skpm validate cncf-vitess-reviewer
skpm package cncf-vitess-reviewer
skpm publish cncf-vitess-reviewer
```
