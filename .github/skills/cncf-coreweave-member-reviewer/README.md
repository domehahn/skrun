...
7. Run `skcr validate` and `skcr asps coverage cncf-coreweave-member-reviewer`.
8. Run `skcr compile cncf-coreweave-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-coreweave-member-reviewer`.
...
```bash
skpm validate cncf-coreweave-member-reviewer
skpm package cncf-coreweave-member-reviewer
skpm publish cncf-coreweave-member-reviewer
```
