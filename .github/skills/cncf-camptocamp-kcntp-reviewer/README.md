...
7. Run `skcr validate` and `skcr asps coverage cncf-camptocamp-kcntp-reviewer`.
8. Run `skcr compile cncf-camptocamp-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-camptocamp-kcntp-reviewer`.
...
```bash
skpm validate cncf-camptocamp-kcntp-reviewer
skpm package cncf-camptocamp-kcntp-reviewer
skpm publish cncf-camptocamp-kcntp-reviewer
```
