...
7. Run `skcr validate` and `skcr asps coverage cncf-containerized-routing-protocol-daemon-reviewer`.
8. Run `skcr compile cncf-containerized-routing-protocol-daemon-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-containerized-routing-protocol-daemon-reviewer`.
...
```bash
skpm validate cncf-containerized-routing-protocol-daemon-reviewer
skpm package cncf-containerized-routing-protocol-daemon-reviewer
skpm publish cncf-containerized-routing-protocol-daemon-reviewer
```
