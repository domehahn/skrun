...
7. Run `skcr validate` and `skcr asps coverage cncf-risc-v-member-reviewer`.
8. Run `skcr compile cncf-risc-v-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-risc-v-member-reviewer`.
...
```bash
skpm validate cncf-risc-v-member-reviewer
skpm package cncf-risc-v-member-reviewer
skpm publish cncf-risc-v-member-reviewer
```
