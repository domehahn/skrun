...
7. Run `skcr validate` and `skcr asps coverage cncf-telenor-norway-member-reviewer`.
8. Run `skcr compile cncf-telenor-norway-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-telenor-norway-member-reviewer`.
...
```bash
skpm validate cncf-telenor-norway-member-reviewer
skpm package cncf-telenor-norway-member-reviewer
skpm publish cncf-telenor-norway-member-reviewer
```
