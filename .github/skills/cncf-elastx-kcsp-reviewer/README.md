...
7. Run `skcr validate` and `skcr asps coverage cncf-elastx-kcsp-reviewer`.
8. Run `skcr compile cncf-elastx-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-elastx-kcsp-reviewer`.
...
```bash
skpm validate cncf-elastx-kcsp-reviewer
skpm package cncf-elastx-kcsp-reviewer
skpm publish cncf-elastx-kcsp-reviewer
```
