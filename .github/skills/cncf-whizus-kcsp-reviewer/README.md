...
7. Run `skcr validate` and `skcr asps coverage cncf-whizus-kcsp-reviewer`.
8. Run `skcr compile cncf-whizus-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-whizus-kcsp-reviewer`.
...
```bash
skpm validate cncf-whizus-kcsp-reviewer
skpm package cncf-whizus-kcsp-reviewer
skpm publish cncf-whizus-kcsp-reviewer
```
