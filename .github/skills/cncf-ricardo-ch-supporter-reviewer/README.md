...
7. Run `skcr validate` and `skcr asps coverage cncf-ricardo-ch-supporter-reviewer`.
8. Run `skcr compile cncf-ricardo-ch-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ricardo-ch-supporter-reviewer`.
...
```bash
skpm validate cncf-ricardo-ch-supporter-reviewer
skpm package cncf-ricardo-ch-supporter-reviewer
skpm publish cncf-ricardo-ch-supporter-reviewer
```
