...
7. Run `skcr validate` and `skcr asps coverage cncf-pingcap-member-reviewer`.
8. Run `skcr compile cncf-pingcap-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-pingcap-member-reviewer`.
...
```bash
skpm validate cncf-pingcap-member-reviewer
skpm package cncf-pingcap-member-reviewer
skpm publish cncf-pingcap-member-reviewer
```
