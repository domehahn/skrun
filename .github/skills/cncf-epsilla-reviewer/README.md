...
7. Run `skcr validate` and `skcr asps coverage cncf-epsilla-reviewer`.
8. Run `skcr compile cncf-epsilla-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-epsilla-reviewer`.
...
```bash
skpm validate cncf-epsilla-reviewer
skpm package cncf-epsilla-reviewer
skpm publish cncf-epsilla-reviewer
```
