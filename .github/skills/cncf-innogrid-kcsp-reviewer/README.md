...
7. Run `skcr validate` and `skcr asps coverage cncf-innogrid-kcsp-reviewer`.
8. Run `skcr compile cncf-innogrid-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-innogrid-kcsp-reviewer`.
...
```bash
skpm validate cncf-innogrid-kcsp-reviewer
skpm package cncf-innogrid-kcsp-reviewer
skpm publish cncf-innogrid-kcsp-reviewer
```
