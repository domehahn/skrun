...
7. Run `skcr validate` and `skcr asps coverage cncf-erlang-ecosystem-foundation-member-reviewer`.
8. Run `skcr compile cncf-erlang-ecosystem-foundation-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-erlang-ecosystem-foundation-member-reviewer`.
...
```bash
skpm validate cncf-erlang-ecosystem-foundation-member-reviewer
skpm package cncf-erlang-ecosystem-foundation-member-reviewer
skpm publish cncf-erlang-ecosystem-foundation-member-reviewer
```
