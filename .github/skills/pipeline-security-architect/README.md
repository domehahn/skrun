...
7. Run `skcr validate` and `skcr asps coverage pipeline-security-architect`.
8. Run `skcr compile pipeline-security-architect --target skil`.
9. Run `skcr sync` and `skcr version recommend pipeline-security-architect`.
