...
7. Run `skcr validate` and `skcr asps coverage cncf-crossplane-reviewer`.
8. Run `skcr compile cncf-crossplane-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-crossplane-reviewer`.
...
```bash
skpm validate cncf-crossplane-reviewer
skpm package cncf-crossplane-reviewer
skpm publish cncf-crossplane-reviewer
```
