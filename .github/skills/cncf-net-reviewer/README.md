...
7. Run `skcr validate` and `skcr asps coverage cncf-net-reviewer`.
8. Run `skcr compile cncf-net-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-net-reviewer`.
...
```bash
skpm validate cncf-net-reviewer
skpm package cncf-net-reviewer
skpm publish cncf-net-reviewer
```
