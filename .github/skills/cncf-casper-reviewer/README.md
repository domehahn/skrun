...
7. Run `skcr validate` and `skcr asps coverage cncf-casper-reviewer`.
8. Run `skcr compile cncf-casper-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-casper-reviewer`.
...
```bash
skpm validate cncf-casper-reviewer
skpm package cncf-casper-reviewer
skpm publish cncf-casper-reviewer
```
