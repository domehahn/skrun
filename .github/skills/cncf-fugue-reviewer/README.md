...
7. Run `skcr validate` and `skcr asps coverage cncf-fugue-reviewer`.
8. Run `skcr compile cncf-fugue-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-fugue-reviewer`.
...
```bash
skpm validate cncf-fugue-reviewer
skpm package cncf-fugue-reviewer
skpm publish cncf-fugue-reviewer
```
