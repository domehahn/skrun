...
7. Run `skcr validate` and `skcr asps coverage cncf-controlplane-kcsp-reviewer`.
8. Run `skcr compile cncf-controlplane-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-controlplane-kcsp-reviewer`.
...
```bash
skpm validate cncf-controlplane-kcsp-reviewer
skpm package cncf-controlplane-kcsp-reviewer
skpm publish cncf-controlplane-kcsp-reviewer
```
