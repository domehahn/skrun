...
7. Run `skcr validate` and `skcr asps coverage cncf-platform-sh-reviewer`.
8. Run `skcr compile cncf-platform-sh-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-platform-sh-reviewer`.
...
```bash
skpm validate cncf-platform-sh-reviewer
skpm package cncf-platform-sh-reviewer
skpm publish cncf-platform-sh-reviewer
```
