...
7. Run `skcr validate` and `skcr asps coverage cncf-alibaba-cloud-application-real-time-service-reviewer`.
8. Run `skcr compile cncf-alibaba-cloud-application-real-time-service-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-alibaba-cloud-application-real-time-service-reviewer`.
...
```bash
skpm validate cncf-alibaba-cloud-application-real-time-service-reviewer
skpm package cncf-alibaba-cloud-application-real-time-service-reviewer
skpm publish cncf-alibaba-cloud-application-real-time-service-reviewer
```
