...
7. Run `skcr validate` and `skcr asps coverage cncf-snapt-nova-reviewer`.
8. Run `skcr compile cncf-snapt-nova-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-snapt-nova-reviewer`.
...
```bash
skpm validate cncf-snapt-nova-reviewer
skpm package cncf-snapt-nova-reviewer
skpm publish cncf-snapt-nova-reviewer
```
