...
7. Run `skcr validate` and `skcr asps coverage cncf-ripple-reviewer`.
8. Run `skcr compile cncf-ripple-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ripple-reviewer`.
...
```bash
skpm validate cncf-ripple-reviewer
skpm package cncf-ripple-reviewer
skpm publish cncf-ripple-reviewer
```
