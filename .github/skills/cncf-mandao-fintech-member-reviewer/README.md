...
7. Run `skcr validate` and `skcr asps coverage cncf-mandao-fintech-member-reviewer`.
8. Run `skcr compile cncf-mandao-fintech-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-mandao-fintech-member-reviewer`.
...
```bash
skpm validate cncf-mandao-fintech-member-reviewer
skpm package cncf-mandao-fintech-member-reviewer
skpm publish cncf-mandao-fintech-member-reviewer
```
