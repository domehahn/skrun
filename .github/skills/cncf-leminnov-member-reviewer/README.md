...
7. Run `skcr validate` and `skcr asps coverage cncf-leminnov-member-reviewer`.
8. Run `skcr compile cncf-leminnov-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-leminnov-member-reviewer`.
...
```bash
skpm validate cncf-leminnov-member-reviewer
skpm package cncf-leminnov-member-reviewer
skpm publish cncf-leminnov-member-reviewer
```
