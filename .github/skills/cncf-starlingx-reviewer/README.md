...
7. Run `skcr validate` and `skcr asps coverage cncf-starlingx-reviewer`.
8. Run `skcr compile cncf-starlingx-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-starlingx-reviewer`.
...
```bash
skpm validate cncf-starlingx-reviewer
skpm package cncf-starlingx-reviewer
skpm publish cncf-starlingx-reviewer
```
