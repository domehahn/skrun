...
7. Run `skcr validate` and `skcr asps coverage cncf-golem-cloud-wasm-reviewer`.
8. Run `skcr compile cncf-golem-cloud-wasm-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-golem-cloud-wasm-reviewer`.
...
```bash
skpm validate cncf-golem-cloud-wasm-reviewer
skpm package cncf-golem-cloud-wasm-reviewer
skpm publish cncf-golem-cloud-wasm-reviewer
```
