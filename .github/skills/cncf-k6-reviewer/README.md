...
7. Run `skcr validate` and `skcr asps coverage cncf-k6-reviewer`.
8. Run `skcr compile cncf-k6-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-k6-reviewer`.
...
```bash
skpm validate cncf-k6-reviewer
skpm package cncf-k6-reviewer
skpm publish cncf-k6-reviewer
```
