...
7. Run `skcr validate` and `skcr asps coverage cncf-apache-hbase-reviewer`.
8. Run `skcr compile cncf-apache-hbase-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-apache-hbase-reviewer`.
...
```bash
skpm validate cncf-apache-hbase-reviewer
skpm package cncf-apache-hbase-reviewer
skpm publish cncf-apache-hbase-reviewer
```
