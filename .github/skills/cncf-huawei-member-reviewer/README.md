...
7. Run `skcr validate` and `skcr asps coverage cncf-huawei-member-reviewer`.
8. Run `skcr compile cncf-huawei-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-huawei-member-reviewer`.
...
```bash
skpm validate cncf-huawei-member-reviewer
skpm package cncf-huawei-member-reviewer
skpm publish cncf-huawei-member-reviewer
```
