...
7. Run `skcr validate` and `skcr asps coverage cncf-vineyard-reviewer`.
8. Run `skcr compile cncf-vineyard-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-vineyard-reviewer`.
...
```bash
skpm validate cncf-vineyard-reviewer
skpm package cncf-vineyard-reviewer
skpm publish cncf-vineyard-reviewer
```
