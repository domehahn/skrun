...
7. Run `skcr validate` and `skcr asps coverage cncf-pixie-reviewer`.
8. Run `skcr compile cncf-pixie-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-pixie-reviewer`.
...
```bash
skpm validate cncf-pixie-reviewer
skpm package cncf-pixie-reviewer
skpm publish cncf-pixie-reviewer
```
