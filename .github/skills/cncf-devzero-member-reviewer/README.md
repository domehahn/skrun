...
7. Run `skcr validate` and `skcr asps coverage cncf-devzero-member-reviewer`.
8. Run `skcr compile cncf-devzero-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-devzero-member-reviewer`.
...
```bash
skpm validate cncf-devzero-member-reviewer
skpm package cncf-devzero-member-reviewer
skpm publish cncf-devzero-member-reviewer
```
