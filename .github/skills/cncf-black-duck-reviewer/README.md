...
7. Run `skcr validate` and `skcr asps coverage cncf-black-duck-reviewer`.
8. Run `skcr compile cncf-black-duck-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-black-duck-reviewer`.
...
```bash
skpm validate cncf-black-duck-reviewer
skpm package cncf-black-duck-reviewer
skpm publish cncf-black-duck-reviewer
```
