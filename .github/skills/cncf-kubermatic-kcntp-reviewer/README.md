...
7. Run `skcr validate` and `skcr asps coverage cncf-kubermatic-kcntp-reviewer`.
8. Run `skcr compile cncf-kubermatic-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kubermatic-kcntp-reviewer`.
...
```bash
skpm validate cncf-kubermatic-kcntp-reviewer
skpm package cncf-kubermatic-kcntp-reviewer
skpm publish cncf-kubermatic-kcntp-reviewer
```
