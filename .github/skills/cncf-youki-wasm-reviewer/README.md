...
7. Run `skcr validate` and `skcr asps coverage cncf-youki-wasm-reviewer`.
8. Run `skcr compile cncf-youki-wasm-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-youki-wasm-reviewer`.
...
```bash
skpm validate cncf-youki-wasm-reviewer
skpm package cncf-youki-wasm-reviewer
skpm publish cncf-youki-wasm-reviewer
```
