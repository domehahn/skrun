...
7. Run `skcr validate` and `skcr asps coverage cncf-nuweba-reviewer`.
8. Run `skcr compile cncf-nuweba-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nuweba-reviewer`.
...
```bash
skpm validate cncf-nuweba-reviewer
skpm package cncf-nuweba-reviewer
skpm publish cncf-nuweba-reviewer
```
