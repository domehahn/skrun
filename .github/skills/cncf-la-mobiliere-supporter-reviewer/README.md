...
7. Run `skcr validate` and `skcr asps coverage cncf-la-mobiliere-supporter-reviewer`.
8. Run `skcr compile cncf-la-mobiliere-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-la-mobiliere-supporter-reviewer`.
...
```bash
skpm validate cncf-la-mobiliere-supporter-reviewer
skpm package cncf-la-mobiliere-supporter-reviewer
skpm publish cncf-la-mobiliere-supporter-reviewer
```
