...
7. Run `skcr validate` and `skcr asps coverage agent-behavior-eval-engineer`.
8. Run `skcr compile agent-behavior-eval-engineer --target skil`.
9. Run `skcr sync` and `skcr version recommend agent-behavior-eval-engineer`.
...
```bash
skpm validate agent-behavior-eval-engineer
skpm package agent-behavior-eval-engineer
skpm publish agent-behavior-eval-engineer
```
