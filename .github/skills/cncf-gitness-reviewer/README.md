...
7. Run `skcr validate` and `skcr asps coverage cncf-gitness-reviewer`.
8. Run `skcr compile cncf-gitness-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-gitness-reviewer`.
...
```bash
skpm validate cncf-gitness-reviewer
skpm package cncf-gitness-reviewer
skpm publish cncf-gitness-reviewer
```
