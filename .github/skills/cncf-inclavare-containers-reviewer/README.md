...
7. Run `skcr validate` and `skcr asps coverage cncf-inclavare-containers-reviewer`.
8. Run `skcr compile cncf-inclavare-containers-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-inclavare-containers-reviewer`.
...
```bash
skpm validate cncf-inclavare-containers-reviewer
skpm package cncf-inclavare-containers-reviewer
skpm publish cncf-inclavare-containers-reviewer
```
