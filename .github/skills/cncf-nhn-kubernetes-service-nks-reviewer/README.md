...
7. Run `skcr validate` and `skcr asps coverage cncf-nhn-kubernetes-service-nks-reviewer`.
8. Run `skcr compile cncf-nhn-kubernetes-service-nks-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nhn-kubernetes-service-nks-reviewer`.
...
```bash
skpm validate cncf-nhn-kubernetes-service-nks-reviewer
skpm package cncf-nhn-kubernetes-service-nks-reviewer
skpm publish cncf-nhn-kubernetes-service-nks-reviewer
```
