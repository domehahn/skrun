...
7. Run `skcr validate` and `skcr asps coverage cncf-nutanix-kubernetes-platform-nkp-reviewer`.
8. Run `skcr compile cncf-nutanix-kubernetes-platform-nkp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nutanix-kubernetes-platform-nkp-reviewer`.
...
```bash
skpm validate cncf-nutanix-kubernetes-platform-nkp-reviewer
skpm package cncf-nutanix-kubernetes-platform-nkp-reviewer
skpm publish cncf-nutanix-kubernetes-platform-nkp-reviewer
```
