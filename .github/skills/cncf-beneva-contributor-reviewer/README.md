...
7. Run `skcr validate` and `skcr asps coverage cncf-beneva-contributor-reviewer`.
8. Run `skcr compile cncf-beneva-contributor-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-beneva-contributor-reviewer`.
...
```bash
skpm validate cncf-beneva-contributor-reviewer
skpm package cncf-beneva-contributor-reviewer
skpm publish cncf-beneva-contributor-reviewer
```
