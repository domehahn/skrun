...
7. Run `skcr validate` and `skcr asps coverage cncf-guida-kcsp-reviewer`.
8. Run `skcr compile cncf-guida-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-guida-kcsp-reviewer`.
...
```bash
skpm validate cncf-guida-kcsp-reviewer
skpm package cncf-guida-kcsp-reviewer
skpm publish cncf-guida-kcsp-reviewer
```
