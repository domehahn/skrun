...
7. Run `skcr validate` and `skcr asps coverage cncf-solo-io-member-reviewer`.
8. Run `skcr compile cncf-solo-io-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-solo-io-member-reviewer`.
...
```bash
skpm validate cncf-solo-io-member-reviewer
skpm package cncf-solo-io-member-reviewer
skpm publish cncf-solo-io-member-reviewer
```
