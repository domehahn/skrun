...
7. Run `skcr validate` and `skcr asps coverage cncf-tata-communications-vayu-kubernetes-service-reviewer`.
8. Run `skcr compile cncf-tata-communications-vayu-kubernetes-service-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-tata-communications-vayu-kubernetes-service-reviewer`.
...
```bash
skpm validate cncf-tata-communications-vayu-kubernetes-service-reviewer
skpm package cncf-tata-communications-vayu-kubernetes-service-reviewer
skpm publish cncf-tata-communications-vayu-kubernetes-service-reviewer
```
