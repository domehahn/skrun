...
7. Run `skcr validate` and `skcr asps coverage cncf-hightech-payment-systems-supporter-reviewer`.
8. Run `skcr compile cncf-hightech-payment-systems-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-hightech-payment-systems-supporter-reviewer`.
...
```bash
skpm validate cncf-hightech-payment-systems-supporter-reviewer
skpm package cncf-hightech-payment-systems-supporter-reviewer
skpm publish cncf-hightech-payment-systems-supporter-reviewer
```
