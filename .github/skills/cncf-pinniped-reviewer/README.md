...
7. Run `skcr validate` and `skcr asps coverage cncf-pinniped-reviewer`.
8. Run `skcr compile cncf-pinniped-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-pinniped-reviewer`.
...
```bash
skpm validate cncf-pinniped-reviewer
skpm package cncf-pinniped-reviewer
skpm publish cncf-pinniped-reviewer
```
