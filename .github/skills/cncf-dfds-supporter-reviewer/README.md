...
7. Run `skcr validate` and `skcr asps coverage cncf-dfds-supporter-reviewer`.
8. Run `skcr compile cncf-dfds-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-dfds-supporter-reviewer`.
...
```bash
skpm validate cncf-dfds-supporter-reviewer
skpm package cncf-dfds-supporter-reviewer
skpm publish cncf-dfds-supporter-reviewer
```
