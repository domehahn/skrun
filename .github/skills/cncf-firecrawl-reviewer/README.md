...
7. Run `skcr validate` and `skcr asps coverage cncf-firecrawl-reviewer`.
8. Run `skcr compile cncf-firecrawl-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-firecrawl-reviewer`.
...
```bash
skpm validate cncf-firecrawl-reviewer
skpm package cncf-firecrawl-reviewer
skpm publish cncf-firecrawl-reviewer
```
