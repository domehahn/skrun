...
7. Run `skcr validate` and `skcr asps coverage cncf-cloudlink-cmp-reviewer`.
8. Run `skcr compile cncf-cloudlink-cmp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloudlink-cmp-reviewer`.
...
```bash
skpm validate cncf-cloudlink-cmp-reviewer
skpm package cncf-cloudlink-cmp-reviewer
skpm publish cncf-cloudlink-cmp-reviewer
```
