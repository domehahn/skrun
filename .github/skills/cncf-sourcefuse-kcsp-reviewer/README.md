...
7. Run `skcr validate` and `skcr asps coverage cncf-sourcefuse-kcsp-reviewer`.
8. Run `skcr compile cncf-sourcefuse-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sourcefuse-kcsp-reviewer`.
...
```bash
skpm validate cncf-sourcefuse-kcsp-reviewer
skpm package cncf-sourcefuse-kcsp-reviewer
skpm publish cncf-sourcefuse-kcsp-reviewer
```
