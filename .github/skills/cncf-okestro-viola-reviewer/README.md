...
7. Run `skcr validate` and `skcr asps coverage cncf-okestro-viola-reviewer`.
8. Run `skcr compile cncf-okestro-viola-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-okestro-viola-reviewer`.
...
```bash
skpm validate cncf-okestro-viola-reviewer
skpm package cncf-okestro-viola-reviewer
skpm publish cncf-okestro-viola-reviewer
```
