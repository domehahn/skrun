...
7. Run `skcr validate` and `skcr asps coverage cncf-chef-habitat-reviewer`.
8. Run `skcr compile cncf-chef-habitat-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-chef-habitat-reviewer`.
...
```bash
skpm validate cncf-chef-habitat-reviewer
skpm package cncf-chef-habitat-reviewer
skpm publish cncf-chef-habitat-reviewer
```
