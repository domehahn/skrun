...
7. Run `skcr validate` and `skcr asps coverage cncf-kubewarden-reviewer`.
8. Run `skcr compile cncf-kubewarden-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kubewarden-reviewer`.
...
```bash
skpm validate cncf-kubewarden-reviewer
skpm package cncf-kubewarden-reviewer
skpm publish cncf-kubewarden-reviewer
```
