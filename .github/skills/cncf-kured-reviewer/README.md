...
7. Run `skcr validate` and `skcr asps coverage cncf-kured-reviewer`.
8. Run `skcr compile cncf-kured-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kured-reviewer`.
...
```bash
skpm validate cncf-kured-reviewer
skpm package cncf-kured-reviewer
skpm publish cncf-kured-reviewer
```
