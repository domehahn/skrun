...
7. Run `skcr validate` and `skcr asps coverage cncf-codezero-reviewer`.
8. Run `skcr compile cncf-codezero-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-codezero-reviewer`.
...
```bash
skpm validate cncf-codezero-reviewer
skpm package cncf-codezero-reviewer
skpm publish cncf-codezero-reviewer
```
