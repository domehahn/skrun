...
7. Run `skcr validate` and `skcr asps coverage cncf-metal-stack-cloud-kubernetes-reviewer`.
8. Run `skcr compile cncf-metal-stack-cloud-kubernetes-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-metal-stack-cloud-kubernetes-reviewer`.
...
```bash
skpm validate cncf-metal-stack-cloud-kubernetes-reviewer
skpm package cncf-metal-stack-cloud-kubernetes-reviewer
skpm publish cncf-metal-stack-cloud-kubernetes-reviewer
```
