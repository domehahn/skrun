...
7. Run `skcr validate` and `skcr asps coverage cncf-strava-member-reviewer`.
8. Run `skcr compile cncf-strava-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-strava-member-reviewer`.
...
```bash
skpm validate cncf-strava-member-reviewer
skpm package cncf-strava-member-reviewer
skpm publish cncf-strava-member-reviewer
```
