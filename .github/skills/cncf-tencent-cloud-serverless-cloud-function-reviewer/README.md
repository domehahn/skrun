...
7. Run `skcr validate` and `skcr asps coverage cncf-tencent-cloud-serverless-cloud-function-reviewer`.
8. Run `skcr compile cncf-tencent-cloud-serverless-cloud-function-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-tencent-cloud-serverless-cloud-function-reviewer`.
...
```bash
skpm validate cncf-tencent-cloud-serverless-cloud-function-reviewer
skpm package cncf-tencent-cloud-serverless-cloud-function-reviewer
skpm publish cncf-tencent-cloud-serverless-cloud-function-reviewer
```
