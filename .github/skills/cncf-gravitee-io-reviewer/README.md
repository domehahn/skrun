...
7. Run `skcr validate` and `skcr asps coverage cncf-gravitee-io-reviewer`.
8. Run `skcr compile cncf-gravitee-io-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-gravitee-io-reviewer`.
...
```bash
skpm validate cncf-gravitee-io-reviewer
skpm package cncf-gravitee-io-reviewer
skpm publish cncf-gravitee-io-reviewer
```
