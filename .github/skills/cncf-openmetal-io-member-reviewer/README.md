...
7. Run `skcr validate` and `skcr asps coverage cncf-openmetal-io-member-reviewer`.
8. Run `skcr compile cncf-openmetal-io-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-openmetal-io-member-reviewer`.
...
```bash
skpm validate cncf-openmetal-io-member-reviewer
skpm package cncf-openmetal-io-member-reviewer
skpm publish cncf-openmetal-io-member-reviewer
```
