...
7. Run `skcr validate` and `skcr asps coverage cncf-huawei-cloud-container-engine-cce-reviewer`.
8. Run `skcr compile cncf-huawei-cloud-container-engine-cce-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-huawei-cloud-container-engine-cce-reviewer`.
...
```bash
skpm validate cncf-huawei-cloud-container-engine-cce-reviewer
skpm package cncf-huawei-cloud-container-engine-cce-reviewer
skpm publish cncf-huawei-cloud-container-engine-cce-reviewer
```
