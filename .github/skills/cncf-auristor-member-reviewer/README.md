...
7. Run `skcr validate` and `skcr asps coverage cncf-auristor-member-reviewer`.
8. Run `skcr compile cncf-auristor-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-auristor-member-reviewer`.
...
```bash
skpm validate cncf-auristor-member-reviewer
skpm package cncf-auristor-member-reviewer
skpm publish cncf-auristor-member-reviewer
```
