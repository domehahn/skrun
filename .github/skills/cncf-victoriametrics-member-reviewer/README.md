...
7. Run `skcr validate` and `skcr asps coverage cncf-victoriametrics-member-reviewer`.
8. Run `skcr compile cncf-victoriametrics-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-victoriametrics-member-reviewer`.
...
```bash
skpm validate cncf-victoriametrics-member-reviewer
skpm package cncf-victoriametrics-member-reviewer
skpm publish cncf-victoriametrics-member-reviewer
```
