...
7. Run `skcr validate` and `skcr asps coverage cncf-stacklet-member-reviewer`.
8. Run `skcr compile cncf-stacklet-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-stacklet-member-reviewer`.
...
```bash
skpm validate cncf-stacklet-member-reviewer
skpm package cncf-stacklet-member-reviewer
skpm publish cncf-stacklet-member-reviewer
```
