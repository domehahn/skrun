...
7. Run `skcr validate` and `skcr asps coverage cncf-aikido-security-member-reviewer`.
8. Run `skcr compile cncf-aikido-security-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-aikido-security-member-reviewer`.
...
```bash
skpm validate cncf-aikido-security-member-reviewer
skpm package cncf-aikido-security-member-reviewer
skpm publish cncf-aikido-security-member-reviewer
```
