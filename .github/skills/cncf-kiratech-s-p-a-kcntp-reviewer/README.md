...
7. Run `skcr validate` and `skcr asps coverage cncf-kiratech-s-p-a-kcntp-reviewer`.
8. Run `skcr compile cncf-kiratech-s-p-a-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kiratech-s-p-a-kcntp-reviewer`.
...
```bash
skpm validate cncf-kiratech-s-p-a-kcntp-reviewer
skpm package cncf-kiratech-s-p-a-kcntp-reviewer
skpm publish cncf-kiratech-s-p-a-kcntp-reviewer
```
