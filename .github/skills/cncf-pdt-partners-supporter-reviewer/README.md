...
7. Run `skcr validate` and `skcr asps coverage cncf-pdt-partners-supporter-reviewer`.
8. Run `skcr compile cncf-pdt-partners-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-pdt-partners-supporter-reviewer`.
...
```bash
skpm validate cncf-pdt-partners-supporter-reviewer
skpm package cncf-pdt-partners-supporter-reviewer
skpm publish cncf-pdt-partners-supporter-reviewer
```
