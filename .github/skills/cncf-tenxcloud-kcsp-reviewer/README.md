...
7. Run `skcr validate` and `skcr asps coverage cncf-tenxcloud-kcsp-reviewer`.
8. Run `skcr compile cncf-tenxcloud-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-tenxcloud-kcsp-reviewer`.
...
```bash
skpm validate cncf-tenxcloud-kcsp-reviewer
skpm package cncf-tenxcloud-kcsp-reviewer
skpm publish cncf-tenxcloud-kcsp-reviewer
```
