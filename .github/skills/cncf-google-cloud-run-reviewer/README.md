...
7. Run `skcr validate` and `skcr asps coverage cncf-google-cloud-run-reviewer`.
8. Run `skcr compile cncf-google-cloud-run-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-google-cloud-run-reviewer`.
...
```bash
skpm validate cncf-google-cloud-run-reviewer
skpm package cncf-google-cloud-run-reviewer
skpm publish cncf-google-cloud-run-reviewer
```
