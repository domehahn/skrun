...
7. Run `skcr validate` and `skcr asps coverage cncf-spiderlightning-reviewer`.
8. Run `skcr compile cncf-spiderlightning-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-spiderlightning-reviewer`.
...
```bash
skpm validate cncf-spiderlightning-reviewer
skpm package cncf-spiderlightning-reviewer
skpm publish cncf-spiderlightning-reviewer
```
