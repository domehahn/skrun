...
7. Run `skcr validate` and `skcr asps coverage cncf-ibm-cloud-kubernetes-service-reviewer`.
8. Run `skcr compile cncf-ibm-cloud-kubernetes-service-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ibm-cloud-kubernetes-service-reviewer`.
...
```bash
skpm validate cncf-ibm-cloud-kubernetes-service-reviewer
skpm package cncf-ibm-cloud-kubernetes-service-reviewer
skpm publish cncf-ibm-cloud-kubernetes-service-reviewer
```
