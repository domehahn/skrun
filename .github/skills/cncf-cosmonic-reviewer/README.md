...
7. Run `skcr validate` and `skcr asps coverage cncf-cosmonic-reviewer`.
8. Run `skcr compile cncf-cosmonic-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cosmonic-reviewer`.
...
```bash
skpm validate cncf-cosmonic-reviewer
skpm package cncf-cosmonic-reviewer
skpm publish cncf-cosmonic-reviewer
```
