...
7. Run `skcr validate` and `skcr asps coverage cncf-cedar-reviewer`.
8. Run `skcr compile cncf-cedar-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cedar-reviewer`.
...
```bash
skpm validate cncf-cedar-reviewer
skpm package cncf-cedar-reviewer
skpm publish cncf-cedar-reviewer
```
