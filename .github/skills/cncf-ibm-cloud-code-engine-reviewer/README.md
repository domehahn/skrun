...
7. Run `skcr validate` and `skcr asps coverage cncf-ibm-cloud-code-engine-reviewer`.
8. Run `skcr compile cncf-ibm-cloud-code-engine-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ibm-cloud-code-engine-reviewer`.
...
```bash
skpm validate cncf-ibm-cloud-code-engine-reviewer
skpm package cncf-ibm-cloud-code-engine-reviewer
skpm publish cncf-ibm-cloud-code-engine-reviewer
```
