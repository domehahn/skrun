...
7. Run `skcr validate` and `skcr asps coverage cncf-wso2-api-microgateway-reviewer`.
8. Run `skcr compile cncf-wso2-api-microgateway-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-wso2-api-microgateway-reviewer`.
...
```bash
skpm validate cncf-wso2-api-microgateway-reviewer
skpm package cncf-wso2-api-microgateway-reviewer
skpm publish cncf-wso2-api-microgateway-reviewer
```
