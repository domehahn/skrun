...
7. Run `skcr validate` and `skcr asps coverage cncf-tingyun-reviewer`.
8. Run `skcr compile cncf-tingyun-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-tingyun-reviewer`.
...
```bash
skpm validate cncf-tingyun-reviewer
skpm package cncf-tingyun-reviewer
skpm publish cncf-tingyun-reviewer
```
