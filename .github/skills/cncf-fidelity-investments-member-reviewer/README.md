...
7. Run `skcr validate` and `skcr asps coverage cncf-fidelity-investments-member-reviewer`.
8. Run `skcr compile cncf-fidelity-investments-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-fidelity-investments-member-reviewer`.
...
```bash
skpm validate cncf-fidelity-investments-member-reviewer
skpm package cncf-fidelity-investments-member-reviewer
skpm publish cncf-fidelity-investments-member-reviewer
```
