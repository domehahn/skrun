...
7. Run `skcr validate` and `skcr asps coverage cncf-chainguard-member-reviewer`.
8. Run `skcr compile cncf-chainguard-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-chainguard-member-reviewer`.
...
```bash
skpm validate cncf-chainguard-member-reviewer
skpm package cncf-chainguard-member-reviewer
skpm publish cncf-chainguard-member-reviewer
```
