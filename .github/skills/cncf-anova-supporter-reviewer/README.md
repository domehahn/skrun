...
7. Run `skcr validate` and `skcr asps coverage cncf-anova-supporter-reviewer`.
8. Run `skcr compile cncf-anova-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-anova-supporter-reviewer`.
...
```bash
skpm validate cncf-anova-supporter-reviewer
skpm package cncf-anova-supporter-reviewer
skpm publish cncf-anova-supporter-reviewer
```
