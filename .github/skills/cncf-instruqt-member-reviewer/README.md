...
7. Run `skcr validate` and `skcr asps coverage cncf-instruqt-member-reviewer`.
8. Run `skcr compile cncf-instruqt-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-instruqt-member-reviewer`.
...
```bash
skpm validate cncf-instruqt-member-reviewer
skpm package cncf-instruqt-member-reviewer
skpm publish cncf-instruqt-member-reviewer
```
