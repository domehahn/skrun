...
7. Run `skcr validate` and `skcr asps coverage cncf-formal-member-reviewer`.
8. Run `skcr compile cncf-formal-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-formal-member-reviewer`.
...
```bash
skpm validate cncf-formal-member-reviewer
skpm package cncf-formal-member-reviewer
skpm publish cncf-formal-member-reviewer
```
