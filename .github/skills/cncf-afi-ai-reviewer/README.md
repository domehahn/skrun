...
7. Run `skcr validate` and `skcr asps coverage cncf-afi-ai-reviewer`.
8. Run `skcr compile cncf-afi-ai-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-afi-ai-reviewer`.
...
```bash
skpm validate cncf-afi-ai-reviewer
skpm package cncf-afi-ai-reviewer
skpm publish cncf-afi-ai-reviewer
```
