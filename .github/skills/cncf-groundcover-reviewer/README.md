...
7. Run `skcr validate` and `skcr asps coverage cncf-groundcover-reviewer`.
8. Run `skcr compile cncf-groundcover-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-groundcover-reviewer`.
...
```bash
skpm validate cncf-groundcover-reviewer
skpm package cncf-groundcover-reviewer
skpm publish cncf-groundcover-reviewer
```
