...
7. Run `skcr validate` and `skcr asps coverage cncf-netbird-member-reviewer`.
8. Run `skcr compile cncf-netbird-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-netbird-member-reviewer`.
...
```bash
skpm validate cncf-netbird-member-reviewer
skpm package cncf-netbird-member-reviewer
skpm publish cncf-netbird-member-reviewer
```
