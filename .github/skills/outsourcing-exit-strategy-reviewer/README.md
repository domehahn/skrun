...
7. Run `skcr validate` and `skcr asps coverage outsourcing-exit-strategy-reviewer`.
8. Run `skcr compile outsourcing-exit-strategy-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend outsourcing-exit-strategy-reviewer`.
