...
7. Run `skcr validate` and `skcr asps coverage runbook-playbook-maintainer`.
8. Run `skcr compile runbook-playbook-maintainer --target skil`.
9. Run `skcr sync` and `skcr version recommend runbook-playbook-maintainer`.
