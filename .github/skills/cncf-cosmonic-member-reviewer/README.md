...
7. Run `skcr validate` and `skcr asps coverage cncf-cosmonic-member-reviewer`.
8. Run `skcr compile cncf-cosmonic-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cosmonic-member-reviewer`.
...
```bash
skpm validate cncf-cosmonic-member-reviewer
skpm package cncf-cosmonic-member-reviewer
skpm publish cncf-cosmonic-member-reviewer
```
