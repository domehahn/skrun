...
7. Run `skcr validate` and `skcr asps coverage cncf-rewe-international-dienstleistungsges-m-66a030c9-reviewer`.
8. Run `skcr compile cncf-rewe-international-dienstleistungsges-m-66a030c9-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-rewe-international-dienstleistungsges-m-66a030c9-reviewer`.
...
```bash
skpm validate cncf-rewe-international-dienstleistungsges-m-66a030c9-reviewer
skpm package cncf-rewe-international-dienstleistungsges-m-66a030c9-reviewer
skpm publish cncf-rewe-international-dienstleistungsges-m-66a030c9-reviewer
```
