...
7. Run `skcr validate` and `skcr asps coverage cncf-superplane-reviewer`.
8. Run `skcr compile cncf-superplane-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-superplane-reviewer`.
...
```bash
skpm validate cncf-superplane-reviewer
skpm package cncf-superplane-reviewer
skpm publish cncf-superplane-reviewer
```
