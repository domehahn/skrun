...
7. Run `skcr validate` and `skcr asps coverage cncf-steadybit-reviewer`.
8. Run `skcr compile cncf-steadybit-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-steadybit-reviewer`.
...
```bash
skpm validate cncf-steadybit-reviewer
skpm package cncf-steadybit-reviewer
skpm publish cncf-steadybit-reviewer
```
