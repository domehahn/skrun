...
7. Run `skcr validate` and `skcr asps coverage cncf-netnod-supporter-reviewer`.
8. Run `skcr compile cncf-netnod-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-netnod-supporter-reviewer`.
...
```bash
skpm validate cncf-netnod-supporter-reviewer
skpm package cncf-netnod-supporter-reviewer
skpm publish cncf-netnod-supporter-reviewer
```
