...
7. Run `skcr validate` and `skcr asps coverage cncf-architect-reviewer`.
8. Run `skcr compile cncf-architect-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-architect-reviewer`.
...
```bash
skpm validate cncf-architect-reviewer
skpm package cncf-architect-reviewer
skpm publish cncf-architect-reviewer
```
