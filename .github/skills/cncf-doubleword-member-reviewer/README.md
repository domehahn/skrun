...
7. Run `skcr validate` and `skcr asps coverage cncf-doubleword-member-reviewer`.
8. Run `skcr compile cncf-doubleword-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-doubleword-member-reviewer`.
...
```bash
skpm validate cncf-doubleword-member-reviewer
skpm package cncf-doubleword-member-reviewer
skpm publish cncf-doubleword-member-reviewer
```
