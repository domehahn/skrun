...
7. Run `skcr validate` and `skcr asps coverage cncf-leaseweb-member-reviewer`.
8. Run `skcr compile cncf-leaseweb-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-leaseweb-member-reviewer`.
...
```bash
skpm validate cncf-leaseweb-member-reviewer
skpm package cncf-leaseweb-member-reviewer
skpm publish cncf-leaseweb-member-reviewer
```
