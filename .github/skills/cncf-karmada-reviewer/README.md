...
7. Run `skcr validate` and `skcr asps coverage cncf-karmada-reviewer`.
8. Run `skcr compile cncf-karmada-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-karmada-reviewer`.
...
```bash
skpm validate cncf-karmada-reviewer
skpm package cncf-karmada-reviewer
skpm publish cncf-karmada-reviewer
```
