...
7. Run `skcr validate` and `skcr asps coverage cncf-capsule8-reviewer`.
8. Run `skcr compile cncf-capsule8-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-capsule8-reviewer`.
...
```bash
skpm validate cncf-capsule8-reviewer
skpm package cncf-capsule8-reviewer
skpm publish cncf-capsule8-reviewer
```
