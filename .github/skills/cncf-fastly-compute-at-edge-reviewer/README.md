...
7. Run `skcr validate` and `skcr asps coverage cncf-fastly-compute-at-edge-reviewer`.
8. Run `skcr compile cncf-fastly-compute-at-edge-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-fastly-compute-at-edge-reviewer`.
...
```bash
skpm validate cncf-fastly-compute-at-edge-reviewer
skpm package cncf-fastly-compute-at-edge-reviewer
skpm publish cncf-fastly-compute-at-edge-reviewer
```
