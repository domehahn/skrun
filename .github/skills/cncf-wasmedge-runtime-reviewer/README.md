...
7. Run `skcr validate` and `skcr asps coverage cncf-wasmedge-runtime-reviewer`.
8. Run `skcr compile cncf-wasmedge-runtime-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-wasmedge-runtime-reviewer`.
...
```bash
skpm validate cncf-wasmedge-runtime-reviewer
skpm package cncf-wasmedge-runtime-reviewer
skpm publish cncf-wasmedge-runtime-reviewer
```
