...
7. Run `skcr validate` and `skcr asps coverage cncf-azure-disk-storage-reviewer`.
8. Run `skcr compile cncf-azure-disk-storage-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-azure-disk-storage-reviewer`.
...
```bash
skpm validate cncf-azure-disk-storage-reviewer
skpm package cncf-azure-disk-storage-reviewer
skpm publish cncf-azure-disk-storage-reviewer
```
