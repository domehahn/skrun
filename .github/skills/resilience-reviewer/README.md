...
7. Run `skcr validate` and `skcr asps coverage resilience-reviewer`.
8. Run `skcr compile resilience-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend resilience-reviewer`.
