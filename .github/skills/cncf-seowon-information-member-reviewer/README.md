...
7. Run `skcr validate` and `skcr asps coverage cncf-seowon-information-member-reviewer`.
8. Run `skcr compile cncf-seowon-information-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-seowon-information-member-reviewer`.
...
```bash
skpm validate cncf-seowon-information-member-reviewer
skpm package cncf-seowon-information-member-reviewer
skpm publish cncf-seowon-information-member-reviewer
```
