...
7. Run `skcr validate` and `skcr asps coverage cncf-bc-cloud-kcsp-reviewer`.
8. Run `skcr compile cncf-bc-cloud-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-bc-cloud-kcsp-reviewer`.
...
```bash
skpm validate cncf-bc-cloud-kcsp-reviewer
skpm package cncf-bc-cloud-kcsp-reviewer
skpm publish cncf-bc-cloud-kcsp-reviewer
```
