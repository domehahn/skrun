...
7. Run `skcr validate` and `skcr asps coverage cncf-kublr-kcsp-reviewer`.
8. Run `skcr compile cncf-kublr-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kublr-kcsp-reviewer`.
...
```bash
skpm validate cncf-kublr-kcsp-reviewer
skpm package cncf-kublr-kcsp-reviewer
skpm publish cncf-kublr-kcsp-reviewer
```
