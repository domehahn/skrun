...
7. Run `skcr validate` and `skcr asps coverage cncf-gmx-supporter-reviewer`.
8. Run `skcr compile cncf-gmx-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-gmx-supporter-reviewer`.
...
```bash
skpm validate cncf-gmx-supporter-reviewer
skpm package cncf-gmx-supporter-reviewer
skpm publish cncf-gmx-supporter-reviewer
```
