...
7. Run `skcr validate` and `skcr asps coverage cncf-icon-business-systems-kcsp-reviewer`.
8. Run `skcr compile cncf-icon-business-systems-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-icon-business-systems-kcsp-reviewer`.
...
```bash
skpm validate cncf-icon-business-systems-kcsp-reviewer
skpm package cncf-icon-business-systems-kcsp-reviewer
skpm publish cncf-icon-business-systems-kcsp-reviewer
```
