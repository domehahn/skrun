...
7. Run `skcr validate` and `skcr asps coverage cncf-solanica-member-reviewer`.
8. Run `skcr compile cncf-solanica-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-solanica-member-reviewer`.
...
```bash
skpm validate cncf-solanica-member-reviewer
skpm package cncf-solanica-member-reviewer
skpm publish cncf-solanica-member-reviewer
```
