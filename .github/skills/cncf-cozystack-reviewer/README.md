...
7. Run `skcr validate` and `skcr asps coverage cncf-cozystack-reviewer`.
8. Run `skcr compile cncf-cozystack-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cozystack-reviewer`.
...
```bash
skpm validate cncf-cozystack-reviewer
skpm package cncf-cozystack-reviewer
skpm publish cncf-cozystack-reviewer
```
