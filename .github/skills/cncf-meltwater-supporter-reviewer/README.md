...
7. Run `skcr validate` and `skcr asps coverage cncf-meltwater-supporter-reviewer`.
8. Run `skcr compile cncf-meltwater-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-meltwater-supporter-reviewer`.
...
```bash
skpm validate cncf-meltwater-supporter-reviewer
skpm package cncf-meltwater-supporter-reviewer
skpm publish cncf-meltwater-supporter-reviewer
```
