...
7. Run `skcr validate` and `skcr asps coverage cncf-apache-nifi-reviewer`.
8. Run `skcr compile cncf-apache-nifi-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-apache-nifi-reviewer`.
...
```bash
skpm validate cncf-apache-nifi-reviewer
skpm package cncf-apache-nifi-reviewer
skpm publish cncf-apache-nifi-reviewer
```
