...
7. Run `skcr validate` and `skcr asps coverage cncf-teuto-net-managed-kubernetes-reviewer`.
8. Run `skcr compile cncf-teuto-net-managed-kubernetes-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-teuto-net-managed-kubernetes-reviewer`.
...
```bash
skpm validate cncf-teuto-net-managed-kubernetes-reviewer
skpm package cncf-teuto-net-managed-kubernetes-reviewer
skpm publish cncf-teuto-net-managed-kubernetes-reviewer
```
