...
7. Run `skcr validate` and `skcr asps coverage cncf-kops-reviewer`.
8. Run `skcr compile cncf-kops-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kops-reviewer`.
...
```bash
skpm validate cncf-kops-reviewer
skpm package cncf-kops-reviewer
skpm publish cncf-kops-reviewer
```
