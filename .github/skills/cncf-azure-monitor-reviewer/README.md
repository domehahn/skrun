...
7. Run `skcr validate` and `skcr asps coverage cncf-azure-monitor-reviewer`.
8. Run `skcr compile cncf-azure-monitor-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-azure-monitor-reviewer`.
...
```bash
skpm validate cncf-azure-monitor-reviewer
skpm package cncf-azure-monitor-reviewer
skpm publish cncf-azure-monitor-reviewer
```
