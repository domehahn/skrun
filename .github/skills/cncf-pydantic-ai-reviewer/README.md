...
7. Run `skcr validate` and `skcr asps coverage cncf-pydantic-ai-reviewer`.
8. Run `skcr compile cncf-pydantic-ai-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-pydantic-ai-reviewer`.
...
```bash
skpm validate cncf-pydantic-ai-reviewer
skpm package cncf-pydantic-ai-reviewer
skpm publish cncf-pydantic-ai-reviewer
```
