...
7. Run `skcr validate` and `skcr asps coverage security-reviewer`.
8. Run `skcr compile security-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend security-reviewer`.
