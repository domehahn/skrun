...
7. Run `skcr validate` and `skcr asps coverage cncf-kiratech-s-p-a-kcsp-reviewer`.
8. Run `skcr compile cncf-kiratech-s-p-a-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kiratech-s-p-a-kcsp-reviewer`.
...
```bash
skpm validate cncf-kiratech-s-p-a-kcsp-reviewer
skpm package cncf-kiratech-s-p-a-kcsp-reviewer
skpm publish cncf-kiratech-s-p-a-kcsp-reviewer
```
