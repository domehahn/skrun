...
7. Run `skcr validate` and `skcr asps coverage secrets-reviewer`.
8. Run `skcr compile secrets-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend secrets-reviewer`.
