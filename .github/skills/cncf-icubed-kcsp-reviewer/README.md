...
7. Run `skcr validate` and `skcr asps coverage cncf-icubed-kcsp-reviewer`.
8. Run `skcr compile cncf-icubed-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-icubed-kcsp-reviewer`.
...
```bash
skpm validate cncf-icubed-kcsp-reviewer
skpm package cncf-icubed-kcsp-reviewer
skpm publish cncf-icubed-kcsp-reviewer
```
