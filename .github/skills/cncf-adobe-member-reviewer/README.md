...
7. Run `skcr validate` and `skcr asps coverage cncf-adobe-member-reviewer`.
8. Run `skcr compile cncf-adobe-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-adobe-member-reviewer`.
...
```bash
skpm validate cncf-adobe-member-reviewer
skpm package cncf-adobe-member-reviewer
skpm publish cncf-adobe-member-reviewer
```
