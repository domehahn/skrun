...
7. Run `skcr validate` and `skcr asps coverage cncf-kube-scheduler-reviewer`.
8. Run `skcr compile cncf-kube-scheduler-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kube-scheduler-reviewer`.
...
```bash
skpm validate cncf-kube-scheduler-reviewer
skpm package cncf-kube-scheduler-reviewer
skpm publish cncf-kube-scheduler-reviewer
```
