...
7. Run `skcr validate` and `skcr asps coverage cncf-qingcloud-kubernetes-engine-qke-reviewer`.
8. Run `skcr compile cncf-qingcloud-kubernetes-engine-qke-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-qingcloud-kubernetes-engine-qke-reviewer`.
...
```bash
skpm validate cncf-qingcloud-kubernetes-engine-qke-reviewer
skpm package cncf-qingcloud-kubernetes-engine-qke-reviewer
skpm publish cncf-qingcloud-kubernetes-engine-qke-reviewer
```
