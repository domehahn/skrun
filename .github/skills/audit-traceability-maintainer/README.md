...
7. Run `skcr validate` and `skcr asps coverage audit-traceability-maintainer`.
8. Run `skcr compile audit-traceability-maintainer --target skil`.
9. Run `skcr sync` and `skcr version recommend audit-traceability-maintainer`.
