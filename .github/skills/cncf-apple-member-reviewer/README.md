...
7. Run `skcr validate` and `skcr asps coverage cncf-apple-member-reviewer`.
8. Run `skcr compile cncf-apple-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-apple-member-reviewer`.
...
```bash
skpm validate cncf-apple-member-reviewer
skpm package cncf-apple-member-reviewer
skpm publish cncf-apple-member-reviewer
```
