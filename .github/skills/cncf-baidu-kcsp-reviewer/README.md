...
7. Run `skcr validate` and `skcr asps coverage cncf-baidu-kcsp-reviewer`.
8. Run `skcr compile cncf-baidu-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-baidu-kcsp-reviewer`.
...
```bash
skpm validate cncf-baidu-kcsp-reviewer
skpm package cncf-baidu-kcsp-reviewer
skpm publish cncf-baidu-kcsp-reviewer
```
