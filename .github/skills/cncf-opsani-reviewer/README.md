...
7. Run `skcr validate` and `skcr asps coverage cncf-opsani-reviewer`.
8. Run `skcr compile cncf-opsani-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-opsani-reviewer`.
...
```bash
skpm validate cncf-opsani-reviewer
skpm package cncf-opsani-reviewer
skpm publish cncf-opsani-reviewer
```
