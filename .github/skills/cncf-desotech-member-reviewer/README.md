...
7. Run `skcr validate` and `skcr asps coverage cncf-desotech-member-reviewer`.
8. Run `skcr compile cncf-desotech-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-desotech-member-reviewer`.
...
```bash
skpm validate cncf-desotech-member-reviewer
skpm package cncf-desotech-member-reviewer
skpm publish cncf-desotech-member-reviewer
```
