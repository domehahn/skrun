...
7. Run `skcr validate` and `skcr asps coverage cloud-governance-reviewer`.
8. Run `skcr compile cloud-governance-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cloud-governance-reviewer`.
