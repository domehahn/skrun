...
7. Run `skcr validate` and `skcr asps coverage cncf-dapr-sdk-reviewer`.
8. Run `skcr compile cncf-dapr-sdk-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-dapr-sdk-reviewer`.
...
```bash
skpm validate cncf-dapr-sdk-reviewer
skpm package cncf-dapr-sdk-reviewer
skpm publish cncf-dapr-sdk-reviewer
```
