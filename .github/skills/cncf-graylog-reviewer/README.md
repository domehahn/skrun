...
7. Run `skcr validate` and `skcr asps coverage cncf-graylog-reviewer`.
8. Run `skcr compile cncf-graylog-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-graylog-reviewer`.
...
```bash
skpm validate cncf-graylog-reviewer
skpm package cncf-graylog-reviewer
skpm publish cncf-graylog-reviewer
```
