...
7. Run `skcr validate` and `skcr asps coverage cncf-percona-server-for-mysql-reviewer`.
8. Run `skcr compile cncf-percona-server-for-mysql-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-percona-server-for-mysql-reviewer`.
...
```bash
skpm validate cncf-percona-server-for-mysql-reviewer
skpm package cncf-percona-server-for-mysql-reviewer
skpm publish cncf-percona-server-for-mysql-reviewer
```
