...
7. Run `skcr validate` and `skcr asps coverage cncf-octopus-deploy-member-reviewer`.
8. Run `skcr compile cncf-octopus-deploy-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-octopus-deploy-member-reviewer`.
...
```bash
skpm validate cncf-octopus-deploy-member-reviewer
skpm package cncf-octopus-deploy-member-reviewer
skpm publish cncf-octopus-deploy-member-reviewer
```
