...
7. Run `skcr validate` and `skcr asps coverage cncf-easy-ngo-reviewer`.
8. Run `skcr compile cncf-easy-ngo-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-easy-ngo-reviewer`.
...
```bash
skpm validate cncf-easy-ngo-reviewer
skpm package cncf-easy-ngo-reviewer
skpm publish cncf-easy-ngo-reviewer
```
