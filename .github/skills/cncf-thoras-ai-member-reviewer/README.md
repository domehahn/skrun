...
7. Run `skcr validate` and `skcr asps coverage cncf-thoras-ai-member-reviewer`.
8. Run `skcr compile cncf-thoras-ai-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-thoras-ai-member-reviewer`.
...
```bash
skpm validate cncf-thoras-ai-member-reviewer
skpm package cncf-thoras-ai-member-reviewer
skpm publish cncf-thoras-ai-member-reviewer
```
