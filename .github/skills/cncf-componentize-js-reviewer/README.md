...
7. Run `skcr validate` and `skcr asps coverage cncf-componentize-js-reviewer`.
8. Run `skcr compile cncf-componentize-js-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-componentize-js-reviewer`.
...
```bash
skpm validate cncf-componentize-js-reviewer
skpm package cncf-componentize-js-reviewer
skpm publish cncf-componentize-js-reviewer
```
