...
7. Run `skcr validate` and `skcr asps coverage cncf-emscripten-reviewer`.
8. Run `skcr compile cncf-emscripten-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-emscripten-reviewer`.
...
```bash
skpm validate cncf-emscripten-reviewer
skpm package cncf-emscripten-reviewer
skpm publish cncf-emscripten-reviewer
```
