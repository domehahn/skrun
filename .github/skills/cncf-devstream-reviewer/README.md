...
7. Run `skcr validate` and `skcr asps coverage cncf-devstream-reviewer`.
8. Run `skcr compile cncf-devstream-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-devstream-reviewer`.
...
```bash
skpm validate cncf-devstream-reviewer
skpm package cncf-devstream-reviewer
skpm publish cncf-devstream-reviewer
```
