...
7. Run `skcr validate` and `skcr asps coverage cncf-new-relic-reviewer`.
8. Run `skcr compile cncf-new-relic-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-new-relic-reviewer`.
...
```bash
skpm validate cncf-new-relic-reviewer
skpm package cncf-new-relic-reviewer
skpm publish cncf-new-relic-reviewer
```
