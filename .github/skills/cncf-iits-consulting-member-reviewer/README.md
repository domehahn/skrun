...
7. Run `skcr validate` and `skcr asps coverage cncf-iits-consulting-member-reviewer`.
8. Run `skcr compile cncf-iits-consulting-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-iits-consulting-member-reviewer`.
...
```bash
skpm validate cncf-iits-consulting-member-reviewer
skpm package cncf-iits-consulting-member-reviewer
skpm publish cncf-iits-consulting-member-reviewer
```
