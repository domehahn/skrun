...
7. Run `skcr validate` and `skcr asps coverage cncf-smolagents-reviewer`.
8. Run `skcr compile cncf-smolagents-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-smolagents-reviewer`.
...
```bash
skpm validate cncf-smolagents-reviewer
skpm package cncf-smolagents-reviewer
skpm publish cncf-smolagents-reviewer
```
