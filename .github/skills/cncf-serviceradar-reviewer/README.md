...
7. Run `skcr validate` and `skcr asps coverage cncf-serviceradar-reviewer`.
8. Run `skcr compile cncf-serviceradar-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-serviceradar-reviewer`.
...
```bash
skpm validate cncf-serviceradar-reviewer
skpm package cncf-serviceradar-reviewer
skpm publish cncf-serviceradar-reviewer
```
