...
7. Run `skcr validate` and `skcr asps coverage cncf-orka-reviewer`.
8. Run `skcr compile cncf-orka-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-orka-reviewer`.
...
```bash
skpm validate cncf-orka-reviewer
skpm package cncf-orka-reviewer
skpm publish cncf-orka-reviewer
```
