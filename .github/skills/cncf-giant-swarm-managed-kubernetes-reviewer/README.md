...
7. Run `skcr validate` and `skcr asps coverage cncf-giant-swarm-managed-kubernetes-reviewer`.
8. Run `skcr compile cncf-giant-swarm-managed-kubernetes-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-giant-swarm-managed-kubernetes-reviewer`.
...
```bash
skpm validate cncf-giant-swarm-managed-kubernetes-reviewer
skpm package cncf-giant-swarm-managed-kubernetes-reviewer
skpm publish cncf-giant-swarm-managed-kubernetes-reviewer
```
