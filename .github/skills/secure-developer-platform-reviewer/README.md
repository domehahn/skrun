...
7. Run `skcr validate` and `skcr asps coverage secure-developer-platform-reviewer`.
8. Run `skcr compile secure-developer-platform-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend secure-developer-platform-reviewer`.
