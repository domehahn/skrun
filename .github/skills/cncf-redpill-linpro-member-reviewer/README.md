...
7. Run `skcr validate` and `skcr asps coverage cncf-redpill-linpro-member-reviewer`.
8. Run `skcr compile cncf-redpill-linpro-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-redpill-linpro-member-reviewer`.
...
```bash
skpm validate cncf-redpill-linpro-member-reviewer
skpm package cncf-redpill-linpro-member-reviewer
skpm publish cncf-redpill-linpro-member-reviewer
```
