...
7. Run `skcr validate` and `skcr asps coverage cncf-bouncy-castle-reviewer`.
8. Run `skcr compile cncf-bouncy-castle-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-bouncy-castle-reviewer`.
...
```bash
skpm validate cncf-bouncy-castle-reviewer
skpm package cncf-bouncy-castle-reviewer
skpm publish cncf-bouncy-castle-reviewer
```
