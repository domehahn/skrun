...
7. Run `skcr validate` and `skcr asps coverage cncf-threatmapper-reviewer`.
8. Run `skcr compile cncf-threatmapper-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-threatmapper-reviewer`.
...
```bash
skpm validate cncf-threatmapper-reviewer
skpm package cncf-threatmapper-reviewer
skpm publish cncf-threatmapper-reviewer
```
