...
7. Run `skcr validate` and `skcr asps coverage backdoor-persistence-reviewer`.
8. Run `skcr compile backdoor-persistence-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend backdoor-persistence-reviewer`.
...
```bash
skpm validate backdoor-persistence-reviewer
skpm package backdoor-persistence-reviewer
skpm publish backdoor-persistence-reviewer
```
