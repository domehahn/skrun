...
7. Run `skcr validate` and `skcr asps coverage cncf-okteto-reviewer`.
8. Run `skcr compile cncf-okteto-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-okteto-reviewer`.
...
```bash
skpm validate cncf-okteto-reviewer
skpm package cncf-okteto-reviewer
skpm publish cncf-okteto-reviewer
```
