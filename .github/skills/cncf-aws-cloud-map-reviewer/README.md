...
7. Run `skcr validate` and `skcr asps coverage cncf-aws-cloud-map-reviewer`.
8. Run `skcr compile cncf-aws-cloud-map-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-aws-cloud-map-reviewer`.
...
```bash
skpm validate cncf-aws-cloud-map-reviewer
skpm package cncf-aws-cloud-map-reviewer
skpm publish cncf-aws-cloud-map-reviewer
```
