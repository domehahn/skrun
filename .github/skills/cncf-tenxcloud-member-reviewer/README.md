...
7. Run `skcr validate` and `skcr asps coverage cncf-tenxcloud-member-reviewer`.
8. Run `skcr compile cncf-tenxcloud-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-tenxcloud-member-reviewer`.
...
```bash
skpm validate cncf-tenxcloud-member-reviewer
skpm package cncf-tenxcloud-member-reviewer
skpm publish cncf-tenxcloud-member-reviewer
```
