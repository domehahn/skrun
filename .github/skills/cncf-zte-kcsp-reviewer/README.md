...
7. Run `skcr validate` and `skcr asps coverage cncf-zte-kcsp-reviewer`.
8. Run `skcr compile cncf-zte-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-zte-kcsp-reviewer`.
...
```bash
skpm validate cncf-zte-kcsp-reviewer
skpm package cncf-zte-kcsp-reviewer
skpm publish cncf-zte-kcsp-reviewer
```
