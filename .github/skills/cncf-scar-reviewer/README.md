...
7. Run `skcr validate` and `skcr asps coverage cncf-scar-reviewer`.
8. Run `skcr compile cncf-scar-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-scar-reviewer`.
...
```bash
skpm validate cncf-scar-reviewer
skpm package cncf-scar-reviewer
skpm publish cncf-scar-reviewer
```
