...
7. Run `skcr validate` and `skcr asps coverage cncf-volcano-engine-apmplus-reviewer`.
8. Run `skcr compile cncf-volcano-engine-apmplus-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-volcano-engine-apmplus-reviewer`.
...
```bash
skpm validate cncf-volcano-engine-apmplus-reviewer
skpm package cncf-volcano-engine-apmplus-reviewer
skpm publish cncf-volcano-engine-apmplus-reviewer
```
