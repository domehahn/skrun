...
7. Run `skcr validate` and `skcr asps coverage cncf-fabedge-reviewer`.
8. Run `skcr compile cncf-fabedge-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-fabedge-reviewer`.
...
```bash
skpm validate cncf-fabedge-reviewer
skpm package cncf-fabedge-reviewer
skpm publish cncf-fabedge-reviewer
```
