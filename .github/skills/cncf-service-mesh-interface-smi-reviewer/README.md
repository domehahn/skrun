...
7. Run `skcr validate` and `skcr asps coverage cncf-service-mesh-interface-smi-reviewer`.
8. Run `skcr compile cncf-service-mesh-interface-smi-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-service-mesh-interface-smi-reviewer`.
...
```bash
skpm validate cncf-service-mesh-interface-smi-reviewer
skpm package cncf-service-mesh-interface-smi-reviewer
skpm publish cncf-service-mesh-interface-smi-reviewer
```
