...
7. Run `skcr validate` and `skcr asps coverage cncf-opentelemetry-reviewer`.
8. Run `skcr compile cncf-opentelemetry-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-opentelemetry-reviewer`.
...
```bash
skpm validate cncf-opentelemetry-reviewer
skpm package cncf-opentelemetry-reviewer
skpm publish cncf-opentelemetry-reviewer
```
