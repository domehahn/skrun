...
7. Run `skcr validate` and `skcr asps coverage cncf-atlantis-reviewer`.
8. Run `skcr compile cncf-atlantis-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-atlantis-reviewer`.
...
```bash
skpm validate cncf-atlantis-reviewer
skpm package cncf-atlantis-reviewer
skpm publish cncf-atlantis-reviewer
```
