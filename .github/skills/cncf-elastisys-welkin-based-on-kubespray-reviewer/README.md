...
7. Run `skcr validate` and `skcr asps coverage cncf-elastisys-welkin-based-on-kubespray-reviewer`.
8. Run `skcr compile cncf-elastisys-welkin-based-on-kubespray-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-elastisys-welkin-based-on-kubespray-reviewer`.
...
```bash
skpm validate cncf-elastisys-welkin-based-on-kubespray-reviewer
skpm package cncf-elastisys-welkin-based-on-kubespray-reviewer
skpm publish cncf-elastisys-welkin-based-on-kubespray-reviewer
```
