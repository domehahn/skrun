...
7. Run `skcr validate` and `skcr asps coverage cncf-scaleway-member-reviewer`.
8. Run `skcr compile cncf-scaleway-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-scaleway-member-reviewer`.
...
```bash
skpm validate cncf-scaleway-member-reviewer
skpm package cncf-scaleway-member-reviewer
skpm publish cncf-scaleway-member-reviewer
```
