...
7. Run `skcr validate` and `skcr asps coverage cncf-apache-openserverless-reviewer`.
8. Run `skcr compile cncf-apache-openserverless-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-apache-openserverless-reviewer`.
...
```bash
skpm validate cncf-apache-openserverless-reviewer
skpm package cncf-apache-openserverless-reviewer
skpm publish cncf-apache-openserverless-reviewer
```
