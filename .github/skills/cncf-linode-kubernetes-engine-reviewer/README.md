...
7. Run `skcr validate` and `skcr asps coverage cncf-linode-kubernetes-engine-reviewer`.
8. Run `skcr compile cncf-linode-kubernetes-engine-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-linode-kubernetes-engine-reviewer`.
...
```bash
skpm validate cncf-linode-kubernetes-engine-reviewer
skpm package cncf-linode-kubernetes-engine-reviewer
skpm publish cncf-linode-kubernetes-engine-reviewer
```
