...
7. Run `skcr validate` and `skcr asps coverage cncf-harness-member-reviewer`.
8. Run `skcr compile cncf-harness-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-harness-member-reviewer`.
...
```bash
skpm validate cncf-harness-member-reviewer
skpm package cncf-harness-member-reviewer
skpm publish cncf-harness-member-reviewer
```
