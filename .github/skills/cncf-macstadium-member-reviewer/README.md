...
7. Run `skcr validate` and `skcr asps coverage cncf-macstadium-member-reviewer`.
8. Run `skcr compile cncf-macstadium-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-macstadium-member-reviewer`.
...
```bash
skpm validate cncf-macstadium-member-reviewer
skpm package cncf-macstadium-member-reviewer
skpm publish cncf-macstadium-member-reviewer
```
