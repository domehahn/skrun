...
7. Run `skcr validate` and `skcr asps coverage cncf-deeperthanblue-member-reviewer`.
8. Run `skcr compile cncf-deeperthanblue-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-deeperthanblue-member-reviewer`.
...
```bash
skpm validate cncf-deeperthanblue-member-reviewer
skpm package cncf-deeperthanblue-member-reviewer
skpm publish cncf-deeperthanblue-member-reviewer
```
