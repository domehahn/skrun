...
7. Run `skcr validate` and `skcr asps coverage cncf-fonio-reviewer`.
8. Run `skcr compile cncf-fonio-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-fonio-reviewer`.
...
```bash
skpm validate cncf-fonio-reviewer
skpm package cncf-fonio-reviewer
skpm publish cncf-fonio-reviewer
```
