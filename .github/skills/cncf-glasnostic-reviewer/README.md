...
7. Run `skcr validate` and `skcr asps coverage cncf-glasnostic-reviewer`.
8. Run `skcr compile cncf-glasnostic-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-glasnostic-reviewer`.
...
```bash
skpm validate cncf-glasnostic-reviewer
skpm package cncf-glasnostic-reviewer
skpm publish cncf-glasnostic-reviewer
```
