...
7. Run `skcr validate` and `skcr asps coverage cncf-buf-technologies-member-reviewer`.
8. Run `skcr compile cncf-buf-technologies-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-buf-technologies-member-reviewer`.
...
```bash
skpm validate cncf-buf-technologies-member-reviewer
skpm package cncf-buf-technologies-member-reviewer
skpm publish cncf-buf-technologies-member-reviewer
```
