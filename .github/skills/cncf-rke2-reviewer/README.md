...
7. Run `skcr validate` and `skcr asps coverage cncf-rke2-reviewer`.
8. Run `skcr compile cncf-rke2-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-rke2-reviewer`.
...
```bash
skpm validate cncf-rke2-reviewer
skpm package cncf-rke2-reviewer
skpm publish cncf-rke2-reviewer
```
