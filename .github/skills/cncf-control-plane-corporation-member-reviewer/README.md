...
7. Run `skcr validate` and `skcr asps coverage cncf-control-plane-corporation-member-reviewer`.
8. Run `skcr compile cncf-control-plane-corporation-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-control-plane-corporation-member-reviewer`.
...
```bash
skpm validate cncf-control-plane-corporation-member-reviewer
skpm package cncf-control-plane-corporation-member-reviewer
skpm publish cncf-control-plane-corporation-member-reviewer
```
