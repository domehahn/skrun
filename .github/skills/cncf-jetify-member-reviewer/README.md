...
7. Run `skcr validate` and `skcr asps coverage cncf-jetify-member-reviewer`.
8. Run `skcr compile cncf-jetify-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-jetify-member-reviewer`.
...
```bash
skpm validate cncf-jetify-member-reviewer
skpm package cncf-jetify-member-reviewer
skpm publish cncf-jetify-member-reviewer
```
