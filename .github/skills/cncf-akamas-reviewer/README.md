...
7. Run `skcr validate` and `skcr asps coverage cncf-akamas-reviewer`.
8. Run `skcr compile cncf-akamas-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-akamas-reviewer`.
...
```bash
skpm validate cncf-akamas-reviewer
skpm package cncf-akamas-reviewer
skpm publish cncf-akamas-reviewer
```
