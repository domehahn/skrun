...
7. Run `skcr validate` and `skcr asps coverage cncf-vultr-kubernetes-engine-reviewer`.
8. Run `skcr compile cncf-vultr-kubernetes-engine-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-vultr-kubernetes-engine-reviewer`.
...
```bash
skpm validate cncf-vultr-kubernetes-engine-reviewer
skpm package cncf-vultr-kubernetes-engine-reviewer
skpm publish cncf-vultr-kubernetes-engine-reviewer
```
