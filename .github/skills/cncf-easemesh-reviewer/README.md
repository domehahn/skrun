...
7. Run `skcr validate` and `skcr asps coverage cncf-easemesh-reviewer`.
8. Run `skcr compile cncf-easemesh-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-easemesh-reviewer`.
...
```bash
skpm validate cncf-easemesh-reviewer
skpm package cncf-easemesh-reviewer
skpm publish cncf-easemesh-reviewer
```
