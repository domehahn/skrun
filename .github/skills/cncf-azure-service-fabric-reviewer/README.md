...
7. Run `skcr validate` and `skcr asps coverage cncf-azure-service-fabric-reviewer`.
8. Run `skcr compile cncf-azure-service-fabric-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-azure-service-fabric-reviewer`.
...
```bash
skpm validate cncf-azure-service-fabric-reviewer
skpm package cncf-azure-service-fabric-reviewer
skpm publish cncf-azure-service-fabric-reviewer
```
