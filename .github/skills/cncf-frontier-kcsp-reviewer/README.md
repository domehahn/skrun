...
7. Run `skcr validate` and `skcr asps coverage cncf-frontier-kcsp-reviewer`.
8. Run `skcr compile cncf-frontier-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-frontier-kcsp-reviewer`.
...
```bash
skpm validate cncf-frontier-kcsp-reviewer
skpm package cncf-frontier-kcsp-reviewer
skpm publish cncf-frontier-kcsp-reviewer
```
