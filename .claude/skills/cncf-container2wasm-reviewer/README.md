...
7. Run `skcr validate` and `skcr asps coverage cncf-container2wasm-reviewer`.
8. Run `skcr compile cncf-container2wasm-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-container2wasm-reviewer`.
...
```bash
skpm validate cncf-container2wasm-reviewer
skpm package cncf-container2wasm-reviewer
skpm publish cncf-container2wasm-reviewer
```
