...
7. Run `skcr validate` and `skcr asps coverage cncf-screwdriver-reviewer`.
8. Run `skcr compile cncf-screwdriver-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-screwdriver-reviewer`.
...
```bash
skpm validate cncf-screwdriver-reviewer
skpm package cncf-screwdriver-reviewer
skpm publish cncf-screwdriver-reviewer
```
