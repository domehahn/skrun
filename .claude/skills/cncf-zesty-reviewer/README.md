...
7. Run `skcr validate` and `skcr asps coverage cncf-zesty-reviewer`.
8. Run `skcr compile cncf-zesty-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-zesty-reviewer`.
...
```bash
skpm validate cncf-zesty-reviewer
skpm package cncf-zesty-reviewer
skpm publish cncf-zesty-reviewer
```
