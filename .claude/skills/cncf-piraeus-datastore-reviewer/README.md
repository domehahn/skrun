...
7. Run `skcr validate` and `skcr asps coverage cncf-piraeus-datastore-reviewer`.
8. Run `skcr compile cncf-piraeus-datastore-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-piraeus-datastore-reviewer`.
...
```bash
skpm validate cncf-piraeus-datastore-reviewer
skpm package cncf-piraeus-datastore-reviewer
skpm publish cncf-piraeus-datastore-reviewer
```
