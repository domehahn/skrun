...
7. Run `skcr validate` and `skcr asps coverage cncf-salad-reviewer`.
8. Run `skcr compile cncf-salad-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-salad-reviewer`.
...
```bash
skpm validate cncf-salad-reviewer
skpm package cncf-salad-reviewer
skpm publish cncf-salad-reviewer
```
