...
7. Run `skcr validate` and `skcr asps coverage cncf-aserto-reviewer`.
8. Run `skcr compile cncf-aserto-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-aserto-reviewer`.
...
```bash
skpm validate cncf-aserto-reviewer
skpm package cncf-aserto-reviewer
skpm publish cncf-aserto-reviewer
```
