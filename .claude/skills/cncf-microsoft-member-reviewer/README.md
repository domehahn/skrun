...
7. Run `skcr validate` and `skcr asps coverage cncf-microsoft-member-reviewer`.
8. Run `skcr compile cncf-microsoft-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-microsoft-member-reviewer`.
...
```bash
skpm validate cncf-microsoft-member-reviewer
skpm package cncf-microsoft-member-reviewer
skpm publish cncf-microsoft-member-reviewer
```
