...
7. Run `skcr validate` and `skcr asps coverage cncf-qiming-kcsp-reviewer`.
8. Run `skcr compile cncf-qiming-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-qiming-kcsp-reviewer`.
...
```bash
skpm validate cncf-qiming-kcsp-reviewer
skpm package cncf-qiming-kcsp-reviewer
skpm publish cncf-qiming-kcsp-reviewer
```
