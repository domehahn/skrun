...
7. Run `skcr validate` and `skcr asps coverage cncf-ntt-data-kcsp-reviewer`.
8. Run `skcr compile cncf-ntt-data-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ntt-data-kcsp-reviewer`.
...
```bash
skpm validate cncf-ntt-data-kcsp-reviewer
skpm package cncf-ntt-data-kcsp-reviewer
skpm publish cncf-ntt-data-kcsp-reviewer
```
