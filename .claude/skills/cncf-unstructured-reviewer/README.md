...
7. Run `skcr validate` and `skcr asps coverage cncf-unstructured-reviewer`.
8. Run `skcr compile cncf-unstructured-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-unstructured-reviewer`.
...
```bash
skpm validate cncf-unstructured-reviewer
skpm package cncf-unstructured-reviewer
skpm publish cncf-unstructured-reviewer
```
