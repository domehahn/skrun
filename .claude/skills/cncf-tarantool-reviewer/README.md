...
7. Run `skcr validate` and `skcr asps coverage cncf-tarantool-reviewer`.
8. Run `skcr compile cncf-tarantool-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-tarantool-reviewer`.
...
```bash
skpm validate cncf-tarantool-reviewer
skpm package cncf-tarantool-reviewer
skpm publish cncf-tarantool-reviewer
```
