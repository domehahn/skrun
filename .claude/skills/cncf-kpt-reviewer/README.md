...
7. Run `skcr validate` and `skcr asps coverage cncf-kpt-reviewer`.
8. Run `skcr compile cncf-kpt-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kpt-reviewer`.
...
```bash
skpm validate cncf-kpt-reviewer
skpm package cncf-kpt-reviewer
skpm publish cncf-kpt-reviewer
```
