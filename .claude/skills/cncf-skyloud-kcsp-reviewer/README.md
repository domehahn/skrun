...
7. Run `skcr validate` and `skcr asps coverage cncf-skyloud-kcsp-reviewer`.
8. Run `skcr compile cncf-skyloud-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-skyloud-kcsp-reviewer`.
...
```bash
skpm validate cncf-skyloud-kcsp-reviewer
skpm package cncf-skyloud-kcsp-reviewer
skpm publish cncf-skyloud-kcsp-reviewer
```
