...
7. Run `skcr validate` and `skcr asps coverage cncf-mia-platform-reviewer`.
8. Run `skcr compile cncf-mia-platform-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-mia-platform-reviewer`.
...
```bash
skpm validate cncf-mia-platform-reviewer
skpm package cncf-mia-platform-reviewer
skpm publish cncf-mia-platform-reviewer
```
