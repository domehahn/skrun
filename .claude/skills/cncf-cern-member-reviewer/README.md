...
7. Run `skcr validate` and `skcr asps coverage cncf-cern-member-reviewer`.
8. Run `skcr compile cncf-cern-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cern-member-reviewer`.
...
```bash
skpm validate cncf-cern-member-reviewer
skpm package cncf-cern-member-reviewer
skpm publish cncf-cern-member-reviewer
```
