...
7. Run `skcr validate` and `skcr asps coverage cncf-blakyaks-member-reviewer`.
8. Run `skcr compile cncf-blakyaks-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-blakyaks-member-reviewer`.
...
```bash
skpm validate cncf-blakyaks-member-reviewer
skpm package cncf-blakyaks-member-reviewer
skpm publish cncf-blakyaks-member-reviewer
```
