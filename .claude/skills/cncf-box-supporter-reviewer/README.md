...
7. Run `skcr validate` and `skcr asps coverage cncf-box-supporter-reviewer`.
8. Run `skcr compile cncf-box-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-box-supporter-reviewer`.
...
```bash
skpm validate cncf-box-supporter-reviewer
skpm package cncf-box-supporter-reviewer
skpm publish cncf-box-supporter-reviewer
```
