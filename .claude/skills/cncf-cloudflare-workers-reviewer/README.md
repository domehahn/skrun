...
7. Run `skcr validate` and `skcr asps coverage cncf-cloudflare-workers-reviewer`.
8. Run `skcr compile cncf-cloudflare-workers-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloudflare-workers-reviewer`.
...
```bash
skpm validate cncf-cloudflare-workers-reviewer
skpm package cncf-cloudflare-workers-reviewer
skpm publish cncf-cloudflare-workers-reviewer
```
