...
7. Run `skcr validate` and `skcr asps coverage finops-reviewer`.
8. Run `skcr compile finops-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend finops-reviewer`.
