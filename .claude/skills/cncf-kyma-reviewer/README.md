...
7. Run `skcr validate` and `skcr asps coverage cncf-kyma-reviewer`.
8. Run `skcr compile cncf-kyma-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kyma-reviewer`.
...
```bash
skpm validate cncf-kyma-reviewer
skpm package cncf-kyma-reviewer
skpm publish cncf-kyma-reviewer
```
