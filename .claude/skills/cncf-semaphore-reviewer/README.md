...
7. Run `skcr validate` and `skcr asps coverage cncf-semaphore-reviewer`.
8. Run `skcr compile cncf-semaphore-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-semaphore-reviewer`.
...
```bash
skpm validate cncf-semaphore-reviewer
skpm package cncf-semaphore-reviewer
skpm publish cncf-semaphore-reviewer
```
