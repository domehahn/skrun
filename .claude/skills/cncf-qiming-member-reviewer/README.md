...
7. Run `skcr validate` and `skcr asps coverage cncf-qiming-member-reviewer`.
8. Run `skcr compile cncf-qiming-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-qiming-member-reviewer`.
...
```bash
skpm validate cncf-qiming-member-reviewer
skpm package cncf-qiming-member-reviewer
skpm publish cncf-qiming-member-reviewer
```
