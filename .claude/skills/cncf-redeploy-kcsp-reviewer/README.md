...
7. Run `skcr validate` and `skcr asps coverage cncf-redeploy-kcsp-reviewer`.
8. Run `skcr compile cncf-redeploy-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-redeploy-kcsp-reviewer`.
...
```bash
skpm validate cncf-redeploy-kcsp-reviewer
skpm package cncf-redeploy-kcsp-reviewer
skpm publish cncf-redeploy-kcsp-reviewer
```
