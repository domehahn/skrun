...
7. Run `skcr validate` and `skcr asps coverage cncf-canonical-charmed-kubernetes-reviewer`.
8. Run `skcr compile cncf-canonical-charmed-kubernetes-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-canonical-charmed-kubernetes-reviewer`.
...
```bash
skpm validate cncf-canonical-charmed-kubernetes-reviewer
skpm package cncf-canonical-charmed-kubernetes-reviewer
skpm publish cncf-canonical-charmed-kubernetes-reviewer
```
