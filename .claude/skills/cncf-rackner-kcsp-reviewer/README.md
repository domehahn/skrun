...
7. Run `skcr validate` and `skcr asps coverage cncf-rackner-kcsp-reviewer`.
8. Run `skcr compile cncf-rackner-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-rackner-kcsp-reviewer`.
...
```bash
skpm validate cncf-rackner-kcsp-reviewer
skpm package cncf-rackner-kcsp-reviewer
skpm publish cncf-rackner-kcsp-reviewer
```
