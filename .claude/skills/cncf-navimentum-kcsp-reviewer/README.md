...
7. Run `skcr validate` and `skcr asps coverage cncf-navimentum-kcsp-reviewer`.
8. Run `skcr compile cncf-navimentum-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-navimentum-kcsp-reviewer`.
...
```bash
skpm validate cncf-navimentum-kcsp-reviewer
skpm package cncf-navimentum-kcsp-reviewer
skpm publish cncf-navimentum-kcsp-reviewer
```
