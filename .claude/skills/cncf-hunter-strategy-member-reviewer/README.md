...
7. Run `skcr validate` and `skcr asps coverage cncf-hunter-strategy-member-reviewer`.
8. Run `skcr compile cncf-hunter-strategy-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-hunter-strategy-member-reviewer`.
...
```bash
skpm validate cncf-hunter-strategy-member-reviewer
skpm package cncf-hunter-strategy-member-reviewer
skpm publish cncf-hunter-strategy-member-reviewer
```
