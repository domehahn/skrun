...
7. Run `skcr validate` and `skcr asps coverage cncf-sysbox-reviewer`.
8. Run `skcr compile cncf-sysbox-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sysbox-reviewer`.
...
```bash
skpm validate cncf-sysbox-reviewer
skpm package cncf-sysbox-reviewer
skpm publish cncf-sysbox-reviewer
```
