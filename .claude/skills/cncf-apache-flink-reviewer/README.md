...
7. Run `skcr validate` and `skcr asps coverage cncf-apache-flink-reviewer`.
8. Run `skcr compile cncf-apache-flink-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-apache-flink-reviewer`.
...
```bash
skpm validate cncf-apache-flink-reviewer
skpm package cncf-apache-flink-reviewer
skpm publish cncf-apache-flink-reviewer
```
