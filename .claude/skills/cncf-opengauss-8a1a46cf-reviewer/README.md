...
7. Run `skcr validate` and `skcr asps coverage cncf-opengauss-8a1a46cf-reviewer`.
8. Run `skcr compile cncf-opengauss-8a1a46cf-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-opengauss-8a1a46cf-reviewer`.
...
```bash
skpm validate cncf-opengauss-8a1a46cf-reviewer
skpm package cncf-opengauss-8a1a46cf-reviewer
skpm publish cncf-opengauss-8a1a46cf-reviewer
```
