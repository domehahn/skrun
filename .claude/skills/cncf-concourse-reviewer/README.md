...
7. Run `skcr validate` and `skcr asps coverage cncf-concourse-reviewer`.
8. Run `skcr compile cncf-concourse-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-concourse-reviewer`.
...
```bash
skpm validate cncf-concourse-reviewer
skpm package cncf-concourse-reviewer
skpm publish cncf-concourse-reviewer
```
