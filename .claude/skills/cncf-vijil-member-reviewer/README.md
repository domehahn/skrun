...
7. Run `skcr validate` and `skcr asps coverage cncf-vijil-member-reviewer`.
8. Run `skcr compile cncf-vijil-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-vijil-member-reviewer`.
...
```bash
skpm validate cncf-vijil-member-reviewer
skpm package cncf-vijil-member-reviewer
skpm publish cncf-vijil-member-reviewer
```
