...
7. Run `skcr validate` and `skcr asps coverage cncf-hydrolix-member-reviewer`.
8. Run `skcr compile cncf-hydrolix-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-hydrolix-member-reviewer`.
...
```bash
skpm validate cncf-hydrolix-member-reviewer
skpm package cncf-hydrolix-member-reviewer
skpm publish cncf-hydrolix-member-reviewer
```
