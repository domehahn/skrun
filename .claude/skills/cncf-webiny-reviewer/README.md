...
7. Run `skcr validate` and `skcr asps coverage cncf-webiny-reviewer`.
8. Run `skcr compile cncf-webiny-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-webiny-reviewer`.
...
```bash
skpm validate cncf-webiny-reviewer
skpm package cncf-webiny-reviewer
skpm publish cncf-webiny-reviewer
```
