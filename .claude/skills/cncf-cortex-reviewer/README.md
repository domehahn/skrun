...
7. Run `skcr validate` and `skcr asps coverage cncf-cortex-reviewer`.
8. Run `skcr compile cncf-cortex-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cortex-reviewer`.
...
```bash
skpm validate cncf-cortex-reviewer
skpm package cncf-cortex-reviewer
skpm publish cncf-cortex-reviewer
```
