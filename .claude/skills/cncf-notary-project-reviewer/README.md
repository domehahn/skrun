...
7. Run `skcr validate` and `skcr asps coverage cncf-notary-project-reviewer`.
8. Run `skcr compile cncf-notary-project-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-notary-project-reviewer`.
...
```bash
skpm validate cncf-notary-project-reviewer
skpm package cncf-notary-project-reviewer
skpm publish cncf-notary-project-reviewer
```
