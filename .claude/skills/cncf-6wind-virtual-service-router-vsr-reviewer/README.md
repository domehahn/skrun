...
7. Run `skcr validate` and `skcr asps coverage cncf-6wind-virtual-service-router-vsr-reviewer`.
8. Run `skcr compile cncf-6wind-virtual-service-router-vsr-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-6wind-virtual-service-router-vsr-reviewer`.
...
```bash
skpm validate cncf-6wind-virtual-service-router-vsr-reviewer
skpm package cncf-6wind-virtual-service-router-vsr-reviewer
skpm publish cncf-6wind-virtual-service-router-vsr-reviewer
```
