...
7. Run `skcr validate` and `skcr asps coverage cncf-excellion-sdn-bhd-member-reviewer`.
8. Run `skcr compile cncf-excellion-sdn-bhd-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-excellion-sdn-bhd-member-reviewer`.
...
```bash
skpm validate cncf-excellion-sdn-bhd-member-reviewer
skpm package cncf-excellion-sdn-bhd-member-reviewer
skpm publish cncf-excellion-sdn-bhd-member-reviewer
```
