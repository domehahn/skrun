...
7. Run `skcr validate` and `skcr asps coverage cncf-cloudmatos-reviewer`.
8. Run `skcr compile cncf-cloudmatos-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloudmatos-reviewer`.
...
```bash
skpm validate cncf-cloudmatos-reviewer
skpm package cncf-cloudmatos-reviewer
skpm publish cncf-cloudmatos-reviewer
```
