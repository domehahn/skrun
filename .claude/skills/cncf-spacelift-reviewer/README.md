...
7. Run `skcr validate` and `skcr asps coverage cncf-spacelift-reviewer`.
8. Run `skcr compile cncf-spacelift-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-spacelift-reviewer`.
...
```bash
skpm validate cncf-spacelift-reviewer
skpm package cncf-spacelift-reviewer
skpm publish cncf-spacelift-reviewer
```
