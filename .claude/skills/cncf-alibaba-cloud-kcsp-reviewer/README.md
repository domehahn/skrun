...
7. Run `skcr validate` and `skcr asps coverage cncf-alibaba-cloud-kcsp-reviewer`.
8. Run `skcr compile cncf-alibaba-cloud-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-alibaba-cloud-kcsp-reviewer`.
...
```bash
skpm validate cncf-alibaba-cloud-kcsp-reviewer
skpm package cncf-alibaba-cloud-kcsp-reviewer
skpm publish cncf-alibaba-cloud-kcsp-reviewer
```
