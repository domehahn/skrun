...
7. Run `skcr validate` and `skcr asps coverage cncf-sap-certified-gardener-reviewer`.
8. Run `skcr compile cncf-sap-certified-gardener-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sap-certified-gardener-reviewer`.
...
```bash
skpm validate cncf-sap-certified-gardener-reviewer
skpm package cncf-sap-certified-gardener-reviewer
skpm publish cncf-sap-certified-gardener-reviewer
```
