...
7. Run `skcr validate` and `skcr asps coverage cncf-canonical-kcsp-reviewer`.
8. Run `skcr compile cncf-canonical-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-canonical-kcsp-reviewer`.
...
```bash
skpm validate cncf-canonical-kcsp-reviewer
skpm package cncf-canonical-kcsp-reviewer
skpm publish cncf-canonical-kcsp-reviewer
```
