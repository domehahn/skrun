...
7. Run `skcr validate` and `skcr asps coverage payment-operations-agent`.
8. Run `skcr compile payment-operations-agent --target skil`.
9. Run `skcr sync` and `skcr version recommend payment-operations-agent`.
...
```bash
skpm validate payment-operations-agent
skpm package payment-operations-agent
skpm publish payment-operations-agent
```
