...
7. Run `skcr validate` and `skcr asps coverage cncf-ovhcloud-member-reviewer`.
8. Run `skcr compile cncf-ovhcloud-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ovhcloud-member-reviewer`.
...
```bash
skpm validate cncf-ovhcloud-member-reviewer
skpm package cncf-ovhcloud-member-reviewer
skpm publish cncf-ovhcloud-member-reviewer
```
