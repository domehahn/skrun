...
7. Run `skcr validate` and `skcr asps coverage cncf-shardingsphere-reviewer`.
8. Run `skcr compile cncf-shardingsphere-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-shardingsphere-reviewer`.
...
```bash
skpm validate cncf-shardingsphere-reviewer
skpm package cncf-shardingsphere-reviewer
skpm publish cncf-shardingsphere-reviewer
```
