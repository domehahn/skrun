...
7. Run `skcr validate` and `skcr asps coverage cncf-datagalaxy-supporter-reviewer`.
8. Run `skcr compile cncf-datagalaxy-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-datagalaxy-supporter-reviewer`.
...
```bash
skpm validate cncf-datagalaxy-supporter-reviewer
skpm package cncf-datagalaxy-supporter-reviewer
skpm publish cncf-datagalaxy-supporter-reviewer
```
