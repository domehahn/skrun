...
7. Run `skcr validate` and `skcr asps coverage cncf-agola-reviewer`.
8. Run `skcr compile cncf-agola-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-agola-reviewer`.
...
```bash
skpm validate cncf-agola-reviewer
skpm package cncf-agola-reviewer
skpm publish cncf-agola-reviewer
```
