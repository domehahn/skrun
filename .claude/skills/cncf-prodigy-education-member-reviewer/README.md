...
7. Run `skcr validate` and `skcr asps coverage cncf-prodigy-education-member-reviewer`.
8. Run `skcr compile cncf-prodigy-education-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-prodigy-education-member-reviewer`.
...
```bash
skpm validate cncf-prodigy-education-member-reviewer
skpm package cncf-prodigy-education-member-reviewer
skpm publish cncf-prodigy-education-member-reviewer
```
