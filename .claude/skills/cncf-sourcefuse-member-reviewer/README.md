...
7. Run `skcr validate` and `skcr asps coverage cncf-sourcefuse-member-reviewer`.
8. Run `skcr compile cncf-sourcefuse-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sourcefuse-member-reviewer`.
...
```bash
skpm validate cncf-sourcefuse-member-reviewer
skpm package cncf-sourcefuse-member-reviewer
skpm publish cncf-sourcefuse-member-reviewer
```
