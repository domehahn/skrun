...
7. Run `skcr validate` and `skcr asps coverage cncf-nokia-member-reviewer`.
8. Run `skcr compile cncf-nokia-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nokia-member-reviewer`.
...
```bash
skpm validate cncf-nokia-member-reviewer
skpm package cncf-nokia-member-reviewer
skpm publish cncf-nokia-member-reviewer
```
