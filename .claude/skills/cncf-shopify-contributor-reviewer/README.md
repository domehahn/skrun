...
7. Run `skcr validate` and `skcr asps coverage cncf-shopify-contributor-reviewer`.
8. Run `skcr compile cncf-shopify-contributor-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-shopify-contributor-reviewer`.
...
```bash
skpm validate cncf-shopify-contributor-reviewer
skpm package cncf-shopify-contributor-reviewer
skpm publish cncf-shopify-contributor-reviewer
```
