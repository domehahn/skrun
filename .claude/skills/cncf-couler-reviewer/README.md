...
7. Run `skcr validate` and `skcr asps coverage cncf-couler-reviewer`.
8. Run `skcr compile cncf-couler-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-couler-reviewer`.
...
```bash
skpm validate cncf-couler-reviewer
skpm package cncf-couler-reviewer
skpm publish cncf-couler-reviewer
```
