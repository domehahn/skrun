...
7. Run `skcr validate` and `skcr asps coverage cncf-wasmcloud-wasm-reviewer`.
8. Run `skcr compile cncf-wasmcloud-wasm-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-wasmcloud-wasm-reviewer`.
...
```bash
skpm validate cncf-wasmcloud-wasm-reviewer
skpm package cncf-wasmcloud-wasm-reviewer
skpm publish cncf-wasmcloud-wasm-reviewer
```
