...
7. Run `skcr validate` and `skcr asps coverage cncf-tanka-reviewer`.
8. Run `skcr compile cncf-tanka-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-tanka-reviewer`.
...
```bash
skpm validate cncf-tanka-reviewer
skpm package cncf-tanka-reviewer
skpm publish cncf-tanka-reviewer
```
