...
7. Run `skcr validate` and `skcr asps coverage cncf-bytesource-member-reviewer`.
8. Run `skcr compile cncf-bytesource-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-bytesource-member-reviewer`.
...
```bash
skpm validate cncf-bytesource-member-reviewer
skpm package cncf-bytesource-member-reviewer
skpm publish cncf-bytesource-member-reviewer
```
