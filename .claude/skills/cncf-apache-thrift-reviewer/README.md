...
7. Run `skcr validate` and `skcr asps coverage cncf-apache-thrift-reviewer`.
8. Run `skcr compile cncf-apache-thrift-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-apache-thrift-reviewer`.
...
```bash
skpm validate cncf-apache-thrift-reviewer
skpm package cncf-apache-thrift-reviewer
skpm publish cncf-apache-thrift-reviewer
```
