...
7. Run `skcr validate` and `skcr asps coverage cncf-lightrun-reviewer`.
8. Run `skcr compile cncf-lightrun-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-lightrun-reviewer`.
...
```bash
skpm validate cncf-lightrun-reviewer
skpm package cncf-lightrun-reviewer
skpm publish cncf-lightrun-reviewer
```
