...
7. Run `skcr validate` and `skcr asps coverage cncf-project-syn-reviewer`.
8. Run `skcr compile cncf-project-syn-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-project-syn-reviewer`.
...
```bash
skpm validate cncf-project-syn-reviewer
skpm package cncf-project-syn-reviewer
skpm publish cncf-project-syn-reviewer
```
