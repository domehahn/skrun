...
7. Run `skcr validate` and `skcr asps coverage cncf-whitestack-whitemist-reviewer`.
8. Run `skcr compile cncf-whitestack-whitemist-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-whitestack-whitemist-reviewer`.
...
```bash
skpm validate cncf-whitestack-whitemist-reviewer
skpm package cncf-whitestack-whitemist-reviewer
skpm publish cncf-whitestack-whitemist-reviewer
```
