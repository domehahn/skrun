...
7. Run `skcr validate` and `skcr asps coverage cncf-k8gb-reviewer`.
8. Run `skcr compile cncf-k8gb-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-k8gb-reviewer`.
...
```bash
skpm validate cncf-k8gb-reviewer
skpm package cncf-k8gb-reviewer
skpm publish cncf-k8gb-reviewer
```
