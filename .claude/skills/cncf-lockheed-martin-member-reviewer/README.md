...
7. Run `skcr validate` and `skcr asps coverage cncf-lockheed-martin-member-reviewer`.
8. Run `skcr compile cncf-lockheed-martin-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-lockheed-martin-member-reviewer`.
...
```bash
skpm validate cncf-lockheed-martin-member-reviewer
skpm package cncf-lockheed-martin-member-reviewer
skpm publish cncf-lockheed-martin-member-reviewer
```
