...
7. Run `skcr validate` and `skcr asps coverage cncf-falcon-reviewer`.
8. Run `skcr compile cncf-falcon-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-falcon-reviewer`.
...
```bash
skpm validate cncf-falcon-reviewer
skpm package cncf-falcon-reviewer
skpm publish cncf-falcon-reviewer
```
