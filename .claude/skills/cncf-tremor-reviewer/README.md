...
7. Run `skcr validate` and `skcr asps coverage cncf-tremor-reviewer`.
8. Run `skcr compile cncf-tremor-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-tremor-reviewer`.
...
```bash
skpm validate cncf-tremor-reviewer
skpm package cncf-tremor-reviewer
skpm publish cncf-tremor-reviewer
```
