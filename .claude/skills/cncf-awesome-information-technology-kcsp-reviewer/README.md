...
7. Run `skcr validate` and `skcr asps coverage cncf-awesome-information-technology-kcsp-reviewer`.
8. Run `skcr compile cncf-awesome-information-technology-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-awesome-information-technology-kcsp-reviewer`.
...
```bash
skpm validate cncf-awesome-information-technology-kcsp-reviewer
skpm package cncf-awesome-information-technology-kcsp-reviewer
skpm publish cncf-awesome-information-technology-kcsp-reviewer
```
