...
7. Run `skcr validate` and `skcr asps coverage cncf-crew-ai-reviewer`.
8. Run `skcr compile cncf-crew-ai-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-crew-ai-reviewer`.
...
```bash
skpm validate cncf-crew-ai-reviewer
skpm package cncf-crew-ai-reviewer
skpm publish cncf-crew-ai-reviewer
```
