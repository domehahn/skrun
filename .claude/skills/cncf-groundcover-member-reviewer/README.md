...
7. Run `skcr validate` and `skcr asps coverage cncf-groundcover-member-reviewer`.
8. Run `skcr compile cncf-groundcover-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-groundcover-member-reviewer`.
...
```bash
skpm validate cncf-groundcover-member-reviewer
skpm package cncf-groundcover-member-reviewer
skpm publish cncf-groundcover-member-reviewer
```
