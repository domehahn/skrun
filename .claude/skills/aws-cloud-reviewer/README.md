...
7. Run `skcr validate` and `skcr asps coverage aws-cloud-reviewer`.
8. Run `skcr compile aws-cloud-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend aws-cloud-reviewer`.
...
```bash
skpm validate aws-cloud-reviewer
skpm package aws-cloud-reviewer
skpm publish aws-cloud-reviewer
```
