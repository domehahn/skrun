...
7. Run `skcr validate` and `skcr asps coverage cncf-keploy-reviewer`.
8. Run `skcr compile cncf-keploy-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-keploy-reviewer`.
...
```bash
skpm validate cncf-keploy-reviewer
skpm package cncf-keploy-reviewer
skpm publish cncf-keploy-reviewer
```
