...
7. Run `skcr validate` and `skcr asps coverage cncf-google-cloud-member-reviewer`.
8. Run `skcr compile cncf-google-cloud-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-google-cloud-member-reviewer`.
...
```bash
skpm validate cncf-google-cloud-member-reviewer
skpm package cncf-google-cloud-member-reviewer
skpm publish cncf-google-cloud-member-reviewer
```
