...
7. Run `skcr validate` and `skcr asps coverage cncf-iits-consulting-kcsp-reviewer`.
8. Run `skcr compile cncf-iits-consulting-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-iits-consulting-kcsp-reviewer`.
...
```bash
skpm validate cncf-iits-consulting-kcsp-reviewer
skpm package cncf-iits-consulting-kcsp-reviewer
skpm publish cncf-iits-consulting-kcsp-reviewer
```
