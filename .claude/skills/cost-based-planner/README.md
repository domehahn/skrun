...
7. Run `skcr validate` and `skcr asps coverage cost-based-planner`.
8. Run `skcr compile cost-based-planner --target skil`.
9. Run `skcr sync` and `skcr version recommend cost-based-planner`.
