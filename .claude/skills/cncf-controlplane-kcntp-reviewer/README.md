...
7. Run `skcr validate` and `skcr asps coverage cncf-controlplane-kcntp-reviewer`.
8. Run `skcr compile cncf-controlplane-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-controlplane-kcntp-reviewer`.
...
```bash
skpm validate cncf-controlplane-kcntp-reviewer
skpm package cncf-controlplane-kcntp-reviewer
skpm publish cncf-controlplane-kcntp-reviewer
```
