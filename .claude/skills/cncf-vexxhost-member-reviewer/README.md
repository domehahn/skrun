...
7. Run `skcr validate` and `skcr asps coverage cncf-vexxhost-member-reviewer`.
8. Run `skcr compile cncf-vexxhost-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-vexxhost-member-reviewer`.
...
```bash
skpm validate cncf-vexxhost-member-reviewer
skpm package cncf-vexxhost-member-reviewer
skpm publish cncf-vexxhost-member-reviewer
```
