...
7. Run `skcr validate` and `skcr asps coverage cncf-amutable-member-reviewer`.
8. Run `skcr compile cncf-amutable-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-amutable-member-reviewer`.
...
```bash
skpm validate cncf-amutable-member-reviewer
skpm package cncf-amutable-member-reviewer
skpm publish cncf-amutable-member-reviewer
```
