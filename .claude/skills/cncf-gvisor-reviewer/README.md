...
7. Run `skcr validate` and `skcr asps coverage cncf-gvisor-reviewer`.
8. Run `skcr compile cncf-gvisor-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-gvisor-reviewer`.
...
```bash
skpm validate cncf-gvisor-reviewer
skpm package cncf-gvisor-reviewer
skpm publish cncf-gvisor-reviewer
```
