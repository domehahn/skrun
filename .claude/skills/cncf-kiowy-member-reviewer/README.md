...
7. Run `skcr validate` and `skcr asps coverage cncf-kiowy-member-reviewer`.
8. Run `skcr compile cncf-kiowy-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kiowy-member-reviewer`.
...
```bash
skpm validate cncf-kiowy-member-reviewer
skpm package cncf-kiowy-member-reviewer
skpm publish cncf-kiowy-member-reviewer
```
