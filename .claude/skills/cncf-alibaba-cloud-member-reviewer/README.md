...
7. Run `skcr validate` and `skcr asps coverage cncf-alibaba-cloud-member-reviewer`.
8. Run `skcr compile cncf-alibaba-cloud-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-alibaba-cloud-member-reviewer`.
...
```bash
skpm validate cncf-alibaba-cloud-member-reviewer
skpm package cncf-alibaba-cloud-member-reviewer
skpm publish cncf-alibaba-cloud-member-reviewer
```
