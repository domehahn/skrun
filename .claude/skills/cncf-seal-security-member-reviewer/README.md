...
7. Run `skcr validate` and `skcr asps coverage cncf-seal-security-member-reviewer`.
8. Run `skcr compile cncf-seal-security-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-seal-security-member-reviewer`.
...
```bash
skpm validate cncf-seal-security-member-reviewer
skpm package cncf-seal-security-member-reviewer
skpm publish cncf-seal-security-member-reviewer
```
