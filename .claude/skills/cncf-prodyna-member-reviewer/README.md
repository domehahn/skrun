...
7. Run `skcr validate` and `skcr asps coverage cncf-prodyna-member-reviewer`.
8. Run `skcr compile cncf-prodyna-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-prodyna-member-reviewer`.
...
```bash
skpm validate cncf-prodyna-member-reviewer
skpm package cncf-prodyna-member-reviewer
skpm publish cncf-prodyna-member-reviewer
```
