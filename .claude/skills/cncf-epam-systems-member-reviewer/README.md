...
7. Run `skcr validate` and `skcr asps coverage cncf-epam-systems-member-reviewer`.
8. Run `skcr compile cncf-epam-systems-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-epam-systems-member-reviewer`.
...
```bash
skpm validate cncf-epam-systems-member-reviewer
skpm package cncf-epam-systems-member-reviewer
skpm publish cncf-epam-systems-member-reviewer
```
