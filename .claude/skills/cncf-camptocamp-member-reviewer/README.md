...
7. Run `skcr validate` and `skcr asps coverage cncf-camptocamp-member-reviewer`.
8. Run `skcr compile cncf-camptocamp-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-camptocamp-member-reviewer`.
...
```bash
skpm validate cncf-camptocamp-member-reviewer
skpm package cncf-camptocamp-member-reviewer
skpm publish cncf-camptocamp-member-reviewer
```
