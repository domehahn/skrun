...
7. Run `skcr validate` and `skcr asps coverage cncf-cloudark-kubeplus-reviewer`.
8. Run `skcr compile cncf-cloudark-kubeplus-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloudark-kubeplus-reviewer`.
...
```bash
skpm validate cncf-cloudark-kubeplus-reviewer
skpm package cncf-cloudark-kubeplus-reviewer
skpm publish cncf-cloudark-kubeplus-reviewer
```
