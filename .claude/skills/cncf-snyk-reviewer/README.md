...
7. Run `skcr validate` and `skcr asps coverage cncf-snyk-reviewer`.
8. Run `skcr compile cncf-snyk-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-snyk-reviewer`.
...
```bash
skpm validate cncf-snyk-reviewer
skpm package cncf-snyk-reviewer
skpm publish cncf-snyk-reviewer
```
