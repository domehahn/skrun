...
7. Run `skcr validate` and `skcr asps coverage cncf-doit-kcntp-reviewer`.
8. Run `skcr compile cncf-doit-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-doit-kcntp-reviewer`.
...
```bash
skpm validate cncf-doit-kcntp-reviewer
skpm package cncf-doit-kcntp-reviewer
skpm publish cncf-doit-kcntp-reviewer
```
