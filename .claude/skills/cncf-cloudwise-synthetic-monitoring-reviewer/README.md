...
7. Run `skcr validate` and `skcr asps coverage cncf-cloudwise-synthetic-monitoring-reviewer`.
8. Run `skcr compile cncf-cloudwise-synthetic-monitoring-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloudwise-synthetic-monitoring-reviewer`.
...
```bash
skpm validate cncf-cloudwise-synthetic-monitoring-reviewer
skpm package cncf-cloudwise-synthetic-monitoring-reviewer
skpm publish cncf-cloudwise-synthetic-monitoring-reviewer
```
