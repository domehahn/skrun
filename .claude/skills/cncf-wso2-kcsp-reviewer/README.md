...
7. Run `skcr validate` and `skcr asps coverage cncf-wso2-kcsp-reviewer`.
8. Run `skcr compile cncf-wso2-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-wso2-kcsp-reviewer`.
...
```bash
skpm validate cncf-wso2-kcsp-reviewer
skpm package cncf-wso2-kcsp-reviewer
skpm publish cncf-wso2-kcsp-reviewer
```
