...
7. Run `skcr validate` and `skcr asps coverage cncf-wasmcloud-reviewer`.
8. Run `skcr compile cncf-wasmcloud-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-wasmcloud-reviewer`.
...
```bash
skpm validate cncf-wasmcloud-reviewer
skpm package cncf-wasmcloud-reviewer
skpm publish cncf-wasmcloud-reviewer
```
