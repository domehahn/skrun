...
7. Run `skcr validate` and `skcr asps coverage cncf-volcano-kthena-reviewer`.
8. Run `skcr compile cncf-volcano-kthena-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-volcano-kthena-reviewer`.
...
```bash
skpm validate cncf-volcano-kthena-reviewer
skpm package cncf-volcano-kthena-reviewer
skpm publish cncf-volcano-kthena-reviewer
```
