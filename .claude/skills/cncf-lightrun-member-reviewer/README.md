...
7. Run `skcr validate` and `skcr asps coverage cncf-lightrun-member-reviewer`.
8. Run `skcr compile cncf-lightrun-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-lightrun-member-reviewer`.
...
```bash
skpm validate cncf-lightrun-member-reviewer
skpm package cncf-lightrun-member-reviewer
skpm publish cncf-lightrun-member-reviewer
```
