...
7. Run `skcr validate` and `skcr asps coverage cncf-profisea-member-reviewer`.
8. Run `skcr compile cncf-profisea-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-profisea-member-reviewer`.
...
```bash
skpm validate cncf-profisea-member-reviewer
skpm package cncf-profisea-member-reviewer
skpm publish cncf-profisea-member-reviewer
```
