...
7. Run `skcr validate` and `skcr asps coverage cncf-docker-hub-reviewer`.
8. Run `skcr compile cncf-docker-hub-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-docker-hub-reviewer`.
...
```bash
skpm validate cncf-docker-hub-reviewer
skpm package cncf-docker-hub-reviewer
skpm publish cncf-docker-hub-reviewer
```
