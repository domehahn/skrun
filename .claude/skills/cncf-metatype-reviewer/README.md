...
7. Run `skcr validate` and `skcr asps coverage cncf-metatype-reviewer`.
8. Run `skcr compile cncf-metatype-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-metatype-reviewer`.
...
```bash
skpm validate cncf-metatype-reviewer
skpm package cncf-metatype-reviewer
skpm publish cncf-metatype-reviewer
```
