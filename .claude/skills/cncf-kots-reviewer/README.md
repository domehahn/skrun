...
7. Run `skcr validate` and `skcr asps coverage cncf-kots-reviewer`.
8. Run `skcr compile cncf-kots-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kots-reviewer`.
...
```bash
skpm validate cncf-kots-reviewer
skpm package cncf-kots-reviewer
skpm publish cncf-kots-reviewer
```
