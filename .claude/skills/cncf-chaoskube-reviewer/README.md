...
7. Run `skcr validate` and `skcr asps coverage cncf-chaoskube-reviewer`.
8. Run `skcr compile cncf-chaoskube-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-chaoskube-reviewer`.
...
```bash
skpm validate cncf-chaoskube-reviewer
skpm package cncf-chaoskube-reviewer
skpm publish cncf-chaoskube-reviewer
```
