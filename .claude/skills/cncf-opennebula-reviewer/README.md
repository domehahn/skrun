...
7. Run `skcr validate` and `skcr asps coverage cncf-opennebula-reviewer`.
8. Run `skcr compile cncf-opennebula-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-opennebula-reviewer`.
...
```bash
skpm validate cncf-opennebula-reviewer
skpm package cncf-opennebula-reviewer
skpm publish cncf-opennebula-reviewer
```
