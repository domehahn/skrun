...
7. Run `skcr validate` and `skcr asps coverage cncf-leminnov-kcsp-reviewer`.
8. Run `skcr compile cncf-leminnov-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-leminnov-kcsp-reviewer`.
...
```bash
skpm validate cncf-leminnov-kcsp-reviewer
skpm package cncf-leminnov-kcsp-reviewer
skpm publish cncf-leminnov-kcsp-reviewer
```
