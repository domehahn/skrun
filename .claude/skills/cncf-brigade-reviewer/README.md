...
7. Run `skcr validate` and `skcr asps coverage cncf-brigade-reviewer`.
8. Run `skcr compile cncf-brigade-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-brigade-reviewer`.
...
```bash
skpm validate cncf-brigade-reviewer
skpm package cncf-brigade-reviewer
skpm publish cncf-brigade-reviewer
```
