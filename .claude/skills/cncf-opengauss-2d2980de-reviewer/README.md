...
7. Run `skcr validate` and `skcr asps coverage cncf-opengauss-2d2980de-reviewer`.
8. Run `skcr compile cncf-opengauss-2d2980de-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-opengauss-2d2980de-reviewer`.
...
```bash
skpm validate cncf-opengauss-2d2980de-reviewer
skpm package cncf-opengauss-2d2980de-reviewer
skpm publish cncf-opengauss-2d2980de-reviewer
```
