...
7. Run `skcr validate` and `skcr asps coverage cncf-stacklok-member-reviewer`.
8. Run `skcr compile cncf-stacklok-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-stacklok-member-reviewer`.
...
```bash
skpm validate cncf-stacklok-member-reviewer
skpm package cncf-stacklok-member-reviewer
skpm publish cncf-stacklok-member-reviewer
```
