...
7. Run `skcr validate` and `skcr asps coverage cncf-aoe-kcsp-reviewer`.
8. Run `skcr compile cncf-aoe-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-aoe-kcsp-reviewer`.
...
```bash
skpm validate cncf-aoe-kcsp-reviewer
skpm package cncf-aoe-kcsp-reviewer
skpm publish cncf-aoe-kcsp-reviewer
```
