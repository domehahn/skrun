...
7. Run `skcr validate` and `skcr asps coverage cncf-astron-agent-reviewer`.
8. Run `skcr compile cncf-astron-agent-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-astron-agent-reviewer`.
...
```bash
skpm validate cncf-astron-agent-reviewer
skpm package cncf-astron-agent-reviewer
skpm publish cncf-astron-agent-reviewer
```
