...
7. Run `skcr validate` and `skcr asps coverage cncf-kudo-reviewer`.
8. Run `skcr compile cncf-kudo-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kudo-reviewer`.
...
```bash
skpm validate cncf-kudo-reviewer
skpm package cncf-kudo-reviewer
skpm publish cncf-kudo-reviewer
```
