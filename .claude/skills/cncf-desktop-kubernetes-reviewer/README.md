...
7. Run `skcr validate` and `skcr asps coverage cncf-desktop-kubernetes-reviewer`.
8. Run `skcr compile cncf-desktop-kubernetes-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-desktop-kubernetes-reviewer`.
...
```bash
skpm validate cncf-desktop-kubernetes-reviewer
skpm package cncf-desktop-kubernetes-reviewer
skpm publish cncf-desktop-kubernetes-reviewer
```
