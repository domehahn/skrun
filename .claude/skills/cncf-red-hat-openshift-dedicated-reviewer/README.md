...
7. Run `skcr validate` and `skcr asps coverage cncf-red-hat-openshift-dedicated-reviewer`.
8. Run `skcr compile cncf-red-hat-openshift-dedicated-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-red-hat-openshift-dedicated-reviewer`.
...
```bash
skpm validate cncf-red-hat-openshift-dedicated-reviewer
skpm package cncf-red-hat-openshift-dedicated-reviewer
skpm publish cncf-red-hat-openshift-dedicated-reviewer
```
