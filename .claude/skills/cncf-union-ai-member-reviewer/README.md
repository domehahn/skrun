...
7. Run `skcr validate` and `skcr asps coverage cncf-union-ai-member-reviewer`.
8. Run `skcr compile cncf-union-ai-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-union-ai-member-reviewer`.
...
```bash
skpm validate cncf-union-ai-member-reviewer
skpm package cncf-union-ai-member-reviewer
skpm publish cncf-union-ai-member-reviewer
```
