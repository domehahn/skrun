...
7. Run `skcr validate` and `skcr asps coverage cncf-azure-functions-reviewer`.
8. Run `skcr compile cncf-azure-functions-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-azure-functions-reviewer`.
...
```bash
skpm validate cncf-azure-functions-reviewer
skpm package cncf-azure-functions-reviewer
skpm publish cncf-azure-functions-reviewer
```
