...
7. Run `skcr validate` and `skcr asps coverage cncf-unicom-cloud-kcsp-reviewer`.
8. Run `skcr compile cncf-unicom-cloud-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-unicom-cloud-kcsp-reviewer`.
...
```bash
skpm validate cncf-unicom-cloud-kcsp-reviewer
skpm package cncf-unicom-cloud-kcsp-reviewer
skpm publish cncf-unicom-cloud-kcsp-reviewer
```
