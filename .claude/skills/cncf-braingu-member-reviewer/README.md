...
7. Run `skcr validate` and `skcr asps coverage cncf-braingu-member-reviewer`.
8. Run `skcr compile cncf-braingu-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-braingu-member-reviewer`.
...
```bash
skpm validate cncf-braingu-member-reviewer
skpm package cncf-braingu-member-reviewer
skpm publish cncf-braingu-member-reviewer
```
