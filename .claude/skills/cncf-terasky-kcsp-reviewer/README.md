...
7. Run `skcr validate` and `skcr asps coverage cncf-terasky-kcsp-reviewer`.
8. Run `skcr compile cncf-terasky-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-terasky-kcsp-reviewer`.
...
```bash
skpm validate cncf-terasky-kcsp-reviewer
skpm package cncf-terasky-kcsp-reviewer
skpm publish cncf-terasky-kcsp-reviewer
```
