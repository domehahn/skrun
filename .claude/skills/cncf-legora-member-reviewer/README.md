...
7. Run `skcr validate` and `skcr asps coverage cncf-legora-member-reviewer`.
8. Run `skcr compile cncf-legora-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-legora-member-reviewer`.
...
```bash
skpm validate cncf-legora-member-reviewer
skpm package cncf-legora-member-reviewer
skpm publish cncf-legora-member-reviewer
```
