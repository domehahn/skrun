...
7. Run `skcr validate` and `skcr asps coverage cncf-airbnb-member-reviewer`.
8. Run `skcr compile cncf-airbnb-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-airbnb-member-reviewer`.
...
```bash
skpm validate cncf-airbnb-member-reviewer
skpm package cncf-airbnb-member-reviewer
skpm publish cncf-airbnb-member-reviewer
```
