...
7. Run `skcr validate` and `skcr asps coverage cncf-scaleops-member-reviewer`.
8. Run `skcr compile cncf-scaleops-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-scaleops-member-reviewer`.
...
```bash
skpm validate cncf-scaleops-member-reviewer
skpm package cncf-scaleops-member-reviewer
skpm publish cncf-scaleops-member-reviewer
```
