...
7. Run `skcr validate` and `skcr asps coverage cncf-surrealdb-member-reviewer`.
8. Run `skcr compile cncf-surrealdb-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-surrealdb-member-reviewer`.
...
```bash
skpm validate cncf-surrealdb-member-reviewer
skpm package cncf-surrealdb-member-reviewer
skpm publish cncf-surrealdb-member-reviewer
```
