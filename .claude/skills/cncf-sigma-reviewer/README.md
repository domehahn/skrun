...
7. Run `skcr validate` and `skcr asps coverage cncf-sigma-reviewer`.
8. Run `skcr compile cncf-sigma-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sigma-reviewer`.
...
```bash
skpm validate cncf-sigma-reviewer
skpm package cncf-sigma-reviewer
skpm publish cncf-sigma-reviewer
```
