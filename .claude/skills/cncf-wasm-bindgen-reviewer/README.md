...
7. Run `skcr validate` and `skcr asps coverage cncf-wasm-bindgen-reviewer`.
8. Run `skcr compile cncf-wasm-bindgen-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-wasm-bindgen-reviewer`.
...
```bash
skpm validate cncf-wasm-bindgen-reviewer
skpm package cncf-wasm-bindgen-reviewer
skpm publish cncf-wasm-bindgen-reviewer
```
