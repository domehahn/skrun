...
7. Run `skcr validate` and `skcr asps coverage cncf-appsignal-reviewer`.
8. Run `skcr compile cncf-appsignal-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-appsignal-reviewer`.
...
```bash
skpm validate cncf-appsignal-reviewer
skpm package cncf-appsignal-reviewer
skpm publish cncf-appsignal-reviewer
```
