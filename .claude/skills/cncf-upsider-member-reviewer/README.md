...
7. Run `skcr validate` and `skcr asps coverage cncf-upsider-member-reviewer`.
8. Run `skcr compile cncf-upsider-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-upsider-member-reviewer`.
...
```bash
skpm validate cncf-upsider-member-reviewer
skpm package cncf-upsider-member-reviewer
skpm publish cncf-upsider-member-reviewer
```
