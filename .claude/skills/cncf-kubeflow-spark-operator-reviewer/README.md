...
7. Run `skcr validate` and `skcr asps coverage cncf-kubeflow-spark-operator-reviewer`.
8. Run `skcr compile cncf-kubeflow-spark-operator-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kubeflow-spark-operator-reviewer`.
...
```bash
skpm validate cncf-kubeflow-spark-operator-reviewer
skpm package cncf-kubeflow-spark-operator-reviewer
skpm publish cncf-kubeflow-spark-operator-reviewer
```
