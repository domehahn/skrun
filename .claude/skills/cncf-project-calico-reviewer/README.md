...
7. Run `skcr validate` and `skcr asps coverage cncf-project-calico-reviewer`.
8. Run `skcr compile cncf-project-calico-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-project-calico-reviewer`.
...
```bash
skpm validate cncf-project-calico-reviewer
skpm package cncf-project-calico-reviewer
skpm publish cncf-project-calico-reviewer
```
