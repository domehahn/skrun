...
7. Run `skcr validate` and `skcr asps coverage cncf-wand-cloud-member-reviewer`.
8. Run `skcr compile cncf-wand-cloud-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-wand-cloud-member-reviewer`.
...
```bash
skpm validate cncf-wand-cloud-member-reviewer
skpm package cncf-wand-cloud-member-reviewer
skpm publish cncf-wand-cloud-member-reviewer
```
