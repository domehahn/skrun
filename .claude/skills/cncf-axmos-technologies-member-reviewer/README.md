...
7. Run `skcr validate` and `skcr asps coverage cncf-axmos-technologies-member-reviewer`.
8. Run `skcr compile cncf-axmos-technologies-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-axmos-technologies-member-reviewer`.
...
```bash
skpm validate cncf-axmos-technologies-member-reviewer
skpm package cncf-axmos-technologies-member-reviewer
skpm publish cncf-axmos-technologies-member-reviewer
```
