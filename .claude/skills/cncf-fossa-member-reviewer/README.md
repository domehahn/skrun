...
7. Run `skcr validate` and `skcr asps coverage cncf-fossa-member-reviewer`.
8. Run `skcr compile cncf-fossa-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-fossa-member-reviewer`.
...
```bash
skpm validate cncf-fossa-member-reviewer
skpm package cncf-fossa-member-reviewer
skpm publish cncf-fossa-member-reviewer
```
