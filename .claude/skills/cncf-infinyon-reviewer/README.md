...
7. Run `skcr validate` and `skcr asps coverage cncf-infinyon-reviewer`.
8. Run `skcr compile cncf-infinyon-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-infinyon-reviewer`.
...
```bash
skpm validate cncf-infinyon-reviewer
skpm package cncf-infinyon-reviewer
skpm publish cncf-infinyon-reviewer
```
