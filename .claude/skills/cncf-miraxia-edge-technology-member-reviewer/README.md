...
7. Run `skcr validate` and `skcr asps coverage cncf-miraxia-edge-technology-member-reviewer`.
8. Run `skcr compile cncf-miraxia-edge-technology-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-miraxia-edge-technology-member-reviewer`.
...
```bash
skpm validate cncf-miraxia-edge-technology-member-reviewer
skpm package cncf-miraxia-edge-technology-member-reviewer
skpm publish cncf-miraxia-edge-technology-member-reviewer
```
