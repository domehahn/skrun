...
7. Run `skcr validate` and `skcr asps coverage cncf-stackit-member-reviewer`.
8. Run `skcr compile cncf-stackit-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-stackit-member-reviewer`.
...
```bash
skpm validate cncf-stackit-member-reviewer
skpm package cncf-stackit-member-reviewer
skpm publish cncf-stackit-member-reviewer
```
