...
7. Run `skcr validate` and `skcr asps coverage cncf-lenovo-member-reviewer`.
8. Run `skcr compile cncf-lenovo-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-lenovo-member-reviewer`.
...
```bash
skpm validate cncf-lenovo-member-reviewer
skpm package cncf-lenovo-member-reviewer
skpm publish cncf-lenovo-member-reviewer
```
