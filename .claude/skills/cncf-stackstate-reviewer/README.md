...
7. Run `skcr validate` and `skcr asps coverage cncf-stackstate-reviewer`.
8. Run `skcr compile cncf-stackstate-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-stackstate-reviewer`.
...
```bash
skpm validate cncf-stackstate-reviewer
skpm package cncf-stackstate-reviewer
skpm publish cncf-stackstate-reviewer
```
