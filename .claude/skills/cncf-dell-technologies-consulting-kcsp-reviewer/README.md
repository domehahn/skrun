...
7. Run `skcr validate` and `skcr asps coverage cncf-dell-technologies-consulting-kcsp-reviewer`.
8. Run `skcr compile cncf-dell-technologies-consulting-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-dell-technologies-consulting-kcsp-reviewer`.
...
```bash
skpm validate cncf-dell-technologies-consulting-kcsp-reviewer
skpm package cncf-dell-technologies-consulting-kcsp-reviewer
skpm publish cncf-dell-technologies-consulting-kcsp-reviewer
```
