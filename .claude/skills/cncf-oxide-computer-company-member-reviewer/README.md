...
7. Run `skcr validate` and `skcr asps coverage cncf-oxide-computer-company-member-reviewer`.
8. Run `skcr compile cncf-oxide-computer-company-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-oxide-computer-company-member-reviewer`.
...
```bash
skpm validate cncf-oxide-computer-company-member-reviewer
skpm package cncf-oxide-computer-company-member-reviewer
skpm publish cncf-oxide-computer-company-member-reviewer
```
