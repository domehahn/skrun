...
7. Run `skcr validate` and `skcr asps coverage cncf-midway-serverless-reviewer`.
8. Run `skcr compile cncf-midway-serverless-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-midway-serverless-reviewer`.
...
```bash
skpm validate cncf-midway-serverless-reviewer
skpm package cncf-midway-serverless-reviewer
skpm publish cncf-midway-serverless-reviewer
```
