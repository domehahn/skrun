...
7. Run `skcr validate` and `skcr asps coverage cncf-simplyblock-reviewer`.
8. Run `skcr compile cncf-simplyblock-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-simplyblock-reviewer`.
...
```bash
skpm validate cncf-simplyblock-reviewer
skpm package cncf-simplyblock-reviewer
skpm publish cncf-simplyblock-reviewer
```
