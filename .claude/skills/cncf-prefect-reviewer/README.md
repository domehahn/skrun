...
7. Run `skcr validate` and `skcr asps coverage cncf-prefect-reviewer`.
8. Run `skcr compile cncf-prefect-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-prefect-reviewer`.
...
```bash
skpm validate cncf-prefect-reviewer
skpm package cncf-prefect-reviewer
skpm publish cncf-prefect-reviewer
```
