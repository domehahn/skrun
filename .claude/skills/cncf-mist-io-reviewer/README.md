...
7. Run `skcr validate` and `skcr asps coverage cncf-mist-io-reviewer`.
8. Run `skcr compile cncf-mist-io-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-mist-io-reviewer`.
...
```bash
skpm validate cncf-mist-io-reviewer
skpm package cncf-mist-io-reviewer
skpm publish cncf-mist-io-reviewer
```
