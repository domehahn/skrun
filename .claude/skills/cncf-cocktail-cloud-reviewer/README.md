...
7. Run `skcr validate` and `skcr asps coverage cncf-cocktail-cloud-reviewer`.
8. Run `skcr compile cncf-cocktail-cloud-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cocktail-cloud-reviewer`.
...
```bash
skpm validate cncf-cocktail-cloud-reviewer
skpm package cncf-cocktail-cloud-reviewer
skpm publish cncf-cocktail-cloud-reviewer
```
