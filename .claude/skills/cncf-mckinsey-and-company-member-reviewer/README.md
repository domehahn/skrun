...
7. Run `skcr validate` and `skcr asps coverage cncf-mckinsey-and-company-member-reviewer`.
8. Run `skcr compile cncf-mckinsey-and-company-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-mckinsey-and-company-member-reviewer`.
...
```bash
skpm validate cncf-mckinsey-and-company-member-reviewer
skpm package cncf-mckinsey-and-company-member-reviewer
skpm publish cncf-mckinsey-and-company-member-reviewer
```
