...
7. Run `skcr validate` and `skcr asps coverage cncf-kusari-member-reviewer`.
8. Run `skcr compile cncf-kusari-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kusari-member-reviewer`.
...
```bash
skpm validate cncf-kusari-member-reviewer
skpm package cncf-kusari-member-reviewer
skpm publish cncf-kusari-member-reviewer
```
