...
7. Run `skcr validate` and `skcr asps coverage cncf-opennebula-member-reviewer`.
8. Run `skcr compile cncf-opennebula-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-opennebula-member-reviewer`.
...
```bash
skpm validate cncf-opennebula-member-reviewer
skpm package cncf-opennebula-member-reviewer
skpm publish cncf-opennebula-member-reviewer
```
