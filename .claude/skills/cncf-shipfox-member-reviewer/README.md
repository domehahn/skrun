...
7. Run `skcr validate` and `skcr asps coverage cncf-shipfox-member-reviewer`.
8. Run `skcr compile cncf-shipfox-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-shipfox-member-reviewer`.
...
```bash
skpm validate cncf-shipfox-member-reviewer
skpm package cncf-shipfox-member-reviewer
skpm publish cncf-shipfox-member-reviewer
```
