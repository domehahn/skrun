...
7. Run `skcr validate` and `skcr asps coverage cncf-cybozu-kubernetes-engine-reviewer`.
8. Run `skcr compile cncf-cybozu-kubernetes-engine-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cybozu-kubernetes-engine-reviewer`.
...
```bash
skpm validate cncf-cybozu-kubernetes-engine-reviewer
skpm package cncf-cybozu-kubernetes-engine-reviewer
skpm publish cncf-cybozu-kubernetes-engine-reviewer
```
