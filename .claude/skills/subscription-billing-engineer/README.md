...
7. Run `skcr validate` and `skcr asps coverage subscription-billing-engineer`.
8. Run `skcr compile subscription-billing-engineer --target skil`.
9. Run `skcr sync` and `skcr version recommend subscription-billing-engineer`.
...
```bash
skpm validate subscription-billing-engineer
skpm package subscription-billing-engineer
skpm publish subscription-billing-engineer
```
