...
7. Run `skcr validate` and `skcr asps coverage cncf-lima-reviewer`.
8. Run `skcr compile cncf-lima-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-lima-reviewer`.
...
```bash
skpm validate cncf-lima-reviewer
skpm package cncf-lima-reviewer
skpm publish cncf-lima-reviewer
```
