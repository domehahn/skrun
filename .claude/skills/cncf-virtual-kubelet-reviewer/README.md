...
7. Run `skcr validate` and `skcr asps coverage cncf-virtual-kubelet-reviewer`.
8. Run `skcr compile cncf-virtual-kubelet-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-virtual-kubelet-reviewer`.
...
```bash
skpm validate cncf-virtual-kubelet-reviewer
skpm package cncf-virtual-kubelet-reviewer
skpm publish cncf-virtual-kubelet-reviewer
```
