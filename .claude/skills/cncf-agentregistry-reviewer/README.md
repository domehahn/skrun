...
7. Run `skcr validate` and `skcr asps coverage cncf-agentregistry-reviewer`.
8. Run `skcr compile cncf-agentregistry-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-agentregistry-reviewer`.
...
```bash
skpm validate cncf-agentregistry-reviewer
skpm package cncf-agentregistry-reviewer
skpm publish cncf-agentregistry-reviewer
```
