...
7. Run `skcr validate` and `skcr asps coverage cncf-zalando-supporter-reviewer`.
8. Run `skcr compile cncf-zalando-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-zalando-supporter-reviewer`.
...
```bash
skpm validate cncf-zalando-supporter-reviewer
skpm package cncf-zalando-supporter-reviewer
skpm publish cncf-zalando-supporter-reviewer
```
