...
7. Run `skcr validate` and `skcr asps coverage cncf-kubeops-kcsp-reviewer`.
8. Run `skcr compile cncf-kubeops-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kubeops-kcsp-reviewer`.
...
```bash
skpm validate cncf-kubeops-kcsp-reviewer
skpm package cncf-kubeops-kcsp-reviewer
skpm publish cncf-kubeops-kcsp-reviewer
```
