...
7. Run `skcr validate` and `skcr asps coverage cncf-hazelcast-imdg-reviewer`.
8. Run `skcr compile cncf-hazelcast-imdg-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-hazelcast-imdg-reviewer`.
...
```bash
skpm validate cncf-hazelcast-imdg-reviewer
skpm package cncf-hazelcast-imdg-reviewer
skpm publish cncf-hazelcast-imdg-reviewer
```
