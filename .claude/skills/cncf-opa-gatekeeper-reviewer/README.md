...
7. Run `skcr validate` and `skcr asps coverage cncf-opa-gatekeeper-reviewer`.
8. Run `skcr compile cncf-opa-gatekeeper-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-opa-gatekeeper-reviewer`.
...
```bash
skpm validate cncf-opa-gatekeeper-reviewer
skpm package cncf-opa-gatekeeper-reviewer
skpm publish cncf-opa-gatekeeper-reviewer
```
