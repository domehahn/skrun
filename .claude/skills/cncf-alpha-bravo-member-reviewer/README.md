...
7. Run `skcr validate` and `skcr asps coverage cncf-alpha-bravo-member-reviewer`.
8. Run `skcr compile cncf-alpha-bravo-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-alpha-bravo-member-reviewer`.
...
```bash
skpm validate cncf-alpha-bravo-member-reviewer
skpm package cncf-alpha-bravo-member-reviewer
skpm publish cncf-alpha-bravo-member-reviewer
```
