...
7. Run `skcr validate` and `skcr asps coverage cncf-apiiro-member-reviewer`.
8. Run `skcr compile cncf-apiiro-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-apiiro-member-reviewer`.
...
```bash
skpm validate cncf-apiiro-member-reviewer
skpm package cncf-apiiro-member-reviewer
skpm publish cncf-apiiro-member-reviewer
```
