...
7. Run `skcr validate` and `skcr asps coverage cncf-nitric-reviewer`.
8. Run `skcr compile cncf-nitric-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nitric-reviewer`.
...
```bash
skpm validate cncf-nitric-reviewer
skpm package cncf-nitric-reviewer
skpm publish cncf-nitric-reviewer
```
