...
7. Run `skcr validate` and `skcr asps coverage cncf-stack8s-member-reviewer`.
8. Run `skcr compile cncf-stack8s-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-stack8s-member-reviewer`.
...
```bash
skpm validate cncf-stack8s-member-reviewer
skpm package cncf-stack8s-member-reviewer
skpm publish cncf-stack8s-member-reviewer
```
