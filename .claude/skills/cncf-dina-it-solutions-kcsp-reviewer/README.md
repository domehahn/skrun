...
7. Run `skcr validate` and `skcr asps coverage cncf-dina-it-solutions-kcsp-reviewer`.
8. Run `skcr compile cncf-dina-it-solutions-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-dina-it-solutions-kcsp-reviewer`.
...
```bash
skpm validate cncf-dina-it-solutions-kcsp-reviewer
skpm package cncf-dina-it-solutions-kcsp-reviewer
skpm publish cncf-dina-it-solutions-kcsp-reviewer
```
