...
7. Run `skcr validate` and `skcr asps coverage cncf-runme-notebooks-reviewer`.
8. Run `skcr compile cncf-runme-notebooks-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-runme-notebooks-reviewer`.
...
```bash
skpm validate cncf-runme-notebooks-reviewer
skpm package cncf-runme-notebooks-reviewer
skpm publish cncf-runme-notebooks-reviewer
```
