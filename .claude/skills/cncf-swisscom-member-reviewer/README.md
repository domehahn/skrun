...
7. Run `skcr validate` and `skcr asps coverage cncf-swisscom-member-reviewer`.
8. Run `skcr compile cncf-swisscom-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-swisscom-member-reviewer`.
...
```bash
skpm validate cncf-swisscom-member-reviewer
skpm package cncf-swisscom-member-reviewer
skpm publish cncf-swisscom-member-reviewer
```
