...
7. Run `skcr validate` and `skcr asps coverage cncf-tarook-reviewer`.
8. Run `skcr compile cncf-tarook-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-tarook-reviewer`.
...
```bash
skpm validate cncf-tarook-reviewer
skpm package cncf-tarook-reviewer
skpm publish cncf-tarook-reviewer
```
