...
7. Run `skcr validate` and `skcr asps coverage cncf-cubesandbox-reviewer`.
8. Run `skcr compile cncf-cubesandbox-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cubesandbox-reviewer`.
...
```bash
skpm validate cncf-cubesandbox-reviewer
skpm package cncf-cubesandbox-reviewer
skpm publish cncf-cubesandbox-reviewer
```
