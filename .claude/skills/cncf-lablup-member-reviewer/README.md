...
7. Run `skcr validate` and `skcr asps coverage cncf-lablup-member-reviewer`.
8. Run `skcr compile cncf-lablup-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-lablup-member-reviewer`.
...
```bash
skpm validate cncf-lablup-member-reviewer
skpm package cncf-lablup-member-reviewer
skpm publish cncf-lablup-member-reviewer
```
