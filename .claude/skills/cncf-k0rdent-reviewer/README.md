...
7. Run `skcr validate` and `skcr asps coverage cncf-k0rdent-reviewer`.
8. Run `skcr compile cncf-k0rdent-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-k0rdent-reviewer`.
...
```bash
skpm validate cncf-k0rdent-reviewer
skpm package cncf-k0rdent-reviewer
skpm publish cncf-k0rdent-reviewer
```
