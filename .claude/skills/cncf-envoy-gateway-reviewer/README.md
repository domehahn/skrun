...
7. Run `skcr validate` and `skcr asps coverage cncf-envoy-gateway-reviewer`.
8. Run `skcr compile cncf-envoy-gateway-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-envoy-gateway-reviewer`.
...
```bash
skpm validate cncf-envoy-gateway-reviewer
skpm package cncf-envoy-gateway-reviewer
skpm publish cncf-envoy-gateway-reviewer
```
