...
7. Run `skcr validate` and `skcr asps coverage cncf-trivago-supporter-reviewer`.
8. Run `skcr compile cncf-trivago-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-trivago-supporter-reviewer`.
...
```bash
skpm validate cncf-trivago-supporter-reviewer
skpm package cncf-trivago-supporter-reviewer
skpm publish cncf-trivago-supporter-reviewer
```
