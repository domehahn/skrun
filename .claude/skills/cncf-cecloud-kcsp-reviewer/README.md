...
7. Run `skcr validate` and `skcr asps coverage cncf-cecloud-kcsp-reviewer`.
8. Run `skcr compile cncf-cecloud-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cecloud-kcsp-reviewer`.
...
```bash
skpm validate cncf-cecloud-kcsp-reviewer
skpm package cncf-cecloud-kcsp-reviewer
skpm publish cncf-cecloud-kcsp-reviewer
```
