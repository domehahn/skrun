...
7. Run `skcr validate` and `skcr asps coverage cncf-datacore-puls8-reviewer`.
8. Run `skcr compile cncf-datacore-puls8-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-datacore-puls8-reviewer`.
...
```bash
skpm validate cncf-datacore-puls8-reviewer
skpm package cncf-datacore-puls8-reviewer
skpm publish cncf-datacore-puls8-reviewer
```
