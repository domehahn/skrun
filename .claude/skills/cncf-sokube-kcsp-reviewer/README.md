...
7. Run `skcr validate` and `skcr asps coverage cncf-sokube-kcsp-reviewer`.
8. Run `skcr compile cncf-sokube-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sokube-kcsp-reviewer`.
...
```bash
skpm validate cncf-sokube-kcsp-reviewer
skpm package cncf-sokube-kcsp-reviewer
skpm publish cncf-sokube-kcsp-reviewer
```
