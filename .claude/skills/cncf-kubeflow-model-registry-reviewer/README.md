...
7. Run `skcr validate` and `skcr asps coverage cncf-kubeflow-model-registry-reviewer`.
8. Run `skcr compile cncf-kubeflow-model-registry-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kubeflow-model-registry-reviewer`.
...
```bash
skpm validate cncf-kubeflow-model-registry-reviewer
skpm package cncf-kubeflow-model-registry-reviewer
skpm publish cncf-kubeflow-model-registry-reviewer
```
