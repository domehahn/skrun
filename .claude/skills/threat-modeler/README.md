...
7. Run `skcr validate` and `skcr asps coverage threat-modeler`.
8. Run `skcr compile threat-modeler --target skil`.
9. Run `skcr sync` and `skcr version recommend threat-modeler`.
