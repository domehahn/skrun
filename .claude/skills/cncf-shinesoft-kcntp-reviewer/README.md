...
7. Run `skcr validate` and `skcr asps coverage cncf-shinesoft-kcntp-reviewer`.
8. Run `skcr compile cncf-shinesoft-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-shinesoft-kcntp-reviewer`.
...
```bash
skpm validate cncf-shinesoft-kcntp-reviewer
skpm package cncf-shinesoft-kcntp-reviewer
skpm publish cncf-shinesoft-kcntp-reviewer
```
