...
7. Run `skcr validate` and `skcr asps coverage cncf-scaleway-kubernetes-kapsule-reviewer`.
8. Run `skcr compile cncf-scaleway-kubernetes-kapsule-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-scaleway-kubernetes-kapsule-reviewer`.
...
```bash
skpm validate cncf-scaleway-kubernetes-kapsule-reviewer
skpm package cncf-scaleway-kubernetes-kapsule-reviewer
skpm publish cncf-scaleway-kubernetes-kapsule-reviewer
```
