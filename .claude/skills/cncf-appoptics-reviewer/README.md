...
7. Run `skcr validate` and `skcr asps coverage cncf-appoptics-reviewer`.
8. Run `skcr compile cncf-appoptics-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-appoptics-reviewer`.
...
```bash
skpm validate cncf-appoptics-reviewer
skpm package cncf-appoptics-reviewer
skpm publish cncf-appoptics-reviewer
```
