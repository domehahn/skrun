...
7. Run `skcr validate` and `skcr asps coverage cncf-nimtech-member-reviewer`.
8. Run `skcr compile cncf-nimtech-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nimtech-member-reviewer`.
...
```bash
skpm validate cncf-nimtech-member-reviewer
skpm package cncf-nimtech-member-reviewer
skpm publish cncf-nimtech-member-reviewer
```
