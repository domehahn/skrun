...
7. Run `skcr validate` and `skcr asps coverage cncf-kubeops-kcntp-reviewer`.
8. Run `skcr compile cncf-kubeops-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kubeops-kcntp-reviewer`.
...
```bash
skpm validate cncf-kubeops-kcntp-reviewer
skpm package cncf-kubeops-kcntp-reviewer
skpm publish cncf-kubeops-kcntp-reviewer
```
