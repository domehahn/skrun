...
7. Run `skcr validate` and `skcr asps coverage cncf-intercept-kcsp-reviewer`.
8. Run `skcr compile cncf-intercept-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-intercept-kcsp-reviewer`.
...
```bash
skpm validate cncf-intercept-kcsp-reviewer
skpm package cncf-intercept-kcsp-reviewer
skpm publish cncf-intercept-kcsp-reviewer
```
