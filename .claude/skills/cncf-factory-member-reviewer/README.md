...
7. Run `skcr validate` and `skcr asps coverage cncf-factory-member-reviewer`.
8. Run `skcr compile cncf-factory-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-factory-member-reviewer`.
...
```bash
skpm validate cncf-factory-member-reviewer
skpm package cncf-factory-member-reviewer
skpm publish cncf-factory-member-reviewer
```
