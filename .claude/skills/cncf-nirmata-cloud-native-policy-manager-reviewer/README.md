...
7. Run `skcr validate` and `skcr asps coverage cncf-nirmata-cloud-native-policy-manager-reviewer`.
8. Run `skcr compile cncf-nirmata-cloud-native-policy-manager-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nirmata-cloud-native-policy-manager-reviewer`.
...
```bash
skpm validate cncf-nirmata-cloud-native-policy-manager-reviewer
skpm package cncf-nirmata-cloud-native-policy-manager-reviewer
skpm publish cncf-nirmata-cloud-native-policy-manager-reviewer
```
