...
7. Run `skcr validate` and `skcr asps coverage cncf-nuage-networks-reviewer`.
8. Run `skcr compile cncf-nuage-networks-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nuage-networks-reviewer`.
...
```bash
skpm validate cncf-nuage-networks-reviewer
skpm package cncf-nuage-networks-reviewer
skpm publish cncf-nuage-networks-reviewer
```
