...
7. Run `skcr validate` and `skcr asps coverage cncf-enroute-onestep-ingress-reviewer`.
8. Run `skcr compile cncf-enroute-onestep-ingress-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-enroute-onestep-ingress-reviewer`.
...
```bash
skpm validate cncf-enroute-onestep-ingress-reviewer
skpm package cncf-enroute-onestep-ingress-reviewer
skpm publish cncf-enroute-onestep-ingress-reviewer
```
