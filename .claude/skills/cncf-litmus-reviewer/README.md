...
7. Run `skcr validate` and `skcr asps coverage cncf-litmus-reviewer`.
8. Run `skcr compile cncf-litmus-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-litmus-reviewer`.
...
```bash
skpm validate cncf-litmus-reviewer
skpm package cncf-litmus-reviewer
skpm publish cncf-litmus-reviewer
```
