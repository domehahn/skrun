...
7. Run `skcr validate` and `skcr asps coverage cncf-jhipster-reviewer`.
8. Run `skcr compile cncf-jhipster-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-jhipster-reviewer`.
...
```bash
skpm validate cncf-jhipster-reviewer
skpm package cncf-jhipster-reviewer
skpm publish cncf-jhipster-reviewer
```
