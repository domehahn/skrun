...
7. Run `skcr validate` and `skcr asps coverage cncf-xregistry-reviewer`.
8. Run `skcr compile cncf-xregistry-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-xregistry-reviewer`.
...
```bash
skpm validate cncf-xregistry-reviewer
skpm package cncf-xregistry-reviewer
skpm publish cncf-xregistry-reviewer
```
