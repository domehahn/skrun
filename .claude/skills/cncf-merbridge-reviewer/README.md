...
7. Run `skcr validate` and `skcr asps coverage cncf-merbridge-reviewer`.
8. Run `skcr compile cncf-merbridge-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-merbridge-reviewer`.
...
```bash
skpm validate cncf-merbridge-reviewer
skpm package cncf-merbridge-reviewer
skpm publish cncf-merbridge-reviewer
```
