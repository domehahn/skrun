...
7. Run `skcr validate` and `skcr asps coverage cncf-wiit-kcsp-reviewer`.
8. Run `skcr compile cncf-wiit-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-wiit-kcsp-reviewer`.
...
```bash
skpm validate cncf-wiit-kcsp-reviewer
skpm package cncf-wiit-kcsp-reviewer
skpm publish cncf-wiit-kcsp-reviewer
```
