...
7. Run `skcr validate` and `skcr asps coverage cncf-zededa-inc-member-reviewer`.
8. Run `skcr compile cncf-zededa-inc-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-zededa-inc-member-reviewer`.
...
```bash
skpm validate cncf-zededa-inc-member-reviewer
skpm package cncf-zededa-inc-member-reviewer
skpm publish cncf-zededa-inc-member-reviewer
```
