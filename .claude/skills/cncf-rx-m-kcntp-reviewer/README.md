...
7. Run `skcr validate` and `skcr asps coverage cncf-rx-m-kcntp-reviewer`.
8. Run `skcr compile cncf-rx-m-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-rx-m-kcntp-reviewer`.
...
```bash
skpm validate cncf-rx-m-kcntp-reviewer
skpm package cncf-rx-m-kcntp-reviewer
skpm publish cncf-rx-m-kcntp-reviewer
```
