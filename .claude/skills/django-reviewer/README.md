...
7. Run `skcr validate` and `skcr asps coverage django-reviewer`.
8. Run `skcr compile django-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend django-reviewer`.
...
```bash
skpm validate django-reviewer
skpm package django-reviewer
skpm publish django-reviewer
```
