...
7. Run `skcr validate` and `skcr asps coverage cncf-samsung-sds-kcsp-reviewer`.
8. Run `skcr compile cncf-samsung-sds-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-samsung-sds-kcsp-reviewer`.
...
```bash
skpm validate cncf-samsung-sds-kcsp-reviewer
skpm package cncf-samsung-sds-kcsp-reviewer
skpm publish cncf-samsung-sds-kcsp-reviewer
```
