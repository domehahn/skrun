...
7. Run `skcr validate` and `skcr asps coverage cncf-x-cellent-kcntp-reviewer`.
8. Run `skcr compile cncf-x-cellent-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-x-cellent-kcntp-reviewer`.
...
```bash
skpm validate cncf-x-cellent-kcntp-reviewer
skpm package cncf-x-cellent-kcntp-reviewer
skpm publish cncf-x-cellent-kcntp-reviewer
```
