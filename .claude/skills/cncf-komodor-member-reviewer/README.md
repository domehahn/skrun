...
7. Run `skcr validate` and `skcr asps coverage cncf-komodor-member-reviewer`.
8. Run `skcr compile cncf-komodor-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-komodor-member-reviewer`.
...
```bash
skpm validate cncf-komodor-member-reviewer
skpm package cncf-komodor-member-reviewer
skpm publish cncf-komodor-member-reviewer
```
