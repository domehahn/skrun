...
7. Run `skcr validate` and `skcr asps coverage cncf-g-research-member-reviewer`.
8. Run `skcr compile cncf-g-research-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-g-research-member-reviewer`.
...
```bash
skpm validate cncf-g-research-member-reviewer
skpm package cncf-g-research-member-reviewer
skpm publish cncf-g-research-member-reviewer
```
