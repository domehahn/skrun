...
7. Run `skcr validate` and `skcr asps coverage cncf-vshn-ag-kcsp-reviewer`.
8. Run `skcr compile cncf-vshn-ag-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-vshn-ag-kcsp-reviewer`.
...
```bash
skpm validate cncf-vshn-ag-kcsp-reviewer
skpm package cncf-vshn-ag-kcsp-reviewer
skpm publish cncf-vshn-ag-kcsp-reviewer
```
