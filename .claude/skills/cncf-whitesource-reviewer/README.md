...
7. Run `skcr validate` and `skcr asps coverage cncf-whitesource-reviewer`.
8. Run `skcr compile cncf-whitesource-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-whitesource-reviewer`.
...
```bash
skpm validate cncf-whitesource-reviewer
skpm package cncf-whitesource-reviewer
skpm publish cncf-whitesource-reviewer
```
