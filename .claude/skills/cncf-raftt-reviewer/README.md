...
7. Run `skcr validate` and `skcr asps coverage cncf-raftt-reviewer`.
8. Run `skcr compile cncf-raftt-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-raftt-reviewer`.
...
```bash
skpm validate cncf-raftt-reviewer
skpm package cncf-raftt-reviewer
skpm publish cncf-raftt-reviewer
```
