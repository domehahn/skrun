...
7. Run `skcr validate` and `skcr asps coverage cncf-kuberhealthy-reviewer`.
8. Run `skcr compile cncf-kuberhealthy-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kuberhealthy-reviewer`.
...
```bash
skpm validate cncf-kuberhealthy-reviewer
skpm package cncf-kuberhealthy-reviewer
skpm publish cncf-kuberhealthy-reviewer
```
