...
7. Run `skcr validate` and `skcr asps coverage cncf-agileops-kcntp-reviewer`.
8. Run `skcr compile cncf-agileops-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-agileops-kcntp-reviewer`.
...
```bash
skpm validate cncf-agileops-kcntp-reviewer
skpm package cncf-agileops-kcntp-reviewer
skpm publish cncf-agileops-kcntp-reviewer
```
