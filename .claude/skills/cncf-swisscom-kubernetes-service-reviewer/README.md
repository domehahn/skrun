...
7. Run `skcr validate` and `skcr asps coverage cncf-swisscom-kubernetes-service-reviewer`.
8. Run `skcr compile cncf-swisscom-kubernetes-service-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-swisscom-kubernetes-service-reviewer`.
...
```bash
skpm validate cncf-swisscom-kubernetes-service-reviewer
skpm package cncf-swisscom-kubernetes-service-reviewer
skpm publish cncf-swisscom-kubernetes-service-reviewer
```
