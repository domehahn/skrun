...
7. Run `skcr validate` and `skcr asps coverage cncf-umb-kcsp-reviewer`.
8. Run `skcr compile cncf-umb-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-umb-kcsp-reviewer`.
...
```bash
skpm validate cncf-umb-kcsp-reviewer
skpm package cncf-umb-kcsp-reviewer
skpm publish cncf-umb-kcsp-reviewer
```
