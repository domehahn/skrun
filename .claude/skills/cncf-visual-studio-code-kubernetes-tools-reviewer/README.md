...
7. Run `skcr validate` and `skcr asps coverage cncf-visual-studio-code-kubernetes-tools-reviewer`.
8. Run `skcr compile cncf-visual-studio-code-kubernetes-tools-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-visual-studio-code-kubernetes-tools-reviewer`.
...
```bash
skpm validate cncf-visual-studio-code-kubernetes-tools-reviewer
skpm package cncf-visual-studio-code-kubernetes-tools-reviewer
skpm publish cncf-visual-studio-code-kubernetes-tools-reviewer
```
