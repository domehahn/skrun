...
7. Run `skcr validate` and `skcr asps coverage cncf-mogenius-kubernetes-platform-reviewer`.
8. Run `skcr compile cncf-mogenius-kubernetes-platform-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-mogenius-kubernetes-platform-reviewer`.
...
```bash
skpm validate cncf-mogenius-kubernetes-platform-reviewer
skpm package cncf-mogenius-kubernetes-platform-reviewer
skpm publish cncf-mogenius-kubernetes-platform-reviewer
```
