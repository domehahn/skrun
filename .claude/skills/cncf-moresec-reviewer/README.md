...
7. Run `skcr validate` and `skcr asps coverage cncf-moresec-reviewer`.
8. Run `skcr compile cncf-moresec-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-moresec-reviewer`.
...
```bash
skpm validate cncf-moresec-reviewer
skpm package cncf-moresec-reviewer
skpm publish cncf-moresec-reviewer
```
