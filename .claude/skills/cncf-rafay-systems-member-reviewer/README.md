...
7. Run `skcr validate` and `skcr asps coverage cncf-rafay-systems-member-reviewer`.
8. Run `skcr compile cncf-rafay-systems-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-rafay-systems-member-reviewer`.
...
```bash
skpm validate cncf-rafay-systems-member-reviewer
skpm package cncf-rafay-systems-member-reviewer
skpm publish cncf-rafay-systems-member-reviewer
```
