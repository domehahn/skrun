...
7. Run `skcr validate` and `skcr asps coverage cncf-cloud-foundry-foundation-member-reviewer`.
8. Run `skcr compile cncf-cloud-foundry-foundation-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloud-foundry-foundation-member-reviewer`.
...
```bash
skpm validate cncf-cloud-foundry-foundation-member-reviewer
skpm package cncf-cloud-foundry-foundation-member-reviewer
skpm publish cncf-cloud-foundry-foundation-member-reviewer
```
