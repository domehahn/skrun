...
7. Run `skcr validate` and `skcr asps coverage cncf-causely-member-reviewer`.
8. Run `skcr compile cncf-causely-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-causely-member-reviewer`.
...
```bash
skpm validate cncf-causely-member-reviewer
skpm package cncf-causely-member-reviewer
skpm publish cncf-causely-member-reviewer
```
