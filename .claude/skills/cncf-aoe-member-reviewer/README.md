...
7. Run `skcr validate` and `skcr asps coverage cncf-aoe-member-reviewer`.
8. Run `skcr compile cncf-aoe-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-aoe-member-reviewer`.
...
```bash
skpm validate cncf-aoe-member-reviewer
skpm package cncf-aoe-member-reviewer
skpm publish cncf-aoe-member-reviewer
```
