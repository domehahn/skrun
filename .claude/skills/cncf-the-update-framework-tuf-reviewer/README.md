...
7. Run `skcr validate` and `skcr asps coverage cncf-the-update-framework-tuf-reviewer`.
8. Run `skcr compile cncf-the-update-framework-tuf-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-the-update-framework-tuf-reviewer`.
...
```bash
skpm validate cncf-the-update-framework-tuf-reviewer
skpm package cncf-the-update-framework-tuf-reviewer
skpm publish cncf-the-update-framework-tuf-reviewer
```
