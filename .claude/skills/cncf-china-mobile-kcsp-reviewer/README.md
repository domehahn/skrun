...
7. Run `skcr validate` and `skcr asps coverage cncf-china-mobile-kcsp-reviewer`.
8. Run `skcr compile cncf-china-mobile-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-china-mobile-kcsp-reviewer`.
...
```bash
skpm validate cncf-china-mobile-kcsp-reviewer
skpm package cncf-china-mobile-kcsp-reviewer
skpm publish cncf-china-mobile-kcsp-reviewer
```
