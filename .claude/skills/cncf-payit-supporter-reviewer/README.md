...
7. Run `skcr validate` and `skcr asps coverage cncf-payit-supporter-reviewer`.
8. Run `skcr compile cncf-payit-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-payit-supporter-reviewer`.
...
```bash
skpm validate cncf-payit-supporter-reviewer
skpm package cncf-payit-supporter-reviewer
skpm publish cncf-payit-supporter-reviewer
```
