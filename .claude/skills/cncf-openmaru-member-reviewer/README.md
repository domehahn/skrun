...
7. Run `skcr validate` and `skcr asps coverage cncf-openmaru-member-reviewer`.
8. Run `skcr compile cncf-openmaru-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-openmaru-member-reviewer`.
...
```bash
skpm validate cncf-openmaru-member-reviewer
skpm package cncf-openmaru-member-reviewer
skpm publish cncf-openmaru-member-reviewer
```
