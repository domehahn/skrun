...
7. Run `skcr validate` and `skcr asps coverage cncf-steamhaus-member-reviewer`.
8. Run `skcr compile cncf-steamhaus-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-steamhaus-member-reviewer`.
...
```bash
skpm validate cncf-steamhaus-member-reviewer
skpm package cncf-steamhaus-member-reviewer
skpm publish cncf-steamhaus-member-reviewer
```
