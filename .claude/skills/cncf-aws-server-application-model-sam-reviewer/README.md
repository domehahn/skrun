...
7. Run `skcr validate` and `skcr asps coverage cncf-aws-server-application-model-sam-reviewer`.
8. Run `skcr compile cncf-aws-server-application-model-sam-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-aws-server-application-model-sam-reviewer`.
...
```bash
skpm validate cncf-aws-server-application-model-sam-reviewer
skpm package cncf-aws-server-application-model-sam-reviewer
skpm publish cncf-aws-server-application-model-sam-reviewer
```
