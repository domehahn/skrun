...
7. Run `skcr validate` and `skcr asps coverage cncf-tinkerbell-reviewer`.
8. Run `skcr compile cncf-tinkerbell-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-tinkerbell-reviewer`.
...
```bash
skpm validate cncf-tinkerbell-reviewer
skpm package cncf-tinkerbell-reviewer
skpm publish cncf-tinkerbell-reviewer
```
