...
7. Run `skcr validate` and `skcr asps coverage cncf-chef-inspec-reviewer`.
8. Run `skcr compile cncf-chef-inspec-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-chef-inspec-reviewer`.
...
```bash
skpm validate cncf-chef-inspec-reviewer
skpm package cncf-chef-inspec-reviewer
skpm publish cncf-chef-inspec-reviewer
```
