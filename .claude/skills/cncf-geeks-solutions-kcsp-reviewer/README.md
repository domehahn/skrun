...
7. Run `skcr validate` and `skcr asps coverage cncf-geeks-solutions-kcsp-reviewer`.
8. Run `skcr compile cncf-geeks-solutions-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-geeks-solutions-kcsp-reviewer`.
...
```bash
skpm validate cncf-geeks-solutions-kcsp-reviewer
skpm package cncf-geeks-solutions-kcsp-reviewer
skpm publish cncf-geeks-solutions-kcsp-reviewer
```
