...
7. Run `skcr validate` and `skcr asps coverage cncf-cloudscale-ch-member-reviewer`.
8. Run `skcr compile cncf-cloudscale-ch-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloudscale-ch-member-reviewer`.
...
```bash
skpm validate cncf-cloudscale-ch-member-reviewer
skpm package cncf-cloudscale-ch-member-reviewer
skpm publish cncf-cloudscale-ch-member-reviewer
```
