...
7. Run `skcr validate` and `skcr asps coverage cncf-altinity-member-reviewer`.
8. Run `skcr compile cncf-altinity-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-altinity-member-reviewer`.
...
```bash
skpm validate cncf-altinity-member-reviewer
skpm package cncf-altinity-member-reviewer
skpm publish cncf-altinity-member-reviewer
```
