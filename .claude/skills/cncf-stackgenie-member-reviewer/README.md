...
7. Run `skcr validate` and `skcr asps coverage cncf-stackgenie-member-reviewer`.
8. Run `skcr compile cncf-stackgenie-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-stackgenie-member-reviewer`.
...
```bash
skpm validate cncf-stackgenie-member-reviewer
skpm package cncf-stackgenie-member-reviewer
skpm publish cncf-stackgenie-member-reviewer
```
