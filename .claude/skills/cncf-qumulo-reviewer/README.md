...
7. Run `skcr validate` and `skcr asps coverage cncf-qumulo-reviewer`.
8. Run `skcr compile cncf-qumulo-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-qumulo-reviewer`.
...
```bash
skpm validate cncf-qumulo-reviewer
skpm package cncf-qumulo-reviewer
skpm publish cncf-qumulo-reviewer
```
