...
7. Run `skcr validate` and `skcr asps coverage cncf-hango-reviewer`.
8. Run `skcr compile cncf-hango-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-hango-reviewer`.
...
```bash
skpm validate cncf-hango-reviewer
skpm package cncf-hango-reviewer
skpm publish cncf-hango-reviewer
```
