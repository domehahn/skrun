...
7. Run `skcr validate` and `skcr asps coverage cncf-traas-bos-reviewer`.
8. Run `skcr compile cncf-traas-bos-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-traas-bos-reviewer`.
...
```bash
skpm validate cncf-traas-bos-reviewer
skpm package cncf-traas-bos-reviewer
skpm publish cncf-traas-bos-reviewer
```
