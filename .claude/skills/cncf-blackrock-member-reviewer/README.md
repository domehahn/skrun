...
7. Run `skcr validate` and `skcr asps coverage cncf-blackrock-member-reviewer`.
8. Run `skcr compile cncf-blackrock-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-blackrock-member-reviewer`.
...
```bash
skpm validate cncf-blackrock-member-reviewer
skpm package cncf-blackrock-member-reviewer
skpm publish cncf-blackrock-member-reviewer
```
