...
7. Run `skcr validate` and `skcr asps coverage cncf-kubeshop-member-reviewer`.
8. Run `skcr compile cncf-kubeshop-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kubeshop-member-reviewer`.
...
```bash
skpm validate cncf-kubeshop-member-reviewer
skpm package cncf-kubeshop-member-reviewer
skpm publish cncf-kubeshop-member-reviewer
```
