...
7. Run `skcr validate` and `skcr asps coverage cncf-second-state-functions-reviewer`.
8. Run `skcr compile cncf-second-state-functions-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-second-state-functions-reviewer`.
...
```bash
skpm validate cncf-second-state-functions-reviewer
skpm package cncf-second-state-functions-reviewer
skpm publish cncf-second-state-functions-reviewer
```
