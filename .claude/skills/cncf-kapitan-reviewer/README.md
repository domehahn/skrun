...
7. Run `skcr validate` and `skcr asps coverage cncf-kapitan-reviewer`.
8. Run `skcr compile cncf-kapitan-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kapitan-reviewer`.
...
```bash
skpm validate cncf-kapitan-reviewer
skpm package cncf-kapitan-reviewer
skpm publish cncf-kapitan-reviewer
```
