...
7. Run `skcr validate` and `skcr asps coverage cncf-chronosphere-member-reviewer`.
8. Run `skcr compile cncf-chronosphere-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-chronosphere-member-reviewer`.
...
```bash
skpm validate cncf-chronosphere-member-reviewer
skpm package cncf-chronosphere-member-reviewer
skpm publish cncf-chronosphere-member-reviewer
```
