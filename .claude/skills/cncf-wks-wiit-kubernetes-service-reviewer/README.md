...
7. Run `skcr validate` and `skcr asps coverage cncf-wks-wiit-kubernetes-service-reviewer`.
8. Run `skcr compile cncf-wks-wiit-kubernetes-service-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-wks-wiit-kubernetes-service-reviewer`.
...
```bash
skpm validate cncf-wks-wiit-kubernetes-service-reviewer
skpm package cncf-wks-wiit-kubernetes-service-reviewer
skpm publish cncf-wks-wiit-kubernetes-service-reviewer
```
