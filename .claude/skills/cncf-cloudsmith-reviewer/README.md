...
7. Run `skcr validate` and `skcr asps coverage cncf-cloudsmith-reviewer`.
8. Run `skcr compile cncf-cloudsmith-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloudsmith-reviewer`.
...
```bash
skpm validate cncf-cloudsmith-reviewer
skpm package cncf-cloudsmith-reviewer
skpm publish cncf-cloudsmith-reviewer
```
