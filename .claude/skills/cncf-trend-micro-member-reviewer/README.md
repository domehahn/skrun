...
7. Run `skcr validate` and `skcr asps coverage cncf-trend-micro-member-reviewer`.
8. Run `skcr compile cncf-trend-micro-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-trend-micro-member-reviewer`.
...
```bash
skpm validate cncf-trend-micro-member-reviewer
skpm package cncf-trend-micro-member-reviewer
skpm publish cncf-trend-micro-member-reviewer
```
