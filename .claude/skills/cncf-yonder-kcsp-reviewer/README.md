...
7. Run `skcr validate` and `skcr asps coverage cncf-yonder-kcsp-reviewer`.
8. Run `skcr compile cncf-yonder-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-yonder-kcsp-reviewer`.
...
```bash
skpm validate cncf-yonder-kcsp-reviewer
skpm package cncf-yonder-kcsp-reviewer
skpm publish cncf-yonder-kcsp-reviewer
```
