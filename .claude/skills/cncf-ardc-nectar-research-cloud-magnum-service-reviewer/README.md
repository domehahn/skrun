...
7. Run `skcr validate` and `skcr asps coverage cncf-ardc-nectar-research-cloud-magnum-service-reviewer`.
8. Run `skcr compile cncf-ardc-nectar-research-cloud-magnum-service-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ardc-nectar-research-cloud-magnum-service-reviewer`.
...
```bash
skpm validate cncf-ardc-nectar-research-cloud-magnum-service-reviewer
skpm package cncf-ardc-nectar-research-cloud-magnum-service-reviewer
skpm publish cncf-ardc-nectar-research-cloud-magnum-service-reviewer
```
