...
7. Run `skcr validate` and `skcr asps coverage cncf-icon-business-systems-member-reviewer`.
8. Run `skcr compile cncf-icon-business-systems-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-icon-business-systems-member-reviewer`.
...
```bash
skpm validate cncf-icon-business-systems-member-reviewer
skpm package cncf-icon-business-systems-member-reviewer
skpm publish cncf-icon-business-systems-member-reviewer
```
