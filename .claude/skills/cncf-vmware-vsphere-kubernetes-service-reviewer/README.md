...
7. Run `skcr validate` and `skcr asps coverage cncf-vmware-vsphere-kubernetes-service-reviewer`.
8. Run `skcr compile cncf-vmware-vsphere-kubernetes-service-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-vmware-vsphere-kubernetes-service-reviewer`.
...
```bash
skpm validate cncf-vmware-vsphere-kubernetes-service-reviewer
skpm package cncf-vmware-vsphere-kubernetes-service-reviewer
skpm publish cncf-vmware-vsphere-kubernetes-service-reviewer
```
