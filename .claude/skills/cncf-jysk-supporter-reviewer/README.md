...
7. Run `skcr validate` and `skcr asps coverage cncf-jysk-supporter-reviewer`.
8. Run `skcr compile cncf-jysk-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-jysk-supporter-reviewer`.
...
```bash
skpm validate cncf-jysk-supporter-reviewer
skpm package cncf-jysk-supporter-reviewer
skpm publish cncf-jysk-supporter-reviewer
```
