...
7. Run `skcr validate` and `skcr asps coverage cncf-trickster-reviewer`.
8. Run `skcr compile cncf-trickster-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-trickster-reviewer`.
...
```bash
skpm validate cncf-trickster-reviewer
skpm package cncf-trickster-reviewer
skpm publish cncf-trickster-reviewer
```
