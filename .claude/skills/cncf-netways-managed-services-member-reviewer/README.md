...
7. Run `skcr validate` and `skcr asps coverage cncf-netways-managed-services-member-reviewer`.
8. Run `skcr compile cncf-netways-managed-services-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-netways-managed-services-member-reviewer`.
...
```bash
skpm validate cncf-netways-managed-services-member-reviewer
skpm package cncf-netways-managed-services-member-reviewer
skpm publish cncf-netways-managed-services-member-reviewer
```
