...
7. Run `skcr validate` and `skcr asps coverage cncf-bocloud-kcsp-reviewer`.
8. Run `skcr compile cncf-bocloud-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-bocloud-kcsp-reviewer`.
...
```bash
skpm validate cncf-bocloud-kcsp-reviewer
skpm package cncf-bocloud-kcsp-reviewer
skpm publish cncf-bocloud-kcsp-reviewer
```
