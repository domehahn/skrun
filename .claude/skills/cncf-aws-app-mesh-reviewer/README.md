...
7. Run `skcr validate` and `skcr asps coverage cncf-aws-app-mesh-reviewer`.
8. Run `skcr compile cncf-aws-app-mesh-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-aws-app-mesh-reviewer`.
...
```bash
skpm validate cncf-aws-app-mesh-reviewer
skpm package cncf-aws-app-mesh-reviewer
skpm publish cncf-aws-app-mesh-reviewer
```
