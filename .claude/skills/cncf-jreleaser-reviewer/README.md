...
7. Run `skcr validate` and `skcr asps coverage cncf-jreleaser-reviewer`.
8. Run `skcr compile cncf-jreleaser-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-jreleaser-reviewer`.
...
```bash
skpm validate cncf-jreleaser-reviewer
skpm package cncf-jreleaser-reviewer
skpm publish cncf-jreleaser-reviewer
```
