...
7. Run `skcr validate` and `skcr asps coverage cncf-kanister-reviewer`.
8. Run `skcr compile cncf-kanister-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kanister-reviewer`.
...
```bash
skpm validate cncf-kanister-reviewer
skpm package cncf-kanister-reviewer
skpm publish cncf-kanister-reviewer
```
