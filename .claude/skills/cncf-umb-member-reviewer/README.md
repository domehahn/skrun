...
7. Run `skcr validate` and `skcr asps coverage cncf-umb-member-reviewer`.
8. Run `skcr compile cncf-umb-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-umb-member-reviewer`.
...
```bash
skpm validate cncf-umb-member-reviewer
skpm package cncf-umb-member-reviewer
skpm publish cncf-umb-member-reviewer
```
