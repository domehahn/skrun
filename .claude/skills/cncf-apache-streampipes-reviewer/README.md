...
7. Run `skcr validate` and `skcr asps coverage cncf-apache-streampipes-reviewer`.
8. Run `skcr compile cncf-apache-streampipes-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-apache-streampipes-reviewer`.
...
```bash
skpm validate cncf-apache-streampipes-reviewer
skpm package cncf-apache-streampipes-reviewer
skpm publish cncf-apache-streampipes-reviewer
```
