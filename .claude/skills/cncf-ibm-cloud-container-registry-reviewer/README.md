...
7. Run `skcr validate` and `skcr asps coverage cncf-ibm-cloud-container-registry-reviewer`.
8. Run `skcr compile cncf-ibm-cloud-container-registry-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ibm-cloud-container-registry-reviewer`.
...
```bash
skpm validate cncf-ibm-cloud-container-registry-reviewer
skpm package cncf-ibm-cloud-container-registry-reviewer
skpm publish cncf-ibm-cloud-container-registry-reviewer
```
