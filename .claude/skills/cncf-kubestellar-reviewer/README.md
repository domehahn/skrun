...
7. Run `skcr validate` and `skcr asps coverage cncf-kubestellar-reviewer`.
8. Run `skcr compile cncf-kubestellar-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kubestellar-reviewer`.
...
```bash
skpm validate cncf-kubestellar-reviewer
skpm package cncf-kubestellar-reviewer
skpm publish cncf-kubestellar-reviewer
```
