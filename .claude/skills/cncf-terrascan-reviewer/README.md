...
7. Run `skcr validate` and `skcr asps coverage cncf-terrascan-reviewer`.
8. Run `skcr compile cncf-terrascan-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-terrascan-reviewer`.
...
```bash
skpm validate cncf-terrascan-reviewer
skpm package cncf-terrascan-reviewer
skpm publish cncf-terrascan-reviewer
```
