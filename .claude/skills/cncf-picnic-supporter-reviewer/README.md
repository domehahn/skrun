...
7. Run `skcr validate` and `skcr asps coverage cncf-picnic-supporter-reviewer`.
8. Run `skcr compile cncf-picnic-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-picnic-supporter-reviewer`.
...
```bash
skpm validate cncf-picnic-supporter-reviewer
skpm package cncf-picnic-supporter-reviewer
skpm publish cncf-picnic-supporter-reviewer
```
