...
7. Run `skcr validate` and `skcr asps coverage cncf-bytesource-kcsp-reviewer`.
8. Run `skcr compile cncf-bytesource-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-bytesource-kcsp-reviewer`.
...
```bash
skpm validate cncf-bytesource-kcsp-reviewer
skpm package cncf-bytesource-kcsp-reviewer
skpm publish cncf-bytesource-kcsp-reviewer
```
