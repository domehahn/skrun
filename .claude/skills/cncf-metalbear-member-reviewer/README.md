...
7. Run `skcr validate` and `skcr asps coverage cncf-metalbear-member-reviewer`.
8. Run `skcr compile cncf-metalbear-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-metalbear-member-reviewer`.
...
```bash
skpm validate cncf-metalbear-member-reviewer
skpm package cncf-metalbear-member-reviewer
skpm publish cncf-metalbear-member-reviewer
```
