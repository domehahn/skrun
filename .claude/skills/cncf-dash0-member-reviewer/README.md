...
7. Run `skcr validate` and `skcr asps coverage cncf-dash0-member-reviewer`.
8. Run `skcr compile cncf-dash0-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-dash0-member-reviewer`.
...
```bash
skpm validate cncf-dash0-member-reviewer
skpm package cncf-dash0-member-reviewer
skpm publish cncf-dash0-member-reviewer
```
