...
7. Run `skcr validate` and `skcr asps coverage cncf-cloudwego-reviewer`.
8. Run `skcr compile cncf-cloudwego-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloudwego-reviewer`.
...
```bash
skpm validate cncf-cloudwego-reviewer
skpm package cncf-cloudwego-reviewer
skpm publish cncf-cloudwego-reviewer
```
