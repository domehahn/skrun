...
7. Run `skcr validate` and `skcr asps coverage cncf-openresty-reviewer`.
8. Run `skcr compile cncf-openresty-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-openresty-reviewer`.
...
```bash
skpm validate cncf-openresty-reviewer
skpm package cncf-openresty-reviewer
skpm publish cncf-openresty-reviewer
```
