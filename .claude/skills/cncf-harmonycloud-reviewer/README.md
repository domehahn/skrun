...
7. Run `skcr validate` and `skcr asps coverage cncf-harmonycloud-reviewer`.
8. Run `skcr compile cncf-harmonycloud-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-harmonycloud-reviewer`.
...
```bash
skpm validate cncf-harmonycloud-reviewer
skpm package cncf-harmonycloud-reviewer
skpm publish cncf-harmonycloud-reviewer
```
