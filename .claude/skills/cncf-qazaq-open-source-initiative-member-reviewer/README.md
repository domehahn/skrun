...
7. Run `skcr validate` and `skcr asps coverage cncf-qazaq-open-source-initiative-member-reviewer`.
8. Run `skcr compile cncf-qazaq-open-source-initiative-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-qazaq-open-source-initiative-member-reviewer`.
...
```bash
skpm validate cncf-qazaq-open-source-initiative-member-reviewer
skpm package cncf-qazaq-open-source-initiative-member-reviewer
skpm publish cncf-qazaq-open-source-initiative-member-reviewer
```
