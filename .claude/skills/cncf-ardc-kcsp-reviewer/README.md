...
7. Run `skcr validate` and `skcr asps coverage cncf-ardc-kcsp-reviewer`.
8. Run `skcr compile cncf-ardc-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ardc-kcsp-reviewer`.
...
```bash
skpm validate cncf-ardc-kcsp-reviewer
skpm package cncf-ardc-kcsp-reviewer
skpm publish cncf-ardc-kcsp-reviewer
```
