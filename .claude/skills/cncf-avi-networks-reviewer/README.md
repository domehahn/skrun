...
7. Run `skcr validate` and `skcr asps coverage cncf-avi-networks-reviewer`.
8. Run `skcr compile cncf-avi-networks-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-avi-networks-reviewer`.
...
```bash
skpm validate cncf-avi-networks-reviewer
skpm package cncf-avi-networks-reviewer
skpm publish cncf-avi-networks-reviewer
```
