...
7. Run `skcr validate` and `skcr asps coverage cncf-access-quality-kcsp-reviewer`.
8. Run `skcr compile cncf-access-quality-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-access-quality-kcsp-reviewer`.
...
```bash
skpm validate cncf-access-quality-kcsp-reviewer
skpm package cncf-access-quality-kcsp-reviewer
skpm publish cncf-access-quality-kcsp-reviewer
```
