...
7. Run `skcr validate` and `skcr asps coverage cncf-controlmonkey-member-reviewer`.
8. Run `skcr compile cncf-controlmonkey-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-controlmonkey-member-reviewer`.
...
```bash
skpm validate cncf-controlmonkey-member-reviewer
skpm package cncf-controlmonkey-member-reviewer
skpm publish cncf-controlmonkey-member-reviewer
```
