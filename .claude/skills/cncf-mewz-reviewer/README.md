...
7. Run `skcr validate` and `skcr asps coverage cncf-mewz-reviewer`.
8. Run `skcr compile cncf-mewz-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-mewz-reviewer`.
...
```bash
skpm validate cncf-mewz-reviewer
skpm package cncf-mewz-reviewer
skpm publish cncf-mewz-reviewer
```
