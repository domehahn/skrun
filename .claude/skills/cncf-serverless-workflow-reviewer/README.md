...
7. Run `skcr validate` and `skcr asps coverage cncf-serverless-workflow-reviewer`.
8. Run `skcr compile cncf-serverless-workflow-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-serverless-workflow-reviewer`.
...
```bash
skpm validate cncf-serverless-workflow-reviewer
skpm package cncf-serverless-workflow-reviewer
skpm publish cncf-serverless-workflow-reviewer
```
