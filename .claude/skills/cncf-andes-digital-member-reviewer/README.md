...
7. Run `skcr validate` and `skcr asps coverage cncf-andes-digital-member-reviewer`.
8. Run `skcr compile cncf-andes-digital-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-andes-digital-member-reviewer`.
...
```bash
skpm validate cncf-andes-digital-member-reviewer
skpm package cncf-andes-digital-member-reviewer
skpm publish cncf-andes-digital-member-reviewer
```
