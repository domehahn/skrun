...
7. Run `skcr validate` and `skcr asps coverage cncf-nightingale-reviewer`.
8. Run `skcr compile cncf-nightingale-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nightingale-reviewer`.
...
```bash
skpm validate cncf-nightingale-reviewer
skpm package cncf-nightingale-reviewer
skpm publish cncf-nightingale-reviewer
```
