...
7. Run `skcr validate` and `skcr asps coverage cncf-if-information-systems-kcsp-reviewer`.
8. Run `skcr compile cncf-if-information-systems-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-if-information-systems-kcsp-reviewer`.
...
```bash
skpm validate cncf-if-information-systems-kcsp-reviewer
skpm package cncf-if-information-systems-kcsp-reviewer
skpm publish cncf-if-information-systems-kcsp-reviewer
```
