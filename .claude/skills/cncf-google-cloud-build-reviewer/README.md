...
7. Run `skcr validate` and `skcr asps coverage cncf-google-cloud-build-reviewer`.
8. Run `skcr compile cncf-google-cloud-build-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-google-cloud-build-reviewer`.
...
```bash
skpm validate cncf-google-cloud-build-reviewer
skpm package cncf-google-cloud-build-reviewer
skpm publish cncf-google-cloud-build-reviewer
```
