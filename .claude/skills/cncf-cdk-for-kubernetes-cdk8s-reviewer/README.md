...
7. Run `skcr validate` and `skcr asps coverage cncf-cdk-for-kubernetes-cdk8s-reviewer`.
8. Run `skcr compile cncf-cdk-for-kubernetes-cdk8s-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cdk-for-kubernetes-cdk8s-reviewer`.
...
```bash
skpm validate cncf-cdk-for-kubernetes-cdk8s-reviewer
skpm package cncf-cdk-for-kubernetes-cdk8s-reviewer
skpm publish cncf-cdk-for-kubernetes-cdk8s-reviewer
```
