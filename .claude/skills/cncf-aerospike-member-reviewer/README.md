...
7. Run `skcr validate` and `skcr asps coverage cncf-aerospike-member-reviewer`.
8. Run `skcr compile cncf-aerospike-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-aerospike-member-reviewer`.
...
```bash
skpm validate cncf-aerospike-member-reviewer
skpm package cncf-aerospike-member-reviewer
skpm publish cncf-aerospike-member-reviewer
```
