...
7. Run `skcr validate` and `skcr asps coverage cncf-like-minds-consulting-kcsp-reviewer`.
8. Run `skcr compile cncf-like-minds-consulting-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-like-minds-consulting-kcsp-reviewer`.
...
```bash
skpm validate cncf-like-minds-consulting-kcsp-reviewer
skpm package cncf-like-minds-consulting-kcsp-reviewer
skpm publish cncf-like-minds-consulting-kcsp-reviewer
```
