...
7. Run `skcr validate` and `skcr asps coverage cncf-typhoon-reviewer`.
8. Run `skcr compile cncf-typhoon-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-typhoon-reviewer`.
...
```bash
skpm validate cncf-typhoon-reviewer
skpm package cncf-typhoon-reviewer
skpm publish cncf-typhoon-reviewer
```
