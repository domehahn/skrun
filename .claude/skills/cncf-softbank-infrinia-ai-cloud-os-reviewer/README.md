...
7. Run `skcr validate` and `skcr asps coverage cncf-softbank-infrinia-ai-cloud-os-reviewer`.
8. Run `skcr compile cncf-softbank-infrinia-ai-cloud-os-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-softbank-infrinia-ai-cloud-os-reviewer`.
...
```bash
skpm validate cncf-softbank-infrinia-ai-cloud-os-reviewer
skpm package cncf-softbank-infrinia-ai-cloud-os-reviewer
skpm publish cncf-softbank-infrinia-ai-cloud-os-reviewer
```
