...
7. Run `skcr validate` and `skcr asps coverage cncf-arrikto-reviewer`.
8. Run `skcr compile cncf-arrikto-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-arrikto-reviewer`.
...
```bash
skpm validate cncf-arrikto-reviewer
skpm package cncf-arrikto-reviewer
skpm publish cncf-arrikto-reviewer
```
