...
7. Run `skcr validate` and `skcr asps coverage cncf-gientech-container-cloud-platform-gtcp-reviewer`.
8. Run `skcr compile cncf-gientech-container-cloud-platform-gtcp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-gientech-container-cloud-platform-gtcp-reviewer`.
...
```bash
skpm validate cncf-gientech-container-cloud-platform-gtcp-reviewer
skpm package cncf-gientech-container-cloud-platform-gtcp-reviewer
skpm publish cncf-gientech-container-cloud-platform-gtcp-reviewer
```
