...
7. Run `skcr validate` and `skcr asps coverage cncf-apollo-reviewer`.
8. Run `skcr compile cncf-apollo-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-apollo-reviewer`.
...
```bash
skpm validate cncf-apollo-reviewer
skpm package cncf-apollo-reviewer
skpm publish cncf-apollo-reviewer
```
