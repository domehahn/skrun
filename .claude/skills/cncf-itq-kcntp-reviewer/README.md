...
7. Run `skcr validate` and `skcr asps coverage cncf-itq-kcntp-reviewer`.
8. Run `skcr compile cncf-itq-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-itq-kcntp-reviewer`.
...
```bash
skpm validate cncf-itq-kcntp-reviewer
skpm package cncf-itq-kcntp-reviewer
skpm publish cncf-itq-kcntp-reviewer
```
