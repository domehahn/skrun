...
7. Run `skcr validate` and `skcr asps coverage cncf-masterclass-supporter-reviewer`.
8. Run `skcr compile cncf-masterclass-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-masterclass-supporter-reviewer`.
...
```bash
skpm validate cncf-masterclass-supporter-reviewer
skpm package cncf-masterclass-supporter-reviewer
skpm publish cncf-masterclass-supporter-reviewer
```
