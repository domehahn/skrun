...
7. Run `skcr validate` and `skcr asps coverage cncf-liquid-reply-kcsp-reviewer`.
8. Run `skcr compile cncf-liquid-reply-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-liquid-reply-kcsp-reviewer`.
...
```bash
skpm validate cncf-liquid-reply-kcsp-reviewer
skpm package cncf-liquid-reply-kcsp-reviewer
skpm publish cncf-liquid-reply-kcsp-reviewer
```
