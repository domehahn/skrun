...
7. Run `skcr validate` and `skcr asps coverage cncf-matrixx-digital-commerce-reviewer`.
8. Run `skcr compile cncf-matrixx-digital-commerce-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-matrixx-digital-commerce-reviewer`.
...
```bash
skpm validate cncf-matrixx-digital-commerce-reviewer
skpm package cncf-matrixx-digital-commerce-reviewer
skpm publish cncf-matrixx-digital-commerce-reviewer
```
