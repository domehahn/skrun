...
7. Run `skcr validate` and `skcr asps coverage cncf-clush-kube-reviewer`.
8. Run `skcr compile cncf-clush-kube-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-clush-kube-reviewer`.
...
```bash
skpm validate cncf-clush-kube-reviewer
skpm package cncf-clush-kube-reviewer
skpm publish cncf-clush-kube-reviewer
```
