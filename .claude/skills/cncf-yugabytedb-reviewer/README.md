...
7. Run `skcr validate` and `skcr asps coverage cncf-yugabytedb-reviewer`.
8. Run `skcr compile cncf-yugabytedb-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-yugabytedb-reviewer`.
...
```bash
skpm validate cncf-yugabytedb-reviewer
skpm package cncf-yugabytedb-reviewer
skpm publish cncf-yugabytedb-reviewer
```
