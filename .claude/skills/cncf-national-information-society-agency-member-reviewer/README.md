...
7. Run `skcr validate` and `skcr asps coverage cncf-national-information-society-agency-member-reviewer`.
8. Run `skcr compile cncf-national-information-society-agency-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-national-information-society-agency-member-reviewer`.
...
```bash
skpm validate cncf-national-information-society-agency-member-reviewer
skpm package cncf-national-information-society-agency-member-reviewer
skpm publish cncf-national-information-society-agency-member-reviewer
```
