...
7. Run `skcr validate` and `skcr asps coverage cncf-kubedb-by-appscode-reviewer`.
8. Run `skcr compile cncf-kubedb-by-appscode-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kubedb-by-appscode-reviewer`.
...
```bash
skpm validate cncf-kubedb-by-appscode-reviewer
skpm package cncf-kubedb-by-appscode-reviewer
skpm publish cncf-kubedb-by-appscode-reviewer
```
