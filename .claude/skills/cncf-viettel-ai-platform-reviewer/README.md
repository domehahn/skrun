...
7. Run `skcr validate` and `skcr asps coverage cncf-viettel-ai-platform-reviewer`.
8. Run `skcr compile cncf-viettel-ai-platform-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-viettel-ai-platform-reviewer`.
...
```bash
skpm validate cncf-viettel-ai-platform-reviewer
skpm package cncf-viettel-ai-platform-reviewer
skpm publish cncf-viettel-ai-platform-reviewer
```
