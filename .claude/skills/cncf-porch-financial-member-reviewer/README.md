...
7. Run `skcr validate` and `skcr asps coverage cncf-porch-financial-member-reviewer`.
8. Run `skcr compile cncf-porch-financial-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-porch-financial-member-reviewer`.
...
```bash
skpm validate cncf-porch-financial-member-reviewer
skpm package cncf-porch-financial-member-reviewer
skpm publish cncf-porch-financial-member-reviewer
```
