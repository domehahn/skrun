...
7. Run `skcr validate` and `skcr asps coverage cncf-mplat-reviewer`.
8. Run `skcr compile cncf-mplat-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-mplat-reviewer`.
...
```bash
skpm validate cncf-mplat-reviewer
skpm package cncf-mplat-reviewer
skpm publish cncf-mplat-reviewer
```
