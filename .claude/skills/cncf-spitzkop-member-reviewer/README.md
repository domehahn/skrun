...
7. Run `skcr validate` and `skcr asps coverage cncf-spitzkop-member-reviewer`.
8. Run `skcr compile cncf-spitzkop-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-spitzkop-member-reviewer`.
...
```bash
skpm validate cncf-spitzkop-member-reviewer
skpm package cncf-spitzkop-member-reviewer
skpm publish cncf-spitzkop-member-reviewer
```
