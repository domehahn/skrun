...
7. Run `skcr validate` and `skcr asps coverage cncf-cyberark-conjur-reviewer`.
8. Run `skcr compile cncf-cyberark-conjur-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cyberark-conjur-reviewer`.
...
```bash
skpm validate cncf-cyberark-conjur-reviewer
skpm package cncf-cyberark-conjur-reviewer
skpm publish cncf-cyberark-conjur-reviewer
```
