...
7. Run `skcr validate` and `skcr asps coverage cncf-drivescale-reviewer`.
8. Run `skcr compile cncf-drivescale-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-drivescale-reviewer`.
...
```bash
skpm validate cncf-drivescale-reviewer
skpm package cncf-drivescale-reviewer
skpm publish cncf-drivescale-reviewer
```
