...
7. Run `skcr validate` and `skcr asps coverage cncf-goldman-sachs-member-reviewer`.
8. Run `skcr compile cncf-goldman-sachs-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-goldman-sachs-member-reviewer`.
...
```bash
skpm validate cncf-goldman-sachs-member-reviewer
skpm package cncf-goldman-sachs-member-reviewer
skpm publish cncf-goldman-sachs-member-reviewer
```
