...
7. Run `skcr validate` and `skcr asps coverage cncf-marimo-reviewer`.
8. Run `skcr compile cncf-marimo-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-marimo-reviewer`.
...
```bash
skpm validate cncf-marimo-reviewer
skpm package cncf-marimo-reviewer
skpm publish cncf-marimo-reviewer
```
