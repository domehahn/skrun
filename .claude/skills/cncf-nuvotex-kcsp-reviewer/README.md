...
7. Run `skcr validate` and `skcr asps coverage cncf-nuvotex-kcsp-reviewer`.
8. Run `skcr compile cncf-nuvotex-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nuvotex-kcsp-reviewer`.
...
```bash
skpm validate cncf-nuvotex-kcsp-reviewer
skpm package cncf-nuvotex-kcsp-reviewer
skpm publish cncf-nuvotex-kcsp-reviewer
```
