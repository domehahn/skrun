...
7. Run `skcr validate` and `skcr asps coverage cncf-volvo-contributor-reviewer`.
8. Run `skcr compile cncf-volvo-contributor-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-volvo-contributor-reviewer`.
...
```bash
skpm validate cncf-volvo-contributor-reviewer
skpm package cncf-volvo-contributor-reviewer
skpm publish cncf-volvo-contributor-reviewer
```
