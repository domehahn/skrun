...
7. Run `skcr validate` and `skcr asps coverage cncf-passage-reviewer`.
8. Run `skcr compile cncf-passage-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-passage-reviewer`.
...
```bash
skpm validate cncf-passage-reviewer
skpm package cncf-passage-reviewer
skpm publish cncf-passage-reviewer
```
