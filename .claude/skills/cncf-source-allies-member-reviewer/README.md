...
7. Run `skcr validate` and `skcr asps coverage cncf-source-allies-member-reviewer`.
8. Run `skcr compile cncf-source-allies-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-source-allies-member-reviewer`.
...
```bash
skpm validate cncf-source-allies-member-reviewer
skpm package cncf-source-allies-member-reviewer
skpm publish cncf-source-allies-member-reviewer
```
