...
7. Run `skcr validate` and `skcr asps coverage cncf-itq-kcsp-reviewer`.
8. Run `skcr compile cncf-itq-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-itq-kcsp-reviewer`.
...
```bash
skpm validate cncf-itq-kcsp-reviewer
skpm package cncf-itq-kcsp-reviewer
skpm publish cncf-itq-kcsp-reviewer
```
