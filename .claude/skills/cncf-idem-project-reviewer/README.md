...
7. Run `skcr validate` and `skcr asps coverage cncf-idem-project-reviewer`.
8. Run `skcr compile cncf-idem-project-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-idem-project-reviewer`.
...
```bash
skpm validate cncf-idem-project-reviewer
skpm package cncf-idem-project-reviewer
skpm publish cncf-idem-project-reviewer
```
