...
7. Run `skcr validate` and `skcr asps coverage cncf-brobridge-kcsp-reviewer`.
8. Run `skcr compile cncf-brobridge-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-brobridge-kcsp-reviewer`.
...
```bash
skpm validate cncf-brobridge-kcsp-reviewer
skpm package cncf-brobridge-kcsp-reviewer
skpm publish cncf-brobridge-kcsp-reviewer
```
