...
7. Run `skcr validate` and `skcr asps coverage cncf-akka-reviewer`.
8. Run `skcr compile cncf-akka-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-akka-reviewer`.
...
```bash
skpm validate cncf-akka-reviewer
skpm package cncf-akka-reviewer
skpm publish cncf-akka-reviewer
```
