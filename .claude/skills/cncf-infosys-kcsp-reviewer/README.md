...
7. Run `skcr validate` and `skcr asps coverage cncf-infosys-kcsp-reviewer`.
8. Run `skcr compile cncf-infosys-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-infosys-kcsp-reviewer`.
...
```bash
skpm validate cncf-infosys-kcsp-reviewer
skpm package cncf-infosys-kcsp-reviewer
skpm publish cncf-infosys-kcsp-reviewer
```
