...
7. Run `skcr validate` and `skcr asps coverage cncf-modelcontextprotocol-reviewer`.
8. Run `skcr compile cncf-modelcontextprotocol-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-modelcontextprotocol-reviewer`.
...
```bash
skpm validate cncf-modelcontextprotocol-reviewer
skpm package cncf-modelcontextprotocol-reviewer
skpm publish cncf-modelcontextprotocol-reviewer
```
