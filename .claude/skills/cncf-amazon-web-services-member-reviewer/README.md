...
7. Run `skcr validate` and `skcr asps coverage cncf-amazon-web-services-member-reviewer`.
8. Run `skcr compile cncf-amazon-web-services-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-amazon-web-services-member-reviewer`.
...
```bash
skpm validate cncf-amazon-web-services-member-reviewer
skpm package cncf-amazon-web-services-member-reviewer
skpm publish cncf-amazon-web-services-member-reviewer
```
