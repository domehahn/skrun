...
7. Run `skcr validate` and `skcr asps coverage cncf-wamr-reviewer`.
8. Run `skcr compile cncf-wamr-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-wamr-reviewer`.
...
```bash
skpm validate cncf-wamr-reviewer
skpm package cncf-wamr-reviewer
skpm publish cncf-wamr-reviewer
```
