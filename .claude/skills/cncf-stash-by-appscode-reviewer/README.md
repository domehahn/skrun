...
7. Run `skcr validate` and `skcr asps coverage cncf-stash-by-appscode-reviewer`.
8. Run `skcr compile cncf-stash-by-appscode-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-stash-by-appscode-reviewer`.
...
```bash
skpm validate cncf-stash-by-appscode-reviewer
skpm package cncf-stash-by-appscode-reviewer
skpm publish cncf-stash-by-appscode-reviewer
```
