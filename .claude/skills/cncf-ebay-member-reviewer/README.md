...
7. Run `skcr validate` and `skcr asps coverage cncf-ebay-member-reviewer`.
8. Run `skcr compile cncf-ebay-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ebay-member-reviewer`.
...
```bash
skpm validate cncf-ebay-member-reviewer
skpm package cncf-ebay-member-reviewer
skpm publish cncf-ebay-member-reviewer
```
