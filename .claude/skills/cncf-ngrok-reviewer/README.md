...
7. Run `skcr validate` and `skcr asps coverage cncf-ngrok-reviewer`.
8. Run `skcr compile cncf-ngrok-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ngrok-reviewer`.
...
```bash
skpm validate cncf-ngrok-reviewer
skpm package cncf-ngrok-reviewer
skpm publish cncf-ngrok-reviewer
```
