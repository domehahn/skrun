...
7. Run `skcr validate` and `skcr asps coverage cncf-ericsson-member-reviewer`.
8. Run `skcr compile cncf-ericsson-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ericsson-member-reviewer`.
...
```bash
skpm validate cncf-ericsson-member-reviewer
skpm package cncf-ericsson-member-reviewer
skpm publish cncf-ericsson-member-reviewer
```
