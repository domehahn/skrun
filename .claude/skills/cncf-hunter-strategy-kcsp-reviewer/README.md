...
7. Run `skcr validate` and `skcr asps coverage cncf-hunter-strategy-kcsp-reviewer`.
8. Run `skcr compile cncf-hunter-strategy-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-hunter-strategy-kcsp-reviewer`.
...
```bash
skpm validate cncf-hunter-strategy-kcsp-reviewer
skpm package cncf-hunter-strategy-kcsp-reviewer
skpm publish cncf-hunter-strategy-kcsp-reviewer
```
