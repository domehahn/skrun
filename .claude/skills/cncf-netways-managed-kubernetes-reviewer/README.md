...
7. Run `skcr validate` and `skcr asps coverage cncf-netways-managed-kubernetes-reviewer`.
8. Run `skcr compile cncf-netways-managed-kubernetes-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-netways-managed-kubernetes-reviewer`.
...
```bash
skpm validate cncf-netways-managed-kubernetes-reviewer
skpm package cncf-netways-managed-kubernetes-reviewer
skpm publish cncf-netways-managed-kubernetes-reviewer
```
