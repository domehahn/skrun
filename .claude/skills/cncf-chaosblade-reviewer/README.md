...
7. Run `skcr validate` and `skcr asps coverage cncf-chaosblade-reviewer`.
8. Run `skcr compile cncf-chaosblade-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-chaosblade-reviewer`.
...
```bash
skpm validate cncf-chaosblade-reviewer
skpm package cncf-chaosblade-reviewer
skpm publish cncf-chaosblade-reviewer
```
