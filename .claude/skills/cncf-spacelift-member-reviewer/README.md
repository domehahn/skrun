...
7. Run `skcr validate` and `skcr asps coverage cncf-spacelift-member-reviewer`.
8. Run `skcr compile cncf-spacelift-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-spacelift-member-reviewer`.
...
```bash
skpm validate cncf-spacelift-member-reviewer
skpm package cncf-spacelift-member-reviewer
skpm publish cncf-spacelift-member-reviewer
```
