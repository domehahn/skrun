...
7. Run `skcr validate` and `skcr asps coverage cncf-salt-project-reviewer`.
8. Run `skcr compile cncf-salt-project-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-salt-project-reviewer`.
...
```bash
skpm validate cncf-salt-project-reviewer
skpm package cncf-salt-project-reviewer
skpm publish cncf-salt-project-reviewer
```
