...
7. Run `skcr validate` and `skcr asps coverage cncf-kublr-reviewer`.
8. Run `skcr compile cncf-kublr-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kublr-reviewer`.
...
```bash
skpm validate cncf-kublr-reviewer
skpm package cncf-kublr-reviewer
skpm publish cncf-kublr-reviewer
```
