...
7. Run `skcr validate` and `skcr asps coverage cncf-sap-kcsp-reviewer`.
8. Run `skcr compile cncf-sap-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sap-kcsp-reviewer`.
...
```bash
skpm validate cncf-sap-kcsp-reviewer
skpm package cncf-sap-kcsp-reviewer
skpm publish cncf-sap-kcsp-reviewer
```
