...
7. Run `skcr validate` and `skcr asps coverage cncf-stackgen-member-reviewer`.
8. Run `skcr compile cncf-stackgen-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-stackgen-member-reviewer`.
...
```bash
skpm validate cncf-stackgen-member-reviewer
skpm package cncf-stackgen-member-reviewer
skpm publish cncf-stackgen-member-reviewer
```
