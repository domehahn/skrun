...
7. Run `skcr validate` and `skcr asps coverage cncf-blue-matador-reviewer`.
8. Run `skcr compile cncf-blue-matador-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-blue-matador-reviewer`.
...
```bash
skpm validate cncf-blue-matador-reviewer
skpm package cncf-blue-matador-reviewer
skpm publish cncf-blue-matador-reviewer
```
