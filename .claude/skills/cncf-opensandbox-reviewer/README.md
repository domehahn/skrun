...
7. Run `skcr validate` and `skcr asps coverage cncf-opensandbox-reviewer`.
8. Run `skcr compile cncf-opensandbox-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-opensandbox-reviewer`.
...
```bash
skpm validate cncf-opensandbox-reviewer
skpm package cncf-opensandbox-reviewer
skpm publish cncf-opensandbox-reviewer
```
