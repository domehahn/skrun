...
7. Run `skcr validate` and `skcr asps coverage cncf-agent-development-kit-reviewer`.
8. Run `skcr compile cncf-agent-development-kit-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-agent-development-kit-reviewer`.
...
```bash
skpm validate cncf-agent-development-kit-reviewer
skpm package cncf-agent-development-kit-reviewer
skpm publish cncf-agent-development-kit-reviewer
```
