...
7. Run `skcr validate` and `skcr asps coverage cncf-stackhawk-reviewer`.
8. Run `skcr compile cncf-stackhawk-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-stackhawk-reviewer`.
...
```bash
skpm validate cncf-stackhawk-reviewer
skpm package cncf-stackhawk-reviewer
skpm publish cncf-stackhawk-reviewer
```
