...
7. Run `skcr validate` and `skcr asps coverage cncf-tomtom-supporter-reviewer`.
8. Run `skcr compile cncf-tomtom-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-tomtom-supporter-reviewer`.
...
```bash
skpm validate cncf-tomtom-supporter-reviewer
skpm package cncf-tomtom-supporter-reviewer
skpm publish cncf-tomtom-supporter-reviewer
```
