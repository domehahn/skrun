...
7. Run `skcr validate` and `skcr asps coverage cncf-dragonfly-reviewer`.
8. Run `skcr compile cncf-dragonfly-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-dragonfly-reviewer`.
...
```bash
skpm validate cncf-dragonfly-reviewer
skpm package cncf-dragonfly-reviewer
skpm publish cncf-dragonfly-reviewer
```
