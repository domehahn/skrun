...
7. Run `skcr validate` and `skcr asps coverage cncf-baidu-cloud-function-compute-reviewer`.
8. Run `skcr compile cncf-baidu-cloud-function-compute-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-baidu-cloud-function-compute-reviewer`.
...
```bash
skpm validate cncf-baidu-cloud-function-compute-reviewer
skpm package cncf-baidu-cloud-function-compute-reviewer
skpm publish cncf-baidu-cloud-function-compute-reviewer
```
