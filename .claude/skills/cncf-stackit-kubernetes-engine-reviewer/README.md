...
7. Run `skcr validate` and `skcr asps coverage cncf-stackit-kubernetes-engine-reviewer`.
8. Run `skcr compile cncf-stackit-kubernetes-engine-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-stackit-kubernetes-engine-reviewer`.
...
```bash
skpm validate cncf-stackit-kubernetes-engine-reviewer
skpm package cncf-stackit-kubernetes-engine-reviewer
skpm publish cncf-stackit-kubernetes-engine-reviewer
```
