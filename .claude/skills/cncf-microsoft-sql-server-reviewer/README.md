...
7. Run `skcr validate` and `skcr asps coverage cncf-microsoft-sql-server-reviewer`.
8. Run `skcr compile cncf-microsoft-sql-server-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-microsoft-sql-server-reviewer`.
...
```bash
skpm validate cncf-microsoft-sql-server-reviewer
skpm package cncf-microsoft-sql-server-reviewer
skpm publish cncf-microsoft-sql-server-reviewer
```
