...
7. Run `skcr validate` and `skcr asps coverage stripe-integration-engineer`.
8. Run `skcr compile stripe-integration-engineer --target skil`.
9. Run `skcr sync` and `skcr version recommend stripe-integration-engineer`.
...
```bash
skpm validate stripe-integration-engineer
skpm package stripe-integration-engineer
skpm publish stripe-integration-engineer
```
