...
7. Run `skcr validate` and `skcr asps coverage cncf-oauth2-proxy-reviewer`.
8. Run `skcr compile cncf-oauth2-proxy-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-oauth2-proxy-reviewer`.
...
```bash
skpm validate cncf-oauth2-proxy-reviewer
skpm package cncf-oauth2-proxy-reviewer
skpm publish cncf-oauth2-proxy-reviewer
```
