...
7. Run `skcr validate` and `skcr asps coverage cncf-project-jupyter-reviewer`.
8. Run `skcr compile cncf-project-jupyter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-project-jupyter-reviewer`.
...
```bash
skpm validate cncf-project-jupyter-reviewer
skpm package cncf-project-jupyter-reviewer
skpm publish cncf-project-jupyter-reviewer
```
