...
7. Run `skcr validate` and `skcr asps coverage cncf-terramate-member-reviewer`.
8. Run `skcr compile cncf-terramate-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-terramate-member-reviewer`.
...
```bash
skpm validate cncf-terramate-member-reviewer
skpm package cncf-terramate-member-reviewer
skpm publish cncf-terramate-member-reviewer
```
