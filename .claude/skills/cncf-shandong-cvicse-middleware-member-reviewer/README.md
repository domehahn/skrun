...
7. Run `skcr validate` and `skcr asps coverage cncf-shandong-cvicse-middleware-member-reviewer`.
8. Run `skcr compile cncf-shandong-cvicse-middleware-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-shandong-cvicse-middleware-member-reviewer`.
...
```bash
skpm validate cncf-shandong-cvicse-middleware-member-reviewer
skpm package cncf-shandong-cvicse-middleware-member-reviewer
skpm publish cncf-shandong-cvicse-middleware-member-reviewer
```
