...
7. Run `skcr validate` and `skcr asps coverage cncf-nodesource-reviewer`.
8. Run `skcr compile cncf-nodesource-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nodesource-reviewer`.
...
```bash
skpm validate cncf-nodesource-reviewer
skpm package cncf-nodesource-reviewer
skpm publish cncf-nodesource-reviewer
```
