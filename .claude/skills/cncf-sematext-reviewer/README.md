...
7. Run `skcr validate` and `skcr asps coverage cncf-sematext-reviewer`.
8. Run `skcr compile cncf-sematext-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sematext-reviewer`.
...
```bash
skpm validate cncf-sematext-reviewer
skpm package cncf-sematext-reviewer
skpm publish cncf-sematext-reviewer
```
