...
7. Run `skcr validate` and `skcr asps coverage ict-risk-management-reviewer`.
8. Run `skcr compile ict-risk-management-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend ict-risk-management-reviewer`.
