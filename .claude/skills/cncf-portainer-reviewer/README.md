...
7. Run `skcr validate` and `skcr asps coverage cncf-portainer-reviewer`.
8. Run `skcr compile cncf-portainer-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-portainer-reviewer`.
...
```bash
skpm validate cncf-portainer-reviewer
skpm package cncf-portainer-reviewer
skpm publish cncf-portainer-reviewer
```
