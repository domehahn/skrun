...
7. Run `skcr validate` and `skcr asps coverage cncf-encore-reviewer`.
8. Run `skcr compile cncf-encore-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-encore-reviewer`.
...
```bash
skpm validate cncf-encore-reviewer
skpm package cncf-encore-reviewer
skpm publish cncf-encore-reviewer
```
