...
7. Run `skcr validate` and `skcr asps coverage cncf-socradev-gmbh-kcsp-reviewer`.
8. Run `skcr compile cncf-socradev-gmbh-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-socradev-gmbh-kcsp-reviewer`.
...
```bash
skpm validate cncf-socradev-gmbh-kcsp-reviewer
skpm package cncf-socradev-gmbh-kcsp-reviewer
skpm publish cncf-socradev-gmbh-kcsp-reviewer
```
