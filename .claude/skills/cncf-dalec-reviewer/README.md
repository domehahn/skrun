...
7. Run `skcr validate` and `skcr asps coverage cncf-dalec-reviewer`.
8. Run `skcr compile cncf-dalec-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-dalec-reviewer`.
...
```bash
skpm validate cncf-dalec-reviewer
skpm package cncf-dalec-reviewer
skpm publish cncf-dalec-reviewer
```
