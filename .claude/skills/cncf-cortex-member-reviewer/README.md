...
7. Run `skcr validate` and `skcr asps coverage cncf-cortex-member-reviewer`.
8. Run `skcr compile cncf-cortex-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cortex-member-reviewer`.
...
```bash
skpm validate cncf-cortex-member-reviewer
skpm package cncf-cortex-member-reviewer
skpm publish cncf-cortex-member-reviewer
```
