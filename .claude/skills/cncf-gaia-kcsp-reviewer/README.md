...
7. Run `skcr validate` and `skcr asps coverage cncf-gaia-kcsp-reviewer`.
8. Run `skcr compile cncf-gaia-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-gaia-kcsp-reviewer`.
...
```bash
skpm validate cncf-gaia-kcsp-reviewer
skpm package cncf-gaia-kcsp-reviewer
skpm publish cncf-gaia-kcsp-reviewer
```
