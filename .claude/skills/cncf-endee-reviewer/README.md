...
7. Run `skcr validate` and `skcr asps coverage cncf-endee-reviewer`.
8. Run `skcr compile cncf-endee-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-endee-reviewer`.
...
```bash
skpm validate cncf-endee-reviewer
skpm package cncf-endee-reviewer
skpm publish cncf-endee-reviewer
```
