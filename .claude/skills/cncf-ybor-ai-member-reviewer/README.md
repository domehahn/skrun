...
7. Run `skcr validate` and `skcr asps coverage cncf-ybor-ai-member-reviewer`.
8. Run `skcr compile cncf-ybor-ai-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ybor-ai-member-reviewer`.
...
```bash
skpm validate cncf-ybor-ai-member-reviewer
skpm package cncf-ybor-ai-member-reviewer
skpm publish cncf-ybor-ai-member-reviewer
```
