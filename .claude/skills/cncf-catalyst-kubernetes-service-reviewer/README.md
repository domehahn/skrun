...
7. Run `skcr validate` and `skcr asps coverage cncf-catalyst-kubernetes-service-reviewer`.
8. Run `skcr compile cncf-catalyst-kubernetes-service-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-catalyst-kubernetes-service-reviewer`.
...
```bash
skpm validate cncf-catalyst-kubernetes-service-reviewer
skpm package cncf-catalyst-kubernetes-service-reviewer
skpm publish cncf-catalyst-kubernetes-service-reviewer
```
