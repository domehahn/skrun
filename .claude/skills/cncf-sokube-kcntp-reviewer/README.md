...
7. Run `skcr validate` and `skcr asps coverage cncf-sokube-kcntp-reviewer`.
8. Run `skcr compile cncf-sokube-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sokube-kcntp-reviewer`.
...
```bash
skpm validate cncf-sokube-kcntp-reviewer
skpm package cncf-sokube-kcntp-reviewer
skpm publish cncf-sokube-kcntp-reviewer
```
