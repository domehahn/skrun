...
7. Run `skcr validate` and `skcr asps coverage cncf-cariad-supporter-reviewer`.
8. Run `skcr compile cncf-cariad-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cariad-supporter-reviewer`.
...
```bash
skpm validate cncf-cariad-supporter-reviewer
skpm package cncf-cariad-supporter-reviewer
skpm publish cncf-cariad-supporter-reviewer
```
