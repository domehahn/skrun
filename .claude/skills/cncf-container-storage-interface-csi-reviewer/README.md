...
7. Run `skcr validate` and `skcr asps coverage cncf-container-storage-interface-csi-reviewer`.
8. Run `skcr compile cncf-container-storage-interface-csi-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-container-storage-interface-csi-reviewer`.
...
```bash
skpm validate cncf-container-storage-interface-csi-reviewer
skpm package cncf-container-storage-interface-csi-reviewer
skpm publish cncf-container-storage-interface-csi-reviewer
```
