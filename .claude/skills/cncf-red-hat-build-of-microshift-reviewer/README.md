...
7. Run `skcr validate` and `skcr asps coverage cncf-red-hat-build-of-microshift-reviewer`.
8. Run `skcr compile cncf-red-hat-build-of-microshift-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-red-hat-build-of-microshift-reviewer`.
...
```bash
skpm validate cncf-red-hat-build-of-microshift-reviewer
skpm package cncf-red-hat-build-of-microshift-reviewer
skpm publish cncf-red-hat-build-of-microshift-reviewer
```
