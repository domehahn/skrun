...
7. Run `skcr validate` and `skcr asps coverage cncf-greymatter-io-reviewer`.
8. Run `skcr compile cncf-greymatter-io-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-greymatter-io-reviewer`.
...
```bash
skpm validate cncf-greymatter-io-reviewer
skpm package cncf-greymatter-io-reviewer
skpm publish cncf-greymatter-io-reviewer
```
