...
7. Run `skcr validate` and `skcr asps coverage cncf-embrace-reviewer`.
8. Run `skcr compile cncf-embrace-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-embrace-reviewer`.
...
```bash
skpm validate cncf-embrace-reviewer
skpm package cncf-embrace-reviewer
skpm publish cncf-embrace-reviewer
```
