...
7. Run `skcr validate` and `skcr asps coverage cncf-sysdig-kcsp-reviewer`.
8. Run `skcr compile cncf-sysdig-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sysdig-kcsp-reviewer`.
...
```bash
skpm validate cncf-sysdig-kcsp-reviewer
skpm package cncf-sysdig-kcsp-reviewer
skpm publish cncf-sysdig-kcsp-reviewer
```
