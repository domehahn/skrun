...
7. Run `skcr validate` and `skcr asps coverage cncf-nuclio-reviewer`.
8. Run `skcr compile cncf-nuclio-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nuclio-reviewer`.
...
```bash
skpm validate cncf-nuclio-reviewer
skpm package cncf-nuclio-reviewer
skpm publish cncf-nuclio-reviewer
```
