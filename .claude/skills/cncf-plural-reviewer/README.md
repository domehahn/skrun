...
7. Run `skcr validate` and `skcr asps coverage cncf-plural-reviewer`.
8. Run `skcr compile cncf-plural-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-plural-reviewer`.
...
```bash
skpm validate cncf-plural-reviewer
skpm package cncf-plural-reviewer
skpm publish cncf-plural-reviewer
```
