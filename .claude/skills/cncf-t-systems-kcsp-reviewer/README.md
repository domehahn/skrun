...
7. Run `skcr validate` and `skcr asps coverage cncf-t-systems-kcsp-reviewer`.
8. Run `skcr compile cncf-t-systems-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-t-systems-kcsp-reviewer`.
...
```bash
skpm validate cncf-t-systems-kcsp-reviewer
skpm package cncf-t-systems-kcsp-reviewer
skpm publish cncf-t-systems-kcsp-reviewer
```
