...
7. Run `skcr validate` and `skcr asps coverage cncf-sighup-distribution-reviewer`.
8. Run `skcr compile cncf-sighup-distribution-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sighup-distribution-reviewer`.
...
```bash
skpm validate cncf-sighup-distribution-reviewer
skpm package cncf-sighup-distribution-reviewer
skpm publish cncf-sighup-distribution-reviewer
```
