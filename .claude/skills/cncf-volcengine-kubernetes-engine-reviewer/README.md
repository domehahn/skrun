...
7. Run `skcr validate` and `skcr asps coverage cncf-volcengine-kubernetes-engine-reviewer`.
8. Run `skcr compile cncf-volcengine-kubernetes-engine-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-volcengine-kubernetes-engine-reviewer`.
...
```bash
skpm validate cncf-volcengine-kubernetes-engine-reviewer
skpm package cncf-volcengine-kubernetes-engine-reviewer
skpm publish cncf-volcengine-kubernetes-engine-reviewer
```
