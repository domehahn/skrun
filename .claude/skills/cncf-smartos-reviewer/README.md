...
7. Run `skcr validate` and `skcr asps coverage cncf-smartos-reviewer`.
8. Run `skcr compile cncf-smartos-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-smartos-reviewer`.
...
```bash
skpm validate cncf-smartos-reviewer
skpm package cncf-smartos-reviewer
skpm publish cncf-smartos-reviewer
```
