...
7. Run `skcr validate` and `skcr asps coverage cncf-aws-lambda-reviewer`.
8. Run `skcr compile cncf-aws-lambda-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-aws-lambda-reviewer`.
...
```bash
skpm validate cncf-aws-lambda-reviewer
skpm package cncf-aws-lambda-reviewer
skpm publish cncf-aws-lambda-reviewer
```
