...
7. Run `skcr validate` and `skcr asps coverage cncf-unleash-reviewer`.
8. Run `skcr compile cncf-unleash-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-unleash-reviewer`.
...
```bash
skpm validate cncf-unleash-reviewer
skpm package cncf-unleash-reviewer
skpm publish cncf-unleash-reviewer
```
