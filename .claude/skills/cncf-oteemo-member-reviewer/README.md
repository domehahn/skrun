...
7. Run `skcr validate` and `skcr asps coverage cncf-oteemo-member-reviewer`.
8. Run `skcr compile cncf-oteemo-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-oteemo-member-reviewer`.
...
```bash
skpm validate cncf-oteemo-member-reviewer
skpm package cncf-oteemo-member-reviewer
skpm publish cncf-oteemo-member-reviewer
```
