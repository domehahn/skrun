...
7. Run `skcr validate` and `skcr asps coverage cncf-cloudgeometry-member-reviewer`.
8. Run `skcr compile cncf-cloudgeometry-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloudgeometry-member-reviewer`.
...
```bash
skpm validate cncf-cloudgeometry-member-reviewer
skpm package cncf-cloudgeometry-member-reviewer
skpm publish cncf-cloudgeometry-member-reviewer
```
