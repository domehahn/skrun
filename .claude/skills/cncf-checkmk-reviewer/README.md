...
7. Run `skcr validate` and `skcr asps coverage cncf-checkmk-reviewer`.
8. Run `skcr compile cncf-checkmk-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-checkmk-reviewer`.
...
```bash
skpm validate cncf-checkmk-reviewer
skpm package cncf-checkmk-reviewer
skpm publish cncf-checkmk-reviewer
```
