...
7. Run `skcr validate` and `skcr asps coverage cncf-pinpoint-reviewer`.
8. Run `skcr compile cncf-pinpoint-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-pinpoint-reviewer`.
...
```bash
skpm validate cncf-pinpoint-reviewer
skpm package cncf-pinpoint-reviewer
skpm publish cncf-pinpoint-reviewer
```
