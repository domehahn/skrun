...
7. Run `skcr validate` and `skcr asps coverage cncf-storm-reply-kcntp-reviewer`.
8. Run `skcr compile cncf-storm-reply-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-storm-reply-kcntp-reviewer`.
...
```bash
skpm validate cncf-storm-reply-kcntp-reviewer
skpm package cncf-storm-reply-kcntp-reviewer
skpm publish cncf-storm-reply-kcntp-reviewer
```
