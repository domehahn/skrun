...
7. Run `skcr validate` and `skcr asps coverage cncf-kloudfuse-member-reviewer`.
8. Run `skcr compile cncf-kloudfuse-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kloudfuse-member-reviewer`.
...
```bash
skpm validate cncf-kloudfuse-member-reviewer
skpm package cncf-kloudfuse-member-reviewer
skpm publish cncf-kloudfuse-member-reviewer
```
