...
7. Run `skcr validate` and `skcr asps coverage kubernetes-platform-reviewer`.
8. Run `skcr compile kubernetes-platform-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend kubernetes-platform-reviewer`.
...
```bash
skpm validate kubernetes-platform-reviewer
skpm package kubernetes-platform-reviewer
skpm publish kubernetes-platform-reviewer
```
