...
7. Run `skcr validate` and `skcr asps coverage cncf-kubeblocks-by-apecloud-reviewer`.
8. Run `skcr compile cncf-kubeblocks-by-apecloud-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kubeblocks-by-apecloud-reviewer`.
...
```bash
skpm validate cncf-kubeblocks-by-apecloud-reviewer
skpm package cncf-kubeblocks-by-apecloud-reviewer
skpm publish cncf-kubeblocks-by-apecloud-reviewer
```
