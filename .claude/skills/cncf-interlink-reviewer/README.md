...
7. Run `skcr validate` and `skcr asps coverage cncf-interlink-reviewer`.
8. Run `skcr compile cncf-interlink-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-interlink-reviewer`.
...
```bash
skpm validate cncf-interlink-reviewer
skpm package cncf-interlink-reviewer
skpm publish cncf-interlink-reviewer
```
