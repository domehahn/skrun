...
7. Run `skcr validate` and `skcr asps coverage cncf-netlify-functions-reviewer`.
8. Run `skcr compile cncf-netlify-functions-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-netlify-functions-reviewer`.
...
```bash
skpm validate cncf-netlify-functions-reviewer
skpm package cncf-netlify-functions-reviewer
skpm publish cncf-netlify-functions-reviewer
```
