...
7. Run `skcr validate` and `skcr asps coverage cncf-red-hat-member-reviewer`.
8. Run `skcr compile cncf-red-hat-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-red-hat-member-reviewer`.
...
```bash
skpm validate cncf-red-hat-member-reviewer
skpm package cncf-red-hat-member-reviewer
skpm publish cncf-red-hat-member-reviewer
```
