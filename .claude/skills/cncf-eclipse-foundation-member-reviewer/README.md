...
7. Run `skcr validate` and `skcr asps coverage cncf-eclipse-foundation-member-reviewer`.
8. Run `skcr compile cncf-eclipse-foundation-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-eclipse-foundation-member-reviewer`.
...
```bash
skpm validate cncf-eclipse-foundation-member-reviewer
skpm package cncf-eclipse-foundation-member-reviewer
skpm publish cncf-eclipse-foundation-member-reviewer
```
