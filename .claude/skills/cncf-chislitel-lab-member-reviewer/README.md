...
7. Run `skcr validate` and `skcr asps coverage cncf-chislitel-lab-member-reviewer`.
8. Run `skcr compile cncf-chislitel-lab-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-chislitel-lab-member-reviewer`.
...
```bash
skpm validate cncf-chislitel-lab-member-reviewer
skpm package cncf-chislitel-lab-member-reviewer
skpm publish cncf-chislitel-lab-member-reviewer
```
