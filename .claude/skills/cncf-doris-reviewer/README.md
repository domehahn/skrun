...
7. Run `skcr validate` and `skcr asps coverage cncf-doris-reviewer`.
8. Run `skcr compile cncf-doris-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-doris-reviewer`.
...
```bash
skpm validate cncf-doris-reviewer
skpm package cncf-doris-reviewer
skpm publish cncf-doris-reviewer
```
