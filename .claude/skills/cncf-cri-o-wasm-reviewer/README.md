...
7. Run `skcr validate` and `skcr asps coverage cncf-cri-o-wasm-reviewer`.
8. Run `skcr compile cncf-cri-o-wasm-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cri-o-wasm-reviewer`.
...
```bash
skpm validate cncf-cri-o-wasm-reviewer
skpm package cncf-cri-o-wasm-reviewer
skpm publish cncf-cri-o-wasm-reviewer
```
