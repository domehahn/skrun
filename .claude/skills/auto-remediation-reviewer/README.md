...
7. Run `skcr validate` and `skcr asps coverage auto-remediation-reviewer`.
8. Run `skcr compile auto-remediation-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend auto-remediation-reviewer`.
