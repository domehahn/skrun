...
7. Run `skcr validate` and `skcr asps coverage cncf-beam-reviewer`.
8. Run `skcr compile cncf-beam-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-beam-reviewer`.
...
```bash
skpm validate cncf-beam-reviewer
skpm package cncf-beam-reviewer
skpm publish cncf-beam-reviewer
```
