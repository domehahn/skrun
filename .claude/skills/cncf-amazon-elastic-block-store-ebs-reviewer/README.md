...
7. Run `skcr validate` and `skcr asps coverage cncf-amazon-elastic-block-store-ebs-reviewer`.
8. Run `skcr compile cncf-amazon-elastic-block-store-ebs-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-amazon-elastic-block-store-ebs-reviewer`.
...
```bash
skpm validate cncf-amazon-elastic-block-store-ebs-reviewer
skpm package cncf-amazon-elastic-block-store-ebs-reviewer
skpm publish cncf-amazon-elastic-block-store-ebs-reviewer
```
