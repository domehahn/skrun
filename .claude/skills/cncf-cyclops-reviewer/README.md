...
7. Run `skcr validate` and `skcr asps coverage cncf-cyclops-reviewer`.
8. Run `skcr compile cncf-cyclops-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cyclops-reviewer`.
...
```bash
skpm validate cncf-cyclops-reviewer
skpm package cncf-cyclops-reviewer
skpm publish cncf-cyclops-reviewer
```
