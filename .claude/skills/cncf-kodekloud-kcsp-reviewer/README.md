...
7. Run `skcr validate` and `skcr asps coverage cncf-kodekloud-kcsp-reviewer`.
8. Run `skcr compile cncf-kodekloud-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kodekloud-kcsp-reviewer`.
...
```bash
skpm validate cncf-kodekloud-kcsp-reviewer
skpm package cncf-kodekloud-kcsp-reviewer
skpm publish cncf-kodekloud-kcsp-reviewer
```
