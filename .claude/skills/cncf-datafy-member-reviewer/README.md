...
7. Run `skcr validate` and `skcr asps coverage cncf-datafy-member-reviewer`.
8. Run `skcr compile cncf-datafy-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-datafy-member-reviewer`.
...
```bash
skpm validate cncf-datafy-member-reviewer
skpm package cncf-datafy-member-reviewer
skpm publish cncf-datafy-member-reviewer
```
