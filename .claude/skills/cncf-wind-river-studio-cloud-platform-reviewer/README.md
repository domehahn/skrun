...
7. Run `skcr validate` and `skcr asps coverage cncf-wind-river-studio-cloud-platform-reviewer`.
8. Run `skcr compile cncf-wind-river-studio-cloud-platform-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-wind-river-studio-cloud-platform-reviewer`.
...
```bash
skpm validate cncf-wind-river-studio-cloud-platform-reviewer
skpm package cncf-wind-river-studio-cloud-platform-reviewer
skpm publish cncf-wind-river-studio-cloud-platform-reviewer
```
