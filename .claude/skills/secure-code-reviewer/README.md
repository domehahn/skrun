...
7. Run `skcr validate` and `skcr asps coverage secure-code-reviewer`.
8. Run `skcr compile secure-code-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend secure-code-reviewer`.
