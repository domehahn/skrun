...
7. Run `skcr validate` and `skcr asps coverage cncf-northflank-reviewer`.
8. Run `skcr compile cncf-northflank-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-northflank-reviewer`.
...
```bash
skpm validate cncf-northflank-reviewer
skpm package cncf-northflank-reviewer
skpm publish cncf-northflank-reviewer
```
