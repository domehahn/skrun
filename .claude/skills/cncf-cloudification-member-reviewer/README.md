...
7. Run `skcr validate` and `skcr asps coverage cncf-cloudification-member-reviewer`.
8. Run `skcr compile cncf-cloudification-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloudification-member-reviewer`.
...
```bash
skpm validate cncf-cloudification-member-reviewer
skpm package cncf-cloudification-member-reviewer
skpm publish cncf-cloudification-member-reviewer
```
