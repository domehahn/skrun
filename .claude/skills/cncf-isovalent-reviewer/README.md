...
7. Run `skcr validate` and `skcr asps coverage cncf-isovalent-reviewer`.
8. Run `skcr compile cncf-isovalent-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-isovalent-reviewer`.
...
```bash
skpm validate cncf-isovalent-reviewer
skpm package cncf-isovalent-reviewer
skpm publish cncf-isovalent-reviewer
```
