...
7. Run `skcr validate` and `skcr asps coverage cncf-openmetrics-reviewer`.
8. Run `skcr compile cncf-openmetrics-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-openmetrics-reviewer`.
...
```bash
skpm validate cncf-openmetrics-reviewer
skpm package cncf-openmetrics-reviewer
skpm publish cncf-openmetrics-reviewer
```
