...
7. Run `skcr validate` and `skcr asps coverage cncf-submariner-reviewer`.
8. Run `skcr compile cncf-submariner-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-submariner-reviewer`.
...
```bash
skpm validate cncf-submariner-reviewer
skpm package cncf-submariner-reviewer
skpm publish cncf-submariner-reviewer
```
