...
7. Run `skcr validate` and `skcr asps coverage cncf-profisea-kcsp-reviewer`.
8. Run `skcr compile cncf-profisea-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-profisea-kcsp-reviewer`.
...
```bash
skpm validate cncf-profisea-kcsp-reviewer
skpm package cncf-profisea-kcsp-reviewer
skpm publish cncf-profisea-kcsp-reviewer
```
