...
7. Run `skcr validate` and `skcr asps coverage cncf-kruize-reviewer`.
8. Run `skcr compile cncf-kruize-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kruize-reviewer`.
...
```bash
skpm validate cncf-kruize-reviewer
skpm package cncf-kruize-reviewer
skpm publish cncf-kruize-reviewer
```
