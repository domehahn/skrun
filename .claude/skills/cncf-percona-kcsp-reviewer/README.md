...
7. Run `skcr validate` and `skcr asps coverage cncf-percona-kcsp-reviewer`.
8. Run `skcr compile cncf-percona-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-percona-kcsp-reviewer`.
...
```bash
skpm validate cncf-percona-kcsp-reviewer
skpm package cncf-percona-kcsp-reviewer
skpm publish cncf-percona-kcsp-reviewer
```
