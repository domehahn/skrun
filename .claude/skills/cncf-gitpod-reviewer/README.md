...
7. Run `skcr validate` and `skcr asps coverage cncf-gitpod-reviewer`.
8. Run `skcr compile cncf-gitpod-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-gitpod-reviewer`.
...
```bash
skpm validate cncf-gitpod-reviewer
skpm package cncf-gitpod-reviewer
skpm publish cncf-gitpod-reviewer
```
