...
7. Run `skcr validate` and `skcr asps coverage cncf-autovia-member-reviewer`.
8. Run `skcr compile cncf-autovia-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-autovia-member-reviewer`.
...
```bash
skpm validate cncf-autovia-member-reviewer
skpm package cncf-autovia-member-reviewer
skpm publish cncf-autovia-member-reviewer
```
