...
7. Run `skcr validate` and `skcr asps coverage cncf-supabase-reviewer`.
8. Run `skcr compile cncf-supabase-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-supabase-reviewer`.
...
```bash
skpm validate cncf-supabase-reviewer
skpm package cncf-supabase-reviewer
skpm publish cncf-supabase-reviewer
```
