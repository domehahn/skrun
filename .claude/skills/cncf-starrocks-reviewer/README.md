...
7. Run `skcr validate` and `skcr asps coverage cncf-starrocks-reviewer`.
8. Run `skcr compile cncf-starrocks-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-starrocks-reviewer`.
...
```bash
skpm validate cncf-starrocks-reviewer
skpm package cncf-starrocks-reviewer
skpm publish cncf-starrocks-reviewer
```
