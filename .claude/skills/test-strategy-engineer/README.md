...
7. Run `skcr validate` and `skcr asps coverage test-strategy-engineer`.
8. Run `skcr compile test-strategy-engineer --target skil`.
9. Run `skcr sync` and `skcr version recommend test-strategy-engineer`.
