...
7. Run `skcr validate` and `skcr asps coverage cncf-effectual-kcsp-reviewer`.
8. Run `skcr compile cncf-effectual-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-effectual-kcsp-reviewer`.
...
```bash
skpm validate cncf-effectual-kcsp-reviewer
skpm package cncf-effectual-kcsp-reviewer
skpm publish cncf-effectual-kcsp-reviewer
```
