...
7. Run `skcr validate` and `skcr asps coverage cncf-sparta-reviewer`.
8. Run `skcr compile cncf-sparta-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sparta-reviewer`.
...
```bash
skpm validate cncf-sparta-reviewer
skpm package cncf-sparta-reviewer
skpm publish cncf-sparta-reviewer
```
