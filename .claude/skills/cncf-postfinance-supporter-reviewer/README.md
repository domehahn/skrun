...
7. Run `skcr validate` and `skcr asps coverage cncf-postfinance-supporter-reviewer`.
8. Run `skcr compile cncf-postfinance-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-postfinance-supporter-reviewer`.
...
```bash
skpm validate cncf-postfinance-supporter-reviewer
skpm package cncf-postfinance-supporter-reviewer
skpm publish cncf-postfinance-supporter-reviewer
```
