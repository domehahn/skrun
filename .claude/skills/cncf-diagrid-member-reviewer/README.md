...
7. Run `skcr validate` and `skcr asps coverage cncf-diagrid-member-reviewer`.
8. Run `skcr compile cncf-diagrid-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-diagrid-member-reviewer`.
...
```bash
skpm validate cncf-diagrid-member-reviewer
skpm package cncf-diagrid-member-reviewer
skpm publish cncf-diagrid-member-reviewer
```
