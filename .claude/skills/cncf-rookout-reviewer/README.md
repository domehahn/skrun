...
7. Run `skcr validate` and `skcr asps coverage cncf-rookout-reviewer`.
8. Run `skcr compile cncf-rookout-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-rookout-reviewer`.
...
```bash
skpm validate cncf-rookout-reviewer
skpm package cncf-rookout-reviewer
skpm publish cncf-rookout-reviewer
```
