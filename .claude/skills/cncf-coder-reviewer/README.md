...
7. Run `skcr validate` and `skcr asps coverage cncf-coder-reviewer`.
8. Run `skcr compile cncf-coder-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-coder-reviewer`.
...
```bash
skpm validate cncf-coder-reviewer
skpm package cncf-coder-reviewer
skpm publish cncf-coder-reviewer
```
