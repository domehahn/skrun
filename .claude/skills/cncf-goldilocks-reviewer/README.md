...
7. Run `skcr validate` and `skcr asps coverage cncf-goldilocks-reviewer`.
8. Run `skcr compile cncf-goldilocks-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-goldilocks-reviewer`.
...
```bash
skpm validate cncf-goldilocks-reviewer
skpm package cncf-goldilocks-reviewer
skpm publish cncf-goldilocks-reviewer
```
