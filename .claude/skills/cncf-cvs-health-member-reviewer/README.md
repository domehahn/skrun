...
7. Run `skcr validate` and `skcr asps coverage cncf-cvs-health-member-reviewer`.
8. Run `skcr compile cncf-cvs-health-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cvs-health-member-reviewer`.
...
```bash
skpm validate cncf-cvs-health-member-reviewer
skpm package cncf-cvs-health-member-reviewer
skpm publish cncf-cvs-health-member-reviewer
```
