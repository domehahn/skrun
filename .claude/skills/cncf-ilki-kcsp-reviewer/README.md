...
7. Run `skcr validate` and `skcr asps coverage cncf-ilki-kcsp-reviewer`.
8. Run `skcr compile cncf-ilki-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ilki-kcsp-reviewer`.
...
```bash
skpm validate cncf-ilki-kcsp-reviewer
skpm package cncf-ilki-kcsp-reviewer
skpm publish cncf-ilki-kcsp-reviewer
```
