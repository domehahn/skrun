...
7. Run `skcr validate` and `skcr asps coverage cncf-daocloud-kcntp-reviewer`.
8. Run `skcr compile cncf-daocloud-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-daocloud-kcntp-reviewer`.
...
```bash
skpm validate cncf-daocloud-kcntp-reviewer
skpm package cncf-daocloud-kcntp-reviewer
skpm publish cncf-daocloud-kcntp-reviewer
```
