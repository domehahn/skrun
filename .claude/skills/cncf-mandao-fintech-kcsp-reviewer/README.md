...
7. Run `skcr validate` and `skcr asps coverage cncf-mandao-fintech-kcsp-reviewer`.
8. Run `skcr compile cncf-mandao-fintech-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-mandao-fintech-kcsp-reviewer`.
...
```bash
skpm validate cncf-mandao-fintech-kcsp-reviewer
skpm package cncf-mandao-fintech-kcsp-reviewer
skpm publish cncf-mandao-fintech-kcsp-reviewer
```
