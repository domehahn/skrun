...
7. Run `skcr validate` and `skcr asps coverage cncf-robusta-member-reviewer`.
8. Run `skcr compile cncf-robusta-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-robusta-member-reviewer`.
...
```bash
skpm validate cncf-robusta-member-reviewer
skpm package cncf-robusta-member-reviewer
skpm publish cncf-robusta-member-reviewer
```
