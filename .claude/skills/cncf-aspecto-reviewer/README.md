...
7. Run `skcr validate` and `skcr asps coverage cncf-aspecto-reviewer`.
8. Run `skcr compile cncf-aspecto-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-aspecto-reviewer`.
...
```bash
skpm validate cncf-aspecto-reviewer
skpm package cncf-aspecto-reviewer
skpm publish cncf-aspecto-reviewer
```
