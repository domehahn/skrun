...
7. Run `skcr validate` and `skcr asps coverage cncf-alauda-kcsp-reviewer`.
8. Run `skcr compile cncf-alauda-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-alauda-kcsp-reviewer`.
...
```bash
skpm validate cncf-alauda-kcsp-reviewer
skpm package cncf-alauda-kcsp-reviewer
skpm publish cncf-alauda-kcsp-reviewer
```
