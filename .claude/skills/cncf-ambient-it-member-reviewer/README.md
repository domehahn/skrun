...
7. Run `skcr validate` and `skcr asps coverage cncf-ambient-it-member-reviewer`.
8. Run `skcr compile cncf-ambient-it-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ambient-it-member-reviewer`.
...
```bash
skpm validate cncf-ambient-it-member-reviewer
skpm package cncf-ambient-it-member-reviewer
skpm publish cncf-ambient-it-member-reviewer
```
