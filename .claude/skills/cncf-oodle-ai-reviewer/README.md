...
7. Run `skcr validate` and `skcr asps coverage cncf-oodle-ai-reviewer`.
8. Run `skcr compile cncf-oodle-ai-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-oodle-ai-reviewer`.
...
```bash
skpm validate cncf-oodle-ai-reviewer
skpm package cncf-oodle-ai-reviewer
skpm publish cncf-oodle-ai-reviewer
```
