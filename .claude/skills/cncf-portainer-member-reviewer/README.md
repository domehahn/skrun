...
7. Run `skcr validate` and `skcr asps coverage cncf-portainer-member-reviewer`.
8. Run `skcr compile cncf-portainer-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-portainer-member-reviewer`.
...
```bash
skpm validate cncf-portainer-member-reviewer
skpm package cncf-portainer-member-reviewer
skpm publish cncf-portainer-member-reviewer
```
