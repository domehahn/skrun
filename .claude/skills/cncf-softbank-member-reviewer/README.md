...
7. Run `skcr validate` and `skcr asps coverage cncf-softbank-member-reviewer`.
8. Run `skcr compile cncf-softbank-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-softbank-member-reviewer`.
...
```bash
skpm validate cncf-softbank-member-reviewer
skpm package cncf-softbank-member-reviewer
skpm publish cncf-softbank-member-reviewer
```
