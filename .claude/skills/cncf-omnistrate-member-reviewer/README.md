...
7. Run `skcr validate` and `skcr asps coverage cncf-omnistrate-member-reviewer`.
8. Run `skcr compile cncf-omnistrate-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-omnistrate-member-reviewer`.
...
```bash
skpm validate cncf-omnistrate-member-reviewer
skpm package cncf-omnistrate-member-reviewer
skpm publish cncf-omnistrate-member-reviewer
```
