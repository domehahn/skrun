...
7. Run `skcr validate` and `skcr asps coverage cncf-wai-reviewer`.
8. Run `skcr compile cncf-wai-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-wai-reviewer`.
...
```bash
skpm validate cncf-wai-reviewer
skpm package cncf-wai-reviewer
skpm publish cncf-wai-reviewer
```
