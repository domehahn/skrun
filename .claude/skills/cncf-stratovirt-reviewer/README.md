...
7. Run `skcr validate` and `skcr asps coverage cncf-stratovirt-reviewer`.
8. Run `skcr compile cncf-stratovirt-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-stratovirt-reviewer`.
...
```bash
skpm validate cncf-stratovirt-reviewer
skpm package cncf-stratovirt-reviewer
skpm publish cncf-stratovirt-reviewer
```
