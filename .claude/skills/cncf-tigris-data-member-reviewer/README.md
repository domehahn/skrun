...
7. Run `skcr validate` and `skcr asps coverage cncf-tigris-data-member-reviewer`.
8. Run `skcr compile cncf-tigris-data-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-tigris-data-member-reviewer`.
...
```bash
skpm validate cncf-tigris-data-member-reviewer
skpm package cncf-tigris-data-member-reviewer
skpm publish cncf-tigris-data-member-reviewer
```
