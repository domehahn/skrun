...
7. Run `skcr validate` and `skcr asps coverage cncf-switch-cloud-kubernetes-sck-reviewer`.
8. Run `skcr compile cncf-switch-cloud-kubernetes-sck-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-switch-cloud-kubernetes-sck-reviewer`.
...
```bash
skpm validate cncf-switch-cloud-kubernetes-sck-reviewer
skpm package cncf-switch-cloud-kubernetes-sck-reviewer
skpm publish cncf-switch-cloud-kubernetes-sck-reviewer
```
