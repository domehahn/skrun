...
7. Run `skcr validate` and `skcr asps coverage cncf-cfl-supporter-reviewer`.
8. Run `skcr compile cncf-cfl-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cfl-supporter-reviewer`.
...
```bash
skpm validate cncf-cfl-supporter-reviewer
skpm package cncf-cfl-supporter-reviewer
skpm publish cncf-cfl-supporter-reviewer
```
