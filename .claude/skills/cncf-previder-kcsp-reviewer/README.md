...
7. Run `skcr validate` and `skcr asps coverage cncf-previder-kcsp-reviewer`.
8. Run `skcr compile cncf-previder-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-previder-kcsp-reviewer`.
...
```bash
skpm validate cncf-previder-kcsp-reviewer
skpm package cncf-previder-kcsp-reviewer
skpm publish cncf-previder-kcsp-reviewer
```
