...
7. Run `skcr validate` and `skcr asps coverage cncf-testkube-reviewer`.
8. Run `skcr compile cncf-testkube-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-testkube-reviewer`.
...
```bash
skpm validate cncf-testkube-reviewer
skpm package cncf-testkube-reviewer
skpm publish cncf-testkube-reviewer
```
