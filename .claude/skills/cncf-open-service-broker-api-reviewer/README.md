...
7. Run `skcr validate` and `skcr asps coverage cncf-open-service-broker-api-reviewer`.
8. Run `skcr compile cncf-open-service-broker-api-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-open-service-broker-api-reviewer`.
...
```bash
skpm validate cncf-open-service-broker-api-reviewer
skpm package cncf-open-service-broker-api-reviewer
skpm publish cncf-open-service-broker-api-reviewer
```
