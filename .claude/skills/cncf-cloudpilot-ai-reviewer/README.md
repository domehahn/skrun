...
7. Run `skcr validate` and `skcr asps coverage cncf-cloudpilot-ai-reviewer`.
8. Run `skcr compile cncf-cloudpilot-ai-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloudpilot-ai-reviewer`.
...
```bash
skpm validate cncf-cloudpilot-ai-reviewer
skpm package cncf-cloudpilot-ai-reviewer
skpm publish cncf-cloudpilot-ai-reviewer
```
