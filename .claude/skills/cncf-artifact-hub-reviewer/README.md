...
7. Run `skcr validate` and `skcr asps coverage cncf-artifact-hub-reviewer`.
8. Run `skcr compile cncf-artifact-hub-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-artifact-hub-reviewer`.
...
```bash
skpm validate cncf-artifact-hub-reviewer
skpm package cncf-artifact-hub-reviewer
skpm publish cncf-artifact-hub-reviewer
```
