...
7. Run `skcr validate` and `skcr asps coverage cncf-inspur-member-reviewer`.
8. Run `skcr compile cncf-inspur-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-inspur-member-reviewer`.
...
```bash
skpm validate cncf-inspur-member-reviewer
skpm package cncf-inspur-member-reviewer
skpm publish cncf-inspur-member-reviewer
```
