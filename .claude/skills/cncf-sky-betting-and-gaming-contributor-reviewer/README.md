...
7. Run `skcr validate` and `skcr asps coverage cncf-sky-betting-and-gaming-contributor-reviewer`.
8. Run `skcr compile cncf-sky-betting-and-gaming-contributor-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sky-betting-and-gaming-contributor-reviewer`.
...
```bash
skpm validate cncf-sky-betting-and-gaming-contributor-reviewer
skpm package cncf-sky-betting-and-gaming-contributor-reviewer
skpm publish cncf-sky-betting-and-gaming-contributor-reviewer
```
