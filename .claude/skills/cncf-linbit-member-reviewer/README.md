...
7. Run `skcr validate` and `skcr asps coverage cncf-linbit-member-reviewer`.
8. Run `skcr compile cncf-linbit-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-linbit-member-reviewer`.
...
```bash
skpm validate cncf-linbit-member-reviewer
skpm package cncf-linbit-member-reviewer
skpm publish cncf-linbit-member-reviewer
```
