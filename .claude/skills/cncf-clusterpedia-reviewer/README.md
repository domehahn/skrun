...
7. Run `skcr validate` and `skcr asps coverage cncf-clusterpedia-reviewer`.
8. Run `skcr compile cncf-clusterpedia-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-clusterpedia-reviewer`.
...
```bash
skpm validate cncf-clusterpedia-reviewer
skpm package cncf-clusterpedia-reviewer
skpm publish cncf-clusterpedia-reviewer
```
