...
7. Run `skcr validate` and `skcr asps coverage cncf-google-persistent-disk-reviewer`.
8. Run `skcr compile cncf-google-persistent-disk-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-google-persistent-disk-reviewer`.
...
```bash
skpm validate cncf-google-persistent-disk-reviewer
skpm package cncf-google-persistent-disk-reviewer
skpm publish cncf-google-persistent-disk-reviewer
```
