...
7. Run `skcr validate` and `skcr asps coverage cncf-volcano-engine-kcsp-reviewer`.
8. Run `skcr compile cncf-volcano-engine-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-volcano-engine-kcsp-reviewer`.
...
```bash
skpm validate cncf-volcano-engine-kcsp-reviewer
skpm package cncf-volcano-engine-kcsp-reviewer
skpm publish cncf-volcano-engine-kcsp-reviewer
```
