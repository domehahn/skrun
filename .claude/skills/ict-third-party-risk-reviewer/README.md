...
7. Run `skcr validate` and `skcr asps coverage ict-third-party-risk-reviewer`.
8. Run `skcr compile ict-third-party-risk-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend ict-third-party-risk-reviewer`.
...
```bash
skpm validate ict-third-party-risk-reviewer
skpm package ict-third-party-risk-reviewer
skpm publish ict-third-party-risk-reviewer
```
