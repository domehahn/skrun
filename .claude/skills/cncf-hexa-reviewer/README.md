...
7. Run `skcr validate` and `skcr asps coverage cncf-hexa-reviewer`.
8. Run `skcr compile cncf-hexa-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-hexa-reviewer`.
...
```bash
skpm validate cncf-hexa-reviewer
skpm package cncf-hexa-reviewer
skpm publish cncf-hexa-reviewer
```
