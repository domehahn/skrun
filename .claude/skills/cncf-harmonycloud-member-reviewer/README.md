...
7. Run `skcr validate` and `skcr asps coverage cncf-harmonycloud-member-reviewer`.
8. Run `skcr compile cncf-harmonycloud-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-harmonycloud-member-reviewer`.
...
```bash
skpm validate cncf-harmonycloud-member-reviewer
skpm package cncf-harmonycloud-member-reviewer
skpm publish cncf-harmonycloud-member-reviewer
```
