...
7. Run `skcr validate` and `skcr asps coverage cncf-okahu-reviewer`.
8. Run `skcr compile cncf-okahu-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-okahu-reviewer`.
...
```bash
skpm validate cncf-okahu-reviewer
skpm package cncf-okahu-reviewer
skpm publish cncf-okahu-reviewer
```
