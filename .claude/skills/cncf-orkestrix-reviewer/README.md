...
7. Run `skcr validate` and `skcr asps coverage cncf-orkestrix-reviewer`.
8. Run `skcr compile cncf-orkestrix-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-orkestrix-reviewer`.
...
```bash
skpm validate cncf-orkestrix-reviewer
skpm package cncf-orkestrix-reviewer
skpm publish cncf-orkestrix-reviewer
```
