...
7. Run `skcr validate` and `skcr asps coverage cncf-elastic-apm-reviewer`.
8. Run `skcr compile cncf-elastic-apm-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-elastic-apm-reviewer`.
...
```bash
skpm validate cncf-elastic-apm-reviewer
skpm package cncf-elastic-apm-reviewer
skpm publish cncf-elastic-apm-reviewer
```
