...
7. Run `skcr validate` and `skcr asps coverage cncf-catalyst-cloud-kcsp-reviewer`.
8. Run `skcr compile cncf-catalyst-cloud-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-catalyst-cloud-kcsp-reviewer`.
...
```bash
skpm validate cncf-catalyst-cloud-kcsp-reviewer
skpm package cncf-catalyst-cloud-kcsp-reviewer
skpm publish cncf-catalyst-cloud-kcsp-reviewer
```
