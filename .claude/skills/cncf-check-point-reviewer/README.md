...
7. Run `skcr validate` and `skcr asps coverage cncf-check-point-reviewer`.
8. Run `skcr compile cncf-check-point-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-check-point-reviewer`.
...
```bash
skpm validate cncf-check-point-reviewer
skpm package cncf-check-point-reviewer
skpm publish cncf-check-point-reviewer
```
