...
7. Run `skcr validate` and `skcr asps coverage dependency-supply-chain-reviewer`.
8. Run `skcr compile dependency-supply-chain-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend dependency-supply-chain-reviewer`.
