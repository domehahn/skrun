...
7. Run `skcr validate` and `skcr asps coverage cncf-ionir-reviewer`.
8. Run `skcr compile cncf-ionir-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ionir-reviewer`.
...
```bash
skpm validate cncf-ionir-reviewer
skpm package cncf-ionir-reviewer
skpm publish cncf-ionir-reviewer
```
