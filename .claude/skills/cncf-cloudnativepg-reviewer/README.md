...
7. Run `skcr validate` and `skcr asps coverage cncf-cloudnativepg-reviewer`.
8. Run `skcr compile cncf-cloudnativepg-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloudnativepg-reviewer`.
...
```bash
skpm validate cncf-cloudnativepg-reviewer
skpm package cncf-cloudnativepg-reviewer
skpm publish cncf-cloudnativepg-reviewer
```
