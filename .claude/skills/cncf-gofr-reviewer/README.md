...
7. Run `skcr validate` and `skcr asps coverage cncf-gofr-reviewer`.
8. Run `skcr compile cncf-gofr-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-gofr-reviewer`.
...
```bash
skpm validate cncf-gofr-reviewer
skpm package cncf-gofr-reviewer
skpm publish cncf-gofr-reviewer
```
