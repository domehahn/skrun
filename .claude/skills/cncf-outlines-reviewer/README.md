...
7. Run `skcr validate` and `skcr asps coverage cncf-outlines-reviewer`.
8. Run `skcr compile cncf-outlines-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-outlines-reviewer`.
...
```bash
skpm validate cncf-outlines-reviewer
skpm package cncf-outlines-reviewer
skpm publish cncf-outlines-reviewer
```
