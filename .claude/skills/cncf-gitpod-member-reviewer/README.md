...
7. Run `skcr validate` and `skcr asps coverage cncf-gitpod-member-reviewer`.
8. Run `skcr compile cncf-gitpod-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-gitpod-member-reviewer`.
...
```bash
skpm validate cncf-gitpod-member-reviewer
skpm package cncf-gitpod-member-reviewer
skpm publish cncf-gitpod-member-reviewer
```
