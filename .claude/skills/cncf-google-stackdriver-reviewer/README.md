...
7. Run `skcr validate` and `skcr asps coverage cncf-google-stackdriver-reviewer`.
8. Run `skcr compile cncf-google-stackdriver-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-google-stackdriver-reviewer`.
...
```bash
skpm validate cncf-google-stackdriver-reviewer
skpm package cncf-google-stackdriver-reviewer
skpm publish cncf-google-stackdriver-reviewer
```
