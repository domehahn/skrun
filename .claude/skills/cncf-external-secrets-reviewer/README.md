...
7. Run `skcr validate` and `skcr asps coverage cncf-external-secrets-reviewer`.
8. Run `skcr compile cncf-external-secrets-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-external-secrets-reviewer`.
...
```bash
skpm validate cncf-external-secrets-reviewer
skpm package cncf-external-secrets-reviewer
skpm publish cncf-external-secrets-reviewer
```
