...
7. Run `skcr validate` and `skcr asps coverage cncf-netflix-eureka-reviewer`.
8. Run `skcr compile cncf-netflix-eureka-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-netflix-eureka-reviewer`.
...
```bash
skpm validate cncf-netflix-eureka-reviewer
skpm package cncf-netflix-eureka-reviewer
skpm publish cncf-netflix-eureka-reviewer
```
