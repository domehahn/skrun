...
7. Run `skcr validate` and `skcr asps coverage cncf-tcc-consulting-limited-kcsp-reviewer`.
8. Run `skcr compile cncf-tcc-consulting-limited-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-tcc-consulting-limited-kcsp-reviewer`.
...
```bash
skpm validate cncf-tcc-consulting-limited-kcsp-reviewer
skpm package cncf-tcc-consulting-limited-kcsp-reviewer
skpm publish cncf-tcc-consulting-limited-kcsp-reviewer
```
