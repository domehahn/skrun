...
7. Run `skcr validate` and `skcr asps coverage cncf-bocloud-kcntp-reviewer`.
8. Run `skcr compile cncf-bocloud-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-bocloud-kcntp-reviewer`.
...
```bash
skpm validate cncf-bocloud-kcntp-reviewer
skpm package cncf-bocloud-kcntp-reviewer
skpm publish cncf-bocloud-kcntp-reviewer
```
