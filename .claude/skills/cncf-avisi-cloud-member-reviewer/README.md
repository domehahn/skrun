...
7. Run `skcr validate` and `skcr asps coverage cncf-avisi-cloud-member-reviewer`.
8. Run `skcr compile cncf-avisi-cloud-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-avisi-cloud-member-reviewer`.
...
```bash
skpm validate cncf-avisi-cloud-member-reviewer
skpm package cncf-avisi-cloud-member-reviewer
skpm publish cncf-avisi-cloud-member-reviewer
```
