...
7. Run `skcr validate` and `skcr asps coverage cncf-stackgenie-kcsp-reviewer`.
8. Run `skcr compile cncf-stackgenie-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-stackgenie-kcsp-reviewer`.
...
```bash
skpm validate cncf-stackgenie-kcsp-reviewer
skpm package cncf-stackgenie-kcsp-reviewer
skpm publish cncf-stackgenie-kcsp-reviewer
```
