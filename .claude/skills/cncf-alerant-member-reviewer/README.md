...
7. Run `skcr validate` and `skcr asps coverage cncf-alerant-member-reviewer`.
8. Run `skcr compile cncf-alerant-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-alerant-member-reviewer`.
...
```bash
skpm validate cncf-alerant-member-reviewer
skpm package cncf-alerant-member-reviewer
skpm publish cncf-alerant-member-reviewer
```
