...
7. Run `skcr validate` and `skcr asps coverage cncf-composefs-reviewer`.
8. Run `skcr compile cncf-composefs-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-composefs-reviewer`.
...
```bash
skpm validate cncf-composefs-reviewer
skpm package cncf-composefs-reviewer
skpm publish cncf-composefs-reviewer
```
