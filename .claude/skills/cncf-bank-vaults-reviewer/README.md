...
7. Run `skcr validate` and `skcr asps coverage cncf-bank-vaults-reviewer`.
8. Run `skcr compile cncf-bank-vaults-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-bank-vaults-reviewer`.
...
```bash
skpm validate cncf-bank-vaults-reviewer
skpm package cncf-bank-vaults-reviewer
skpm publish cncf-bank-vaults-reviewer
```
