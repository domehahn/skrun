...
7. Run `skcr validate` and `skcr asps coverage cncf-salt-lake-city-devops-days-member-reviewer`.
8. Run `skcr compile cncf-salt-lake-city-devops-days-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-salt-lake-city-devops-days-member-reviewer`.
...
```bash
skpm validate cncf-salt-lake-city-devops-days-member-reviewer
skpm package cncf-salt-lake-city-devops-days-member-reviewer
skpm publish cncf-salt-lake-city-devops-days-member-reviewer
```
