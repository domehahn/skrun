...
7. Run `skcr validate` and `skcr asps coverage cncf-gientech-kcsp-reviewer`.
8. Run `skcr compile cncf-gientech-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-gientech-kcsp-reviewer`.
...
```bash
skpm validate cncf-gientech-kcsp-reviewer
skpm package cncf-gientech-kcsp-reviewer
skpm publish cncf-gientech-kcsp-reviewer
```
