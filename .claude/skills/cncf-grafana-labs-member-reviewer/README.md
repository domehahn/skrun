...
7. Run `skcr validate` and `skcr asps coverage cncf-grafana-labs-member-reviewer`.
8. Run `skcr compile cncf-grafana-labs-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-grafana-labs-member-reviewer`.
...
```bash
skpm validate cncf-grafana-labs-member-reviewer
skpm package cncf-grafana-labs-member-reviewer
skpm publish cncf-grafana-labs-member-reviewer
```
