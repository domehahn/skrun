...
7. Run `skcr validate` and `skcr asps coverage cncf-centrica-energy-contributor-reviewer`.
8. Run `skcr compile cncf-centrica-energy-contributor-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-centrica-energy-contributor-reviewer`.
...
```bash
skpm validate cncf-centrica-energy-contributor-reviewer
skpm package cncf-centrica-energy-contributor-reviewer
skpm publish cncf-centrica-energy-contributor-reviewer
```
