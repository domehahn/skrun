...
7. Run `skcr validate` and `skcr asps coverage cncf-syseleven-member-reviewer`.
8. Run `skcr compile cncf-syseleven-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-syseleven-member-reviewer`.
...
```bash
skpm validate cncf-syseleven-member-reviewer
skpm package cncf-syseleven-member-reviewer
skpm publish cncf-syseleven-member-reviewer
```
