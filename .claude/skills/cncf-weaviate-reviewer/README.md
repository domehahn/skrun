...
7. Run `skcr validate` and `skcr asps coverage cncf-weaviate-reviewer`.
8. Run `skcr compile cncf-weaviate-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-weaviate-reviewer`.
...
```bash
skpm validate cncf-weaviate-reviewer
skpm package cncf-weaviate-reviewer
skpm publish cncf-weaviate-reviewer
```
