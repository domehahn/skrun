...
7. Run `skcr validate` and `skcr asps coverage cncf-alcide-reviewer`.
8. Run `skcr compile cncf-alcide-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-alcide-reviewer`.
...
```bash
skpm validate cncf-alcide-reviewer
skpm package cncf-alcide-reviewer
skpm publish cncf-alcide-reviewer
```
