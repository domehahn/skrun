...
7. Run `skcr validate` and `skcr asps coverage cncf-cloudchipr-member-reviewer`.
8. Run `skcr compile cncf-cloudchipr-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloudchipr-member-reviewer`.
...
```bash
skpm validate cncf-cloudchipr-member-reviewer
skpm package cncf-cloudchipr-member-reviewer
skpm publish cncf-cloudchipr-member-reviewer
```
