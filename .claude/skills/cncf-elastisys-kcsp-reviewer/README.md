...
7. Run `skcr validate` and `skcr asps coverage cncf-elastisys-kcsp-reviewer`.
8. Run `skcr compile cncf-elastisys-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-elastisys-kcsp-reviewer`.
...
```bash
skpm validate cncf-elastisys-kcsp-reviewer
skpm package cncf-elastisys-kcsp-reviewer
skpm publish cncf-elastisys-kcsp-reviewer
```
