...
7. Run `skcr validate` and `skcr asps coverage cncf-syseleven-kcsp-reviewer`.
8. Run `skcr compile cncf-syseleven-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-syseleven-kcsp-reviewer`.
...
```bash
skpm validate cncf-syseleven-kcsp-reviewer
skpm package cncf-syseleven-kcsp-reviewer
skpm publish cncf-syseleven-kcsp-reviewer
```
