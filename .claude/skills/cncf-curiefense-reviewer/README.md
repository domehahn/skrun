...
7. Run `skcr validate` and `skcr asps coverage cncf-curiefense-reviewer`.
8. Run `skcr compile cncf-curiefense-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-curiefense-reviewer`.
...
```bash
skpm validate cncf-curiefense-reviewer
skpm package cncf-curiefense-reviewer
skpm publish cncf-curiefense-reviewer
```
