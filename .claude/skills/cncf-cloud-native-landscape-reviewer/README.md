...
7. Run `skcr validate` and `skcr asps coverage cncf-cloud-native-landscape-reviewer`.
8. Run `skcr compile cncf-cloud-native-landscape-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloud-native-landscape-reviewer`.
...
```bash
skpm validate cncf-cloud-native-landscape-reviewer
skpm package cncf-cloud-native-landscape-reviewer
skpm publish cncf-cloud-native-landscape-reviewer
```
