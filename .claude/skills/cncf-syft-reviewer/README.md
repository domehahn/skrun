...
7. Run `skcr validate` and `skcr asps coverage cncf-syft-reviewer`.
8. Run `skcr compile cncf-syft-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-syft-reviewer`.
...
```bash
skpm validate cncf-syft-reviewer
skpm package cncf-syft-reviewer
skpm publish cncf-syft-reviewer
```
