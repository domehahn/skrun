...
7. Run `skcr validate` and `skcr asps coverage cncf-sva-kcsp-reviewer`.
8. Run `skcr compile cncf-sva-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sva-kcsp-reviewer`.
...
```bash
skpm validate cncf-sva-kcsp-reviewer
skpm package cncf-sva-kcsp-reviewer
skpm publish cncf-sva-kcsp-reviewer
```
