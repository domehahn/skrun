...
7. Run `skcr validate` and `skcr asps coverage cncf-hpe-kcsp-reviewer`.
8. Run `skcr compile cncf-hpe-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-hpe-kcsp-reviewer`.
...
```bash
skpm validate cncf-hpe-kcsp-reviewer
skpm package cncf-hpe-kcsp-reviewer
skpm publish cncf-hpe-kcsp-reviewer
```
