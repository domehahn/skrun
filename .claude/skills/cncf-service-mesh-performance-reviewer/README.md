...
7. Run `skcr validate` and `skcr asps coverage cncf-service-mesh-performance-reviewer`.
8. Run `skcr compile cncf-service-mesh-performance-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-service-mesh-performance-reviewer`.
...
```bash
skpm validate cncf-service-mesh-performance-reviewer
skpm package cncf-service-mesh-performance-reviewer
skpm publish cncf-service-mesh-performance-reviewer
```
