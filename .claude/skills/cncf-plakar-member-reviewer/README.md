...
7. Run `skcr validate` and `skcr asps coverage cncf-plakar-member-reviewer`.
8. Run `skcr compile cncf-plakar-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-plakar-member-reviewer`.
...
```bash
skpm validate cncf-plakar-member-reviewer
skpm package cncf-plakar-member-reviewer
skpm publish cncf-plakar-member-reviewer
```
