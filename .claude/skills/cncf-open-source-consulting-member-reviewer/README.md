...
7. Run `skcr validate` and `skcr asps coverage cncf-open-source-consulting-member-reviewer`.
8. Run `skcr compile cncf-open-source-consulting-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-open-source-consulting-member-reviewer`.
...
```bash
skpm validate cncf-open-source-consulting-member-reviewer
skpm package cncf-open-source-consulting-member-reviewer
skpm publish cncf-open-source-consulting-member-reviewer
```
