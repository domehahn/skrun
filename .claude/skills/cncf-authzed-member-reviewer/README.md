...
7. Run `skcr validate` and `skcr asps coverage cncf-authzed-member-reviewer`.
8. Run `skcr compile cncf-authzed-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-authzed-member-reviewer`.
...
```bash
skpm validate cncf-authzed-member-reviewer
skpm package cncf-authzed-member-reviewer
skpm publish cncf-authzed-member-reviewer
```
