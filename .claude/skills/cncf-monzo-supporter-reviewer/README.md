...
7. Run `skcr validate` and `skcr asps coverage cncf-monzo-supporter-reviewer`.
8. Run `skcr compile cncf-monzo-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-monzo-supporter-reviewer`.
...
```bash
skpm validate cncf-monzo-supporter-reviewer
skpm package cncf-monzo-supporter-reviewer
skpm publish cncf-monzo-supporter-reviewer
```
