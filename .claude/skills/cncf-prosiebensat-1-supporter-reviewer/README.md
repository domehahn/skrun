...
7. Run `skcr validate` and `skcr asps coverage cncf-prosiebensat-1-supporter-reviewer`.
8. Run `skcr compile cncf-prosiebensat-1-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-prosiebensat-1-supporter-reviewer`.
...
```bash
skpm validate cncf-prosiebensat-1-supporter-reviewer
skpm package cncf-prosiebensat-1-supporter-reviewer
skpm publish cncf-prosiebensat-1-supporter-reviewer
```
