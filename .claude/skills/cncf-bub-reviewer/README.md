...
7. Run `skcr validate` and `skcr asps coverage cncf-bub-reviewer`.
8. Run `skcr compile cncf-bub-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-bub-reviewer`.
...
```bash
skpm validate cncf-bub-reviewer
skpm package cncf-bub-reviewer
skpm publish cncf-bub-reviewer
```
