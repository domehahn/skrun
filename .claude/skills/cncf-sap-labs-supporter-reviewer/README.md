...
7. Run `skcr validate` and `skcr asps coverage cncf-sap-labs-supporter-reviewer`.
8. Run `skcr compile cncf-sap-labs-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sap-labs-supporter-reviewer`.
...
```bash
skpm validate cncf-sap-labs-supporter-reviewer
skpm package cncf-sap-labs-supporter-reviewer
skpm publish cncf-sap-labs-supporter-reviewer
```
