...
7. Run `skcr validate` and `skcr asps coverage cncf-prodyna-kcsp-reviewer`.
8. Run `skcr compile cncf-prodyna-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-prodyna-kcsp-reviewer`.
...
```bash
skpm validate cncf-prodyna-kcsp-reviewer
skpm package cncf-prodyna-kcsp-reviewer
skpm publish cncf-prodyna-kcsp-reviewer
```
