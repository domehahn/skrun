...
7. Run `skcr validate` and `skcr asps coverage cncf-huawei-kcsp-reviewer`.
8. Run `skcr compile cncf-huawei-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-huawei-kcsp-reviewer`.
...
```bash
skpm validate cncf-huawei-kcsp-reviewer
skpm package cncf-huawei-kcsp-reviewer
skpm publish cncf-huawei-kcsp-reviewer
```
