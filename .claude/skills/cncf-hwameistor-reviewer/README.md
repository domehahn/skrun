...
7. Run `skcr validate` and `skcr asps coverage cncf-hwameistor-reviewer`.
8. Run `skcr compile cncf-hwameistor-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-hwameistor-reviewer`.
...
```bash
skpm validate cncf-hwameistor-reviewer
skpm package cncf-hwameistor-reviewer
skpm publish cncf-hwameistor-reviewer
```
