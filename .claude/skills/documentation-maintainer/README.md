...
7. Run `skcr validate` and `skcr asps coverage documentation-maintainer`.
8. Run `skcr compile documentation-maintainer --target skil`.
9. Run `skcr sync` and `skcr version recommend documentation-maintainer`.
