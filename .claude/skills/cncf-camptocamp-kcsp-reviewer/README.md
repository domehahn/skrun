...
7. Run `skcr validate` and `skcr asps coverage cncf-camptocamp-kcsp-reviewer`.
8. Run `skcr compile cncf-camptocamp-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-camptocamp-kcsp-reviewer`.
...
```bash
skpm validate cncf-camptocamp-kcsp-reviewer
skpm package cncf-camptocamp-kcsp-reviewer
skpm publish cncf-camptocamp-kcsp-reviewer
```
