...
7. Run `skcr validate` and `skcr asps coverage cncf-myfitnesspal-member-reviewer`.
8. Run `skcr compile cncf-myfitnesspal-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-myfitnesspal-member-reviewer`.
...
```bash
skpm validate cncf-myfitnesspal-member-reviewer
skpm package cncf-myfitnesspal-member-reviewer
skpm publish cncf-myfitnesspal-member-reviewer
```
