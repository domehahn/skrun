...
7. Run `skcr validate` and `skcr asps coverage cncf-moonlight-marketing-member-reviewer`.
8. Run `skcr compile cncf-moonlight-marketing-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-moonlight-marketing-member-reviewer`.
...
```bash
skpm validate cncf-moonlight-marketing-member-reviewer
skpm package cncf-moonlight-marketing-member-reviewer
skpm publish cncf-moonlight-marketing-member-reviewer
```
