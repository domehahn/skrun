...
7. Run `skcr validate` and `skcr asps coverage cncf-containerd-reviewer`.
8. Run `skcr compile cncf-containerd-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-containerd-reviewer`.
...
```bash
skpm validate cncf-containerd-reviewer
skpm package cncf-containerd-reviewer
skpm publish cncf-containerd-reviewer
```
