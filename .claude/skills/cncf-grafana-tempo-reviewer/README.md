...
7. Run `skcr validate` and `skcr asps coverage cncf-grafana-tempo-reviewer`.
8. Run `skcr compile cncf-grafana-tempo-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-grafana-tempo-reviewer`.
...
```bash
skpm validate cncf-grafana-tempo-reviewer
skpm package cncf-grafana-tempo-reviewer
skpm publish cncf-grafana-tempo-reviewer
```
