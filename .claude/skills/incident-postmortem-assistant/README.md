...
7. Run `skcr validate` and `skcr asps coverage incident-postmortem-assistant`.
8. Run `skcr compile incident-postmortem-assistant --target skil`.
9. Run `skcr sync` and `skcr version recommend incident-postmortem-assistant`.
