...
7. Run `skcr validate` and `skcr asps coverage cncf-kubectl-mcp-server-reviewer`.
8. Run `skcr compile cncf-kubectl-mcp-server-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kubectl-mcp-server-reviewer`.
...
```bash
skpm validate cncf-kubectl-mcp-server-reviewer
skpm package cncf-kubectl-mcp-server-reviewer
skpm publish cncf-kubectl-mcp-server-reviewer
```
