...
7. Run `skcr validate` and `skcr asps coverage cncf-vamp-io-reviewer`.
8. Run `skcr compile cncf-vamp-io-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-vamp-io-reviewer`.
...
```bash
skpm validate cncf-vamp-io-reviewer
skpm package cncf-vamp-io-reviewer
skpm publish cncf-vamp-io-reviewer
```
