...
7. Run `skcr validate` and `skcr asps coverage cncf-secloudit-reviewer`.
8. Run `skcr compile cncf-secloudit-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-secloudit-reviewer`.
...
```bash
skpm validate cncf-secloudit-reviewer
skpm package cncf-secloudit-reviewer
skpm publish cncf-secloudit-reviewer
```
