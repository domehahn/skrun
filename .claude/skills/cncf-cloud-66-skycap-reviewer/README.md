...
7. Run `skcr validate` and `skcr asps coverage cncf-cloud-66-skycap-reviewer`.
8. Run `skcr compile cncf-cloud-66-skycap-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloud-66-skycap-reviewer`.
...
```bash
skpm validate cncf-cloud-66-skycap-reviewer
skpm package cncf-cloud-66-skycap-reviewer
skpm publish cncf-cloud-66-skycap-reviewer
```
