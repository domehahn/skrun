...
7. Run `skcr validate` and `skcr asps coverage cncf-linux-foundation-education-kcntp-reviewer`.
8. Run `skcr compile cncf-linux-foundation-education-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-linux-foundation-education-kcntp-reviewer`.
...
```bash
skpm validate cncf-linux-foundation-education-kcntp-reviewer
skpm package cncf-linux-foundation-education-kcntp-reviewer
skpm publish cncf-linux-foundation-education-kcntp-reviewer
```
