...
7. Run `skcr validate` and `skcr asps coverage cncf-carina-reviewer`.
8. Run `skcr compile cncf-carina-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-carina-reviewer`.
...
```bash
skpm validate cncf-carina-reviewer
skpm package cncf-carina-reviewer
skpm publish cncf-carina-reviewer
```
