...
7. Run `skcr validate` and `skcr asps coverage cncf-raydian-cloud-member-reviewer`.
8. Run `skcr compile cncf-raydian-cloud-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-raydian-cloud-member-reviewer`.
...
```bash
skpm validate cncf-raydian-cloud-member-reviewer
skpm package cncf-raydian-cloud-member-reviewer
skpm publish cncf-raydian-cloud-member-reviewer
```
