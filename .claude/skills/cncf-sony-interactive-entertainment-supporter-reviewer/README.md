...
7. Run `skcr validate` and `skcr asps coverage cncf-sony-interactive-entertainment-supporter-reviewer`.
8. Run `skcr compile cncf-sony-interactive-entertainment-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sony-interactive-entertainment-supporter-reviewer`.
...
```bash
skpm validate cncf-sony-interactive-entertainment-supporter-reviewer
skpm package cncf-sony-interactive-entertainment-supporter-reviewer
skpm publish cncf-sony-interactive-entertainment-supporter-reviewer
```
