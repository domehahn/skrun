...
7. Run `skcr validate` and `skcr asps coverage cncf-db-systel-supporter-reviewer`.
8. Run `skcr compile cncf-db-systel-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-db-systel-supporter-reviewer`.
...
```bash
skpm validate cncf-db-systel-supporter-reviewer
skpm package cncf-db-systel-supporter-reviewer
skpm publish cncf-db-systel-supporter-reviewer
```
