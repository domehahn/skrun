...
7. Run `skcr validate` and `skcr asps coverage policy-as-code-reviewer`.
8. Run `skcr compile policy-as-code-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend policy-as-code-reviewer`.
