...
7. Run `skcr validate` and `skcr asps coverage cncf-flomesh-service-mesh-fsm-reviewer`.
8. Run `skcr compile cncf-flomesh-service-mesh-fsm-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-flomesh-service-mesh-fsm-reviewer`.
...
```bash
skpm validate cncf-flomesh-service-mesh-fsm-reviewer
skpm package cncf-flomesh-service-mesh-fsm-reviewer
skpm publish cncf-flomesh-service-mesh-fsm-reviewer
```
