...
7. Run `skcr validate` and `skcr asps coverage cncf-syseleven-metakube-reviewer`.
8. Run `skcr compile cncf-syseleven-metakube-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-syseleven-metakube-reviewer`.
...
```bash
skpm validate cncf-syseleven-metakube-reviewer
skpm package cncf-syseleven-metakube-reviewer
skpm publish cncf-syseleven-metakube-reviewer
```
