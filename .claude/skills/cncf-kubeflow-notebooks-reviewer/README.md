...
7. Run `skcr validate` and `skcr asps coverage cncf-kubeflow-notebooks-reviewer`.
8. Run `skcr compile cncf-kubeflow-notebooks-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kubeflow-notebooks-reviewer`.
...
```bash
skpm validate cncf-kubeflow-notebooks-reviewer
skpm package cncf-kubeflow-notebooks-reviewer
skpm publish cncf-kubeflow-notebooks-reviewer
```
