...
7. Run `skcr validate` and `skcr asps coverage cncf-banco-de-cr-dito-bcp-member-reviewer`.
8. Run `skcr compile cncf-banco-de-cr-dito-bcp-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-banco-de-cr-dito-bcp-member-reviewer`.
...
```bash
skpm validate cncf-banco-de-cr-dito-bcp-member-reviewer
skpm package cncf-banco-de-cr-dito-bcp-member-reviewer
skpm publish cncf-banco-de-cr-dito-bcp-member-reviewer
```
