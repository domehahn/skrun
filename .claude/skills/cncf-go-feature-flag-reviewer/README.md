...
7. Run `skcr validate` and `skcr asps coverage cncf-go-feature-flag-reviewer`.
8. Run `skcr compile cncf-go-feature-flag-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-go-feature-flag-reviewer`.
...
```bash
skpm validate cncf-go-feature-flag-reviewer
skpm package cncf-go-feature-flag-reviewer
skpm publish cncf-go-feature-flag-reviewer
```
