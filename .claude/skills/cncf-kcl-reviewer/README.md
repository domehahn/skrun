...
7. Run `skcr validate` and `skcr asps coverage cncf-kcl-reviewer`.
8. Run `skcr compile cncf-kcl-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kcl-reviewer`.
...
```bash
skpm validate cncf-kcl-reviewer
skpm package cncf-kcl-reviewer
skpm publish cncf-kcl-reviewer
```
