...
7. Run `skcr validate` and `skcr asps coverage cncf-sokube-member-reviewer`.
8. Run `skcr compile cncf-sokube-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sokube-member-reviewer`.
...
```bash
skpm validate cncf-sokube-member-reviewer
skpm package cncf-sokube-member-reviewer
skpm publish cncf-sokube-member-reviewer
```
