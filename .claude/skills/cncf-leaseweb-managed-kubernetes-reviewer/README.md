...
7. Run `skcr validate` and `skcr asps coverage cncf-leaseweb-managed-kubernetes-reviewer`.
8. Run `skcr compile cncf-leaseweb-managed-kubernetes-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-leaseweb-managed-kubernetes-reviewer`.
...
```bash
skpm validate cncf-leaseweb-managed-kubernetes-reviewer
skpm package cncf-leaseweb-managed-kubernetes-reviewer
skpm publish cncf-leaseweb-managed-kubernetes-reviewer
```
