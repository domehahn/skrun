...
7. Run `skcr validate` and `skcr asps coverage cncf-ps-cloud-services-kcsp-reviewer`.
8. Run `skcr compile cncf-ps-cloud-services-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ps-cloud-services-kcsp-reviewer`.
...
```bash
skpm validate cncf-ps-cloud-services-kcsp-reviewer
skpm package cncf-ps-cloud-services-kcsp-reviewer
skpm publish cncf-ps-cloud-services-kcsp-reviewer
```
