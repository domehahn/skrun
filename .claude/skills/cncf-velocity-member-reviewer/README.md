...
7. Run `skcr validate` and `skcr asps coverage cncf-velocity-member-reviewer`.
8. Run `skcr compile cncf-velocity-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-velocity-member-reviewer`.
...
```bash
skpm validate cncf-velocity-member-reviewer
skpm package cncf-velocity-member-reviewer
skpm publish cncf-velocity-member-reviewer
```
