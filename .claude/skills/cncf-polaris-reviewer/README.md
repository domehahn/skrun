...
7. Run `skcr validate` and `skcr asps coverage cncf-polaris-reviewer`.
8. Run `skcr compile cncf-polaris-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-polaris-reviewer`.
...
```bash
skpm validate cncf-polaris-reviewer
skpm package cncf-polaris-reviewer
skpm publish cncf-polaris-reviewer
```
