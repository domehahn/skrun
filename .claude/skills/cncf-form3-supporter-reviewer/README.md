...
7. Run `skcr validate` and `skcr asps coverage cncf-form3-supporter-reviewer`.
8. Run `skcr compile cncf-form3-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-form3-supporter-reviewer`.
...
```bash
skpm validate cncf-form3-supporter-reviewer
skpm package cncf-form3-supporter-reviewer
skpm publish cncf-form3-supporter-reviewer
```
