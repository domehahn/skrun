...
7. Run `skcr validate` and `skcr asps coverage cncf-bpfman-reviewer`.
8. Run `skcr compile cncf-bpfman-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-bpfman-reviewer`.
...
```bash
skpm validate cncf-bpfman-reviewer
skpm package cncf-bpfman-reviewer
skpm publish cncf-bpfman-reviewer
```
