...
7. Run `skcr validate` and `skcr asps coverage cncf-cto2b-member-reviewer`.
8. Run `skcr compile cncf-cto2b-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cto2b-member-reviewer`.
...
```bash
skpm validate cncf-cto2b-member-reviewer
skpm package cncf-cto2b-member-reviewer
skpm publish cncf-cto2b-member-reviewer
```
