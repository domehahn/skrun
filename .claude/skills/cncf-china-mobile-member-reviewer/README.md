...
7. Run `skcr validate` and `skcr asps coverage cncf-china-mobile-member-reviewer`.
8. Run `skcr compile cncf-china-mobile-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-china-mobile-member-reviewer`.
...
```bash
skpm validate cncf-china-mobile-member-reviewer
skpm package cncf-china-mobile-member-reviewer
skpm publish cncf-china-mobile-member-reviewer
```
