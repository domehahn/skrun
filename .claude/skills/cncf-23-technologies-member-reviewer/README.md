...
7. Run `skcr validate` and `skcr asps coverage cncf-23-technologies-member-reviewer`.
8. Run `skcr compile cncf-23-technologies-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-23-technologies-member-reviewer`.
...
```bash
skpm validate cncf-23-technologies-member-reviewer
skpm package cncf-23-technologies-member-reviewer
skpm publish cncf-23-technologies-member-reviewer
```
