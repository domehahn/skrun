...
7. Run `skcr validate` and `skcr asps coverage cncf-tensor-security-reviewer`.
8. Run `skcr compile cncf-tensor-security-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-tensor-security-reviewer`.
...
```bash
skpm validate cncf-tensor-security-reviewer
skpm package cncf-tensor-security-reviewer
skpm publish cncf-tensor-security-reviewer
```
