...
7. Run `skcr validate` and `skcr asps coverage cncf-crates-io-reviewer`.
8. Run `skcr compile cncf-crates-io-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-crates-io-reviewer`.
...
```bash
skpm validate cncf-crates-io-reviewer
skpm package cncf-crates-io-reviewer
skpm publish cncf-crates-io-reviewer
```
