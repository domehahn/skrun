...
7. Run `skcr validate` and `skcr asps coverage cncf-cme-group-member-reviewer`.
8. Run `skcr compile cncf-cme-group-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cme-group-member-reviewer`.
...
```bash
skpm validate cncf-cme-group-member-reviewer
skpm package cncf-cme-group-member-reviewer
skpm publish cncf-cme-group-member-reviewer
```
