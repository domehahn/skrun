...
7. Run `skcr validate` and `skcr asps coverage cncf-nscale-member-reviewer`.
8. Run `skcr compile cncf-nscale-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nscale-member-reviewer`.
...
```bash
skpm validate cncf-nscale-member-reviewer
skpm package cncf-nscale-member-reviewer
skpm publish cncf-nscale-member-reviewer
```
