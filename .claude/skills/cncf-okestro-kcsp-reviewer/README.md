...
7. Run `skcr validate` and `skcr asps coverage cncf-okestro-kcsp-reviewer`.
8. Run `skcr compile cncf-okestro-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-okestro-kcsp-reviewer`.
...
```bash
skpm validate cncf-okestro-kcsp-reviewer
skpm package cncf-okestro-kcsp-reviewer
skpm publish cncf-okestro-kcsp-reviewer
```
