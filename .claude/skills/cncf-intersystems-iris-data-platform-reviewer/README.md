...
7. Run `skcr validate` and `skcr asps coverage cncf-intersystems-iris-data-platform-reviewer`.
8. Run `skcr compile cncf-intersystems-iris-data-platform-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-intersystems-iris-data-platform-reviewer`.
...
```bash
skpm validate cncf-intersystems-iris-data-platform-reviewer
skpm package cncf-intersystems-iris-data-platform-reviewer
skpm publish cncf-intersystems-iris-data-platform-reviewer
```
