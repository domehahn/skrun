...
7. Run `skcr validate` and `skcr asps coverage cncf-pelotech-member-reviewer`.
8. Run `skcr compile cncf-pelotech-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-pelotech-member-reviewer`.
...
```bash
skpm validate cncf-pelotech-member-reviewer
skpm package cncf-pelotech-member-reviewer
skpm publish cncf-pelotech-member-reviewer
```
