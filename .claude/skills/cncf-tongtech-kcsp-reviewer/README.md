...
7. Run `skcr validate` and `skcr asps coverage cncf-tongtech-kcsp-reviewer`.
8. Run `skcr compile cncf-tongtech-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-tongtech-kcsp-reviewer`.
...
```bash
skpm validate cncf-tongtech-kcsp-reviewer
skpm package cncf-tongtech-kcsp-reviewer
skpm publish cncf-tongtech-kcsp-reviewer
```
