...
7. Run `skcr validate` and `skcr asps coverage cncf-guardicore-centra-reviewer`.
8. Run `skcr compile cncf-guardicore-centra-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-guardicore-centra-reviewer`.
...
```bash
skpm validate cncf-guardicore-centra-reviewer
skpm package cncf-guardicore-centra-reviewer
skpm publish cncf-guardicore-centra-reviewer
```
