...
7. Run `skcr validate` and `skcr asps coverage cncf-konveyor-reviewer`.
8. Run `skcr compile cncf-konveyor-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-konveyor-reviewer`.
...
```bash
skpm validate cncf-konveyor-reviewer
skpm package cncf-konveyor-reviewer
skpm publish cncf-konveyor-reviewer
```
