...
7. Run `skcr validate` and `skcr asps coverage cncf-middleware-reviewer`.
8. Run `skcr compile cncf-middleware-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-middleware-reviewer`.
...
```bash
skpm validate cncf-middleware-reviewer
skpm package cncf-middleware-reviewer
skpm publish cncf-middleware-reviewer
```
