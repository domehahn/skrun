...
7. Run `skcr validate` and `skcr asps coverage cncf-stormforge-reviewer`.
8. Run `skcr compile cncf-stormforge-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-stormforge-reviewer`.
...
```bash
skpm validate cncf-stormforge-reviewer
skpm package cncf-stormforge-reviewer
skpm publish cncf-stormforge-reviewer
```
