...
7. Run `skcr validate` and `skcr asps coverage cncf-upwind-security-member-reviewer`.
8. Run `skcr compile cncf-upwind-security-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-upwind-security-member-reviewer`.
...
```bash
skpm validate cncf-upwind-security-member-reviewer
skpm package cncf-upwind-security-member-reviewer
skpm publish cncf-upwind-security-member-reviewer
```
