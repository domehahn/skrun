...
7. Run `skcr validate` and `skcr asps coverage cncf-natwest-member-reviewer`.
8. Run `skcr compile cncf-natwest-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-natwest-member-reviewer`.
...
```bash
skpm validate cncf-natwest-member-reviewer
skpm package cncf-natwest-member-reviewer
skpm publish cncf-natwest-member-reviewer
```
