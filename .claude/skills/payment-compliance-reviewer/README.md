...
7. Run `skcr validate` and `skcr asps coverage payment-compliance-reviewer`.
8. Run `skcr compile payment-compliance-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend payment-compliance-reviewer`.
...
```bash
skpm validate payment-compliance-reviewer
skpm package payment-compliance-reviewer
skpm publish payment-compliance-reviewer
```
