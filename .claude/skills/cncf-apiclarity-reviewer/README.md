...
7. Run `skcr validate` and `skcr asps coverage cncf-apiclarity-reviewer`.
8. Run `skcr compile cncf-apiclarity-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-apiclarity-reviewer`.
...
```bash
skpm validate cncf-apiclarity-reviewer
skpm package cncf-apiclarity-reviewer
skpm publish cncf-apiclarity-reviewer
```
