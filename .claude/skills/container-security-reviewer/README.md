...
7. Run `skcr validate` and `skcr asps coverage container-security-reviewer`.
8. Run `skcr compile container-security-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend container-security-reviewer`.
...
```bash
skpm validate container-security-reviewer
skpm package container-security-reviewer
skpm publish container-security-reviewer
```
