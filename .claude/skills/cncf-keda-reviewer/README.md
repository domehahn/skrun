...
7. Run `skcr validate` and `skcr asps coverage cncf-keda-reviewer`.
8. Run `skcr compile cncf-keda-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-keda-reviewer`.
...
```bash
skpm validate cncf-keda-reviewer
skpm package cncf-keda-reviewer
skpm publish cncf-keda-reviewer
```
