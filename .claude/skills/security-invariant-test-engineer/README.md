...
7. Run `skcr validate` and `skcr asps coverage security-invariant-test-engineer`.
8. Run `skcr compile security-invariant-test-engineer --target skil`.
9. Run `skcr sync` and `skcr version recommend security-invariant-test-engineer`.
...
```bash
skpm validate security-invariant-test-engineer
skpm package security-invariant-test-engineer
skpm publish security-invariant-test-engineer
```
