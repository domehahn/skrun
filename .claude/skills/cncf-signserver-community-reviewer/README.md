...
7. Run `skcr validate` and `skcr asps coverage cncf-signserver-community-reviewer`.
8. Run `skcr compile cncf-signserver-community-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-signserver-community-reviewer`.
...
```bash
skpm validate cncf-signserver-community-reviewer
skpm package cncf-signserver-community-reviewer
skpm publish cncf-signserver-community-reviewer
```
