...
7. Run `skcr validate` and `skcr asps coverage secure-design-reviewer`.
8. Run `skcr compile secure-design-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend secure-design-reviewer`.
...
```bash
skpm validate secure-design-reviewer
skpm package secure-design-reviewer
skpm publish secure-design-reviewer
```
