...
7. Run `skcr validate` and `skcr asps coverage cncf-nimtech-kcsp-reviewer`.
8. Run `skcr compile cncf-nimtech-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nimtech-kcsp-reviewer`.
...
```bash
skpm validate cncf-nimtech-kcsp-reviewer
skpm package cncf-nimtech-kcsp-reviewer
skpm publish cncf-nimtech-kcsp-reviewer
```
