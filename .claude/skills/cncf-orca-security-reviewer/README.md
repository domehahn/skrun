...
7. Run `skcr validate` and `skcr asps coverage cncf-orca-security-reviewer`.
8. Run `skcr compile cncf-orca-security-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-orca-security-reviewer`.
...
```bash
skpm validate cncf-orca-security-reviewer
skpm package cncf-orca-security-reviewer
skpm publish cncf-orca-security-reviewer
```
