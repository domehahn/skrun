...
7. Run `skcr validate` and `skcr asps coverage cncf-alauda-container-platform-acp-reviewer`.
8. Run `skcr compile cncf-alauda-container-platform-acp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-alauda-container-platform-acp-reviewer`.
...
```bash
skpm validate cncf-alauda-container-platform-acp-reviewer
skpm package cncf-alauda-container-platform-acp-reviewer
skpm publish cncf-alauda-container-platform-acp-reviewer
```
