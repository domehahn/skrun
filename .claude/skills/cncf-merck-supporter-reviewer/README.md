...
7. Run `skcr validate` and `skcr asps coverage cncf-merck-supporter-reviewer`.
8. Run `skcr compile cncf-merck-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-merck-supporter-reviewer`.
...
```bash
skpm validate cncf-merck-supporter-reviewer
skpm package cncf-merck-supporter-reviewer
skpm publish cncf-merck-supporter-reviewer
```
