...
7. Run `skcr validate` and `skcr asps coverage cncf-clusternet-reviewer`.
8. Run `skcr compile cncf-clusternet-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-clusternet-reviewer`.
...
```bash
skpm validate cncf-clusternet-reviewer
skpm package cncf-clusternet-reviewer
skpm publish cncf-clusternet-reviewer
```
