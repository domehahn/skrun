...
7. Run `skcr validate` and `skcr asps coverage cncf-spectro-cloud-kcsp-reviewer`.
8. Run `skcr compile cncf-spectro-cloud-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-spectro-cloud-kcsp-reviewer`.
...
```bash
skpm validate cncf-spectro-cloud-kcsp-reviewer
skpm package cncf-spectro-cloud-kcsp-reviewer
skpm publish cncf-spectro-cloud-kcsp-reviewer
```
