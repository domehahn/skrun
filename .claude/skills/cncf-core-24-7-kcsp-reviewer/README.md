...
7. Run `skcr validate` and `skcr asps coverage cncf-core-24-7-kcsp-reviewer`.
8. Run `skcr compile cncf-core-24-7-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-core-24-7-kcsp-reviewer`.
...
```bash
skpm validate cncf-core-24-7-kcsp-reviewer
skpm package cncf-core-24-7-kcsp-reviewer
skpm publish cncf-core-24-7-kcsp-reviewer
```
