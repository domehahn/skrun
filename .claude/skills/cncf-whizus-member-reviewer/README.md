...
7. Run `skcr validate` and `skcr asps coverage cncf-whizus-member-reviewer`.
8. Run `skcr compile cncf-whizus-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-whizus-member-reviewer`.
...
```bash
skpm validate cncf-whizus-member-reviewer
skpm package cncf-whizus-member-reviewer
skpm publish cncf-whizus-member-reviewer
```
