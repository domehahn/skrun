...
7. Run `skcr validate` and `skcr asps coverage cncf-storm-reply-kcsp-reviewer`.
8. Run `skcr compile cncf-storm-reply-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-storm-reply-kcsp-reviewer`.
...
```bash
skpm validate cncf-storm-reply-kcsp-reviewer
skpm package cncf-storm-reply-kcsp-reviewer
skpm publish cncf-storm-reply-kcsp-reviewer
```
