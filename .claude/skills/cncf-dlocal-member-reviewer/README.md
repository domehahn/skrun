...
7. Run `skcr validate` and `skcr asps coverage cncf-dlocal-member-reviewer`.
8. Run `skcr compile cncf-dlocal-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-dlocal-member-reviewer`.
...
```bash
skpm validate cncf-dlocal-member-reviewer
skpm package cncf-dlocal-member-reviewer
skpm publish cncf-dlocal-member-reviewer
```
