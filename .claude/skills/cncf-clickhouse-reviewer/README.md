...
7. Run `skcr validate` and `skcr asps coverage cncf-clickhouse-reviewer`.
8. Run `skcr compile cncf-clickhouse-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-clickhouse-reviewer`.
...
```bash
skpm validate cncf-clickhouse-reviewer
skpm package cncf-clickhouse-reviewer
skpm publish cncf-clickhouse-reviewer
```
