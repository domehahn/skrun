...
7. Run `skcr validate` and `skcr asps coverage cncf-entigo-kcsp-reviewer`.
8. Run `skcr compile cncf-entigo-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-entigo-kcsp-reviewer`.
...
```bash
skpm validate cncf-entigo-kcsp-reviewer
skpm package cncf-entigo-kcsp-reviewer
skpm publish cncf-entigo-kcsp-reviewer
```
