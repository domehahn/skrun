...
7. Run `skcr validate` and `skcr asps coverage cncf-superedge-reviewer`.
8. Run `skcr compile cncf-superedge-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-superedge-reviewer`.
...
```bash
skpm validate cncf-superedge-reviewer
skpm package cncf-superedge-reviewer
skpm publish cncf-superedge-reviewer
```
