...
7. Run `skcr validate` and `skcr asps coverage cncf-bunnyshell-reviewer`.
8. Run `skcr compile cncf-bunnyshell-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-bunnyshell-reviewer`.
...
```bash
skpm validate cncf-bunnyshell-reviewer
skpm package cncf-bunnyshell-reviewer
skpm publish cncf-bunnyshell-reviewer
```
