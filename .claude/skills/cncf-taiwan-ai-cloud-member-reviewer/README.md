...
7. Run `skcr validate` and `skcr asps coverage cncf-taiwan-ai-cloud-member-reviewer`.
8. Run `skcr compile cncf-taiwan-ai-cloud-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-taiwan-ai-cloud-member-reviewer`.
...
```bash
skpm validate cncf-taiwan-ai-cloud-member-reviewer
skpm package cncf-taiwan-ai-cloud-member-reviewer
skpm publish cncf-taiwan-ai-cloud-member-reviewer
```
