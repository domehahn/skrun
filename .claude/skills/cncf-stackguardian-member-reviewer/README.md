...
7. Run `skcr validate` and `skcr asps coverage cncf-stackguardian-member-reviewer`.
8. Run `skcr compile cncf-stackguardian-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-stackguardian-member-reviewer`.
...
```bash
skpm validate cncf-stackguardian-member-reviewer
skpm package cncf-stackguardian-member-reviewer
skpm publish cncf-stackguardian-member-reviewer
```
