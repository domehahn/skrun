...
7. Run `skcr validate` and `skcr asps coverage cncf-akamas-member-reviewer`.
8. Run `skcr compile cncf-akamas-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-akamas-member-reviewer`.
...
```bash
skpm validate cncf-akamas-member-reviewer
skpm package cncf-akamas-member-reviewer
skpm publish cncf-akamas-member-reviewer
```
