...
7. Run `skcr validate` and `skcr asps coverage cncf-codefresh-reviewer`.
8. Run `skcr compile cncf-codefresh-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-codefresh-reviewer`.
...
```bash
skpm validate cncf-codefresh-reviewer
skpm package cncf-codefresh-reviewer
skpm publish cncf-codefresh-reviewer
```
