...
7. Run `skcr validate` and `skcr asps coverage cncf-cerbos-reviewer`.
8. Run `skcr compile cncf-cerbos-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cerbos-reviewer`.
...
```bash
skpm validate cncf-cerbos-reviewer
skpm package cncf-cerbos-reviewer
skpm publish cncf-cerbos-reviewer
```
