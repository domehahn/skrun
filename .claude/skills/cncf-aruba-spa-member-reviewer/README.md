...
7. Run `skcr validate` and `skcr asps coverage cncf-aruba-spa-member-reviewer`.
8. Run `skcr compile cncf-aruba-spa-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-aruba-spa-member-reviewer`.
...
```bash
skpm validate cncf-aruba-spa-member-reviewer
skpm package cncf-aruba-spa-member-reviewer
skpm publish cncf-aruba-spa-member-reviewer
```
