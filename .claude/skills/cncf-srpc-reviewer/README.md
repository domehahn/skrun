...
7. Run `skcr validate` and `skcr asps coverage cncf-srpc-reviewer`.
8. Run `skcr compile cncf-srpc-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-srpc-reviewer`.
...
```bash
skpm validate cncf-srpc-reviewer
skpm package cncf-srpc-reviewer
skpm publish cncf-srpc-reviewer
```
