...
7. Run `skcr validate` and `skcr asps coverage cncf-t-mobile-member-reviewer`.
8. Run `skcr compile cncf-t-mobile-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-t-mobile-member-reviewer`.
...
```bash
skpm validate cncf-t-mobile-member-reviewer
skpm package cncf-t-mobile-member-reviewer
skpm publish cncf-t-mobile-member-reviewer
```
