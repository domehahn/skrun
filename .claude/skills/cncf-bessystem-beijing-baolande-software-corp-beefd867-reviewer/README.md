...
7. Run `skcr validate` and `skcr asps coverage cncf-bessystem-beijing-baolande-software-corp-beefd867-reviewer`.
8. Run `skcr compile cncf-bessystem-beijing-baolande-software-corp-beefd867-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-bessystem-beijing-baolande-software-corp-beefd867-reviewer`.
...
```bash
skpm validate cncf-bessystem-beijing-baolande-software-corp-beefd867-reviewer
skpm package cncf-bessystem-beijing-baolande-software-corp-beefd867-reviewer
skpm publish cncf-bessystem-beijing-baolande-software-corp-beefd867-reviewer
```
