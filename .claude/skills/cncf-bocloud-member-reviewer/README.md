...
7. Run `skcr validate` and `skcr asps coverage cncf-bocloud-member-reviewer`.
8. Run `skcr compile cncf-bocloud-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-bocloud-member-reviewer`.
...
```bash
skpm validate cncf-bocloud-member-reviewer
skpm package cncf-bocloud-member-reviewer
skpm publish cncf-bocloud-member-reviewer
```
