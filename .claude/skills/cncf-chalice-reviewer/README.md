...
7. Run `skcr validate` and `skcr asps coverage cncf-chalice-reviewer`.
8. Run `skcr compile cncf-chalice-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-chalice-reviewer`.
...
```bash
skpm validate cncf-chalice-reviewer
skpm package cncf-chalice-reviewer
skpm publish cncf-chalice-reviewer
```
