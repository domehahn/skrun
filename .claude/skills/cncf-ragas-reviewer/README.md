...
7. Run `skcr validate` and `skcr asps coverage cncf-ragas-reviewer`.
8. Run `skcr compile cncf-ragas-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ragas-reviewer`.
...
```bash
skpm validate cncf-ragas-reviewer
skpm package cncf-ragas-reviewer
skpm publish cncf-ragas-reviewer
```
