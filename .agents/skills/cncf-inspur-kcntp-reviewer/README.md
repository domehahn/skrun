...
7. Run `skcr validate` and `skcr asps coverage cncf-inspur-kcntp-reviewer`.
8. Run `skcr compile cncf-inspur-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-inspur-kcntp-reviewer`.
...
```bash
skpm validate cncf-inspur-kcntp-reviewer
skpm package cncf-inspur-kcntp-reviewer
skpm publish cncf-inspur-kcntp-reviewer
```
