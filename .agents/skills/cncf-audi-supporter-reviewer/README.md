...
7. Run `skcr validate` and `skcr asps coverage cncf-audi-supporter-reviewer`.
8. Run `skcr compile cncf-audi-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-audi-supporter-reviewer`.
...
```bash
skpm validate cncf-audi-supporter-reviewer
skpm package cncf-audi-supporter-reviewer
skpm publish cncf-audi-supporter-reviewer
```
