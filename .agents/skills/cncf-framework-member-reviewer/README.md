...
7. Run `skcr validate` and `skcr asps coverage cncf-framework-member-reviewer`.
8. Run `skcr compile cncf-framework-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-framework-member-reviewer`.
...
```bash
skpm validate cncf-framework-member-reviewer
skpm package cncf-framework-member-reviewer
skpm publish cncf-framework-member-reviewer
```
