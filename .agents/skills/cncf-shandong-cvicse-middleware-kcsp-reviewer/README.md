...
7. Run `skcr validate` and `skcr asps coverage cncf-shandong-cvicse-middleware-kcsp-reviewer`.
8. Run `skcr compile cncf-shandong-cvicse-middleware-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-shandong-cvicse-middleware-kcsp-reviewer`.
...
```bash
skpm validate cncf-shandong-cvicse-middleware-kcsp-reviewer
skpm package cncf-shandong-cvicse-middleware-kcsp-reviewer
skpm publish cncf-shandong-cvicse-middleware-kcsp-reviewer
```
