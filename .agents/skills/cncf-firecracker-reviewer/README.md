...
7. Run `skcr validate` and `skcr asps coverage cncf-firecracker-reviewer`.
8. Run `skcr compile cncf-firecracker-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-firecracker-reviewer`.
...
```bash
skpm validate cncf-firecracker-reviewer
skpm package cncf-firecracker-reviewer
skpm publish cncf-firecracker-reviewer
```
