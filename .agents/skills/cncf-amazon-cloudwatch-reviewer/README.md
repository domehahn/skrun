...
7. Run `skcr validate` and `skcr asps coverage cncf-amazon-cloudwatch-reviewer`.
8. Run `skcr compile cncf-amazon-cloudwatch-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-amazon-cloudwatch-reviewer`.
...
```bash
skpm validate cncf-amazon-cloudwatch-reviewer
skpm package cncf-amazon-cloudwatch-reviewer
skpm publish cncf-amazon-cloudwatch-reviewer
```
