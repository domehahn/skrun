...
7. Run `skcr validate` and `skcr asps coverage cncf-novaglobal-kcsp-reviewer`.
8. Run `skcr compile cncf-novaglobal-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-novaglobal-kcsp-reviewer`.
...
```bash
skpm validate cncf-novaglobal-kcsp-reviewer
skpm package cncf-novaglobal-kcsp-reviewer
skpm publish cncf-novaglobal-kcsp-reviewer
```
