...
7. Run `skcr validate` and `skcr asps coverage cncf-ticketmaster-supporter-reviewer`.
8. Run `skcr compile cncf-ticketmaster-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ticketmaster-supporter-reviewer`.
...
```bash
skpm validate cncf-ticketmaster-supporter-reviewer
skpm package cncf-ticketmaster-supporter-reviewer
skpm publish cncf-ticketmaster-supporter-reviewer
```
