...
7. Run `skcr validate` and `skcr asps coverage cncf-aqua-security-kcsp-reviewer`.
8. Run `skcr compile cncf-aqua-security-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-aqua-security-kcsp-reviewer`.
...
```bash
skpm validate cncf-aqua-security-kcsp-reviewer
skpm package cncf-aqua-security-kcsp-reviewer
skpm publish cncf-aqua-security-kcsp-reviewer
```
