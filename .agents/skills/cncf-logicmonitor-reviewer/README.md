...
7. Run `skcr validate` and `skcr asps coverage cncf-logicmonitor-reviewer`.
8. Run `skcr compile cncf-logicmonitor-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-logicmonitor-reviewer`.
...
```bash
skpm validate cncf-logicmonitor-reviewer
skpm package cncf-logicmonitor-reviewer
skpm publish cncf-logicmonitor-reviewer
```
