...
7. Run `skcr validate` and `skcr asps coverage cncf-dachs-it-kcsp-reviewer`.
8. Run `skcr compile cncf-dachs-it-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-dachs-it-kcsp-reviewer`.
...
```bash
skpm validate cncf-dachs-it-kcsp-reviewer
skpm package cncf-dachs-it-kcsp-reviewer
skpm publish cncf-dachs-it-kcsp-reviewer
```
