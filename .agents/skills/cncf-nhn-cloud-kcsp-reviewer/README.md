...
7. Run `skcr validate` and `skcr asps coverage cncf-nhn-cloud-kcsp-reviewer`.
8. Run `skcr compile cncf-nhn-cloud-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nhn-cloud-kcsp-reviewer`.
...
```bash
skpm validate cncf-nhn-cloud-kcsp-reviewer
skpm package cncf-nhn-cloud-kcsp-reviewer
skpm publish cncf-nhn-cloud-kcsp-reviewer
```
