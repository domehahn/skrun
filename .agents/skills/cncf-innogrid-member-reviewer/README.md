...
7. Run `skcr validate` and `skcr asps coverage cncf-innogrid-member-reviewer`.
8. Run `skcr compile cncf-innogrid-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-innogrid-member-reviewer`.
...
```bash
skpm validate cncf-innogrid-member-reviewer
skpm package cncf-innogrid-member-reviewer
skpm publish cncf-innogrid-member-reviewer
```
