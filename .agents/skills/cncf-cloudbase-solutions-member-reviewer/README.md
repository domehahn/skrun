...
7. Run `skcr validate` and `skcr asps coverage cncf-cloudbase-solutions-member-reviewer`.
8. Run `skcr compile cncf-cloudbase-solutions-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloudbase-solutions-member-reviewer`.
...
```bash
skpm validate cncf-cloudbase-solutions-member-reviewer
skpm package cncf-cloudbase-solutions-member-reviewer
skpm publish cncf-cloudbase-solutions-member-reviewer
```
