...
7. Run `skcr validate` and `skcr asps coverage cncf-intercept-member-reviewer`.
8. Run `skcr compile cncf-intercept-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-intercept-member-reviewer`.
...
```bash
skpm validate cncf-intercept-member-reviewer
skpm package cncf-intercept-member-reviewer
skpm publish cncf-intercept-member-reviewer
```
