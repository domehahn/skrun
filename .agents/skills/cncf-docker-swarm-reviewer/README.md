...
7. Run `skcr validate` and `skcr asps coverage cncf-docker-swarm-reviewer`.
8. Run `skcr compile cncf-docker-swarm-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-docker-swarm-reviewer`.
...
```bash
skpm validate cncf-docker-swarm-reviewer
skpm package cncf-docker-swarm-reviewer
skpm publish cncf-docker-swarm-reviewer
```
