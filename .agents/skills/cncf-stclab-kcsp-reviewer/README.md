...
7. Run `skcr validate` and `skcr asps coverage cncf-stclab-kcsp-reviewer`.
8. Run `skcr compile cncf-stclab-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-stclab-kcsp-reviewer`.
...
```bash
skpm validate cncf-stclab-kcsp-reviewer
skpm package cncf-stclab-kcsp-reviewer
skpm publish cncf-stclab-kcsp-reviewer
```
