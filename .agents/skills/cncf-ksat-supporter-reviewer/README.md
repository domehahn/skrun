...
7. Run `skcr validate` and `skcr asps coverage cncf-ksat-supporter-reviewer`.
8. Run `skcr compile cncf-ksat-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ksat-supporter-reviewer`.
...
```bash
skpm validate cncf-ksat-supporter-reviewer
skpm package cncf-ksat-supporter-reviewer
skpm publish cncf-ksat-supporter-reviewer
```
