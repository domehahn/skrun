...
7. Run `skcr validate` and `skcr asps coverage cncf-tensorflow-extended-tfx-reviewer`.
8. Run `skcr compile cncf-tensorflow-extended-tfx-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-tensorflow-extended-tfx-reviewer`.
...
```bash
skpm validate cncf-tensorflow-extended-tfx-reviewer
skpm package cncf-tensorflow-extended-tfx-reviewer
skpm publish cncf-tensorflow-extended-tfx-reviewer
```
