...
7. Run `skcr validate` and `skcr asps coverage cncf-docomo-innovations-member-reviewer`.
8. Run `skcr compile cncf-docomo-innovations-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-docomo-innovations-member-reviewer`.
...
```bash
skpm validate cncf-docomo-innovations-member-reviewer
skpm package cncf-docomo-innovations-member-reviewer
skpm publish cncf-docomo-innovations-member-reviewer
```
