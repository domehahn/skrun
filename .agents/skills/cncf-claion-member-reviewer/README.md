...
7. Run `skcr validate` and `skcr asps coverage cncf-claion-member-reviewer`.
8. Run `skcr compile cncf-claion-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-claion-member-reviewer`.
...
```bash
skpm validate cncf-claion-member-reviewer
skpm package cncf-claion-member-reviewer
skpm publish cncf-claion-member-reviewer
```
