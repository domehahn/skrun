...
7. Run `skcr validate` and `skcr asps coverage cncf-tetrate-service-bridge-tsb-reviewer`.
8. Run `skcr compile cncf-tetrate-service-bridge-tsb-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-tetrate-service-bridge-tsb-reviewer`.
...
```bash
skpm validate cncf-tetrate-service-bridge-tsb-reviewer
skpm package cncf-tetrate-service-bridge-tsb-reviewer
skpm publish cncf-tetrate-service-bridge-tsb-reviewer
```
