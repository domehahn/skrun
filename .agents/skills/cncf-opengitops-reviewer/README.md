...
7. Run `skcr validate` and `skcr asps coverage cncf-opengitops-reviewer`.
8. Run `skcr compile cncf-opengitops-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-opengitops-reviewer`.
...
```bash
skpm validate cncf-opengitops-reviewer
skpm package cncf-opengitops-reviewer
skpm publish cncf-opengitops-reviewer
```
