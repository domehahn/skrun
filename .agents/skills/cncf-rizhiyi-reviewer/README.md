...
7. Run `skcr validate` and `skcr asps coverage cncf-rizhiyi-reviewer`.
8. Run `skcr compile cncf-rizhiyi-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-rizhiyi-reviewer`.
...
```bash
skpm validate cncf-rizhiyi-reviewer
skpm package cncf-rizhiyi-reviewer
skpm publish cncf-rizhiyi-reviewer
```
