...
7. Run `skcr validate` and `skcr asps coverage cncf-hyve-managed-hosting-member-reviewer`.
8. Run `skcr compile cncf-hyve-managed-hosting-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-hyve-managed-hosting-member-reviewer`.
...
```bash
skpm validate cncf-hyve-managed-hosting-member-reviewer
skpm package cncf-hyve-managed-hosting-member-reviewer
skpm publish cncf-hyve-managed-hosting-member-reviewer
```
