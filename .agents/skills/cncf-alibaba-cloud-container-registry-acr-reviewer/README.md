...
7. Run `skcr validate` and `skcr asps coverage cncf-alibaba-cloud-container-registry-acr-reviewer`.
8. Run `skcr compile cncf-alibaba-cloud-container-registry-acr-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-alibaba-cloud-container-registry-acr-reviewer`.
...
```bash
skpm validate cncf-alibaba-cloud-container-registry-acr-reviewer
skpm package cncf-alibaba-cloud-container-registry-acr-reviewer
skpm publish cncf-alibaba-cloud-container-registry-acr-reviewer
```
