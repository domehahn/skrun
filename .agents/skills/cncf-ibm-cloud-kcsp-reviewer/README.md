...
7. Run `skcr validate` and `skcr asps coverage cncf-ibm-cloud-kcsp-reviewer`.
8. Run `skcr compile cncf-ibm-cloud-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ibm-cloud-kcsp-reviewer`.
...
```bash
skpm validate cncf-ibm-cloud-kcsp-reviewer
skpm package cncf-ibm-cloud-kcsp-reviewer
skpm publish cncf-ibm-cloud-kcsp-reviewer
```
