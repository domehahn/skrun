...
7. Run `skcr validate` and `skcr asps coverage cncf-dx-o2-by-broadcom-reviewer`.
8. Run `skcr compile cncf-dx-o2-by-broadcom-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-dx-o2-by-broadcom-reviewer`.
...
```bash
skpm validate cncf-dx-o2-by-broadcom-reviewer
skpm package cncf-dx-o2-by-broadcom-reviewer
skpm publish cncf-dx-o2-by-broadcom-reviewer
```
