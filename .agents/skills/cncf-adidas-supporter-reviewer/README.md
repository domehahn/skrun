...
7. Run `skcr validate` and `skcr asps coverage cncf-adidas-supporter-reviewer`.
8. Run `skcr compile cncf-adidas-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-adidas-supporter-reviewer`.
...
```bash
skpm validate cncf-adidas-supporter-reviewer
skpm package cncf-adidas-supporter-reviewer
skpm publish cncf-adidas-supporter-reviewer
```
