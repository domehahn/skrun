...
7. Run `skcr validate` and `skcr asps coverage cncf-serverless-devs-reviewer`.
8. Run `skcr compile cncf-serverless-devs-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-serverless-devs-reviewer`.
...
```bash
skpm validate cncf-serverless-devs-reviewer
skpm package cncf-serverless-devs-reviewer
skpm publish cncf-serverless-devs-reviewer
```
