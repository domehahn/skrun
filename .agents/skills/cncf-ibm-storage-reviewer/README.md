...
7. Run `skcr validate` and `skcr asps coverage cncf-ibm-storage-reviewer`.
8. Run `skcr compile cncf-ibm-storage-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ibm-storage-reviewer`.
...
```bash
skpm validate cncf-ibm-storage-reviewer
skpm package cncf-ibm-storage-reviewer
skpm publish cncf-ibm-storage-reviewer
```
