...
7. Run `skcr validate` and `skcr asps coverage cncf-wind-river-member-reviewer`.
8. Run `skcr compile cncf-wind-river-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-wind-river-member-reviewer`.
...
```bash
skpm validate cncf-wind-river-member-reviewer
skpm package cncf-wind-river-member-reviewer
skpm publish cncf-wind-river-member-reviewer
```
