...
7. Run `skcr validate` and `skcr asps coverage cncf-ovhcloud-kcsp-reviewer`.
8. Run `skcr compile cncf-ovhcloud-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ovhcloud-kcsp-reviewer`.
...
```bash
skpm validate cncf-ovhcloud-kcsp-reviewer
skpm package cncf-ovhcloud-kcsp-reviewer
skpm publish cncf-ovhcloud-kcsp-reviewer
```
