...
7. Run `skcr validate` and `skcr asps coverage cncf-wavecon-member-reviewer`.
8. Run `skcr compile cncf-wavecon-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-wavecon-member-reviewer`.
...
```bash
skpm validate cncf-wavecon-member-reviewer
skpm package cncf-wavecon-member-reviewer
skpm publish cncf-wavecon-member-reviewer
```
