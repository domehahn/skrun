...
7. Run `skcr validate` and `skcr asps coverage cncf-sva-kcntp-reviewer`.
8. Run `skcr compile cncf-sva-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sva-kcntp-reviewer`.
...
```bash
skpm validate cncf-sva-kcntp-reviewer
skpm package cncf-sva-kcntp-reviewer
skpm publish cncf-sva-kcntp-reviewer
```
