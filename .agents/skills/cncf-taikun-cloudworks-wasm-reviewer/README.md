...
7. Run `skcr validate` and `skcr asps coverage cncf-taikun-cloudworks-wasm-reviewer`.
8. Run `skcr compile cncf-taikun-cloudworks-wasm-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-taikun-cloudworks-wasm-reviewer`.
...
```bash
skpm validate cncf-taikun-cloudworks-wasm-reviewer
skpm package cncf-taikun-cloudworks-wasm-reviewer
skpm publish cncf-taikun-cloudworks-wasm-reviewer
```
