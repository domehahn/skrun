...
7. Run `skcr validate` and `skcr asps coverage cncf-new-relic-member-reviewer`.
8. Run `skcr compile cncf-new-relic-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-new-relic-member-reviewer`.
...
```bash
skpm validate cncf-new-relic-member-reviewer
skpm package cncf-new-relic-member-reviewer
skpm publish cncf-new-relic-member-reviewer
```
