...
7. Run `skcr validate` and `skcr asps coverage cncf-edb-kcsp-reviewer`.
8. Run `skcr compile cncf-edb-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-edb-kcsp-reviewer`.
...
```bash
skpm validate cncf-edb-kcsp-reviewer
skpm package cncf-edb-kcsp-reviewer
skpm publish cncf-edb-kcsp-reviewer
```
