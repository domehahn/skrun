...
7. Run `skcr validate` and `skcr asps coverage cncf-prometheus-reviewer`.
8. Run `skcr compile cncf-prometheus-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-prometheus-reviewer`.
...
```bash
skpm validate cncf-prometheus-reviewer
skpm package cncf-prometheus-reviewer
skpm publish cncf-prometheus-reviewer
```
