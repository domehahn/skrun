...
7. Run `skcr validate` and `skcr asps coverage observability-reviewer`.
8. Run `skcr compile observability-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend observability-reviewer`.
