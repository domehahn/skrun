...
7. Run `skcr validate` and `skcr asps coverage cncf-guidewire-member-reviewer`.
8. Run `skcr compile cncf-guidewire-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-guidewire-member-reviewer`.
...
```bash
skpm validate cncf-guidewire-member-reviewer
skpm package cncf-guidewire-member-reviewer
skpm publish cncf-guidewire-member-reviewer
```
