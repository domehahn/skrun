...
7. Run `skcr validate` and `skcr asps coverage cncf-resolve-technology-member-reviewer`.
8. Run `skcr compile cncf-resolve-technology-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-resolve-technology-member-reviewer`.
...
```bash
skpm validate cncf-resolve-technology-member-reviewer
skpm package cncf-resolve-technology-member-reviewer
skpm publish cncf-resolve-technology-member-reviewer
```
