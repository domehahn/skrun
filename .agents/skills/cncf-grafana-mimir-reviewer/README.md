...
7. Run `skcr validate` and `skcr asps coverage cncf-grafana-mimir-reviewer`.
8. Run `skcr compile cncf-grafana-mimir-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-grafana-mimir-reviewer`.
...
```bash
skpm validate cncf-grafana-mimir-reviewer
skpm package cncf-grafana-mimir-reviewer
skpm publish cncf-grafana-mimir-reviewer
```
