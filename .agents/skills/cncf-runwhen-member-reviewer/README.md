...
7. Run `skcr validate` and `skcr asps coverage cncf-runwhen-member-reviewer`.
8. Run `skcr compile cncf-runwhen-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-runwhen-member-reviewer`.
...
```bash
skpm validate cncf-runwhen-member-reviewer
skpm package cncf-runwhen-member-reviewer
skpm publish cncf-runwhen-member-reviewer
```
