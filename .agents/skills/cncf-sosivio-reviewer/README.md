...
7. Run `skcr validate` and `skcr asps coverage cncf-sosivio-reviewer`.
8. Run `skcr compile cncf-sosivio-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sosivio-reviewer`.
...
```bash
skpm validate cncf-sosivio-reviewer
skpm package cncf-sosivio-reviewer
skpm publish cncf-sosivio-reviewer
```
