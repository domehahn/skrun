...
7. Run `skcr validate` and `skcr asps coverage cncf-alibaba-cloud-function-compute-reviewer`.
8. Run `skcr compile cncf-alibaba-cloud-function-compute-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-alibaba-cloud-function-compute-reviewer`.
...
```bash
skpm validate cncf-alibaba-cloud-function-compute-reviewer
skpm package cncf-alibaba-cloud-function-compute-reviewer
skpm publish cncf-alibaba-cloud-function-compute-reviewer
```
