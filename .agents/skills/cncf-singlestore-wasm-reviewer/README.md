...
7. Run `skcr validate` and `skcr asps coverage cncf-singlestore-wasm-reviewer`.
8. Run `skcr compile cncf-singlestore-wasm-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-singlestore-wasm-reviewer`.
...
```bash
skpm validate cncf-singlestore-wasm-reviewer
skpm package cncf-singlestore-wasm-reviewer
skpm publish cncf-singlestore-wasm-reviewer
```
