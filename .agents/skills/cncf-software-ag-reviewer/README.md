...
7. Run `skcr validate` and `skcr asps coverage cncf-software-ag-reviewer`.
8. Run `skcr compile cncf-software-ag-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-software-ag-reviewer`.
...
```bash
skpm validate cncf-software-ag-reviewer
skpm package cncf-software-ag-reviewer
skpm publish cncf-software-ag-reviewer
```
