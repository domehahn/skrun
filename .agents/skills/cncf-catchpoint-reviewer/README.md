...
7. Run `skcr validate` and `skcr asps coverage cncf-catchpoint-reviewer`.
8. Run `skcr compile cncf-catchpoint-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-catchpoint-reviewer`.
...
```bash
skpm validate cncf-catchpoint-reviewer
skpm package cncf-catchpoint-reviewer
skpm publish cncf-catchpoint-reviewer
```
