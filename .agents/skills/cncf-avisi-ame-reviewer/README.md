...
7. Run `skcr validate` and `skcr asps coverage cncf-avisi-ame-reviewer`.
8. Run `skcr compile cncf-avisi-ame-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-avisi-ame-reviewer`.
...
```bash
skpm validate cncf-avisi-ame-reviewer
skpm package cncf-avisi-ame-reviewer
skpm publish cncf-avisi-ame-reviewer
```
