...
7. Run `skcr validate` and `skcr asps coverage cncf-hawkstack-member-reviewer`.
8. Run `skcr compile cncf-hawkstack-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-hawkstack-member-reviewer`.
...
```bash
skpm validate cncf-hawkstack-member-reviewer
skpm package cncf-hawkstack-member-reviewer
skpm publish cncf-hawkstack-member-reviewer
```
