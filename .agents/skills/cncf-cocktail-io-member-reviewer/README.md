...
7. Run `skcr validate` and `skcr asps coverage cncf-cocktail-io-member-reviewer`.
8. Run `skcr compile cncf-cocktail-io-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cocktail-io-member-reviewer`.
...
```bash
skpm validate cncf-cocktail-io-member-reviewer
skpm package cncf-cocktail-io-member-reviewer
skpm publish cncf-cocktail-io-member-reviewer
```
