...
7. Run `skcr validate` and `skcr asps coverage cncf-koordinator-reviewer`.
8. Run `skcr compile cncf-koordinator-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-koordinator-reviewer`.
...
```bash
skpm validate cncf-koordinator-reviewer
skpm package cncf-koordinator-reviewer
skpm publish cncf-koordinator-reviewer
```
