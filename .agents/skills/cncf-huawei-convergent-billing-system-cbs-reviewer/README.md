...
7. Run `skcr validate` and `skcr asps coverage cncf-huawei-convergent-billing-system-cbs-reviewer`.
8. Run `skcr compile cncf-huawei-convergent-billing-system-cbs-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-huawei-convergent-billing-system-cbs-reviewer`.
...
```bash
skpm validate cncf-huawei-convergent-billing-system-cbs-reviewer
skpm package cncf-huawei-convergent-billing-system-cbs-reviewer
skpm publish cncf-huawei-convergent-billing-system-cbs-reviewer
```
