...
7. Run `skcr validate` and `skcr asps coverage cncf-ahnlab-cloudmate-member-reviewer`.
8. Run `skcr compile cncf-ahnlab-cloudmate-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ahnlab-cloudmate-member-reviewer`.
...
```bash
skpm validate cncf-ahnlab-cloudmate-member-reviewer
skpm package cncf-ahnlab-cloudmate-member-reviewer
skpm publish cncf-ahnlab-cloudmate-member-reviewer
```
