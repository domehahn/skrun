...
7. Run `skcr validate` and `skcr asps coverage cncf-rbac-manager-reviewer`.
8. Run `skcr compile cncf-rbac-manager-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-rbac-manager-reviewer`.
...
```bash
skpm validate cncf-rbac-manager-reviewer
skpm package cncf-rbac-manager-reviewer
skpm publish cncf-rbac-manager-reviewer
```
