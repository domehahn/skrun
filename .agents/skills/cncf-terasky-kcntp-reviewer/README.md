...
7. Run `skcr validate` and `skcr asps coverage cncf-terasky-kcntp-reviewer`.
8. Run `skcr compile cncf-terasky-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-terasky-kcntp-reviewer`.
...
```bash
skpm validate cncf-terasky-kcntp-reviewer
skpm package cncf-terasky-kcntp-reviewer
skpm publish cncf-terasky-kcntp-reviewer
```
