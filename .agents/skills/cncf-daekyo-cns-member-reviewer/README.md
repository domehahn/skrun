...
7. Run `skcr validate` and `skcr asps coverage cncf-daekyo-cns-member-reviewer`.
8. Run `skcr compile cncf-daekyo-cns-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-daekyo-cns-member-reviewer`.
...
```bash
skpm validate cncf-daekyo-cns-member-reviewer
skpm package cncf-daekyo-cns-member-reviewer
skpm publish cncf-daekyo-cns-member-reviewer
```
