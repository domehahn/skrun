...
7. Run `skcr validate` and `skcr asps coverage cncf-prisma-cloud-reviewer`.
8. Run `skcr compile cncf-prisma-cloud-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-prisma-cloud-reviewer`.
...
```bash
skpm validate cncf-prisma-cloud-reviewer
skpm package cncf-prisma-cloud-reviewer
skpm publish cncf-prisma-cloud-reviewer
```
