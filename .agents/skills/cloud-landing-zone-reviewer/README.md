...
7. Run `skcr validate` and `skcr asps coverage cloud-landing-zone-reviewer`.
8. Run `skcr compile cloud-landing-zone-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cloud-landing-zone-reviewer`.
...
```bash
skpm validate cloud-landing-zone-reviewer
skpm package cloud-landing-zone-reviewer
skpm publish cloud-landing-zone-reviewer
```
