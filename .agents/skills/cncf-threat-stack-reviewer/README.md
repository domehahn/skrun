...
7. Run `skcr validate` and `skcr asps coverage cncf-threat-stack-reviewer`.
8. Run `skcr compile cncf-threat-stack-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-threat-stack-reviewer`.
...
```bash
skpm validate cncf-threat-stack-reviewer
skpm package cncf-threat-stack-reviewer
skpm publish cncf-threat-stack-reviewer
```
