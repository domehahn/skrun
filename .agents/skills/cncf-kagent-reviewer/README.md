...
7. Run `skcr validate` and `skcr asps coverage cncf-kagent-reviewer`.
8. Run `skcr compile cncf-kagent-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kagent-reviewer`.
...
```bash
skpm validate cncf-kagent-reviewer
skpm package cncf-kagent-reviewer
skpm publish cncf-kagent-reviewer
```
