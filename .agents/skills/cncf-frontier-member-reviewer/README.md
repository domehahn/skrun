...
7. Run `skcr validate` and `skcr asps coverage cncf-frontier-member-reviewer`.
8. Run `skcr compile cncf-frontier-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-frontier-member-reviewer`.
...
```bash
skpm validate cncf-frontier-member-reviewer
skpm package cncf-frontier-member-reviewer
skpm publish cncf-frontier-member-reviewer
```
