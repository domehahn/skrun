...
7. Run `skcr validate` and `skcr asps coverage cncf-k3k-reviewer`.
8. Run `skcr compile cncf-k3k-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-k3k-reviewer`.
...
```bash
skpm validate cncf-k3k-reviewer
skpm package cncf-k3k-reviewer
skpm publish cncf-k3k-reviewer
```
