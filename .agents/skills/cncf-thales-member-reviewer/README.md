...
7. Run `skcr validate` and `skcr asps coverage cncf-thales-member-reviewer`.
8. Run `skcr compile cncf-thales-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-thales-member-reviewer`.
...
```bash
skpm validate cncf-thales-member-reviewer
skpm package cncf-thales-member-reviewer
skpm publish cncf-thales-member-reviewer
```
