...
7. Run `skcr validate` and `skcr asps coverage cncf-tongtech-member-reviewer`.
8. Run `skcr compile cncf-tongtech-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-tongtech-member-reviewer`.
...
```bash
skpm validate cncf-tongtech-member-reviewer
skpm package cncf-tongtech-member-reviewer
skpm publish cncf-tongtech-member-reviewer
```
