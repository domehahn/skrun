...
7. Run `skcr validate` and `skcr asps coverage cncf-endress-plus-hauser-supporter-reviewer`.
8. Run `skcr compile cncf-endress-plus-hauser-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-endress-plus-hauser-supporter-reviewer`.
...
```bash
skpm validate cncf-endress-plus-hauser-supporter-reviewer
skpm package cncf-endress-plus-hauser-supporter-reviewer
skpm publish cncf-endress-plus-hauser-supporter-reviewer
```
