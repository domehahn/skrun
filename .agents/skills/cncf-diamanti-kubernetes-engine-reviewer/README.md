...
7. Run `skcr validate` and `skcr asps coverage cncf-diamanti-kubernetes-engine-reviewer`.
8. Run `skcr compile cncf-diamanti-kubernetes-engine-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-diamanti-kubernetes-engine-reviewer`.
...
```bash
skpm validate cncf-diamanti-kubernetes-engine-reviewer
skpm package cncf-diamanti-kubernetes-engine-reviewer
skpm publish cncf-diamanti-kubernetes-engine-reviewer
```
