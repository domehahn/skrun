...
7. Run `skcr validate` and `skcr asps coverage cncf-clever-cloud-reviewer`.
8. Run `skcr compile cncf-clever-cloud-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-clever-cloud-reviewer`.
...
```bash
skpm validate cncf-clever-cloud-reviewer
skpm package cncf-clever-cloud-reviewer
skpm publish cncf-clever-cloud-reviewer
```
