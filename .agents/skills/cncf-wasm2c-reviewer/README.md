...
7. Run `skcr validate` and `skcr asps coverage cncf-wasm2c-reviewer`.
8. Run `skcr compile cncf-wasm2c-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-wasm2c-reviewer`.
...
```bash
skpm validate cncf-wasm2c-reviewer
skpm package cncf-wasm2c-reviewer
skpm publish cncf-wasm2c-reviewer
```
