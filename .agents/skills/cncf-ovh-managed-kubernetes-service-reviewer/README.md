...
7. Run `skcr validate` and `skcr asps coverage cncf-ovh-managed-kubernetes-service-reviewer`.
8. Run `skcr compile cncf-ovh-managed-kubernetes-service-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ovh-managed-kubernetes-service-reviewer`.
...
```bash
skpm validate cncf-ovh-managed-kubernetes-service-reviewer
skpm package cncf-ovh-managed-kubernetes-service-reviewer
skpm publish cncf-ovh-managed-kubernetes-service-reviewer
```
