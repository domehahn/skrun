...
7. Run `skcr validate` and `skcr asps coverage cncf-cast-ai-reviewer`.
8. Run `skcr compile cncf-cast-ai-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cast-ai-reviewer`.
...
```bash
skpm validate cncf-cast-ai-reviewer
skpm package cncf-cast-ai-reviewer
skpm publish cncf-cast-ai-reviewer
```
