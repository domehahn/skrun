...
7. Run `skcr validate` and `skcr asps coverage cncf-arcfra-member-reviewer`.
8. Run `skcr compile cncf-arcfra-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-arcfra-member-reviewer`.
...
```bash
skpm validate cncf-arcfra-member-reviewer
skpm package cncf-arcfra-member-reviewer
skpm publish cncf-arcfra-member-reviewer
```
