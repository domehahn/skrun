...
7. Run `skcr validate` and `skcr asps coverage cncf-china-systems-kcsp-reviewer`.
8. Run `skcr compile cncf-china-systems-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-china-systems-kcsp-reviewer`.
...
```bash
skpm validate cncf-china-systems-kcsp-reviewer
skpm package cncf-china-systems-kcsp-reviewer
skpm publish cncf-china-systems-kcsp-reviewer
```
