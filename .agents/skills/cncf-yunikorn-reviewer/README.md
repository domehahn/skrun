...
7. Run `skcr validate` and `skcr asps coverage cncf-yunikorn-reviewer`.
8. Run `skcr compile cncf-yunikorn-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-yunikorn-reviewer`.
...
```bash
skpm validate cncf-yunikorn-reviewer
skpm package cncf-yunikorn-reviewer
skpm publish cncf-yunikorn-reviewer
```
