...
7. Run `skcr validate` and `skcr asps coverage cncf-samsung-sds-member-reviewer`.
8. Run `skcr compile cncf-samsung-sds-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-samsung-sds-member-reviewer`.
...
```bash
skpm validate cncf-samsung-sds-member-reviewer
skpm package cncf-samsung-sds-member-reviewer
skpm publish cncf-samsung-sds-member-reviewer
```
