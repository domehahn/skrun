...
7. Run `skcr validate` and `skcr asps coverage cncf-american-express-member-reviewer`.
8. Run `skcr compile cncf-american-express-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-american-express-member-reviewer`.
...
```bash
skpm validate cncf-american-express-member-reviewer
skpm package cncf-american-express-member-reviewer
skpm publish cncf-american-express-member-reviewer
```
