...
7. Run `skcr validate` and `skcr asps coverage cncf-standard-library-reviewer`.
8. Run `skcr compile cncf-standard-library-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-standard-library-reviewer`.
...
```bash
skpm validate cncf-standard-library-reviewer
skpm package cncf-standard-library-reviewer
skpm publish cncf-standard-library-reviewer
```
