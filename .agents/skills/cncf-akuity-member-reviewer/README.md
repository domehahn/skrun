...
7. Run `skcr validate` and `skcr asps coverage cncf-akuity-member-reviewer`.
8. Run `skcr compile cncf-akuity-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-akuity-member-reviewer`.
...
```bash
skpm validate cncf-akuity-member-reviewer
skpm package cncf-akuity-member-reviewer
skpm publish cncf-akuity-member-reviewer
```
