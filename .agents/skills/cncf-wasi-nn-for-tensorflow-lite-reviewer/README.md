...
7. Run `skcr validate` and `skcr asps coverage cncf-wasi-nn-for-tensorflow-lite-reviewer`.
8. Run `skcr compile cncf-wasi-nn-for-tensorflow-lite-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-wasi-nn-for-tensorflow-lite-reviewer`.
...
```bash
skpm validate cncf-wasi-nn-for-tensorflow-lite-reviewer
skpm package cncf-wasi-nn-for-tensorflow-lite-reviewer
skpm publish cncf-wasi-nn-for-tensorflow-lite-reviewer
```
