...
7. Run `skcr validate` and `skcr asps coverage cncf-cloud-foundry-application-runtime-reviewer`.
8. Run `skcr compile cncf-cloud-foundry-application-runtime-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloud-foundry-application-runtime-reviewer`.
...
```bash
skpm validate cncf-cloud-foundry-application-runtime-reviewer
skpm package cncf-cloud-foundry-application-runtime-reviewer
skpm publish cncf-cloud-foundry-application-runtime-reviewer
```
