...
7. Run `skcr validate` and `skcr asps coverage cncf-dina-it-solutions-member-reviewer`.
8. Run `skcr compile cncf-dina-it-solutions-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-dina-it-solutions-member-reviewer`.
...
```bash
skpm validate cncf-dina-it-solutions-member-reviewer
skpm package cncf-dina-it-solutions-member-reviewer
skpm publish cncf-dina-it-solutions-member-reviewer
```
