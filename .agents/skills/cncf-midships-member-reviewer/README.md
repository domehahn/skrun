...
7. Run `skcr validate` and `skcr asps coverage cncf-midships-member-reviewer`.
8. Run `skcr compile cncf-midships-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-midships-member-reviewer`.
...
```bash
skpm validate cncf-midships-member-reviewer
skpm package cncf-midships-member-reviewer
skpm publish cncf-midships-member-reviewer
```
