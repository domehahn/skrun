...
7. Run `skcr validate` and `skcr asps coverage cncf-sofatracer-reviewer`.
8. Run `skcr compile cncf-sofatracer-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sofatracer-reviewer`.
...
```bash
skpm validate cncf-sofatracer-reviewer
skpm package cncf-sofatracer-reviewer
skpm publish cncf-sofatracer-reviewer
```
