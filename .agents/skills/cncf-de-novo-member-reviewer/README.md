...
7. Run `skcr validate` and `skcr asps coverage cncf-de-novo-member-reviewer`.
8. Run `skcr compile cncf-de-novo-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-de-novo-member-reviewer`.
...
```bash
skpm validate cncf-de-novo-member-reviewer
skpm package cncf-de-novo-member-reviewer
skpm publish cncf-de-novo-member-reviewer
```
