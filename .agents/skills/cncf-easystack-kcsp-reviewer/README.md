...
7. Run `skcr validate` and `skcr asps coverage cncf-easystack-kcsp-reviewer`.
8. Run `skcr compile cncf-easystack-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-easystack-kcsp-reviewer`.
...
```bash
skpm validate cncf-easystack-kcsp-reviewer
skpm package cncf-easystack-kcsp-reviewer
skpm publish cncf-easystack-kcsp-reviewer
```
