...
7. Run `skcr validate` and `skcr asps coverage cncf-tailscale-member-reviewer`.
8. Run `skcr compile cncf-tailscale-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-tailscale-member-reviewer`.
...
```bash
skpm validate cncf-tailscale-member-reviewer
skpm package cncf-tailscale-member-reviewer
skpm publish cncf-tailscale-member-reviewer
```
