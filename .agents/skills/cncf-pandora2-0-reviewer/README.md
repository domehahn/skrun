...
7. Run `skcr validate` and `skcr asps coverage cncf-pandora2-0-reviewer`.
8. Run `skcr compile cncf-pandora2-0-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-pandora2-0-reviewer`.
...
```bash
skpm validate cncf-pandora2-0-reviewer
skpm package cncf-pandora2-0-reviewer
skpm publish cncf-pandora2-0-reviewer
```
