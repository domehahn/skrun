...
7. Run `skcr validate` and `skcr asps coverage cncf-cadence-workflow-reviewer`.
8. Run `skcr compile cncf-cadence-workflow-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cadence-workflow-reviewer`.
...
```bash
skpm validate cncf-cadence-workflow-reviewer
skpm package cncf-cadence-workflow-reviewer
skpm publish cncf-cadence-workflow-reviewer
```
