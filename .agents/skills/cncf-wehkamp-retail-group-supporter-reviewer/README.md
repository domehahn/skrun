...
7. Run `skcr validate` and `skcr asps coverage cncf-wehkamp-retail-group-supporter-reviewer`.
8. Run `skcr compile cncf-wehkamp-retail-group-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-wehkamp-retail-group-supporter-reviewer`.
...
```bash
skpm validate cncf-wehkamp-retail-group-supporter-reviewer
skpm package cncf-wehkamp-retail-group-supporter-reviewer
skpm publish cncf-wehkamp-retail-group-supporter-reviewer
```
