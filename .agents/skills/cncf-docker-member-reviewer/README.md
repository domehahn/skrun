...
7. Run `skcr validate` and `skcr asps coverage cncf-docker-member-reviewer`.
8. Run `skcr compile cncf-docker-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-docker-member-reviewer`.
...
```bash
skpm validate cncf-docker-member-reviewer
skpm package cncf-docker-member-reviewer
skpm publish cncf-docker-member-reviewer
```
