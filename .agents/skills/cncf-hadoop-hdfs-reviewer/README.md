...
7. Run `skcr validate` and `skcr asps coverage cncf-hadoop-hdfs-reviewer`.
8. Run `skcr compile cncf-hadoop-hdfs-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-hadoop-hdfs-reviewer`.
...
```bash
skpm validate cncf-hadoop-hdfs-reviewer
skpm package cncf-hadoop-hdfs-reviewer
skpm publish cncf-hadoop-hdfs-reviewer
```
