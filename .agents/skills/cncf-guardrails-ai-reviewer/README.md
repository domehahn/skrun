...
7. Run `skcr validate` and `skcr asps coverage cncf-guardrails-ai-reviewer`.
8. Run `skcr compile cncf-guardrails-ai-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-guardrails-ai-reviewer`.
...
```bash
skpm validate cncf-guardrails-ai-reviewer
skpm package cncf-guardrails-ai-reviewer
skpm publish cncf-guardrails-ai-reviewer
```
