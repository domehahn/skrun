...
7. Run `skcr validate` and `skcr asps coverage cncf-pionative-kcsp-reviewer`.
8. Run `skcr compile cncf-pionative-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-pionative-kcsp-reviewer`.
...
```bash
skpm validate cncf-pionative-kcsp-reviewer
skpm package cncf-pionative-kcsp-reviewer
skpm publish cncf-pionative-kcsp-reviewer
```
