...
7. Run `skcr validate` and `skcr asps coverage cncf-1nce-member-reviewer`.
8. Run `skcr compile cncf-1nce-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-1nce-member-reviewer`.
...
```bash
skpm validate cncf-1nce-member-reviewer
skpm package cncf-1nce-member-reviewer
skpm publish cncf-1nce-member-reviewer
```
