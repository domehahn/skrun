...
7. Run `skcr validate` and `skcr asps coverage cncf-cockroachdb-reviewer`.
8. Run `skcr compile cncf-cockroachdb-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cockroachdb-reviewer`.
...
```bash
skpm validate cncf-cockroachdb-reviewer
skpm package cncf-cockroachdb-reviewer
skpm publish cncf-cockroachdb-reviewer
```
