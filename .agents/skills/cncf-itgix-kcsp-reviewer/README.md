...
7. Run `skcr validate` and `skcr asps coverage cncf-itgix-kcsp-reviewer`.
8. Run `skcr compile cncf-itgix-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-itgix-kcsp-reviewer`.
...
```bash
skpm validate cncf-itgix-kcsp-reviewer
skpm package cncf-itgix-kcsp-reviewer
skpm publish cncf-itgix-kcsp-reviewer
```
