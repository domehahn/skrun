...
7. Run `skcr validate` and `skcr asps coverage cncf-nemo-guardrails-reviewer`.
8. Run `skcr compile cncf-nemo-guardrails-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nemo-guardrails-reviewer`.
...
```bash
skpm validate cncf-nemo-guardrails-reviewer
skpm package cncf-nemo-guardrails-reviewer
skpm publish cncf-nemo-guardrails-reviewer
```
