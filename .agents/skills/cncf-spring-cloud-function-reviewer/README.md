...
7. Run `skcr validate` and `skcr asps coverage cncf-spring-cloud-function-reviewer`.
8. Run `skcr compile cncf-spring-cloud-function-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-spring-cloud-function-reviewer`.
...
```bash
skpm validate cncf-spring-cloud-function-reviewer
skpm package cncf-spring-cloud-function-reviewer
skpm publish cncf-spring-cloud-function-reviewer
```
