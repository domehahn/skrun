...
7. Run `skcr validate` and `skcr asps coverage cncf-slimfaas-reviewer`.
8. Run `skcr compile cncf-slimfaas-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-slimfaas-reviewer`.
...
```bash
skpm validate cncf-slimfaas-reviewer
skpm package cncf-slimfaas-reviewer
skpm publish cncf-slimfaas-reviewer
```
