...
7. Run `skcr validate` and `skcr asps coverage cncf-quai-network-reviewer`.
8. Run `skcr compile cncf-quai-network-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-quai-network-reviewer`.
...
```bash
skpm validate cncf-quai-network-reviewer
skpm package cncf-quai-network-reviewer
skpm publish cncf-quai-network-reviewer
```
