...
7. Run `skcr validate` and `skcr asps coverage api-contract-reviewer`.
8. Run `skcr compile api-contract-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend api-contract-reviewer`.
