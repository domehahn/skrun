...
7. Run `skcr validate` and `skcr asps coverage cncf-kt-cloud-member-reviewer`.
8. Run `skcr compile cncf-kt-cloud-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kt-cloud-member-reviewer`.
...
```bash
skpm validate cncf-kt-cloud-member-reviewer
skpm package cncf-kt-cloud-member-reviewer
skpm publish cncf-kt-cloud-member-reviewer
```
