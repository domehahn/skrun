...
7. Run `skcr validate` and `skcr asps coverage cncf-thermo-fisher-scientific-supporter-reviewer`.
8. Run `skcr compile cncf-thermo-fisher-scientific-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-thermo-fisher-scientific-supporter-reviewer`.
...
```bash
skpm validate cncf-thermo-fisher-scientific-supporter-reviewer
skpm package cncf-thermo-fisher-scientific-supporter-reviewer
skpm publish cncf-thermo-fisher-scientific-supporter-reviewer
```
