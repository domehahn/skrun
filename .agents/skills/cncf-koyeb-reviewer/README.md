...
7. Run `skcr validate` and `skcr asps coverage cncf-koyeb-reviewer`.
8. Run `skcr compile cncf-koyeb-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-koyeb-reviewer`.
...
```bash
skpm validate cncf-koyeb-reviewer
skpm package cncf-koyeb-reviewer
skpm publish cncf-koyeb-reviewer
```
