...
7. Run `skcr validate` and `skcr asps coverage cncf-diamanti-member-reviewer`.
8. Run `skcr compile cncf-diamanti-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-diamanti-member-reviewer`.
...
```bash
skpm validate cncf-diamanti-member-reviewer
skpm package cncf-diamanti-member-reviewer
skpm publish cncf-diamanti-member-reviewer
```
