...
7. Run `skcr validate` and `skcr asps coverage cncf-apache-zookeeper-reviewer`.
8. Run `skcr compile cncf-apache-zookeeper-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-apache-zookeeper-reviewer`.
...
```bash
skpm validate cncf-apache-zookeeper-reviewer
skpm package cncf-apache-zookeeper-reviewer
skpm publish cncf-apache-zookeeper-reviewer
```
