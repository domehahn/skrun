...
7. Run `skcr validate` and `skcr asps coverage cncf-jetstack-kcsp-reviewer`.
8. Run `skcr compile cncf-jetstack-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-jetstack-kcsp-reviewer`.
...
```bash
skpm validate cncf-jetstack-kcsp-reviewer
skpm package cncf-jetstack-kcsp-reviewer
skpm publish cncf-jetstack-kcsp-reviewer
```
