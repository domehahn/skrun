...
7. Run `skcr validate` and `skcr asps coverage cncf-odigos-member-reviewer`.
8. Run `skcr compile cncf-odigos-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-odigos-member-reviewer`.
...
```bash
skpm validate cncf-odigos-member-reviewer
skpm package cncf-odigos-member-reviewer
skpm publish cncf-odigos-member-reviewer
```
