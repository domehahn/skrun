...
7. Run `skcr validate` and `skcr asps coverage cncf-mogenius-member-reviewer`.
8. Run `skcr compile cncf-mogenius-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-mogenius-member-reviewer`.
...
```bash
skpm validate cncf-mogenius-member-reviewer
skpm package cncf-mogenius-member-reviewer
skpm publish cncf-mogenius-member-reviewer
```
