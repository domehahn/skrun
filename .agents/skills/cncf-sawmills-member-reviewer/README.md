...
7. Run `skcr validate` and `skcr asps coverage cncf-sawmills-member-reviewer`.
8. Run `skcr compile cncf-sawmills-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sawmills-member-reviewer`.
...
```bash
skpm validate cncf-sawmills-member-reviewer
skpm package cncf-sawmills-member-reviewer
skpm publish cncf-sawmills-member-reviewer
```
