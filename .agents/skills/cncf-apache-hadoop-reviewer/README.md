...
7. Run `skcr validate` and `skcr asps coverage cncf-apache-hadoop-reviewer`.
8. Run `skcr compile cncf-apache-hadoop-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-apache-hadoop-reviewer`.
...
```bash
skpm validate cncf-apache-hadoop-reviewer
skpm package cncf-apache-hadoop-reviewer
skpm publish cncf-apache-hadoop-reviewer
```
