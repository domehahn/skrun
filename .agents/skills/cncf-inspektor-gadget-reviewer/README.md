...
7. Run `skcr validate` and `skcr asps coverage cncf-inspektor-gadget-reviewer`.
8. Run `skcr compile cncf-inspektor-gadget-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-inspektor-gadget-reviewer`.
...
```bash
skpm validate cncf-inspektor-gadget-reviewer
skpm package cncf-inspektor-gadget-reviewer
skpm publish cncf-inspektor-gadget-reviewer
```
