...
7. Run `skcr validate` and `skcr asps coverage cncf-infino-ai-member-reviewer`.
8. Run `skcr compile cncf-infino-ai-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-infino-ai-member-reviewer`.
...
```bash
skpm validate cncf-infino-ai-member-reviewer
skpm package cncf-infino-ai-member-reviewer
skpm publish cncf-infino-ai-member-reviewer
```
