...
7. Run `skcr validate` and `skcr asps coverage cncf-canonical-member-reviewer`.
8. Run `skcr compile cncf-canonical-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-canonical-member-reviewer`.
...
```bash
skpm validate cncf-canonical-member-reviewer
skpm package cncf-canonical-member-reviewer
skpm publish cncf-canonical-member-reviewer
```
