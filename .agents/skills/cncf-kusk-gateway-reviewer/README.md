...
7. Run `skcr validate` and `skcr asps coverage cncf-kusk-gateway-reviewer`.
8. Run `skcr compile cncf-kusk-gateway-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kusk-gateway-reviewer`.
...
```bash
skpm validate cncf-kusk-gateway-reviewer
skpm package cncf-kusk-gateway-reviewer
skpm publish cncf-kusk-gateway-reviewer
```
