...
7. Run `skcr validate` and `skcr asps coverage cncf-software-mind-member-reviewer`.
8. Run `skcr compile cncf-software-mind-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-software-mind-member-reviewer`.
...
```bash
skpm validate cncf-software-mind-member-reviewer
skpm package cncf-software-mind-member-reviewer
skpm publish cncf-software-mind-member-reviewer
```
