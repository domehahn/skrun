...
7. Run `skcr validate` and `skcr asps coverage cncf-andes-digital-kcsp-reviewer`.
8. Run `skcr compile cncf-andes-digital-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-andes-digital-kcsp-reviewer`.
...
```bash
skpm validate cncf-andes-digital-kcsp-reviewer
skpm package cncf-andes-digital-kcsp-reviewer
skpm publish cncf-andes-digital-kcsp-reviewer
```
