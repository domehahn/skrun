...
7. Run `skcr validate` and `skcr asps coverage control-mapping-reviewer`.
8. Run `skcr compile control-mapping-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend control-mapping-reviewer`.
