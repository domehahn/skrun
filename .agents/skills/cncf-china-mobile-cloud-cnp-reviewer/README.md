...
7. Run `skcr validate` and `skcr asps coverage cncf-china-mobile-cloud-cnp-reviewer`.
8. Run `skcr compile cncf-china-mobile-cloud-cnp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-china-mobile-cloud-cnp-reviewer`.
...
```bash
skpm validate cncf-china-mobile-cloud-cnp-reviewer
skpm package cncf-china-mobile-cloud-cnp-reviewer
skpm publish cncf-china-mobile-cloud-cnp-reviewer
```
