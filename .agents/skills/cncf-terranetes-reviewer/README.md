...
7. Run `skcr validate` and `skcr asps coverage cncf-terranetes-reviewer`.
8. Run `skcr compile cncf-terranetes-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-terranetes-reviewer`.
...
```bash
skpm validate cncf-terranetes-reviewer
skpm package cncf-terranetes-reviewer
skpm publish cncf-terranetes-reviewer
```
