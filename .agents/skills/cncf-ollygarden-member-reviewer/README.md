...
7. Run `skcr validate` and `skcr asps coverage cncf-ollygarden-member-reviewer`.
8. Run `skcr compile cncf-ollygarden-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ollygarden-member-reviewer`.
...
```bash
skpm validate cncf-ollygarden-member-reviewer
skpm package cncf-ollygarden-member-reviewer
skpm publish cncf-ollygarden-member-reviewer
```
