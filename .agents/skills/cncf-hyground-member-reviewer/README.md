...
7. Run `skcr validate` and `skcr asps coverage cncf-hyground-member-reviewer`.
8. Run `skcr compile cncf-hyground-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-hyground-member-reviewer`.
...
```bash
skpm validate cncf-hyground-member-reviewer
skpm package cncf-hyground-member-reviewer
skpm publish cncf-hyground-member-reviewer
```
