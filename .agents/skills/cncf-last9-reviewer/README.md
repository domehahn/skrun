...
7. Run `skcr validate` and `skcr asps coverage cncf-last9-reviewer`.
8. Run `skcr compile cncf-last9-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-last9-reviewer`.
...
```bash
skpm validate cncf-last9-reviewer
skpm package cncf-last9-reviewer
skpm publish cncf-last9-reviewer
```
