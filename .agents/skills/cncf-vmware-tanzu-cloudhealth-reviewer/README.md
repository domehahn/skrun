...
7. Run `skcr validate` and `skcr asps coverage cncf-vmware-tanzu-cloudhealth-reviewer`.
8. Run `skcr compile cncf-vmware-tanzu-cloudhealth-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-vmware-tanzu-cloudhealth-reviewer`.
...
```bash
skpm validate cncf-vmware-tanzu-cloudhealth-reviewer
skpm package cncf-vmware-tanzu-cloudhealth-reviewer
skpm publish cncf-vmware-tanzu-cloudhealth-reviewer
```
