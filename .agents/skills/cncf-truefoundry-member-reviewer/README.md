...
7. Run `skcr validate` and `skcr asps coverage cncf-truefoundry-member-reviewer`.
8. Run `skcr compile cncf-truefoundry-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-truefoundry-member-reviewer`.
...
```bash
skpm validate cncf-truefoundry-member-reviewer
skpm package cncf-truefoundry-member-reviewer
skpm publish cncf-truefoundry-member-reviewer
```
