...
7. Run `skcr validate` and `skcr asps coverage cncf-ferymon-cloud-reviewer`.
8. Run `skcr compile cncf-ferymon-cloud-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ferymon-cloud-reviewer`.
...
```bash
skpm validate cncf-ferymon-cloud-reviewer
skpm package cncf-ferymon-cloud-reviewer
skpm publish cncf-ferymon-cloud-reviewer
```
