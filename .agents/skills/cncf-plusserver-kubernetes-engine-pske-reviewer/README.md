...
7. Run `skcr validate` and `skcr asps coverage cncf-plusserver-kubernetes-engine-pske-reviewer`.
8. Run `skcr compile cncf-plusserver-kubernetes-engine-pske-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-plusserver-kubernetes-engine-pske-reviewer`.
...
```bash
skpm validate cncf-plusserver-kubernetes-engine-pske-reviewer
skpm package cncf-plusserver-kubernetes-engine-pske-reviewer
skpm publish cncf-plusserver-kubernetes-engine-pske-reviewer
```
