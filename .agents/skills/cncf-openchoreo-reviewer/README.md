...
7. Run `skcr validate` and `skcr asps coverage cncf-openchoreo-reviewer`.
8. Run `skcr compile cncf-openchoreo-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-openchoreo-reviewer`.
...
```bash
skpm validate cncf-openchoreo-reviewer
skpm package cncf-openchoreo-reviewer
skpm publish cncf-openchoreo-reviewer
```
