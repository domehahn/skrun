...
7. Run `skcr validate` and `skcr asps coverage cncf-kubereport-reviewer`.
8. Run `skcr compile cncf-kubereport-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kubereport-reviewer`.
...
```bash
skpm validate cncf-kubereport-reviewer
skpm package cncf-kubereport-reviewer
skpm publish cncf-kubereport-reviewer
```
