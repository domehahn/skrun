...
7. Run `skcr validate` and `skcr asps coverage cncf-bc-cloud-member-reviewer`.
8. Run `skcr compile cncf-bc-cloud-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-bc-cloud-member-reviewer`.
...
```bash
skpm validate cncf-bc-cloud-member-reviewer
skpm package cncf-bc-cloud-member-reviewer
skpm publish cncf-bc-cloud-member-reviewer
```
