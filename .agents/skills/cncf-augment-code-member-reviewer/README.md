...
7. Run `skcr validate` and `skcr asps coverage cncf-augment-code-member-reviewer`.
8. Run `skcr compile cncf-augment-code-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-augment-code-member-reviewer`.
...
```bash
skpm validate cncf-augment-code-member-reviewer
skpm package cncf-augment-code-member-reviewer
skpm publish cncf-augment-code-member-reviewer
```
