...
7. Run `skcr validate` and `skcr asps coverage cncf-squash-reviewer`.
8. Run `skcr compile cncf-squash-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-squash-reviewer`.
...
```bash
skpm validate cncf-squash-reviewer
skpm package cncf-squash-reviewer
skpm publish cncf-squash-reviewer
```
