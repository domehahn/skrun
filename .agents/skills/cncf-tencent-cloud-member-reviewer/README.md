...
7. Run `skcr validate` and `skcr asps coverage cncf-tencent-cloud-member-reviewer`.
8. Run `skcr compile cncf-tencent-cloud-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-tencent-cloud-member-reviewer`.
...
```bash
skpm validate cncf-tencent-cloud-member-reviewer
skpm package cncf-tencent-cloud-member-reviewer
skpm publish cncf-tencent-cloud-member-reviewer
```
