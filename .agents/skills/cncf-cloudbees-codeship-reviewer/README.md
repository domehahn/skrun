...
7. Run `skcr validate` and `skcr asps coverage cncf-cloudbees-codeship-reviewer`.
8. Run `skcr compile cncf-cloudbees-codeship-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloudbees-codeship-reviewer`.
...
```bash
skpm validate cncf-cloudbees-codeship-reviewer
skpm package cncf-cloudbees-codeship-reviewer
skpm publish cncf-cloudbees-codeship-reviewer
```
