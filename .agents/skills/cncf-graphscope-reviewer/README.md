...
7. Run `skcr validate` and `skcr asps coverage cncf-graphscope-reviewer`.
8. Run `skcr compile cncf-graphscope-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-graphscope-reviewer`.
...
```bash
skpm validate cncf-graphscope-reviewer
skpm package cncf-graphscope-reviewer
skpm publish cncf-graphscope-reviewer
```
