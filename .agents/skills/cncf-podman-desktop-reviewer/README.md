...
7. Run `skcr validate` and `skcr asps coverage cncf-podman-desktop-reviewer`.
8. Run `skcr compile cncf-podman-desktop-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-podman-desktop-reviewer`.
...
```bash
skpm validate cncf-podman-desktop-reviewer
skpm package cncf-podman-desktop-reviewer
skpm publish cncf-podman-desktop-reviewer
```
