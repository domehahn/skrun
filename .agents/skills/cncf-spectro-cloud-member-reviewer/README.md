...
7. Run `skcr validate` and `skcr asps coverage cncf-spectro-cloud-member-reviewer`.
8. Run `skcr compile cncf-spectro-cloud-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-spectro-cloud-member-reviewer`.
...
```bash
skpm validate cncf-spectro-cloud-member-reviewer
skpm package cncf-spectro-cloud-member-reviewer
skpm publish cncf-spectro-cloud-member-reviewer
```
