...
7. Run `skcr validate` and `skcr asps coverage cncf-ahnlab-cloudmate-kcsp-reviewer`.
8. Run `skcr compile cncf-ahnlab-cloudmate-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ahnlab-cloudmate-kcsp-reviewer`.
...
```bash
skpm validate cncf-ahnlab-cloudmate-kcsp-reviewer
skpm package cncf-ahnlab-cloudmate-kcsp-reviewer
skpm publish cncf-ahnlab-cloudmate-kcsp-reviewer
```
