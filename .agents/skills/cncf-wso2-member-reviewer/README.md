...
7. Run `skcr validate` and `skcr asps coverage cncf-wso2-member-reviewer`.
8. Run `skcr compile cncf-wso2-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-wso2-member-reviewer`.
...
```bash
skpm validate cncf-wso2-member-reviewer
skpm package cncf-wso2-member-reviewer
skpm publish cncf-wso2-member-reviewer
```
