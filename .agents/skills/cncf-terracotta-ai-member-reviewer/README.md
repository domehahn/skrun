...
7. Run `skcr validate` and `skcr asps coverage cncf-terracotta-ai-member-reviewer`.
8. Run `skcr compile cncf-terracotta-ai-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-terracotta-ai-member-reviewer`.
...
```bash
skpm validate cncf-terracotta-ai-member-reviewer
skpm package cncf-terracotta-ai-member-reviewer
skpm publish cncf-terracotta-ai-member-reviewer
```
