...
7. Run `skcr validate` and `skcr asps coverage cncf-cyso-member-reviewer`.
8. Run `skcr compile cncf-cyso-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cyso-member-reviewer`.
...
```bash
skpm validate cncf-cyso-member-reviewer
skpm package cncf-cyso-member-reviewer
skpm publish cncf-cyso-member-reviewer
```
