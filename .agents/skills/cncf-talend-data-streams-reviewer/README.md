...
7. Run `skcr validate` and `skcr asps coverage cncf-talend-data-streams-reviewer`.
8. Run `skcr compile cncf-talend-data-streams-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-talend-data-streams-reviewer`.
...
```bash
skpm validate cncf-talend-data-streams-reviewer
skpm package cncf-talend-data-streams-reviewer
skpm publish cncf-talend-data-streams-reviewer
```
