...
7. Run `skcr validate` and `skcr asps coverage cncf-daocloud-enterprise-reviewer`.
8. Run `skcr compile cncf-daocloud-enterprise-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-daocloud-enterprise-reviewer`.
...
```bash
skpm validate cncf-daocloud-enterprise-reviewer
skpm package cncf-daocloud-enterprise-reviewer
skpm publish cncf-daocloud-enterprise-reviewer
```
