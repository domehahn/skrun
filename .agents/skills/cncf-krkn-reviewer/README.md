...
7. Run `skcr validate` and `skcr asps coverage cncf-krkn-reviewer`.
8. Run `skcr compile cncf-krkn-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-krkn-reviewer`.
...
```bash
skpm validate cncf-krkn-reviewer
skpm package cncf-krkn-reviewer
skpm publish cncf-krkn-reviewer
```
