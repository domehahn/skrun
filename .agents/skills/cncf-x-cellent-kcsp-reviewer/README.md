...
7. Run `skcr validate` and `skcr asps coverage cncf-x-cellent-kcsp-reviewer`.
8. Run `skcr compile cncf-x-cellent-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-x-cellent-kcsp-reviewer`.
...
```bash
skpm validate cncf-x-cellent-kcsp-reviewer
skpm package cncf-x-cellent-kcsp-reviewer
skpm publish cncf-x-cellent-kcsp-reviewer
```
