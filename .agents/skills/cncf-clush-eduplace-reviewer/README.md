...
7. Run `skcr validate` and `skcr asps coverage cncf-clush-eduplace-reviewer`.
8. Run `skcr compile cncf-clush-eduplace-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-clush-eduplace-reviewer`.
...
```bash
skpm validate cncf-clush-eduplace-reviewer
skpm package cncf-clush-eduplace-reviewer
skpm publish cncf-clush-eduplace-reviewer
```
