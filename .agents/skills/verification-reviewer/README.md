...
7. Run `skcr validate` and `skcr asps coverage verification-reviewer`.
8. Run `skcr compile verification-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend verification-reviewer`.
