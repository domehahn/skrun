...
7. Run `skcr validate` and `skcr asps coverage cncf-google-container-registry-reviewer`.
8. Run `skcr compile cncf-google-container-registry-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-google-container-registry-reviewer`.
...
```bash
skpm validate cncf-google-container-registry-reviewer
skpm package cncf-google-container-registry-reviewer
skpm publish cncf-google-container-registry-reviewer
```
