...
7. Run `skcr validate` and `skcr asps coverage cncf-okestro-member-reviewer`.
8. Run `skcr compile cncf-okestro-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-okestro-member-reviewer`.
...
```bash
skpm validate cncf-okestro-member-reviewer
skpm package cncf-okestro-member-reviewer
skpm publish cncf-okestro-member-reviewer
```
