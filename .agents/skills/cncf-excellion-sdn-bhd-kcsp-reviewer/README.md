...
7. Run `skcr validate` and `skcr asps coverage cncf-excellion-sdn-bhd-kcsp-reviewer`.
8. Run `skcr compile cncf-excellion-sdn-bhd-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-excellion-sdn-bhd-kcsp-reviewer`.
...
```bash
skpm validate cncf-excellion-sdn-bhd-kcsp-reviewer
skpm package cncf-excellion-sdn-bhd-kcsp-reviewer
skpm publish cncf-excellion-sdn-bhd-kcsp-reviewer
```
