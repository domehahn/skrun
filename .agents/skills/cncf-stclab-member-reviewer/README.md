...
7. Run `skcr validate` and `skcr asps coverage cncf-stclab-member-reviewer`.
8. Run `skcr compile cncf-stclab-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-stclab-member-reviewer`.
...
```bash
skpm validate cncf-stclab-member-reviewer
skpm package cncf-stclab-member-reviewer
skpm publish cncf-stclab-member-reviewer
```
