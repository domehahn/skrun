...
7. Run `skcr validate` and `skcr asps coverage cncf-teuto-net-kcsp-reviewer`.
8. Run `skcr compile cncf-teuto-net-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-teuto-net-kcsp-reviewer`.
...
```bash
skpm validate cncf-teuto-net-kcsp-reviewer
skpm package cncf-teuto-net-kcsp-reviewer
skpm publish cncf-teuto-net-kcsp-reviewer
```
