...
7. Run `skcr validate` and `skcr asps coverage cncf-cloudzero-reviewer`.
8. Run `skcr compile cncf-cloudzero-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloudzero-reviewer`.
...
```bash
skpm validate cncf-cloudzero-reviewer
skpm package cncf-cloudzero-reviewer
skpm publish cncf-cloudzero-reviewer
```
