...
7. Run `skcr validate` and `skcr asps coverage cncf-dynatrace-member-reviewer`.
8. Run `skcr compile cncf-dynatrace-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-dynatrace-member-reviewer`.
...
```bash
skpm validate cncf-dynatrace-member-reviewer
skpm package cncf-dynatrace-member-reviewer
skpm publish cncf-dynatrace-member-reviewer
```
