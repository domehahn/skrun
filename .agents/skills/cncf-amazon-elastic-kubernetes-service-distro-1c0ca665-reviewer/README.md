...
7. Run `skcr validate` and `skcr asps coverage cncf-amazon-elastic-kubernetes-service-distro-1c0ca665-reviewer`.
8. Run `skcr compile cncf-amazon-elastic-kubernetes-service-distro-1c0ca665-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-amazon-elastic-kubernetes-service-distro-1c0ca665-reviewer`.
...
```bash
skpm validate cncf-amazon-elastic-kubernetes-service-distro-1c0ca665-reviewer
skpm package cncf-amazon-elastic-kubernetes-service-distro-1c0ca665-reviewer
skpm publish cncf-amazon-elastic-kubernetes-service-distro-1c0ca665-reviewer
```
