...
7. Run `skcr validate` and `skcr asps coverage cncf-shipwright-reviewer`.
8. Run `skcr compile cncf-shipwright-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-shipwright-reviewer`.
...
```bash
skpm validate cncf-shipwright-reviewer
skpm package cncf-shipwright-reviewer
skpm publish cncf-shipwright-reviewer
```
