...
7. Run `skcr validate` and `skcr asps coverage cncf-zoi-kcsp-reviewer`.
8. Run `skcr compile cncf-zoi-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-zoi-kcsp-reviewer`.
...
```bash
skpm validate cncf-zoi-kcsp-reviewer
skpm package cncf-zoi-kcsp-reviewer
skpm publish cncf-zoi-kcsp-reviewer
```
