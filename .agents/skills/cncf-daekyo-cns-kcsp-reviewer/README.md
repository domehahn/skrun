...
7. Run `skcr validate` and `skcr asps coverage cncf-daekyo-cns-kcsp-reviewer`.
8. Run `skcr compile cncf-daekyo-cns-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-daekyo-cns-kcsp-reviewer`.
...
```bash
skpm validate cncf-daekyo-cns-kcsp-reviewer
skpm package cncf-daekyo-cns-kcsp-reviewer
skpm publish cncf-daekyo-cns-kcsp-reviewer
```
