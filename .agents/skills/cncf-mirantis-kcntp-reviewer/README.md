...
7. Run `skcr validate` and `skcr asps coverage cncf-mirantis-kcntp-reviewer`.
8. Run `skcr compile cncf-mirantis-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-mirantis-kcntp-reviewer`.
...
```bash
skpm validate cncf-mirantis-kcntp-reviewer
skpm package cncf-mirantis-kcntp-reviewer
skpm publish cncf-mirantis-kcntp-reviewer
```
