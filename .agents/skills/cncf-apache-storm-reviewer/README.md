...
7. Run `skcr validate` and `skcr asps coverage cncf-apache-storm-reviewer`.
8. Run `skcr compile cncf-apache-storm-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-apache-storm-reviewer`.
...
```bash
skpm validate cncf-apache-storm-reviewer
skpm package cncf-apache-storm-reviewer
skpm publish cncf-apache-storm-reviewer
```
