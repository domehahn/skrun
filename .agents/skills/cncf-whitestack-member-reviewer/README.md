...
7. Run `skcr validate` and `skcr asps coverage cncf-whitestack-member-reviewer`.
8. Run `skcr compile cncf-whitestack-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-whitestack-member-reviewer`.
...
```bash
skpm validate cncf-whitestack-member-reviewer
skpm package cncf-whitestack-member-reviewer
skpm publish cncf-whitestack-member-reviewer
```
