...
7. Run `skcr validate` and `skcr asps coverage cncf-myota-member-reviewer`.
8. Run `skcr compile cncf-myota-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-myota-member-reviewer`.
...
```bash
skpm validate cncf-myota-member-reviewer
skpm package cncf-myota-member-reviewer
skpm publish cncf-myota-member-reviewer
```
