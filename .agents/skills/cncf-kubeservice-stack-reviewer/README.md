...
7. Run `skcr validate` and `skcr asps coverage cncf-kubeservice-stack-reviewer`.
8. Run `skcr compile cncf-kubeservice-stack-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kubeservice-stack-reviewer`.
...
```bash
skpm validate cncf-kubeservice-stack-reviewer
skpm package cncf-kubeservice-stack-reviewer
skpm publish cncf-kubeservice-stack-reviewer
```
