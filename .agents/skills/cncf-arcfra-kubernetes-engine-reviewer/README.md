...
7. Run `skcr validate` and `skcr asps coverage cncf-arcfra-kubernetes-engine-reviewer`.
8. Run `skcr compile cncf-arcfra-kubernetes-engine-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-arcfra-kubernetes-engine-reviewer`.
...
```bash
skpm validate cncf-arcfra-kubernetes-engine-reviewer
skpm package cncf-arcfra-kubernetes-engine-reviewer
skpm publish cncf-arcfra-kubernetes-engine-reviewer
```
