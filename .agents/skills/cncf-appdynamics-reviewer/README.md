...
7. Run `skcr validate` and `skcr asps coverage cncf-appdynamics-reviewer`.
8. Run `skcr compile cncf-appdynamics-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-appdynamics-reviewer`.
...
```bash
skpm validate cncf-appdynamics-reviewer
skpm package cncf-appdynamics-reviewer
skpm publish cncf-appdynamics-reviewer
```
