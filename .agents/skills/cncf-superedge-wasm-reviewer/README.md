...
7. Run `skcr validate` and `skcr asps coverage cncf-superedge-wasm-reviewer`.
8. Run `skcr compile cncf-superedge-wasm-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-superedge-wasm-reviewer`.
...
```bash
skpm validate cncf-superedge-wasm-reviewer
skpm package cncf-superedge-wasm-reviewer
skpm publish cncf-superedge-wasm-reviewer
```
