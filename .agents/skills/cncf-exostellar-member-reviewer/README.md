...
7. Run `skcr validate` and `skcr asps coverage cncf-exostellar-member-reviewer`.
8. Run `skcr compile cncf-exostellar-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-exostellar-member-reviewer`.
...
```bash
skpm validate cncf-exostellar-member-reviewer
skpm package cncf-exostellar-member-reviewer
skpm publish cncf-exostellar-member-reviewer
```
