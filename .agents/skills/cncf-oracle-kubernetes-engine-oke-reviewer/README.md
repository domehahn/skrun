...
7. Run `skcr validate` and `skcr asps coverage cncf-oracle-kubernetes-engine-oke-reviewer`.
8. Run `skcr compile cncf-oracle-kubernetes-engine-oke-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-oracle-kubernetes-engine-oke-reviewer`.
...
```bash
skpm validate cncf-oracle-kubernetes-engine-oke-reviewer
skpm package cncf-oracle-kubernetes-engine-oke-reviewer
skpm publish cncf-oracle-kubernetes-engine-oke-reviewer
```
