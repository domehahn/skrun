...
7. Run `skcr validate` and `skcr asps coverage cncf-puffersoft-member-reviewer`.
8. Run `skcr compile cncf-puffersoft-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-puffersoft-member-reviewer`.
...
```bash
skpm validate cncf-puffersoft-member-reviewer
skpm package cncf-puffersoft-member-reviewer
skpm publish cncf-puffersoft-member-reviewer
```
