...
7. Run `skcr validate` and `skcr asps coverage cncf-blizzard-supporter-reviewer`.
8. Run `skcr compile cncf-blizzard-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-blizzard-supporter-reviewer`.
...
```bash
skpm validate cncf-blizzard-supporter-reviewer
skpm package cncf-blizzard-supporter-reviewer
skpm publish cncf-blizzard-supporter-reviewer
```
