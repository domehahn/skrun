...
7. Run `skcr validate` and `skcr asps coverage cncf-keptn-reviewer`.
8. Run `skcr compile cncf-keptn-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-keptn-reviewer`.
...
```bash
skpm validate cncf-keptn-reviewer
skpm package cncf-keptn-reviewer
skpm publish cncf-keptn-reviewer
```
