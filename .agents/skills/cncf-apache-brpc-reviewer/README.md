...
7. Run `skcr validate` and `skcr asps coverage cncf-apache-brpc-reviewer`.
8. Run `skcr compile cncf-apache-brpc-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-apache-brpc-reviewer`.
...
```bash
skpm validate cncf-apache-brpc-reviewer
skpm package cncf-apache-brpc-reviewer
skpm publish cncf-apache-brpc-reviewer
```
