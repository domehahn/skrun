...
7. Run `skcr validate` and `skcr asps coverage cncf-puzzle-itc-ag-kcsp-reviewer`.
8. Run `skcr compile cncf-puzzle-itc-ag-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-puzzle-itc-ag-kcsp-reviewer`.
...
```bash
skpm validate cncf-puzzle-itc-ag-kcsp-reviewer
skpm package cncf-puzzle-itc-ag-kcsp-reviewer
skpm publish cncf-puzzle-itc-ag-kcsp-reviewer
```
