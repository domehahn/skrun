...
7. Run `skcr validate` and `skcr asps coverage cncf-qualitysoft-member-reviewer`.
8. Run `skcr compile cncf-qualitysoft-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-qualitysoft-member-reviewer`.
...
```bash
skpm validate cncf-qualitysoft-member-reviewer
skpm package cncf-qualitysoft-member-reviewer
skpm publish cncf-qualitysoft-member-reviewer
```
