...
7. Run `skcr validate` and `skcr asps coverage cncf-wasm-workers-server-reviewer`.
8. Run `skcr compile cncf-wasm-workers-server-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-wasm-workers-server-reviewer`.
...
```bash
skpm validate cncf-wasm-workers-server-reviewer
skpm package cncf-wasm-workers-server-reviewer
skpm publish cncf-wasm-workers-server-reviewer
```
