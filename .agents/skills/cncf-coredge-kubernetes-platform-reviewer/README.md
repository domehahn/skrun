...
7. Run `skcr validate` and `skcr asps coverage cncf-coredge-kubernetes-platform-reviewer`.
8. Run `skcr compile cncf-coredge-kubernetes-platform-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-coredge-kubernetes-platform-reviewer`.
...
```bash
skpm validate cncf-coredge-kubernetes-platform-reviewer
skpm package cncf-coredge-kubernetes-platform-reviewer
skpm publish cncf-coredge-kubernetes-platform-reviewer
```
