...
7. Run `skcr validate` and `skcr asps coverage cncf-jina-reader-reviewer`.
8. Run `skcr compile cncf-jina-reader-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-jina-reader-reviewer`.
...
```bash
skpm validate cncf-jina-reader-reviewer
skpm package cncf-jina-reader-reviewer
skpm publish cncf-jina-reader-reviewer
```
