...
7. Run `skcr validate` and `skcr asps coverage cncf-liquid-reply-kcntp-reviewer`.
8. Run `skcr compile cncf-liquid-reply-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-liquid-reply-kcntp-reviewer`.
...
```bash
skpm validate cncf-liquid-reply-kcntp-reviewer
skpm package cncf-liquid-reply-kcntp-reviewer
skpm publish cncf-liquid-reply-kcntp-reviewer
```
