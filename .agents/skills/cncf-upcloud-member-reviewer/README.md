...
7. Run `skcr validate` and `skcr asps coverage cncf-upcloud-member-reviewer`.
8. Run `skcr compile cncf-upcloud-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-upcloud-member-reviewer`.
...
```bash
skpm validate cncf-upcloud-member-reviewer
skpm package cncf-upcloud-member-reviewer
skpm publish cncf-upcloud-member-reviewer
```
