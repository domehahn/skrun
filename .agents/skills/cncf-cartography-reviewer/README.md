...
7. Run `skcr validate` and `skcr asps coverage cncf-cartography-reviewer`.
8. Run `skcr compile cncf-cartography-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cartography-reviewer`.
...
```bash
skpm validate cncf-cartography-reviewer
skpm package cncf-cartography-reviewer
skpm publish cncf-cartography-reviewer
```
