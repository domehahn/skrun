...
7. Run `skcr validate` and `skcr asps coverage cncf-guance-cloud-reviewer`.
8. Run `skcr compile cncf-guance-cloud-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-guance-cloud-reviewer`.
...
```bash
skpm validate cncf-guance-cloud-reviewer
skpm package cncf-guance-cloud-reviewer
skpm publish cncf-guance-cloud-reviewer
```
