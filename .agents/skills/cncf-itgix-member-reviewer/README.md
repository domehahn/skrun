...
7. Run `skcr validate` and `skcr asps coverage cncf-itgix-member-reviewer`.
8. Run `skcr compile cncf-itgix-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-itgix-member-reviewer`.
...
```bash
skpm validate cncf-itgix-member-reviewer
skpm package cncf-itgix-member-reviewer
skpm publish cncf-itgix-member-reviewer
```
