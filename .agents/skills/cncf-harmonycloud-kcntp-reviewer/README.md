...
7. Run `skcr validate` and `skcr asps coverage cncf-harmonycloud-kcntp-reviewer`.
8. Run `skcr compile cncf-harmonycloud-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-harmonycloud-kcntp-reviewer`.
...
```bash
skpm validate cncf-harmonycloud-kcntp-reviewer
skpm package cncf-harmonycloud-kcntp-reviewer
skpm publish cncf-harmonycloud-kcntp-reviewer
```
