...
7. Run `skcr validate` and `skcr asps coverage cncf-nimbella-reviewer`.
8. Run `skcr compile cncf-nimbella-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nimbella-reviewer`.
...
```bash
skpm validate cncf-nimbella-reviewer
skpm package cncf-nimbella-reviewer
skpm publish cncf-nimbella-reviewer
```
