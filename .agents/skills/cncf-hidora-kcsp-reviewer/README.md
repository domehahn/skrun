...
7. Run `skcr validate` and `skcr asps coverage cncf-hidora-kcsp-reviewer`.
8. Run `skcr compile cncf-hidora-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-hidora-kcsp-reviewer`.
...
```bash
skpm validate cncf-hidora-kcsp-reviewer
skpm package cncf-hidora-kcsp-reviewer
skpm publish cncf-hidora-kcsp-reviewer
```
