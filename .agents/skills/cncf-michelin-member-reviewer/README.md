...
7. Run `skcr validate` and `skcr asps coverage cncf-michelin-member-reviewer`.
8. Run `skcr compile cncf-michelin-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-michelin-member-reviewer`.
...
```bash
skpm validate cncf-michelin-member-reviewer
skpm package cncf-michelin-member-reviewer
skpm publish cncf-michelin-member-reviewer
```
