...
7. Run `skcr validate` and `skcr asps coverage cncf-lenovo-kcsp-reviewer`.
8. Run `skcr compile cncf-lenovo-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-lenovo-kcsp-reviewer`.
...
```bash
skpm validate cncf-lenovo-kcsp-reviewer
skpm package cncf-lenovo-kcsp-reviewer
skpm publish cncf-lenovo-kcsp-reviewer
```
