...
7. Run `skcr validate` and `skcr asps coverage cncf-8gears-member-reviewer`.
8. Run `skcr compile cncf-8gears-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-8gears-member-reviewer`.
...
```bash
skpm validate cncf-8gears-member-reviewer
skpm package cncf-8gears-member-reviewer
skpm publish cncf-8gears-member-reviewer
```
