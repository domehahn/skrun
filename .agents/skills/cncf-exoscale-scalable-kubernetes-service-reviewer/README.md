...
7. Run `skcr validate` and `skcr asps coverage cncf-exoscale-scalable-kubernetes-service-reviewer`.
8. Run `skcr compile cncf-exoscale-scalable-kubernetes-service-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-exoscale-scalable-kubernetes-service-reviewer`.
...
```bash
skpm validate cncf-exoscale-scalable-kubernetes-service-reviewer
skpm package cncf-exoscale-scalable-kubernetes-service-reviewer
skpm publish cncf-exoscale-scalable-kubernetes-service-reviewer
```
