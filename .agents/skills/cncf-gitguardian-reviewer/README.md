...
7. Run `skcr validate` and `skcr asps coverage cncf-gitguardian-reviewer`.
8. Run `skcr compile cncf-gitguardian-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-gitguardian-reviewer`.
...
```bash
skpm validate cncf-gitguardian-reviewer
skpm package cncf-gitguardian-reviewer
skpm publish cncf-gitguardian-reviewer
```
