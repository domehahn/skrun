...
7. Run `skcr validate` and `skcr asps coverage cncf-ejbca-community-reviewer`.
8. Run `skcr compile cncf-ejbca-community-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ejbca-community-reviewer`.
...
```bash
skpm validate cncf-ejbca-community-reviewer
skpm package cncf-ejbca-community-reviewer
skpm publish cncf-ejbca-community-reviewer
```
