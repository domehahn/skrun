...
7. Run `skcr validate` and `skcr asps coverage cncf-virtasant-reviewer`.
8. Run `skcr compile cncf-virtasant-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-virtasant-reviewer`.
...
```bash
skpm validate cncf-virtasant-reviewer
skpm package cncf-virtasant-reviewer
skpm publish cncf-virtasant-reviewer
```
