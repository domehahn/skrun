...
7. Run `skcr validate` and `skcr asps coverage cncf-c-plus-plus-reviewer`.
8. Run `skcr compile cncf-c-plus-plus-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-c-plus-plus-reviewer`.
...
```bash
skpm validate cncf-c-plus-plus-reviewer
skpm package cncf-c-plus-plus-reviewer
skpm publish cncf-c-plus-plus-reviewer
```
