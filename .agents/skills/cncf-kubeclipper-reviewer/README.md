...
7. Run `skcr validate` and `skcr asps coverage cncf-kubeclipper-reviewer`.
8. Run `skcr compile cncf-kubeclipper-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kubeclipper-reviewer`.
...
```bash
skpm validate cncf-kubeclipper-reviewer
skpm package cncf-kubeclipper-reviewer
skpm publish cncf-kubeclipper-reviewer
```
