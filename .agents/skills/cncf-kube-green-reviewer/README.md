...
7. Run `skcr validate` and `skcr asps coverage cncf-kube-green-reviewer`.
8. Run `skcr compile cncf-kube-green-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kube-green-reviewer`.
...
```bash
skpm validate cncf-kube-green-reviewer
skpm package cncf-kube-green-reviewer
skpm publish cncf-kube-green-reviewer
```
