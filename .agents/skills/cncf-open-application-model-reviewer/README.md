...
7. Run `skcr validate` and `skcr asps coverage cncf-open-application-model-reviewer`.
8. Run `skcr compile cncf-open-application-model-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-open-application-model-reviewer`.
...
```bash
skpm validate cncf-open-application-model-reviewer
skpm package cncf-open-application-model-reviewer
skpm publish cncf-open-application-model-reviewer
```
