...
7. Run `skcr validate` and `skcr asps coverage cncf-deepchecks-reviewer`.
8. Run `skcr compile cncf-deepchecks-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-deepchecks-reviewer`.
...
```bash
skpm validate cncf-deepchecks-reviewer
skpm package cncf-deepchecks-reviewer
skpm publish cncf-deepchecks-reviewer
```
