...
7. Run `skcr validate` and `skcr asps coverage cncf-awesome-information-technology-member-reviewer`.
8. Run `skcr compile cncf-awesome-information-technology-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-awesome-information-technology-member-reviewer`.
...
```bash
skpm validate cncf-awesome-information-technology-member-reviewer
skpm package cncf-awesome-information-technology-member-reviewer
skpm publish cncf-awesome-information-technology-member-reviewer
```
