...
7. Run `skcr validate` and `skcr asps coverage cncf-southworks-member-reviewer`.
8. Run `skcr compile cncf-southworks-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-southworks-member-reviewer`.
...
```bash
skpm validate cncf-southworks-member-reviewer
skpm package cncf-southworks-member-reviewer
skpm publish cncf-southworks-member-reviewer
```
