...
7. Run `skcr validate` and `skcr asps coverage cncf-cloudcasa-by-catalogic-software-reviewer`.
8. Run `skcr compile cncf-cloudcasa-by-catalogic-software-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloudcasa-by-catalogic-software-reviewer`.
...
```bash
skpm validate cncf-cloudcasa-by-catalogic-software-reviewer
skpm package cncf-cloudcasa-by-catalogic-software-reviewer
skpm publish cncf-cloudcasa-by-catalogic-software-reviewer
```
