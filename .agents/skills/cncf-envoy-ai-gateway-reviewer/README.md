...
7. Run `skcr validate` and `skcr asps coverage cncf-envoy-ai-gateway-reviewer`.
8. Run `skcr compile cncf-envoy-ai-gateway-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-envoy-ai-gateway-reviewer`.
...
```bash
skpm validate cncf-envoy-ai-gateway-reviewer
skpm package cncf-envoy-ai-gateway-reviewer
skpm publish cncf-envoy-ai-gateway-reviewer
```
