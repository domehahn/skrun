...
7. Run `skcr validate` and `skcr asps coverage cncf-akana-reviewer`.
8. Run `skcr compile cncf-akana-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-akana-reviewer`.
...
```bash
skpm validate cncf-akana-reviewer
skpm package cncf-akana-reviewer
skpm publish cncf-akana-reviewer
```
