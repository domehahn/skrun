...
7. Run `skcr validate` and `skcr asps coverage cncf-previder-member-reviewer`.
8. Run `skcr compile cncf-previder-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-previder-member-reviewer`.
...
```bash
skpm validate cncf-previder-member-reviewer
skpm package cncf-previder-member-reviewer
skpm publish cncf-previder-member-reviewer
```
