...
7. Run `skcr validate` and `skcr asps coverage cncf-fairwinds-kcsp-reviewer`.
8. Run `skcr compile cncf-fairwinds-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-fairwinds-kcsp-reviewer`.
...
```bash
skpm validate cncf-fairwinds-kcsp-reviewer
skpm package cncf-fairwinds-kcsp-reviewer
skpm publish cncf-fairwinds-kcsp-reviewer
```
