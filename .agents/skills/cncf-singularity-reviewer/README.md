...
7. Run `skcr validate` and `skcr asps coverage cncf-singularity-reviewer`.
8. Run `skcr compile cncf-singularity-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-singularity-reviewer`.
...
```bash
skpm validate cncf-singularity-reviewer
skpm package cncf-singularity-reviewer
skpm publish cncf-singularity-reviewer
```
