...
7. Run `skcr validate` and `skcr asps coverage cncf-doctor-droid-member-reviewer`.
8. Run `skcr compile cncf-doctor-droid-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-doctor-droid-member-reviewer`.
...
```bash
skpm validate cncf-doctor-droid-member-reviewer
skpm package cncf-doctor-droid-member-reviewer
skpm publish cncf-doctor-droid-member-reviewer
```
