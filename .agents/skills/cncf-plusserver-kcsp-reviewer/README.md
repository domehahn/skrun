...
7. Run `skcr validate` and `skcr asps coverage cncf-plusserver-kcsp-reviewer`.
8. Run `skcr compile cncf-plusserver-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-plusserver-kcsp-reviewer`.
...
```bash
skpm validate cncf-plusserver-kcsp-reviewer
skpm package cncf-plusserver-kcsp-reviewer
skpm publish cncf-plusserver-kcsp-reviewer
```
