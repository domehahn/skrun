...
7. Run `skcr validate` and `skcr asps coverage cncf-directv-supporter-reviewer`.
8. Run `skcr compile cncf-directv-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-directv-supporter-reviewer`.
...
```bash
skpm validate cncf-directv-supporter-reviewer
skpm package cncf-directv-supporter-reviewer
skpm publish cncf-directv-supporter-reviewer
```
