...
7. Run `skcr validate` and `skcr asps coverage cncf-hostersi-member-reviewer`.
8. Run `skcr compile cncf-hostersi-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-hostersi-member-reviewer`.
...
```bash
skpm validate cncf-hostersi-member-reviewer
skpm package cncf-hostersi-member-reviewer
skpm publish cncf-hostersi-member-reviewer
```
