...
7. Run `skcr validate` and `skcr asps coverage cncf-trend-micro-cloud-one-reviewer`.
8. Run `skcr compile cncf-trend-micro-cloud-one-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-trend-micro-cloud-one-reviewer`.
...
```bash
skpm validate cncf-trend-micro-cloud-one-reviewer
skpm package cncf-trend-micro-cloud-one-reviewer
skpm publish cncf-trend-micro-cloud-one-reviewer
```
