...
7. Run `skcr validate` and `skcr asps coverage cncf-siddhi-reviewer`.
8. Run `skcr compile cncf-siddhi-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-siddhi-reviewer`.
...
```bash
skpm validate cncf-siddhi-reviewer
skpm package cncf-siddhi-reviewer
skpm publish cncf-siddhi-reviewer
```
