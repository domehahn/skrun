...
7. Run `skcr validate` and `skcr asps coverage cncf-puffersoft-kcsp-reviewer`.
8. Run `skcr compile cncf-puffersoft-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-puffersoft-kcsp-reviewer`.
...
```bash
skpm validate cncf-puffersoft-kcsp-reviewer
skpm package cncf-puffersoft-kcsp-reviewer
skpm publish cncf-puffersoft-kcsp-reviewer
```
