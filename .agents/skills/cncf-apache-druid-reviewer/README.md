...
7. Run `skcr validate` and `skcr asps coverage cncf-apache-druid-reviewer`.
8. Run `skcr compile cncf-apache-druid-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-apache-druid-reviewer`.
...
```bash
skpm validate cncf-apache-druid-reviewer
skpm package cncf-apache-druid-reviewer
skpm publish cncf-apache-druid-reviewer
```
