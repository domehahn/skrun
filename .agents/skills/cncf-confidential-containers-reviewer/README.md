...
7. Run `skcr validate` and `skcr asps coverage cncf-confidential-containers-reviewer`.
8. Run `skcr compile cncf-confidential-containers-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-confidential-containers-reviewer`.
...
```bash
skpm validate cncf-confidential-containers-reviewer
skpm package cncf-confidential-containers-reviewer
skpm publish cncf-confidential-containers-reviewer
```
