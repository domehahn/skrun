...
7. Run `skcr validate` and `skcr asps coverage cncf-agent-field-member-reviewer`.
8. Run `skcr compile cncf-agent-field-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-agent-field-member-reviewer`.
...
```bash
skpm validate cncf-agent-field-member-reviewer
skpm package cncf-agent-field-member-reviewer
skpm publish cncf-agent-field-member-reviewer
```
