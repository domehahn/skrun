...
7. Run `skcr validate` and `skcr asps coverage cncf-cecloud-member-reviewer`.
8. Run `skcr compile cncf-cecloud-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cecloud-member-reviewer`.
...
```bash
skpm validate cncf-cecloud-member-reviewer
skpm package cncf-cecloud-member-reviewer
skpm publish cncf-cecloud-member-reviewer
```
