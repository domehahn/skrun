...
7. Run `skcr validate` and `skcr asps coverage cncf-nebulagraph-reviewer`.
8. Run `skcr compile cncf-nebulagraph-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nebulagraph-reviewer`.
...
```bash
skpm validate cncf-nebulagraph-reviewer
skpm package cncf-nebulagraph-reviewer
skpm publish cncf-nebulagraph-reviewer
```
