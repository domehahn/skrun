...
7. Run `skcr validate` and `skcr asps coverage cncf-planetscale-member-reviewer`.
8. Run `skcr compile cncf-planetscale-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-planetscale-member-reviewer`.
...
```bash
skpm validate cncf-planetscale-member-reviewer
skpm package cncf-planetscale-member-reviewer
skpm publish cncf-planetscale-member-reviewer
```
