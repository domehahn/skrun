...
7. Run `skcr validate` and `skcr asps coverage cncf-source-allies-kcsp-reviewer`.
8. Run `skcr compile cncf-source-allies-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-source-allies-kcsp-reviewer`.
...
```bash
skpm validate cncf-source-allies-kcsp-reviewer
skpm package cncf-source-allies-kcsp-reviewer
skpm publish cncf-source-allies-kcsp-reviewer
```
