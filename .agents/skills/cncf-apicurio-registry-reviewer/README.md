...
7. Run `skcr validate` and `skcr asps coverage cncf-apicurio-registry-reviewer`.
8. Run `skcr compile cncf-apicurio-registry-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-apicurio-registry-reviewer`.
...
```bash
skpm validate cncf-apicurio-registry-reviewer
skpm package cncf-apicurio-registry-reviewer
skpm publish cncf-apicurio-registry-reviewer
```
