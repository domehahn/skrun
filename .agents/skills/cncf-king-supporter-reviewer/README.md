...
7. Run `skcr validate` and `skcr asps coverage cncf-king-supporter-reviewer`.
8. Run `skcr compile cncf-king-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-king-supporter-reviewer`.
...
```bash
skpm validate cncf-king-supporter-reviewer
skpm package cncf-king-supporter-reviewer
skpm publish cncf-king-supporter-reviewer
```
