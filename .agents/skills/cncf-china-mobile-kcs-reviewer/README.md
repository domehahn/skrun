...
7. Run `skcr validate` and `skcr asps coverage cncf-china-mobile-kcs-reviewer`.
8. Run `skcr compile cncf-china-mobile-kcs-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-china-mobile-kcs-reviewer`.
...
```bash
skpm validate cncf-china-mobile-kcs-reviewer
skpm package cncf-china-mobile-kcs-reviewer
skpm publish cncf-china-mobile-kcs-reviewer
```
