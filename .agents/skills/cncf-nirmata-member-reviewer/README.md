...
7. Run `skcr validate` and `skcr asps coverage cncf-nirmata-member-reviewer`.
8. Run `skcr compile cncf-nirmata-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nirmata-member-reviewer`.
...
```bash
skpm validate cncf-nirmata-member-reviewer
skpm package cncf-nirmata-member-reviewer
skpm publish cncf-nirmata-member-reviewer
```
