...
7. Run `skcr validate` and `skcr asps coverage cncf-bloomberg-member-reviewer`.
8. Run `skcr compile cncf-bloomberg-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-bloomberg-member-reviewer`.
...
```bash
skpm validate cncf-bloomberg-member-reviewer
skpm package cncf-bloomberg-member-reviewer
skpm publish cncf-bloomberg-member-reviewer
```
