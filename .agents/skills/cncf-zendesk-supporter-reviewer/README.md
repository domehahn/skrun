...
7. Run `skcr validate` and `skcr asps coverage cncf-zendesk-supporter-reviewer`.
8. Run `skcr compile cncf-zendesk-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-zendesk-supporter-reviewer`.
...
```bash
skpm validate cncf-zendesk-supporter-reviewer
skpm package cncf-zendesk-supporter-reviewer
skpm publish cncf-zendesk-supporter-reviewer
```
