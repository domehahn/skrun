...
7. Run `skcr validate` and `skcr asps coverage cncf-infosys-member-reviewer`.
8. Run `skcr compile cncf-infosys-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-infosys-member-reviewer`.
...
```bash
skpm validate cncf-infosys-member-reviewer
skpm package cncf-infosys-member-reviewer
skpm publish cncf-infosys-member-reviewer
```
