...
7. Run `skcr validate` and `skcr asps coverage cncf-circleci-member-reviewer`.
8. Run `skcr compile cncf-circleci-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-circleci-member-reviewer`.
...
```bash
skpm validate cncf-circleci-member-reviewer
skpm package cncf-circleci-member-reviewer
skpm publish cncf-circleci-member-reviewer
```
