...
7. Run `skcr validate` and `skcr asps coverage cncf-emissary-ingress-reviewer`.
8. Run `skcr compile cncf-emissary-ingress-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-emissary-ingress-reviewer`.
...
```bash
skpm validate cncf-emissary-ingress-reviewer
skpm package cncf-emissary-ingress-reviewer
skpm publish cncf-emissary-ingress-reviewer
```
