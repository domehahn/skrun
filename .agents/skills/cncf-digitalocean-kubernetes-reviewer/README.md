...
7. Run `skcr validate` and `skcr asps coverage cncf-digitalocean-kubernetes-reviewer`.
8. Run `skcr compile cncf-digitalocean-kubernetes-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-digitalocean-kubernetes-reviewer`.
...
```bash
skpm validate cncf-digitalocean-kubernetes-reviewer
skpm package cncf-digitalocean-kubernetes-reviewer
skpm publish cncf-digitalocean-kubernetes-reviewer
```
