...
7. Run `skcr validate` and `skcr asps coverage cncf-perfectscale-by-doit-reviewer`.
8. Run `skcr compile cncf-perfectscale-by-doit-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-perfectscale-by-doit-reviewer`.
...
```bash
skpm validate cncf-perfectscale-by-doit-reviewer
skpm package cncf-perfectscale-by-doit-reviewer
skpm publish cncf-perfectscale-by-doit-reviewer
```
