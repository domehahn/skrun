...
7. Run `skcr validate` and `skcr asps coverage cncf-ozone-reviewer`.
8. Run `skcr compile cncf-ozone-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ozone-reviewer`.
...
```bash
skpm validate cncf-ozone-reviewer
skpm package cncf-ozone-reviewer
skpm publish cncf-ozone-reviewer
```
