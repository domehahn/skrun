...
7. Run `skcr validate` and `skcr asps coverage cncf-china-mobile-cloud-cloud-native-applicat-3728c2b4-reviewer`.
8. Run `skcr compile cncf-china-mobile-cloud-cloud-native-applicat-3728c2b4-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-china-mobile-cloud-cloud-native-applicat-3728c2b4-reviewer`.
...
```bash
skpm validate cncf-china-mobile-cloud-cloud-native-applicat-3728c2b4-reviewer
skpm package cncf-china-mobile-cloud-cloud-native-applicat-3728c2b4-reviewer
skpm publish cncf-china-mobile-cloud-cloud-native-applicat-3728c2b4-reviewer
```
