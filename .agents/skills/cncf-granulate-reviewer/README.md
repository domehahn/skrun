...
7. Run `skcr validate` and `skcr asps coverage cncf-granulate-reviewer`.
8. Run `skcr compile cncf-granulate-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-granulate-reviewer`.
...
```bash
skpm validate cncf-granulate-reviewer
skpm package cncf-granulate-reviewer
skpm publish cncf-granulate-reviewer
```
