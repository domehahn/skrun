...
7. Run `skcr validate` and `skcr asps coverage cncf-bmc-helix-reviewer`.
8. Run `skcr compile cncf-bmc-helix-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-bmc-helix-reviewer`.
...
```bash
skpm validate cncf-bmc-helix-reviewer
skpm package cncf-bmc-helix-reviewer
skpm publish cncf-bmc-helix-reviewer
```
