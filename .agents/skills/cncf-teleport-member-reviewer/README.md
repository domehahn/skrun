...
7. Run `skcr validate` and `skcr asps coverage cncf-teleport-member-reviewer`.
8. Run `skcr compile cncf-teleport-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-teleport-member-reviewer`.
...
```bash
skpm validate cncf-teleport-member-reviewer
skpm package cncf-teleport-member-reviewer
skpm publish cncf-teleport-member-reviewer
```
