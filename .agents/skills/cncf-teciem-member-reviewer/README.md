...
7. Run `skcr validate` and `skcr asps coverage cncf-teciem-member-reviewer`.
8. Run `skcr compile cncf-teciem-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-teciem-member-reviewer`.
...
```bash
skpm validate cncf-teciem-member-reviewer
skpm package cncf-teciem-member-reviewer
skpm publish cncf-teciem-member-reviewer
```
