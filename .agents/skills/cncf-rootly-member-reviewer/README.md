...
7. Run `skcr validate` and `skcr asps coverage cncf-rootly-member-reviewer`.
8. Run `skcr compile cncf-rootly-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-rootly-member-reviewer`.
...
```bash
skpm validate cncf-rootly-member-reviewer
skpm package cncf-rootly-member-reviewer
skpm publish cncf-rootly-member-reviewer
```
