...
7. Run `skcr validate` and `skcr asps coverage cncf-posit-supporter-reviewer`.
8. Run `skcr compile cncf-posit-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-posit-supporter-reviewer`.
...
```bash
skpm validate cncf-posit-supporter-reviewer
skpm package cncf-posit-supporter-reviewer
skpm publish cncf-posit-supporter-reviewer
```
