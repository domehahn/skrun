...
7. Run `skcr validate` and `skcr asps coverage cncf-grafana-pyroscope-reviewer`.
8. Run `skcr compile cncf-grafana-pyroscope-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-grafana-pyroscope-reviewer`.
...
```bash
skpm validate cncf-grafana-pyroscope-reviewer
skpm package cncf-grafana-pyroscope-reviewer
skpm publish cncf-grafana-pyroscope-reviewer
```
