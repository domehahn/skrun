...
7. Run `skcr validate` and `skcr asps coverage cncf-veinmind-tools-reviewer`.
8. Run `skcr compile cncf-veinmind-tools-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-veinmind-tools-reviewer`.
...
```bash
skpm validate cncf-veinmind-tools-reviewer
skpm package cncf-veinmind-tools-reviewer
skpm publish cncf-veinmind-tools-reviewer
```
