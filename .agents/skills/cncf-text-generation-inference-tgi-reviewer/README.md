...
7. Run `skcr validate` and `skcr asps coverage cncf-text-generation-inference-tgi-reviewer`.
8. Run `skcr compile cncf-text-generation-inference-tgi-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-text-generation-inference-tgi-reviewer`.
...
```bash
skpm validate cncf-text-generation-inference-tgi-reviewer
skpm package cncf-text-generation-inference-tgi-reviewer
skpm publish cncf-text-generation-inference-tgi-reviewer
```
