...
7. Run `skcr validate` and `skcr asps coverage cncf-keymate-io-member-reviewer`.
8. Run `skcr compile cncf-keymate-io-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-keymate-io-member-reviewer`.
...
```bash
skpm validate cncf-keymate-io-member-reviewer
skpm package cncf-keymate-io-member-reviewer
skpm publish cncf-keymate-io-member-reviewer
```
