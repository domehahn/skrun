...
7. Run `skcr validate` and `skcr asps coverage cncf-thundra-reviewer`.
8. Run `skcr compile cncf-thundra-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-thundra-reviewer`.
...
```bash
skpm validate cncf-thundra-reviewer
skpm package cncf-thundra-reviewer
skpm publish cncf-thundra-reviewer
```
