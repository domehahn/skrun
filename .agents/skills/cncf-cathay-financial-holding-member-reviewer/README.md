...
7. Run `skcr validate` and `skcr asps coverage cncf-cathay-financial-holding-member-reviewer`.
8. Run `skcr compile cncf-cathay-financial-holding-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cathay-financial-holding-member-reviewer`.
...
```bash
skpm validate cncf-cathay-financial-holding-member-reviewer
skpm package cncf-cathay-financial-holding-member-reviewer
skpm publish cncf-cathay-financial-holding-member-reviewer
```
