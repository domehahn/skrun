...
7. Run `skcr validate` and `skcr asps coverage cncf-synadia-member-reviewer`.
8. Run `skcr compile cncf-synadia-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-synadia-member-reviewer`.
...
```bash
skpm validate cncf-synadia-member-reviewer
skpm package cncf-synadia-member-reviewer
skpm publish cncf-synadia-member-reviewer
```
