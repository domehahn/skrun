...
7. Run `skcr validate` and `skcr asps coverage cncf-kubeflow-pipelines-reviewer`.
8. Run `skcr compile cncf-kubeflow-pipelines-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kubeflow-pipelines-reviewer`.
...
```bash
skpm validate cncf-kubeflow-pipelines-reviewer
skpm package cncf-kubeflow-pipelines-reviewer
skpm publish cncf-kubeflow-pipelines-reviewer
```
