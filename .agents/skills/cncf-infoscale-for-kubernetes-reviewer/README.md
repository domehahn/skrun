...
7. Run `skcr validate` and `skcr asps coverage cncf-infoscale-for-kubernetes-reviewer`.
8. Run `skcr compile cncf-infoscale-for-kubernetes-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-infoscale-for-kubernetes-reviewer`.
...
```bash
skpm validate cncf-infoscale-for-kubernetes-reviewer
skpm package cncf-infoscale-for-kubernetes-reviewer
skpm publish cncf-infoscale-for-kubernetes-reviewer
```
