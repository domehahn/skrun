...
7. Run `skcr validate` and `skcr asps coverage cncf-sparkfabrik-kcsp-reviewer`.
8. Run `skcr compile cncf-sparkfabrik-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sparkfabrik-kcsp-reviewer`.
...
```bash
skpm validate cncf-sparkfabrik-kcsp-reviewer
skpm package cncf-sparkfabrik-kcsp-reviewer
skpm publish cncf-sparkfabrik-kcsp-reviewer
```
