...
7. Run `skcr validate` and `skcr asps coverage cncf-google-cloud-dataflow-reviewer`.
8. Run `skcr compile cncf-google-cloud-dataflow-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-google-cloud-dataflow-reviewer`.
...
```bash
skpm validate cncf-google-cloud-dataflow-reviewer
skpm package cncf-google-cloud-dataflow-reviewer
skpm publish cncf-google-cloud-dataflow-reviewer
```
