...
7. Run `skcr validate` and `skcr asps coverage cncf-openapi-reviewer`.
8. Run `skcr compile cncf-openapi-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-openapi-reviewer`.
...
```bash
skpm validate cncf-openapi-reviewer
skpm package cncf-openapi-reviewer
skpm publish cncf-openapi-reviewer
```
