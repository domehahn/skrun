...
7. Run `skcr validate` and `skcr asps coverage cncf-vmware-application-catalog-reviewer`.
8. Run `skcr compile cncf-vmware-application-catalog-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-vmware-application-catalog-reviewer`.
...
```bash
skpm validate cncf-vmware-application-catalog-reviewer
skpm package cncf-vmware-application-catalog-reviewer
skpm publish cncf-vmware-application-catalog-reviewer
```
