...
7. Run `skcr validate` and `skcr asps coverage cncf-fabric8-kubernetes-client-reviewer`.
8. Run `skcr compile cncf-fabric8-kubernetes-client-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-fabric8-kubernetes-client-reviewer`.
...
```bash
skpm validate cncf-fabric8-kubernetes-client-reviewer
skpm package cncf-fabric8-kubernetes-client-reviewer
skpm publish cncf-fabric8-kubernetes-client-reviewer
```
