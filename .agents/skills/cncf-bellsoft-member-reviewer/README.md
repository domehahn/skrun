...
7. Run `skcr validate` and `skcr asps coverage cncf-bellsoft-member-reviewer`.
8. Run `skcr compile cncf-bellsoft-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-bellsoft-member-reviewer`.
...
```bash
skpm validate cncf-bellsoft-member-reviewer
skpm package cncf-bellsoft-member-reviewer
skpm publish cncf-bellsoft-member-reviewer
```
