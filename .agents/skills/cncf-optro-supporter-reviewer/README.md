...
7. Run `skcr validate` and `skcr asps coverage cncf-optro-supporter-reviewer`.
8. Run `skcr compile cncf-optro-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-optro-supporter-reviewer`.
...
```bash
skpm validate cncf-optro-supporter-reviewer
skpm package cncf-optro-supporter-reviewer
skpm publish cncf-optro-supporter-reviewer
```
