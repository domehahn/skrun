...
7. Run `skcr validate` and `skcr asps coverage cncf-red-hat-openshift-reviewer`.
8. Run `skcr compile cncf-red-hat-openshift-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-red-hat-openshift-reviewer`.
...
```bash
skpm validate cncf-red-hat-openshift-reviewer
skpm package cncf-red-hat-openshift-reviewer
skpm publish cncf-red-hat-openshift-reviewer
```
