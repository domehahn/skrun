...
7. Run `skcr validate` and `skcr asps coverage cncf-kwasm-reviewer`.
8. Run `skcr compile cncf-kwasm-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kwasm-reviewer`.
...
```bash
skpm validate cncf-kwasm-reviewer
skpm package cncf-kwasm-reviewer
skpm publish cncf-kwasm-reviewer
```
