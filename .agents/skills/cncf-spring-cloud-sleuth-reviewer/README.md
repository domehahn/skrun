...
7. Run `skcr validate` and `skcr asps coverage cncf-spring-cloud-sleuth-reviewer`.
8. Run `skcr compile cncf-spring-cloud-sleuth-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-spring-cloud-sleuth-reviewer`.
...
```bash
skpm validate cncf-spring-cloud-sleuth-reviewer
skpm package cncf-spring-cloud-sleuth-reviewer
skpm publish cncf-spring-cloud-sleuth-reviewer
```
