...
7. Run `skcr validate` and `skcr asps coverage cncf-aibrix-reviewer`.
8. Run `skcr compile cncf-aibrix-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-aibrix-reviewer`.
...
```bash
skpm validate cncf-aibrix-reviewer
skpm package cncf-aibrix-reviewer
skpm publish cncf-aibrix-reviewer
```
