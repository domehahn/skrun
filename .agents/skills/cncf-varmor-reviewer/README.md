...
7. Run `skcr validate` and `skcr asps coverage cncf-varmor-reviewer`.
8. Run `skcr compile cncf-varmor-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-varmor-reviewer`.
...
```bash
skpm validate cncf-varmor-reviewer
skpm package cncf-varmor-reviewer
skpm publish cncf-varmor-reviewer
```
