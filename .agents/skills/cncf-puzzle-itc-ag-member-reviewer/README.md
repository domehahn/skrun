...
7. Run `skcr validate` and `skcr asps coverage cncf-puzzle-itc-ag-member-reviewer`.
8. Run `skcr compile cncf-puzzle-itc-ag-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-puzzle-itc-ag-member-reviewer`.
...
```bash
skpm validate cncf-puzzle-itc-ag-member-reviewer
skpm package cncf-puzzle-itc-ag-member-reviewer
skpm publish cncf-puzzle-itc-ag-member-reviewer
```
