...
7. Run `skcr validate` and `skcr asps coverage cncf-reo-dev-member-reviewer`.
8. Run `skcr compile cncf-reo-dev-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-reo-dev-member-reviewer`.
...
```bash
skpm validate cncf-reo-dev-member-reviewer
skpm package cncf-reo-dev-member-reviewer
skpm publish cncf-reo-dev-member-reviewer
```
