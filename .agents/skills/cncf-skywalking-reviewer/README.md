...
7. Run `skcr validate` and `skcr asps coverage cncf-skywalking-reviewer`.
8. Run `skcr compile cncf-skywalking-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-skywalking-reviewer`.
...
```bash
skpm validate cncf-skywalking-reviewer
skpm package cncf-skywalking-reviewer
skpm publish cncf-skywalking-reviewer
```
