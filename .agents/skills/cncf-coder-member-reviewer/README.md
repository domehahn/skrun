...
7. Run `skcr validate` and `skcr asps coverage cncf-coder-member-reviewer`.
8. Run `skcr compile cncf-coder-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-coder-member-reviewer`.
...
```bash
skpm validate cncf-coder-member-reviewer
skpm package cncf-coder-member-reviewer
skpm publish cncf-coder-member-reviewer
```
