...
7. Run `skcr validate` and `skcr asps coverage cncf-kestrel-ai-member-reviewer`.
8. Run `skcr compile cncf-kestrel-ai-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kestrel-ai-member-reviewer`.
...
```bash
skpm validate cncf-kestrel-ai-member-reviewer
skpm package cncf-kestrel-ai-member-reviewer
skpm publish cncf-kestrel-ai-member-reviewer
```
