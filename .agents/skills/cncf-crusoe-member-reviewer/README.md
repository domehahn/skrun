...
7. Run `skcr validate` and `skcr asps coverage cncf-crusoe-member-reviewer`.
8. Run `skcr compile cncf-crusoe-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-crusoe-member-reviewer`.
...
```bash
skpm validate cncf-crusoe-member-reviewer
skpm package cncf-crusoe-member-reviewer
skpm publish cncf-crusoe-member-reviewer
```
