...
7. Run `skcr validate` and `skcr asps coverage risk-acceptance-reviewer`.
8. Run `skcr compile risk-acceptance-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend risk-acceptance-reviewer`.
