...
7. Run `skcr validate` and `skcr asps coverage cncf-chef-infra-reviewer`.
8. Run `skcr compile cncf-chef-infra-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-chef-infra-reviewer`.
...
```bash
skpm validate cncf-chef-infra-reviewer
skpm package cncf-chef-infra-reviewer
skpm publish cncf-chef-infra-reviewer
```
