...
7. Run `skcr validate` and `skcr asps coverage cncf-cyso-managed-kubernetes-reviewer`.
8. Run `skcr compile cncf-cyso-managed-kubernetes-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cyso-managed-kubernetes-reviewer`.
...
```bash
skpm validate cncf-cyso-managed-kubernetes-reviewer
skpm package cncf-cyso-managed-kubernetes-reviewer
skpm publish cncf-cyso-managed-kubernetes-reviewer
```
