...
7. Run `skcr validate` and `skcr asps coverage cncf-blacksmith-member-reviewer`.
8. Run `skcr compile cncf-blacksmith-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-blacksmith-member-reviewer`.
...
```bash
skpm validate cncf-blacksmith-member-reviewer
skpm package cncf-blacksmith-member-reviewer
skpm publish cncf-blacksmith-member-reviewer
```
