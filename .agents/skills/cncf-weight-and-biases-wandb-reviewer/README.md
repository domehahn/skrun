...
7. Run `skcr validate` and `skcr asps coverage cncf-weight-and-biases-wandb-reviewer`.
8. Run `skcr compile cncf-weight-and-biases-wandb-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-weight-and-biases-wandb-reviewer`.
...
```bash
skpm validate cncf-weight-and-biases-wandb-reviewer
skpm package cncf-weight-and-biases-wandb-reviewer
skpm publish cncf-weight-and-biases-wandb-reviewer
```
