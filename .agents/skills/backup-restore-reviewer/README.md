...
7. Run `skcr validate` and `skcr asps coverage backup-restore-reviewer`.
8. Run `skcr compile backup-restore-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend backup-restore-reviewer`.
