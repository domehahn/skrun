...
7. Run `skcr validate` and `skcr asps coverage cncf-cast-ai-member-reviewer`.
8. Run `skcr compile cncf-cast-ai-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cast-ai-member-reviewer`.
...
```bash
skpm validate cncf-cast-ai-member-reviewer
skpm package cncf-cast-ai-member-reviewer
skpm publish cncf-cast-ai-member-reviewer
```
