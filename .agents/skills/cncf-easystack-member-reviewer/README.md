...
7. Run `skcr validate` and `skcr asps coverage cncf-easystack-member-reviewer`.
8. Run `skcr compile cncf-easystack-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-easystack-member-reviewer`.
...
```bash
skpm validate cncf-easystack-member-reviewer
skpm package cncf-easystack-member-reviewer
skpm publish cncf-easystack-member-reviewer
```
