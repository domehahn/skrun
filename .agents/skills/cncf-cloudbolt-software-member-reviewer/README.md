...
7. Run `skcr validate` and `skcr asps coverage cncf-cloudbolt-software-member-reviewer`.
8. Run `skcr compile cncf-cloudbolt-software-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloudbolt-software-member-reviewer`.
...
```bash
skpm validate cncf-cloudbolt-software-member-reviewer
skpm package cncf-cloudbolt-software-member-reviewer
skpm publish cncf-cloudbolt-software-member-reviewer
```
