...
7. Run `skcr validate` and `skcr asps coverage cncf-qingteng-reviewer`.
8. Run `skcr compile cncf-qingteng-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-qingteng-reviewer`.
...
```bash
skpm validate cncf-qingteng-reviewer
skpm package cncf-qingteng-reviewer
skpm publish cncf-qingteng-reviewer
```
