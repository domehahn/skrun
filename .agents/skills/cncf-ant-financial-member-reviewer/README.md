...
7. Run `skcr validate` and `skcr asps coverage cncf-ant-financial-member-reviewer`.
8. Run `skcr compile cncf-ant-financial-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ant-financial-member-reviewer`.
...
```bash
skpm validate cncf-ant-financial-member-reviewer
skpm package cncf-ant-financial-member-reviewer
skpm publish cncf-ant-financial-member-reviewer
```
