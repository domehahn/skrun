...
7. Run `skcr validate` and `skcr asps coverage cncf-volcano-engine-member-reviewer`.
8. Run `skcr compile cncf-volcano-engine-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-volcano-engine-member-reviewer`.
...
```bash
skpm validate cncf-volcano-engine-member-reviewer
skpm package cncf-volcano-engine-member-reviewer
skpm publish cncf-volcano-engine-member-reviewer
```
