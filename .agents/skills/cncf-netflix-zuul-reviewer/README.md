...
7. Run `skcr validate` and `skcr asps coverage cncf-netflix-zuul-reviewer`.
8. Run `skcr compile cncf-netflix-zuul-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-netflix-zuul-reviewer`.
...
```bash
skpm validate cncf-netflix-zuul-reviewer
skpm package cncf-netflix-zuul-reviewer
skpm publish cncf-netflix-zuul-reviewer
```
