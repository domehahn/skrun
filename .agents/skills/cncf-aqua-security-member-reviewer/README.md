...
7. Run `skcr validate` and `skcr asps coverage cncf-aqua-security-member-reviewer`.
8. Run `skcr compile cncf-aqua-security-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-aqua-security-member-reviewer`.
...
```bash
skpm validate cncf-aqua-security-member-reviewer
skpm package cncf-aqua-security-member-reviewer
skpm publish cncf-aqua-security-member-reviewer
```
