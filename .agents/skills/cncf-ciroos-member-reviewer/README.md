...
7. Run `skcr validate` and `skcr asps coverage cncf-ciroos-member-reviewer`.
8. Run `skcr compile cncf-ciroos-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ciroos-member-reviewer`.
...
```bash
skpm validate cncf-ciroos-member-reviewer
skpm package cncf-ciroos-member-reviewer
skpm publish cncf-ciroos-member-reviewer
```
