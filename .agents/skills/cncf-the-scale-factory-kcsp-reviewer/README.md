...
7. Run `skcr validate` and `skcr asps coverage cncf-the-scale-factory-kcsp-reviewer`.
8. Run `skcr compile cncf-the-scale-factory-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-the-scale-factory-kcsp-reviewer`.
...
```bash
skpm validate cncf-the-scale-factory-kcsp-reviewer
skpm package cncf-the-scale-factory-kcsp-reviewer
skpm publish cncf-the-scale-factory-kcsp-reviewer
```
