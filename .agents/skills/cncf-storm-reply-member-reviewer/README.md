...
7. Run `skcr validate` and `skcr asps coverage cncf-storm-reply-member-reviewer`.
8. Run `skcr compile cncf-storm-reply-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-storm-reply-member-reviewer`.
...
```bash
skpm validate cncf-storm-reply-member-reviewer
skpm package cncf-storm-reply-member-reviewer
skpm publish cncf-storm-reply-member-reviewer
```
