...
7. Run `skcr validate` and `skcr asps coverage cncf-deepstream-reviewer`.
8. Run `skcr compile cncf-deepstream-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-deepstream-reviewer`.
...
```bash
skpm validate cncf-deepstream-reviewer
skpm package cncf-deepstream-reviewer
skpm publish cncf-deepstream-reviewer
```
