...
7. Run `skcr validate` and `skcr asps coverage cncf-embrace-member-reviewer`.
8. Run `skcr compile cncf-embrace-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-embrace-member-reviewer`.
...
```bash
skpm validate cncf-embrace-member-reviewer
skpm package cncf-embrace-member-reviewer
skpm publish cncf-embrace-member-reviewer
```
