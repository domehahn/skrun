...
7. Run `skcr validate` and `skcr asps coverage cncf-asus-cloud-infra-reviewer`.
8. Run `skcr compile cncf-asus-cloud-infra-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-asus-cloud-infra-reviewer`.
...
```bash
skpm validate cncf-asus-cloud-infra-reviewer
skpm package cncf-asus-cloud-infra-reviewer
skpm publish cncf-asus-cloud-infra-reviewer
```
