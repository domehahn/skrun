...
7. Run `skcr validate` and `skcr asps coverage cncf-golden-gate-university-member-reviewer`.
8. Run `skcr compile cncf-golden-gate-university-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-golden-gate-university-member-reviewer`.
...
```bash
skpm validate cncf-golden-gate-university-member-reviewer
skpm package cncf-golden-gate-university-member-reviewer
skpm publish cncf-golden-gate-university-member-reviewer
```
