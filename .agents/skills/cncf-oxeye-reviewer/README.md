...
7. Run `skcr validate` and `skcr asps coverage cncf-oxeye-reviewer`.
8. Run `skcr compile cncf-oxeye-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-oxeye-reviewer`.
...
```bash
skpm validate cncf-oxeye-reviewer
skpm package cncf-oxeye-reviewer
skpm publish cncf-oxeye-reviewer
```
