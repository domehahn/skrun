...
7. Run `skcr validate` and `skcr asps coverage requirements-analyst`.
8. Run `skcr compile requirements-analyst --target skil`.
9. Run `skcr sync` and `skcr version recommend requirements-analyst`.
