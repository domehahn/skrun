...
7. Run `skcr validate` and `skcr asps coverage cncf-authkeys-supporter-reviewer`.
8. Run `skcr compile cncf-authkeys-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-authkeys-supporter-reviewer`.
...
```bash
skpm validate cncf-authkeys-supporter-reviewer
skpm package cncf-authkeys-supporter-reviewer
skpm publish cncf-authkeys-supporter-reviewer
```
