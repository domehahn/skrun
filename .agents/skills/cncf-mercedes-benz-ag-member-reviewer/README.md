...
7. Run `skcr validate` and `skcr asps coverage cncf-mercedes-benz-ag-member-reviewer`.
8. Run `skcr compile cncf-mercedes-benz-ag-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-mercedes-benz-ag-member-reviewer`.
...
```bash
skpm validate cncf-mercedes-benz-ag-member-reviewer
skpm package cncf-mercedes-benz-ag-member-reviewer
skpm publish cncf-mercedes-benz-ag-member-reviewer
```
