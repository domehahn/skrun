...
7. Run `skcr validate` and `skcr asps coverage cncf-shinesoft-kcsp-reviewer`.
8. Run `skcr compile cncf-shinesoft-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-shinesoft-kcsp-reviewer`.
...
```bash
skpm validate cncf-shinesoft-kcsp-reviewer
skpm package cncf-shinesoft-kcsp-reviewer
skpm publish cncf-shinesoft-kcsp-reviewer
```
