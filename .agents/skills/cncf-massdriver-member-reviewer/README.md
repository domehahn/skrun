...
7. Run `skcr validate` and `skcr asps coverage cncf-massdriver-member-reviewer`.
8. Run `skcr compile cncf-massdriver-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-massdriver-member-reviewer`.
...
```bash
skpm validate cncf-massdriver-member-reviewer
skpm package cncf-massdriver-member-reviewer
skpm publish cncf-massdriver-member-reviewer
```
