...
7. Run `skcr validate` and `skcr asps coverage cncf-ilki-kcntp-reviewer`.
8. Run `skcr compile cncf-ilki-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ilki-kcntp-reviewer`.
...
```bash
skpm validate cncf-ilki-kcntp-reviewer
skpm package cncf-ilki-kcntp-reviewer
skpm publish cncf-ilki-kcntp-reviewer
```
