...
7. Run `skcr validate` and `skcr asps coverage cncf-breqwatr-member-reviewer`.
8. Run `skcr compile cncf-breqwatr-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-breqwatr-member-reviewer`.
...
```bash
skpm validate cncf-breqwatr-member-reviewer
skpm package cncf-breqwatr-member-reviewer
skpm publish cncf-breqwatr-member-reviewer
```
