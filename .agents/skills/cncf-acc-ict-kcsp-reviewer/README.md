...
7. Run `skcr validate` and `skcr asps coverage cncf-acc-ict-kcsp-reviewer`.
8. Run `skcr compile cncf-acc-ict-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-acc-ict-kcsp-reviewer`.
...
```bash
skpm validate cncf-acc-ict-kcsp-reviewer
skpm package cncf-acc-ict-kcsp-reviewer
skpm publish cncf-acc-ict-kcsp-reviewer
```
