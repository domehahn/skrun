...
7. Run `skcr validate` and `skcr asps coverage cncf-pengyun-network-reviewer`.
8. Run `skcr compile cncf-pengyun-network-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-pengyun-network-reviewer`.
...
```bash
skpm validate cncf-pengyun-network-reviewer
skpm package cncf-pengyun-network-reviewer
skpm publish cncf-pengyun-network-reviewer
```
