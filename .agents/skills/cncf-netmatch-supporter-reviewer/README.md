...
7. Run `skcr validate` and `skcr asps coverage cncf-netmatch-supporter-reviewer`.
8. Run `skcr compile cncf-netmatch-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-netmatch-supporter-reviewer`.
...
```bash
skpm validate cncf-netmatch-supporter-reviewer
skpm package cncf-netmatch-supporter-reviewer
skpm publish cncf-netmatch-supporter-reviewer
```
