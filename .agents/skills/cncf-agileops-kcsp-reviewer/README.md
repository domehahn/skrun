...
7. Run `skcr validate` and `skcr asps coverage cncf-agileops-kcsp-reviewer`.
8. Run `skcr compile cncf-agileops-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-agileops-kcsp-reviewer`.
...
```bash
skpm validate cncf-agileops-kcsp-reviewer
skpm package cncf-agileops-kcsp-reviewer
skpm publish cncf-agileops-kcsp-reviewer
```
