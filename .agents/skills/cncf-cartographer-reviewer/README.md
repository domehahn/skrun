...
7. Run `skcr validate` and `skcr asps coverage cncf-cartographer-reviewer`.
8. Run `skcr compile cncf-cartographer-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cartographer-reviewer`.
...
```bash
skpm validate cncf-cartographer-reviewer
skpm package cncf-cartographer-reviewer
skpm publish cncf-cartographer-reviewer
```
