...
7. Run `skcr validate` and `skcr asps coverage cncf-ambient-it-kcntp-reviewer`.
8. Run `skcr compile cncf-ambient-it-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ambient-it-kcntp-reviewer`.
...
```bash
skpm validate cncf-ambient-it-kcntp-reviewer
skpm package cncf-ambient-it-kcntp-reviewer
skpm publish cncf-ambient-it-kcntp-reviewer
```
