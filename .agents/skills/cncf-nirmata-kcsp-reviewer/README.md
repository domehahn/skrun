...
7. Run `skcr validate` and `skcr asps coverage cncf-nirmata-kcsp-reviewer`.
8. Run `skcr compile cncf-nirmata-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nirmata-kcsp-reviewer`.
...
```bash
skpm validate cncf-nirmata-kcsp-reviewer
skpm package cncf-nirmata-kcsp-reviewer
skpm publish cncf-nirmata-kcsp-reviewer
```
