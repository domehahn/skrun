...
7. Run `skcr validate` and `skcr asps coverage cncf-unryo-reviewer`.
8. Run `skcr compile cncf-unryo-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-unryo-reviewer`.
...
```bash
skpm validate cncf-unryo-reviewer
skpm package cncf-unryo-reviewer
skpm publish cncf-unryo-reviewer
```
