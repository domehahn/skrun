...
7. Run `skcr validate` and `skcr asps coverage cncf-china-unicom-member-reviewer`.
8. Run `skcr compile cncf-china-unicom-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-china-unicom-member-reviewer`.
...
```bash
skpm validate cncf-china-unicom-member-reviewer
skpm package cncf-china-unicom-member-reviewer
skpm publish cncf-china-unicom-member-reviewer
```
