...
7. Run `skcr validate` and `skcr asps coverage cncf-fairwinds-member-reviewer`.
8. Run `skcr compile cncf-fairwinds-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-fairwinds-member-reviewer`.
...
```bash
skpm validate cncf-fairwinds-member-reviewer
skpm package cncf-fairwinds-member-reviewer
skpm publish cncf-fairwinds-member-reviewer
```
