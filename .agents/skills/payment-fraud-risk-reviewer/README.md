...
7. Run `skcr validate` and `skcr asps coverage payment-fraud-risk-reviewer`.
8. Run `skcr compile payment-fraud-risk-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend payment-fraud-risk-reviewer`.
...
```bash
skpm validate payment-fraud-risk-reviewer
skpm package payment-fraud-risk-reviewer
skpm publish payment-fraud-risk-reviewer
```
