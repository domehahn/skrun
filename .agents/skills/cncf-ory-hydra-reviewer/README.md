...
7. Run `skcr validate` and `skcr asps coverage cncf-ory-hydra-reviewer`.
8. Run `skcr compile cncf-ory-hydra-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ory-hydra-reviewer`.
...
```bash
skpm validate cncf-ory-hydra-reviewer
skpm package cncf-ory-hydra-reviewer
skpm publish cncf-ory-hydra-reviewer
```
