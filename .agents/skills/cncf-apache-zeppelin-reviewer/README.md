...
7. Run `skcr validate` and `skcr asps coverage cncf-apache-zeppelin-reviewer`.
8. Run `skcr compile cncf-apache-zeppelin-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-apache-zeppelin-reviewer`.
...
```bash
skpm validate cncf-apache-zeppelin-reviewer
skpm package cncf-apache-zeppelin-reviewer
skpm publish cncf-apache-zeppelin-reviewer
```
