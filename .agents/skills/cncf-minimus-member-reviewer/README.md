...
7. Run `skcr validate` and `skcr asps coverage cncf-minimus-member-reviewer`.
8. Run `skcr compile cncf-minimus-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-minimus-member-reviewer`.
...
```bash
skpm validate cncf-minimus-member-reviewer
skpm package cncf-minimus-member-reviewer
skpm publish cncf-minimus-member-reviewer
```
