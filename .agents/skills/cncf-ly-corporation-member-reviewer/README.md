...
7. Run `skcr validate` and `skcr asps coverage cncf-ly-corporation-member-reviewer`.
8. Run `skcr compile cncf-ly-corporation-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ly-corporation-member-reviewer`.
...
```bash
skpm validate cncf-ly-corporation-member-reviewer
skpm package cncf-ly-corporation-member-reviewer
skpm publish cncf-ly-corporation-member-reviewer
```
