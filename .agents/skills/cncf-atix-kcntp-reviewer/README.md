...
7. Run `skcr validate` and `skcr asps coverage cncf-atix-kcntp-reviewer`.
8. Run `skcr compile cncf-atix-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-atix-kcntp-reviewer`.
...
```bash
skpm validate cncf-atix-kcntp-reviewer
skpm package cncf-atix-kcntp-reviewer
skpm publish cncf-atix-kcntp-reviewer
```
