...
7. Run `skcr validate` and `skcr asps coverage cncf-kata-containers-reviewer`.
8. Run `skcr compile cncf-kata-containers-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kata-containers-reviewer`.
...
```bash
skpm validate cncf-kata-containers-reviewer
skpm package cncf-kata-containers-reviewer
skpm publish cncf-kata-containers-reviewer
```
