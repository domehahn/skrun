...
7. Run `skcr validate` and `skcr asps coverage cncf-kubeelasti-reviewer`.
8. Run `skcr compile cncf-kubeelasti-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kubeelasti-reviewer`.
...
```bash
skpm validate cncf-kubeelasti-reviewer
skpm package cncf-kubeelasti-reviewer
skpm publish cncf-kubeelasti-reviewer
```
