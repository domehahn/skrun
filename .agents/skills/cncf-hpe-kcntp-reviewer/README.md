...
7. Run `skcr validate` and `skcr asps coverage cncf-hpe-kcntp-reviewer`.
8. Run `skcr compile cncf-hpe-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-hpe-kcntp-reviewer`.
...
```bash
skpm validate cncf-hpe-kcntp-reviewer
skpm package cncf-hpe-kcntp-reviewer
skpm publish cncf-hpe-kcntp-reviewer
```
