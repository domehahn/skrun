...
7. Run `skcr validate` and `skcr asps coverage cncf-software-mind-kcsp-reviewer`.
8. Run `skcr compile cncf-software-mind-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-software-mind-kcsp-reviewer`.
...
```bash
skpm validate cncf-software-mind-kcsp-reviewer
skpm package cncf-software-mind-kcsp-reviewer
skpm publish cncf-software-mind-kcsp-reviewer
```
