...
7. Run `skcr validate` and `skcr asps coverage cncf-datica-reviewer`.
8. Run `skcr compile cncf-datica-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-datica-reviewer`.
...
```bash
skpm validate cncf-datica-reviewer
skpm package cncf-datica-reviewer
skpm publish cncf-datica-reviewer
```
