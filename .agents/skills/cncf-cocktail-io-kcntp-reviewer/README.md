...
7. Run `skcr validate` and `skcr asps coverage cncf-cocktail-io-kcntp-reviewer`.
8. Run `skcr compile cncf-cocktail-io-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cocktail-io-kcntp-reviewer`.
...
```bash
skpm validate cncf-cocktail-io-kcntp-reviewer
skpm package cncf-cocktail-io-kcntp-reviewer
skpm publish cncf-cocktail-io-kcntp-reviewer
```
