...
7. Run `skcr validate` and `skcr asps coverage cncf-whizus-kcntp-reviewer`.
8. Run `skcr compile cncf-whizus-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-whizus-kcntp-reviewer`.
...
```bash
skpm validate cncf-whizus-kcntp-reviewer
skpm package cncf-whizus-kcntp-reviewer
skpm publish cncf-whizus-kcntp-reviewer
```
