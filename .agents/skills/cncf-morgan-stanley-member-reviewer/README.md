...
7. Run `skcr validate` and `skcr asps coverage cncf-morgan-stanley-member-reviewer`.
8. Run `skcr compile cncf-morgan-stanley-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-morgan-stanley-member-reviewer`.
...
```bash
skpm validate cncf-morgan-stanley-member-reviewer
skpm package cncf-morgan-stanley-member-reviewer
skpm publish cncf-morgan-stanley-member-reviewer
```
