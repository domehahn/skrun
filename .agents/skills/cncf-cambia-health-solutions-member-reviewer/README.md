...
7. Run `skcr validate` and `skcr asps coverage cncf-cambia-health-solutions-member-reviewer`.
8. Run `skcr compile cncf-cambia-health-solutions-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cambia-health-solutions-member-reviewer`.
...
```bash
skpm validate cncf-cambia-health-solutions-member-reviewer
skpm package cncf-cambia-health-solutions-member-reviewer
skpm publish cncf-cambia-health-solutions-member-reviewer
```
