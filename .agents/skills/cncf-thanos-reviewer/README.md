...
7. Run `skcr validate` and `skcr asps coverage cncf-thanos-reviewer`.
8. Run `skcr compile cncf-thanos-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-thanos-reviewer`.
...
```bash
skpm validate cncf-thanos-reviewer
skpm package cncf-thanos-reviewer
skpm publish cncf-thanos-reviewer
```
