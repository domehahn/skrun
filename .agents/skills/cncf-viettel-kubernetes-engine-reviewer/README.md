...
7. Run `skcr validate` and `skcr asps coverage cncf-viettel-kubernetes-engine-reviewer`.
8. Run `skcr compile cncf-viettel-kubernetes-engine-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-viettel-kubernetes-engine-reviewer`.
...
```bash
skpm validate cncf-viettel-kubernetes-engine-reviewer
skpm package cncf-viettel-kubernetes-engine-reviewer
skpm publish cncf-viettel-kubernetes-engine-reviewer
```
