...
7. Run `skcr validate` and `skcr asps coverage cncf-oxia-reviewer`.
8. Run `skcr compile cncf-oxia-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-oxia-reviewer`.
...
```bash
skpm validate cncf-oxia-reviewer
skpm package cncf-oxia-reviewer
skpm publish cncf-oxia-reviewer
```
