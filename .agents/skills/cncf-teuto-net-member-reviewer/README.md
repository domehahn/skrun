...
7. Run `skcr validate` and `skcr asps coverage cncf-teuto-net-member-reviewer`.
8. Run `skcr compile cncf-teuto-net-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-teuto-net-member-reviewer`.
...
```bash
skpm validate cncf-teuto-net-member-reviewer
skpm package cncf-teuto-net-member-reviewer
skpm publish cncf-teuto-net-member-reviewer
```
