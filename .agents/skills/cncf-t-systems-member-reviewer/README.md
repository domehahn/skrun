...
7. Run `skcr validate` and `skcr asps coverage cncf-t-systems-member-reviewer`.
8. Run `skcr compile cncf-t-systems-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-t-systems-member-reviewer`.
...
```bash
skpm validate cncf-t-systems-member-reviewer
skpm package cncf-t-systems-member-reviewer
skpm publish cncf-t-systems-member-reviewer
```
