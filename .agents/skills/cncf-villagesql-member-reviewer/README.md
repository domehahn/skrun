...
7. Run `skcr validate` and `skcr asps coverage cncf-villagesql-member-reviewer`.
8. Run `skcr compile cncf-villagesql-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-villagesql-member-reviewer`.
...
```bash
skpm validate cncf-villagesql-member-reviewer
skpm package cncf-villagesql-member-reviewer
skpm publish cncf-villagesql-member-reviewer
```
