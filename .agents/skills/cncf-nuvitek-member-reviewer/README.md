...
7. Run `skcr validate` and `skcr asps coverage cncf-nuvitek-member-reviewer`.
8. Run `skcr compile cncf-nuvitek-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nuvitek-member-reviewer`.
...
```bash
skpm validate cncf-nuvitek-member-reviewer
skpm package cncf-nuvitek-member-reviewer
skpm publish cncf-nuvitek-member-reviewer
```
