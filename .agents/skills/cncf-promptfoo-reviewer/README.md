...
7. Run `skcr validate` and `skcr asps coverage cncf-promptfoo-reviewer`.
8. Run `skcr compile cncf-promptfoo-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-promptfoo-reviewer`.
...
```bash
skpm validate cncf-promptfoo-reviewer
skpm package cncf-promptfoo-reviewer
skpm publish cncf-promptfoo-reviewer
```
