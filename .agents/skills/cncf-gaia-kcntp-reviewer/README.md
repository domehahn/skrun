...
7. Run `skcr validate` and `skcr asps coverage cncf-gaia-kcntp-reviewer`.
8. Run `skcr compile cncf-gaia-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-gaia-kcntp-reviewer`.
...
```bash
skpm validate cncf-gaia-kcntp-reviewer
skpm package cncf-gaia-kcntp-reviewer
skpm publish cncf-gaia-kcntp-reviewer
```
