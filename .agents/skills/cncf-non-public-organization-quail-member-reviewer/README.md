...
7. Run `skcr validate` and `skcr asps coverage cncf-non-public-organization-quail-member-reviewer`.
8. Run `skcr compile cncf-non-public-organization-quail-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-non-public-organization-quail-member-reviewer`.
...
```bash
skpm validate cncf-non-public-organization-quail-member-reviewer
skpm package cncf-non-public-organization-quail-member-reviewer
skpm publish cncf-non-public-organization-quail-member-reviewer
```
