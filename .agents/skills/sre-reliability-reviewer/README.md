...
7. Run `skcr validate` and `skcr asps coverage sre-reliability-reviewer`.
8. Run `skcr compile sre-reliability-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend sre-reliability-reviewer`.
