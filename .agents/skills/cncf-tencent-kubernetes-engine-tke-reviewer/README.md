...
7. Run `skcr validate` and `skcr asps coverage cncf-tencent-kubernetes-engine-tke-reviewer`.
8. Run `skcr compile cncf-tencent-kubernetes-engine-tke-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-tencent-kubernetes-engine-tke-reviewer`.
...
```bash
skpm validate cncf-tencent-kubernetes-engine-tke-reviewer
skpm package cncf-tencent-kubernetes-engine-tke-reviewer
skpm publish cncf-tencent-kubernetes-engine-tke-reviewer
```
