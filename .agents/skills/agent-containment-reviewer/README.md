...
7. Run `skcr validate` and `skcr asps coverage agent-containment-reviewer`.
8. Run `skcr compile agent-containment-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend agent-containment-reviewer`.
...
```bash
skpm validate agent-containment-reviewer
skpm package agent-containment-reviewer
skpm publish agent-containment-reviewer
```
