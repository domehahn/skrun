...
7. Run `skcr validate` and `skcr asps coverage cncf-controltheory-reviewer`.
8. Run `skcr compile cncf-controltheory-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-controltheory-reviewer`.
...
```bash
skpm validate cncf-controltheory-reviewer
skpm package cncf-controltheory-reviewer
skpm publish cncf-controltheory-reviewer
```
