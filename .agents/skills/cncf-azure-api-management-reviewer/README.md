...
7. Run `skcr validate` and `skcr asps coverage cncf-azure-api-management-reviewer`.
8. Run `skcr compile cncf-azure-api-management-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-azure-api-management-reviewer`.
...
```bash
skpm validate cncf-azure-api-management-reviewer
skpm package cncf-azure-api-management-reviewer
skpm publish cncf-azure-api-management-reviewer
```
