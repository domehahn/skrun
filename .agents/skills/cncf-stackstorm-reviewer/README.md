...
7. Run `skcr validate` and `skcr asps coverage cncf-stackstorm-reviewer`.
8. Run `skcr compile cncf-stackstorm-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-stackstorm-reviewer`.
...
```bash
skpm validate cncf-stackstorm-reviewer
skpm package cncf-stackstorm-reviewer
skpm publish cncf-stackstorm-reviewer
```
