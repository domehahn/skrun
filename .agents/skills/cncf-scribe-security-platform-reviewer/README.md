...
7. Run `skcr validate` and `skcr asps coverage cncf-scribe-security-platform-reviewer`.
8. Run `skcr compile cncf-scribe-security-platform-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-scribe-security-platform-reviewer`.
...
```bash
skpm validate cncf-scribe-security-platform-reviewer
skpm package cncf-scribe-security-platform-reviewer
skpm publish cncf-scribe-security-platform-reviewer
```
