...
7. Run `skcr validate` and `skcr asps coverage cncf-mcp-gateway-registry-reviewer`.
8. Run `skcr compile cncf-mcp-gateway-registry-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-mcp-gateway-registry-reviewer`.
...
```bash
skpm validate cncf-mcp-gateway-registry-reviewer
skpm package cncf-mcp-gateway-registry-reviewer
skpm publish cncf-mcp-gateway-registry-reviewer
```
