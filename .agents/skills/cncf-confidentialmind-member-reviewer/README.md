...
7. Run `skcr validate` and `skcr asps coverage cncf-confidentialmind-member-reviewer`.
8. Run `skcr compile cncf-confidentialmind-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-confidentialmind-member-reviewer`.
...
```bash
skpm validate cncf-confidentialmind-member-reviewer
skpm package cncf-confidentialmind-member-reviewer
skpm publish cncf-confidentialmind-member-reviewer
```
