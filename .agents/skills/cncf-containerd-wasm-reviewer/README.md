...
7. Run `skcr validate` and `skcr asps coverage cncf-containerd-wasm-reviewer`.
8. Run `skcr compile cncf-containerd-wasm-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-containerd-wasm-reviewer`.
...
```bash
skpm validate cncf-containerd-wasm-reviewer
skpm package cncf-containerd-wasm-reviewer
skpm publish cncf-containerd-wasm-reviewer
```
