...
7. Run `skcr validate` and `skcr asps coverage cncf-civo-kubernetes-reviewer`.
8. Run `skcr compile cncf-civo-kubernetes-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-civo-kubernetes-reviewer`.
...
```bash
skpm validate cncf-civo-kubernetes-reviewer
skpm package cncf-civo-kubernetes-reviewer
skpm publish cncf-civo-kubernetes-reviewer
```
