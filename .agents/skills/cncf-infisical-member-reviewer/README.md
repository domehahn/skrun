...
7. Run `skcr validate` and `skcr asps coverage cncf-infisical-member-reviewer`.
8. Run `skcr compile cncf-infisical-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-infisical-member-reviewer`.
...
```bash
skpm validate cncf-infisical-member-reviewer
skpm package cncf-infisical-member-reviewer
skpm publish cncf-infisical-member-reviewer
```
