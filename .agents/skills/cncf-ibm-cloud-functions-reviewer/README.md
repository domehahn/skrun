...
7. Run `skcr validate` and `skcr asps coverage cncf-ibm-cloud-functions-reviewer`.
8. Run `skcr compile cncf-ibm-cloud-functions-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ibm-cloud-functions-reviewer`.
...
```bash
skpm validate cncf-ibm-cloud-functions-reviewer
skpm package cncf-ibm-cloud-functions-reviewer
skpm publish cncf-ibm-cloud-functions-reviewer
```
