...
7. Run `skcr validate` and `skcr asps coverage cncf-vscode-wasm-reviewer`.
8. Run `skcr compile cncf-vscode-wasm-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-vscode-wasm-reviewer`.
...
```bash
skpm validate cncf-vscode-wasm-reviewer
skpm package cncf-vscode-wasm-reviewer
skpm publish cncf-vscode-wasm-reviewer
```
