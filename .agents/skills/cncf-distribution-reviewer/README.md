...
7. Run `skcr validate` and `skcr asps coverage cncf-distribution-reviewer`.
8. Run `skcr compile cncf-distribution-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-distribution-reviewer`.
...
```bash
skpm validate cncf-distribution-reviewer
skpm package cncf-distribution-reviewer
skpm publish cncf-distribution-reviewer
```
