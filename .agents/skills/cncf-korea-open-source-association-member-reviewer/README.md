...
7. Run `skcr validate` and `skcr asps coverage cncf-korea-open-source-association-member-reviewer`.
8. Run `skcr compile cncf-korea-open-source-association-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-korea-open-source-association-member-reviewer`.
...
```bash
skpm validate cncf-korea-open-source-association-member-reviewer
skpm package cncf-korea-open-source-association-member-reviewer
skpm publish cncf-korea-open-source-association-member-reviewer
```
