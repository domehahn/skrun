...
7. Run `skcr validate` and `skcr asps coverage cncf-application-high-availability-service-reviewer`.
8. Run `skcr compile cncf-application-high-availability-service-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-application-high-availability-service-reviewer`.
...
```bash
skpm validate cncf-application-high-availability-service-reviewer
skpm package cncf-application-high-availability-service-reviewer
skpm publish cncf-application-high-availability-service-reviewer
```
