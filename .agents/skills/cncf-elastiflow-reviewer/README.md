...
7. Run `skcr validate` and `skcr asps coverage cncf-elastiflow-reviewer`.
8. Run `skcr compile cncf-elastiflow-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-elastiflow-reviewer`.
...
```bash
skpm validate cncf-elastiflow-reviewer
skpm package cncf-elastiflow-reviewer
skpm publish cncf-elastiflow-reviewer
```
