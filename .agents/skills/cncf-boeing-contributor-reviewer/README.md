...
7. Run `skcr validate` and `skcr asps coverage cncf-boeing-contributor-reviewer`.
8. Run `skcr compile cncf-boeing-contributor-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-boeing-contributor-reviewer`.
...
```bash
skpm validate cncf-boeing-contributor-reviewer
skpm package cncf-boeing-contributor-reviewer
skpm publish cncf-boeing-contributor-reviewer
```
