...
7. Run `skcr validate` and `skcr asps coverage cncf-microsoft-kcsp-reviewer`.
8. Run `skcr compile cncf-microsoft-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-microsoft-kcsp-reviewer`.
...
```bash
skpm validate cncf-microsoft-kcsp-reviewer
skpm package cncf-microsoft-kcsp-reviewer
skpm publish cncf-microsoft-kcsp-reviewer
```
