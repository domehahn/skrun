...
7. Run `skcr validate` and `skcr asps coverage cncf-kodekloud-kcntp-reviewer`.
8. Run `skcr compile cncf-kodekloud-kcntp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kodekloud-kcntp-reviewer`.
...
```bash
skpm validate cncf-kodekloud-kcntp-reviewer
skpm package cncf-kodekloud-kcntp-reviewer
skpm publish cncf-kodekloud-kcntp-reviewer
```
