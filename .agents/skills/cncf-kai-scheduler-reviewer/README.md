...
7. Run `skcr validate` and `skcr asps coverage cncf-kai-scheduler-reviewer`.
8. Run `skcr compile cncf-kai-scheduler-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kai-scheduler-reviewer`.
...
```bash
skpm validate cncf-kai-scheduler-reviewer
skpm package cncf-kai-scheduler-reviewer
skpm publish cncf-kai-scheduler-reviewer
```
