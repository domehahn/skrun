...
7. Run `skcr validate` and `skcr asps coverage cncf-bigchaindb-reviewer`.
8. Run `skcr compile cncf-bigchaindb-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-bigchaindb-reviewer`.
...
```bash
skpm validate cncf-bigchaindb-reviewer
skpm package cncf-bigchaindb-reviewer
skpm publish cncf-bigchaindb-reviewer
```
