...
7. Run `skcr validate` and `skcr asps coverage cncf-squer-kcsp-reviewer`.
8. Run `skcr compile cncf-squer-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-squer-kcsp-reviewer`.
...
```bash
skpm validate cncf-squer-kcsp-reviewer
skpm package cncf-squer-kcsp-reviewer
skpm publish cncf-squer-kcsp-reviewer
```
