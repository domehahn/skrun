...
7. Run `skcr validate` and `skcr asps coverage cncf-spot-io-reviewer`.
8. Run `skcr compile cncf-spot-io-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-spot-io-reviewer`.
...
```bash
skpm validate cncf-spot-io-reviewer
skpm package cncf-spot-io-reviewer
skpm publish cncf-spot-io-reviewer
```
