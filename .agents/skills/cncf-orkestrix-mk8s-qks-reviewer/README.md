...
7. Run `skcr validate` and `skcr asps coverage cncf-orkestrix-mk8s-qks-reviewer`.
8. Run `skcr compile cncf-orkestrix-mk8s-qks-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-orkestrix-mk8s-qks-reviewer`.
...
```bash
skpm validate cncf-orkestrix-mk8s-qks-reviewer
skpm package cncf-orkestrix-mk8s-qks-reviewer
skpm publish cncf-orkestrix-mk8s-qks-reviewer
```
