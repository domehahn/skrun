...
7. Run `skcr validate` and `skcr asps coverage cncf-pengcheng-laboratory-member-reviewer`.
8. Run `skcr compile cncf-pengcheng-laboratory-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-pengcheng-laboratory-member-reviewer`.
...
```bash
skpm validate cncf-pengcheng-laboratory-member-reviewer
skpm package cncf-pengcheng-laboratory-member-reviewer
skpm publish cncf-pengcheng-laboratory-member-reviewer
```
