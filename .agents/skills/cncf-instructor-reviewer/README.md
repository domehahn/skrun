...
7. Run `skcr validate` and `skcr asps coverage cncf-instructor-reviewer`.
8. Run `skcr compile cncf-instructor-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-instructor-reviewer`.
...
```bash
skpm validate cncf-instructor-reviewer
skpm package cncf-instructor-reviewer
skpm publish cncf-instructor-reviewer
```
