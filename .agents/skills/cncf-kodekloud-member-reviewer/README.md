...
7. Run `skcr validate` and `skcr asps coverage cncf-kodekloud-member-reviewer`.
8. Run `skcr compile cncf-kodekloud-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kodekloud-member-reviewer`.
...
```bash
skpm validate cncf-kodekloud-member-reviewer
skpm package cncf-kodekloud-member-reviewer
skpm publish cncf-kodekloud-member-reviewer
```
