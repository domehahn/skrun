...
7. Run `skcr validate` and `skcr asps coverage cncf-amazon-kinesis-reviewer`.
8. Run `skcr compile cncf-amazon-kinesis-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-amazon-kinesis-reviewer`.
...
```bash
skpm validate cncf-amazon-kinesis-reviewer
skpm package cncf-amazon-kinesis-reviewer
skpm publish cncf-amazon-kinesis-reviewer
```
