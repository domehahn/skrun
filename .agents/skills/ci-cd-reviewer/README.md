...
7. Run `skcr validate` and `skcr asps coverage ci-cd-reviewer`.
8. Run `skcr compile ci-cd-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend ci-cd-reviewer`.
