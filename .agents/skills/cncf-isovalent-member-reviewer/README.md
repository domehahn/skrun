...
7. Run `skcr validate` and `skcr asps coverage cncf-isovalent-member-reviewer`.
8. Run `skcr compile cncf-isovalent-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-isovalent-member-reviewer`.
...
```bash
skpm validate cncf-isovalent-member-reviewer
skpm package cncf-isovalent-member-reviewer
skpm publish cncf-isovalent-member-reviewer
```
