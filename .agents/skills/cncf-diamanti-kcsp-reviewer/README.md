...
7. Run `skcr validate` and `skcr asps coverage cncf-diamanti-kcsp-reviewer`.
8. Run `skcr compile cncf-diamanti-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-diamanti-kcsp-reviewer`.
...
```bash
skpm validate cncf-diamanti-kcsp-reviewer
skpm package cncf-diamanti-kcsp-reviewer
skpm publish cncf-diamanti-kcsp-reviewer
```
