...
7. Run `skcr validate` and `skcr asps coverage cncf-sel4-reviewer`.
8. Run `skcr compile cncf-sel4-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sel4-reviewer`.
...
```bash
skpm validate cncf-sel4-reviewer
skpm package cncf-sel4-reviewer
skpm publish cncf-sel4-reviewer
```
