...
7. Run `skcr validate` and `skcr asps coverage cncf-b1-systems-kcsp-reviewer`.
8. Run `skcr compile cncf-b1-systems-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-b1-systems-kcsp-reviewer`.
...
```bash
skpm validate cncf-b1-systems-kcsp-reviewer
skpm package cncf-b1-systems-kcsp-reviewer
skpm publish cncf-b1-systems-kcsp-reviewer
```
