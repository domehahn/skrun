...
7. Run `skcr validate` and `skcr asps coverage cncf-squarespace-member-reviewer`.
8. Run `skcr compile cncf-squarespace-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-squarespace-member-reviewer`.
...
```bash
skpm validate cncf-squarespace-member-reviewer
skpm package cncf-squarespace-member-reviewer
skpm publish cncf-squarespace-member-reviewer
```
