...
7. Run `skcr validate` and `skcr asps coverage cncf-ntt-data-member-reviewer`.
8. Run `skcr compile cncf-ntt-data-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ntt-data-member-reviewer`.
...
```bash
skpm validate cncf-ntt-data-member-reviewer
skpm package cncf-ntt-data-member-reviewer
skpm publish cncf-ntt-data-member-reviewer
```
