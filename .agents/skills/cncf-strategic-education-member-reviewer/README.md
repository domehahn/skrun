...
7. Run `skcr validate` and `skcr asps coverage cncf-strategic-education-member-reviewer`.
8. Run `skcr compile cncf-strategic-education-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-strategic-education-member-reviewer`.
...
```bash
skpm validate cncf-strategic-education-member-reviewer
skpm package cncf-strategic-education-member-reviewer
skpm publish cncf-strategic-education-member-reviewer
```
