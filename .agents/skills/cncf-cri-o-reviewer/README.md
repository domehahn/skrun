...
7. Run `skcr validate` and `skcr asps coverage cncf-cri-o-reviewer`.
8. Run `skcr compile cncf-cri-o-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cri-o-reviewer`.
...
```bash
skpm validate cncf-cri-o-reviewer
skpm package cncf-cri-o-reviewer
skpm publish cncf-cri-o-reviewer
```
