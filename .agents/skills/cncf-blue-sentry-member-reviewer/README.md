...
7. Run `skcr validate` and `skcr asps coverage cncf-blue-sentry-member-reviewer`.
8. Run `skcr compile cncf-blue-sentry-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-blue-sentry-member-reviewer`.
...
```bash
skpm validate cncf-blue-sentry-member-reviewer
skpm package cncf-blue-sentry-member-reviewer
skpm publish cncf-blue-sentry-member-reviewer
```
