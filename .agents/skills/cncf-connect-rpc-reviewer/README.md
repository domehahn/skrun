...
7. Run `skcr validate` and `skcr asps coverage cncf-connect-rpc-reviewer`.
8. Run `skcr compile cncf-connect-rpc-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-connect-rpc-reviewer`.
...
```bash
skpm validate cncf-connect-rpc-reviewer
skpm package cncf-connect-rpc-reviewer
skpm publish cncf-connect-rpc-reviewer
```
