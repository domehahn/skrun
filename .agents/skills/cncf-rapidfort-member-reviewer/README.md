...
7. Run `skcr validate` and `skcr asps coverage cncf-rapidfort-member-reviewer`.
8. Run `skcr compile cncf-rapidfort-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-rapidfort-member-reviewer`.
...
```bash
skpm validate cncf-rapidfort-member-reviewer
skpm package cncf-rapidfort-member-reviewer
skpm publish cncf-rapidfort-member-reviewer
```
