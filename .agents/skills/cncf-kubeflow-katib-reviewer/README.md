...
7. Run `skcr validate` and `skcr asps coverage cncf-kubeflow-katib-reviewer`.
8. Run `skcr compile cncf-kubeflow-katib-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kubeflow-katib-reviewer`.
...
```bash
skpm validate cncf-kubeflow-katib-reviewer
skpm package cncf-kubeflow-katib-reviewer
skpm publish cncf-kubeflow-katib-reviewer
```
