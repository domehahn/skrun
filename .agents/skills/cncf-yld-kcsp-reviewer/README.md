...
7. Run `skcr validate` and `skcr asps coverage cncf-yld-kcsp-reviewer`.
8. Run `skcr compile cncf-yld-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-yld-kcsp-reviewer`.
...
```bash
skpm validate cncf-yld-kcsp-reviewer
skpm package cncf-yld-kcsp-reviewer
skpm publish cncf-yld-kcsp-reviewer
```
