...
7. Run `skcr validate` and `skcr asps coverage cncf-telepresence-reviewer`.
8. Run `skcr compile cncf-telepresence-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-telepresence-reviewer`.
...
```bash
skpm validate cncf-telepresence-reviewer
skpm package cncf-telepresence-reviewer
skpm publish cncf-telepresence-reviewer
```
