...
7. Run `skcr validate` and `skcr asps coverage cncf-agent-evaluation-reviewer`.
8. Run `skcr compile cncf-agent-evaluation-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-agent-evaluation-reviewer`.
...
```bash
skpm validate cncf-agent-evaluation-reviewer
skpm package cncf-agent-evaluation-reviewer
skpm publish cncf-agent-evaluation-reviewer
```
