...
7. Run `skcr validate` and `skcr asps coverage cncf-kubermatic-kcsp-reviewer`.
8. Run `skcr compile cncf-kubermatic-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kubermatic-kcsp-reviewer`.
...
```bash
skpm validate cncf-kubermatic-kcsp-reviewer
skpm package cncf-kubermatic-kcsp-reviewer
skpm publish cncf-kubermatic-kcsp-reviewer
```
