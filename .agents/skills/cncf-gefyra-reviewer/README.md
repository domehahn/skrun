...
7. Run `skcr validate` and `skcr asps coverage cncf-gefyra-reviewer`.
8. Run `skcr compile cncf-gefyra-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-gefyra-reviewer`.
...
```bash
skpm validate cncf-gefyra-reviewer
skpm package cncf-gefyra-reviewer
skpm publish cncf-gefyra-reviewer
```
