...
7. Run `skcr validate` and `skcr asps coverage cncf-better-stack-member-reviewer`.
8. Run `skcr compile cncf-better-stack-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-better-stack-member-reviewer`.
...
```bash
skpm validate cncf-better-stack-member-reviewer
skpm package cncf-better-stack-member-reviewer
skpm publish cncf-better-stack-member-reviewer
```
