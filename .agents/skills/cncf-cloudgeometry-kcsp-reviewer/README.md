...
7. Run `skcr validate` and `skcr asps coverage cncf-cloudgeometry-kcsp-reviewer`.
8. Run `skcr compile cncf-cloudgeometry-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloudgeometry-kcsp-reviewer`.
...
```bash
skpm validate cncf-cloudgeometry-kcsp-reviewer
skpm package cncf-cloudgeometry-kcsp-reviewer
skpm publish cncf-cloudgeometry-kcsp-reviewer
```
