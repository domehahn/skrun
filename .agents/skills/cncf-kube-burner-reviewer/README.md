...
7. Run `skcr validate` and `skcr asps coverage cncf-kube-burner-reviewer`.
8. Run `skcr compile cncf-kube-burner-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kube-burner-reviewer`.
...
```bash
skpm validate cncf-kube-burner-reviewer
skpm package cncf-kube-burner-reviewer
skpm publish cncf-kube-burner-reviewer
```
