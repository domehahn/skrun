...
7. Run `skcr validate` and `skcr asps coverage cncf-celonis-supporter-reviewer`.
8. Run `skcr compile cncf-celonis-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-celonis-supporter-reviewer`.
...
```bash
skpm validate cncf-celonis-supporter-reviewer
skpm package cncf-celonis-supporter-reviewer
skpm publish cncf-celonis-supporter-reviewer
```
