...
7. Run `skcr validate` and `skcr asps coverage cncf-pipekit-member-reviewer`.
8. Run `skcr compile cncf-pipekit-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-pipekit-member-reviewer`.
...
```bash
skpm validate cncf-pipekit-member-reviewer
skpm package cncf-pipekit-member-reviewer
skpm publish cncf-pipekit-member-reviewer
```
