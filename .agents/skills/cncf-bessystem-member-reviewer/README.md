...
7. Run `skcr validate` and `skcr asps coverage cncf-bessystem-member-reviewer`.
8. Run `skcr compile cncf-bessystem-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-bessystem-member-reviewer`.
...
```bash
skpm validate cncf-bessystem-member-reviewer
skpm package cncf-bessystem-member-reviewer
skpm publish cncf-bessystem-member-reviewer
```
