...
7. Run `skcr validate` and `skcr asps coverage operational-resilience-tester`.
8. Run `skcr compile operational-resilience-tester --target skil`.
9. Run `skcr sync` and `skcr version recommend operational-resilience-tester`.
...
```bash
skpm validate operational-resilience-tester
skpm package operational-resilience-tester
skpm publish operational-resilience-tester
```
