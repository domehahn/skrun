...
7. Run `skcr validate` and `skcr asps coverage cncf-pelotech-kcsp-reviewer`.
8. Run `skcr compile cncf-pelotech-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-pelotech-kcsp-reviewer`.
...
```bash
skpm validate cncf-pelotech-kcsp-reviewer
skpm package cncf-pelotech-kcsp-reviewer
skpm publish cncf-pelotech-kcsp-reviewer
```
