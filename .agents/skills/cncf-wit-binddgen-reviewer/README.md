...
7. Run `skcr validate` and `skcr asps coverage cncf-wit-binddgen-reviewer`.
8. Run `skcr compile cncf-wit-binddgen-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-wit-binddgen-reviewer`.
...
```bash
skpm validate cncf-wit-binddgen-reviewer
skpm package cncf-wit-binddgen-reviewer
skpm publish cncf-wit-binddgen-reviewer
```
