...
7. Run `skcr validate` and `skcr asps coverage cncf-sidero-talos-linux-reviewer`.
8. Run `skcr compile cncf-sidero-talos-linux-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sidero-talos-linux-reviewer`.
...
```bash
skpm validate cncf-sidero-talos-linux-reviewer
skpm package cncf-sidero-talos-linux-reviewer
skpm publish cncf-sidero-talos-linux-reviewer
```
