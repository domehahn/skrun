...
7. Run `skcr validate` and `skcr asps coverage cncf-wasm-pack-reviewer`.
8. Run `skcr compile cncf-wasm-pack-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-wasm-pack-reviewer`.
...
```bash
skpm validate cncf-wasm-pack-reviewer
skpm package cncf-wasm-pack-reviewer
skpm publish cncf-wasm-pack-reviewer
```
