...
7. Run `skcr validate` and `skcr asps coverage cncf-portworx-reviewer`.
8. Run `skcr compile cncf-portworx-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-portworx-reviewer`.
...
```bash
skpm validate cncf-portworx-reviewer
skpm package cncf-portworx-reviewer
skpm publish cncf-portworx-reviewer
```
