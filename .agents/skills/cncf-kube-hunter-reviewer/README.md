...
7. Run `skcr validate` and `skcr asps coverage cncf-kube-hunter-reviewer`.
8. Run `skcr compile cncf-kube-hunter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-kube-hunter-reviewer`.
...
```bash
skpm validate cncf-kube-hunter-reviewer
skpm package cncf-kube-hunter-reviewer
skpm publish cncf-kube-hunter-reviewer
```
