...
7. Run `skcr validate` and `skcr asps coverage cncf-nutanix-data-services-for-kubernetes-ndk-reviewer`.
8. Run `skcr compile cncf-nutanix-data-services-for-kubernetes-ndk-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-nutanix-data-services-for-kubernetes-ndk-reviewer`.
...
```bash
skpm validate cncf-nutanix-data-services-for-kubernetes-ndk-reviewer
skpm package cncf-nutanix-data-services-for-kubernetes-ndk-reviewer
skpm publish cncf-nutanix-data-services-for-kubernetes-ndk-reviewer
```
