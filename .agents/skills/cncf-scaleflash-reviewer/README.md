...
7. Run `skcr validate` and `skcr asps coverage cncf-scaleflash-reviewer`.
8. Run `skcr compile cncf-scaleflash-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-scaleflash-reviewer`.
...
```bash
skpm validate cncf-scaleflash-reviewer
skpm package cncf-scaleflash-reviewer
skpm publish cncf-scaleflash-reviewer
```
