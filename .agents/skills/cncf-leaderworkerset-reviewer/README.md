...
7. Run `skcr validate` and `skcr asps coverage cncf-leaderworkerset-reviewer`.
8. Run `skcr compile cncf-leaderworkerset-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-leaderworkerset-reviewer`.
...
```bash
skpm validate cncf-leaderworkerset-reviewer
skpm package cncf-leaderworkerset-reviewer
skpm publish cncf-leaderworkerset-reviewer
```
