...
7. Run `skcr validate` and `skcr asps coverage cncf-saic-kcsp-reviewer`.
8. Run `skcr compile cncf-saic-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-saic-kcsp-reviewer`.
...
```bash
skpm validate cncf-saic-kcsp-reviewer
skpm package cncf-saic-kcsp-reviewer
skpm publish cncf-saic-kcsp-reviewer
```
