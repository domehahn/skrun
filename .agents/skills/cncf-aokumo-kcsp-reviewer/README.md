...
7. Run `skcr validate` and `skcr asps coverage cncf-aokumo-kcsp-reviewer`.
8. Run `skcr compile cncf-aokumo-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-aokumo-kcsp-reviewer`.
...
```bash
skpm validate cncf-aokumo-kcsp-reviewer
skpm package cncf-aokumo-kcsp-reviewer
skpm publish cncf-aokumo-kcsp-reviewer
```
