...
7. Run `skcr validate` and `skcr asps coverage cncf-mirantis-kubernetes-engine-reviewer`.
8. Run `skcr compile cncf-mirantis-kubernetes-engine-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-mirantis-kubernetes-engine-reviewer`.
...
```bash
skpm validate cncf-mirantis-kubernetes-engine-reviewer
skpm package cncf-mirantis-kubernetes-engine-reviewer
skpm publish cncf-mirantis-kubernetes-engine-reviewer
```
