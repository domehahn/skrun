...
7. Run `skcr validate` and `skcr asps coverage cncf-wise2c-member-reviewer`.
8. Run `skcr compile cncf-wise2c-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-wise2c-member-reviewer`.
...
```bash
skpm validate cncf-wise2c-member-reviewer
skpm package cncf-wise2c-member-reviewer
skpm publish cncf-wise2c-member-reviewer
```
