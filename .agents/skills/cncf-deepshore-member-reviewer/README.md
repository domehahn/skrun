...
7. Run `skcr validate` and `skcr asps coverage cncf-deepshore-member-reviewer`.
8. Run `skcr compile cncf-deepshore-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-deepshore-member-reviewer`.
...
```bash
skpm validate cncf-deepshore-member-reviewer
skpm package cncf-deepshore-member-reviewer
skpm publish cncf-deepshore-member-reviewer
```
