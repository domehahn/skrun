...
7. Run `skcr validate` and `skcr asps coverage cncf-ericsson-cloud-container-distribution-reviewer`.
8. Run `skcr compile cncf-ericsson-cloud-container-distribution-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ericsson-cloud-container-distribution-reviewer`.
...
```bash
skpm validate cncf-ericsson-cloud-container-distribution-reviewer
skpm package cncf-ericsson-cloud-container-distribution-reviewer
skpm publish cncf-ericsson-cloud-container-distribution-reviewer
```
