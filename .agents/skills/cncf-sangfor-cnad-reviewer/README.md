...
7. Run `skcr validate` and `skcr asps coverage cncf-sangfor-cnad-reviewer`.
8. Run `skcr compile cncf-sangfor-cnad-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sangfor-cnad-reviewer`.
...
```bash
skpm validate cncf-sangfor-cnad-reviewer
skpm package cncf-sangfor-cnad-reviewer
skpm publish cncf-sangfor-cnad-reviewer
```
