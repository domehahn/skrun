...
7. Run `skcr validate` and `skcr asps coverage cncf-gim-uemoa-member-reviewer`.
8. Run `skcr compile cncf-gim-uemoa-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-gim-uemoa-member-reviewer`.
...
```bash
skpm validate cncf-gim-uemoa-member-reviewer
skpm package cncf-gim-uemoa-member-reviewer
skpm publish cncf-gim-uemoa-member-reviewer
```
