...
7. Run `skcr validate` and `skcr asps coverage cncf-cloudify-reviewer`.
8. Run `skcr compile cncf-cloudify-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cloudify-reviewer`.
...
```bash
skpm validate cncf-cloudify-reviewer
skpm package cncf-cloudify-reviewer
skpm publish cncf-cloudify-reviewer
```
