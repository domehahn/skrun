...
7. Run `skcr validate` and `skcr asps coverage cncf-sonobuoy-reviewer`.
8. Run `skcr compile cncf-sonobuoy-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-sonobuoy-reviewer`.
...
```bash
skpm validate cncf-sonobuoy-reviewer
skpm package cncf-sonobuoy-reviewer
skpm publish cncf-sonobuoy-reviewer
```
