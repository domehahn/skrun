...
7. Run `skcr validate` and `skcr asps coverage cncf-ovn-kubernetes-reviewer`.
8. Run `skcr compile cncf-ovn-kubernetes-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ovn-kubernetes-reviewer`.
...
```bash
skpm validate cncf-ovn-kubernetes-reviewer
skpm package cncf-ovn-kubernetes-reviewer
skpm publish cncf-ovn-kubernetes-reviewer
```
