...
7. Run `skcr validate` and `skcr asps coverage cncf-trink-io-reviewer`.
8. Run `skcr compile cncf-trink-io-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-trink-io-reviewer`.
...
```bash
skpm validate cncf-trink-io-reviewer
skpm package cncf-trink-io-reviewer
skpm publish cncf-trink-io-reviewer
```
