...
7. Run `skcr validate` and `skcr asps coverage cncf-crun-reviewer`.
8. Run `skcr compile cncf-crun-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-crun-reviewer`.
...
```bash
skpm validate cncf-crun-reviewer
skpm package cncf-crun-reviewer
skpm publish cncf-crun-reviewer
```
