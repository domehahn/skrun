...
7. Run `skcr validate` and `skcr asps coverage cncf-lagoon-reviewer`.
8. Run `skcr compile cncf-lagoon-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-lagoon-reviewer`.
...
```bash
skpm validate cncf-lagoon-reviewer
skpm package cncf-lagoon-reviewer
skpm publish cncf-lagoon-reviewer
```
