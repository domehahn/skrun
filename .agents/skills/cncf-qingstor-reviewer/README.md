...
7. Run `skcr validate` and `skcr asps coverage cncf-qingstor-reviewer`.
8. Run `skcr compile cncf-qingstor-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-qingstor-reviewer`.
...
```bash
skpm validate cncf-qingstor-reviewer
skpm package cncf-qingstor-reviewer
skpm publish cncf-qingstor-reviewer
```
