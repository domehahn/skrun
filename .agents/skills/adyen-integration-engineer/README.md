...
7. Run `skcr validate` and `skcr asps coverage adyen-integration-engineer`.
8. Run `skcr compile adyen-integration-engineer --target skil`.
9. Run `skcr sync` and `skcr version recommend adyen-integration-engineer`.
...
```bash
skpm validate adyen-integration-engineer
skpm package adyen-integration-engineer
skpm publish adyen-integration-engineer
```
