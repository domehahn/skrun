...
7. Run `skcr validate` and `skcr asps coverage cncf-tigera-member-reviewer`.
8. Run `skcr compile cncf-tigera-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-tigera-member-reviewer`.
...
```bash
skpm validate cncf-tigera-member-reviewer
skpm package cncf-tigera-member-reviewer
skpm publish cncf-tigera-member-reviewer
```
