...
7. Run `skcr validate` and `skcr asps coverage cncf-gcore-managed-kubernetes-reviewer`.
8. Run `skcr compile cncf-gcore-managed-kubernetes-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-gcore-managed-kubernetes-reviewer`.
...
```bash
skpm validate cncf-gcore-managed-kubernetes-reviewer
skpm package cncf-gcore-managed-kubernetes-reviewer
skpm publish cncf-gcore-managed-kubernetes-reviewer
```
