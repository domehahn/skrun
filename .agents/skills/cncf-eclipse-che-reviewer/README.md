...
7. Run `skcr validate` and `skcr asps coverage cncf-eclipse-che-reviewer`.
8. Run `skcr compile cncf-eclipse-che-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-eclipse-che-reviewer`.
...
```bash
skpm validate cncf-eclipse-che-reviewer
skpm package cncf-eclipse-che-reviewer
skpm publish cncf-eclipse-che-reviewer
```
