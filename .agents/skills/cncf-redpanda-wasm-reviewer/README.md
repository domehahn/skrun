...
7. Run `skcr validate` and `skcr asps coverage cncf-redpanda-wasm-reviewer`.
8. Run `skcr compile cncf-redpanda-wasm-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-redpanda-wasm-reviewer`.
...
```bash
skpm validate cncf-redpanda-wasm-reviewer
skpm package cncf-redpanda-wasm-reviewer
skpm publish cncf-redpanda-wasm-reviewer
```
