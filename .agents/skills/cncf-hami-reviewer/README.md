...
7. Run `skcr validate` and `skcr asps coverage cncf-hami-reviewer`.
8. Run `skcr compile cncf-hami-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-hami-reviewer`.
...
```bash
skpm validate cncf-hami-reviewer
skpm package cncf-hami-reviewer
skpm publish cncf-hami-reviewer
```
