...
7. Run `skcr validate` and `skcr asps coverage cncf-infros-member-reviewer`.
8. Run `skcr compile cncf-infros-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-infros-member-reviewer`.
...
```bash
skpm validate cncf-infros-member-reviewer
skpm package cncf-infros-member-reviewer
skpm publish cncf-infros-member-reviewer
```
