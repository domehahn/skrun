...
7. Run `skcr validate` and `skcr asps coverage cncf-apache-age-reviewer`.
8. Run `skcr compile cncf-apache-age-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-apache-age-reviewer`.
...
```bash
skpm validate cncf-apache-age-reviewer
skpm package cncf-apache-age-reviewer
skpm publish cncf-apache-age-reviewer
```
