...
7. Run `skcr validate` and `skcr asps coverage cncf-ibm-turbonomic-reviewer`.
8. Run `skcr compile cncf-ibm-turbonomic-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-ibm-turbonomic-reviewer`.
...
```bash
skpm validate cncf-ibm-turbonomic-reviewer
skpm package cncf-ibm-turbonomic-reviewer
skpm publish cncf-ibm-turbonomic-reviewer
```
