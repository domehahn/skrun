...
7. Run `skcr validate` and `skcr asps coverage cncf-tigera-reviewer`.
8. Run `skcr compile cncf-tigera-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-tigera-reviewer`.
...
```bash
skpm validate cncf-tigera-reviewer
skpm package cncf-tigera-reviewer
skpm publish cncf-tigera-reviewer
```
