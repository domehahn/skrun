...
7. Run `skcr validate` and `skcr asps coverage cncf-aokumo-member-reviewer`.
8. Run `skcr compile cncf-aokumo-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-aokumo-member-reviewer`.
...
```bash
skpm validate cncf-aokumo-member-reviewer
skpm package cncf-aokumo-member-reviewer
skpm publish cncf-aokumo-member-reviewer
```
