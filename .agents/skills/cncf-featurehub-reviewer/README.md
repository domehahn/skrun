...
7. Run `skcr validate` and `skcr asps coverage cncf-featurehub-reviewer`.
8. Run `skcr compile cncf-featurehub-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-featurehub-reviewer`.
...
```bash
skpm validate cncf-featurehub-reviewer
skpm package cncf-featurehub-reviewer
skpm publish cncf-featurehub-reviewer
```
