...
7. Run `skcr validate` and `skcr asps coverage cncf-neevcloud-member-reviewer`.
8. Run `skcr compile cncf-neevcloud-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-neevcloud-member-reviewer`.
...
```bash
skpm validate cncf-neevcloud-member-reviewer
skpm package cncf-neevcloud-member-reviewer
skpm publish cncf-neevcloud-member-reviewer
```
