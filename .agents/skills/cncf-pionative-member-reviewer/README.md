...
7. Run `skcr validate` and `skcr asps coverage cncf-pionative-member-reviewer`.
8. Run `skcr compile cncf-pionative-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-pionative-member-reviewer`.
...
```bash
skpm validate cncf-pionative-member-reviewer
skpm package cncf-pionative-member-reviewer
skpm publish cncf-pionative-member-reviewer
```
