...
7. Run `skcr validate` and `skcr asps coverage cncf-effodio-member-reviewer`.
8. Run `skcr compile cncf-effodio-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-effodio-member-reviewer`.
...
```bash
skpm validate cncf-effodio-member-reviewer
skpm package cncf-effodio-member-reviewer
skpm publish cncf-effodio-member-reviewer
```
