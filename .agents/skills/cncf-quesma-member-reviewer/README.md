...
7. Run `skcr validate` and `skcr asps coverage cncf-quesma-member-reviewer`.
8. Run `skcr compile cncf-quesma-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-quesma-member-reviewer`.
...
```bash
skpm validate cncf-quesma-member-reviewer
skpm package cncf-quesma-member-reviewer
skpm publish cncf-quesma-member-reviewer
```
