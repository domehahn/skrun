...
7. Run `skcr validate` and `skcr asps coverage cncf-cardinal-health-supporter-reviewer`.
8. Run `skcr compile cncf-cardinal-health-supporter-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-cardinal-health-supporter-reviewer`.
...
```bash
skpm validate cncf-cardinal-health-supporter-reviewer
skpm package cncf-cardinal-health-supporter-reviewer
skpm publish cncf-cardinal-health-supporter-reviewer
```
