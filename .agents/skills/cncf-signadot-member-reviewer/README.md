...
7. Run `skcr validate` and `skcr asps coverage cncf-signadot-member-reviewer`.
8. Run `skcr compile cncf-signadot-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-signadot-member-reviewer`.
...
```bash
skpm validate cncf-signadot-member-reviewer
skpm package cncf-signadot-member-reviewer
skpm publish cncf-signadot-member-reviewer
```
