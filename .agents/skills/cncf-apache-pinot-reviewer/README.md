...
7. Run `skcr validate` and `skcr asps coverage cncf-apache-pinot-reviewer`.
8. Run `skcr compile cncf-apache-pinot-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-apache-pinot-reviewer`.
...
```bash
skpm validate cncf-apache-pinot-reviewer
skpm package cncf-apache-pinot-reviewer
skpm publish cncf-apache-pinot-reviewer
```
