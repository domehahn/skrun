...
7. Run `skcr validate` and `skcr asps coverage cncf-victoriametrics-reviewer`.
8. Run `skcr compile cncf-victoriametrics-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-victoriametrics-reviewer`.
...
```bash
skpm validate cncf-victoriametrics-reviewer
skpm package cncf-victoriametrics-reviewer
skpm publish cncf-victoriametrics-reviewer
```
