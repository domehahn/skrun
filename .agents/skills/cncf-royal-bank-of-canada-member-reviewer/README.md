...
7. Run `skcr validate` and `skcr asps coverage cncf-royal-bank-of-canada-member-reviewer`.
8. Run `skcr compile cncf-royal-bank-of-canada-member-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-royal-bank-of-canada-member-reviewer`.
...
```bash
skpm validate cncf-royal-bank-of-canada-member-reviewer
skpm package cncf-royal-bank-of-canada-member-reviewer
skpm publish cncf-royal-bank-of-canada-member-reviewer
```
