...
7. Run `skcr validate` and `skcr asps coverage cncf-open-cluster-management-reviewer`.
8. Run `skcr compile cncf-open-cluster-management-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-open-cluster-management-reviewer`.
...
```bash
skpm validate cncf-open-cluster-management-reviewer
skpm package cncf-open-cluster-management-reviewer
skpm publish cncf-open-cluster-management-reviewer
```
