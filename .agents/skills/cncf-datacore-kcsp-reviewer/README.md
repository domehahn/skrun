...
7. Run `skcr validate` and `skcr asps coverage cncf-datacore-kcsp-reviewer`.
8. Run `skcr compile cncf-datacore-kcsp-reviewer --target skil`.
9. Run `skcr sync` and `skcr version recommend cncf-datacore-kcsp-reviewer`.
...
```bash
skpm validate cncf-datacore-kcsp-reviewer
skpm package cncf-datacore-kcsp-reviewer
skpm publish cncf-datacore-kcsp-reviewer
```
